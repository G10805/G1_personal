...
import vendor.qti.hardware.data.iwlan.V1_1.IIWlanIndication;
...
public class IWlanIndication extends IIWlanIndication.Stub {
     ...
     */
    public void dataCallListChangeIndication(ArrayList<android.hardware.radio.V1_4.SetupDataCallResult> dcList) {
        mProxy.iwlanLog.e(IWlanDataService.TAG, "dataCallListChangeIndication V1_0 should not be called!");
    }
    public void dataCallListChangeIndication_1_1(ArrayList<SetupDataCallResult> dcList) {
        mProxy.iwlanLog.d(IWlanDataService.TAG, "dataCallListChangeIndication_1_1");
     ...
     */
    public void unthrottleApn(String apn) {
        mProxy.iwlanLog.d(IWlanDataService.TAG, "unthrottleApn " + apn);
        mProxy.sendAck(IWlanDataService.TAG);
        mProxy.mApnUnthrottledRegistrants.notifyRegistrants(new AsyncResult(null, apn, null));
    }
}
