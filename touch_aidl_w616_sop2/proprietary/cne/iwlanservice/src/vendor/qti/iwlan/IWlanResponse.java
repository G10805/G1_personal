...
import vendor.qti.hardware.data.iwlan.V1_1.IIWlanResponse;
...
public class IWlanResponse extends IIWlanResponse.Stub {
    ...
    static String setDataCallResponseToString(SetupDataCallResult setupDataCallResult) {
        ...
        b.append(", MTU V4  = " + setupDataCallResult.mtuV4);
        b.append(", MTU V6  = " + setupDataCallResult.mtuV6);
        return b.toString();
    }
    ...
    public void setupDataCallResponse(IWlanResponseInfo responseInfo,
        ...
        mProxy.iwlanLog.e(IWlanDataService.TAG, "setupDataCallResponse V1_0 should not be called!");
    }
    public void setupDataCallResponse_1_1(IWlanResponseInfo responseInfo,
                                          SetupDataCallResult setupDataCallResult) {
        mProxy.iwlanLog.d(IWlanDataService.TAG, "setupDataCallResponse_1_1: " + responseInfoToString(responseInfo));
        mProxy.iwlanLog.d(IWlanDataService.TAG, "setupDataCallResponse_1_1: " + setDataCallResponseToString(setupDataCallResult));
    ...
    public void getDataCallListResponse(IWlanResponseInfo responseInfo,
        ...
        mProxy.iwlanLog.e(IWlanDataService.TAG, "getDataCallListResponse V1_0 should not be called!");
    }
    public void getDataCallListResponse_1_1(IWlanResponseInfo responseInfo,
                                            ArrayList<SetupDataCallResult> dataCallResultList) {
        mProxy.iwlanLog.d(IWlanDataService.TAG, "getDataCallListResponse_1_1: " + dataCallResultListToString(dataCallResultList));
    ...
    private void responseDataCallList(IWlanResponseInfo responseInfo,
        ...
        if (rr != null) {
            ...
            mProxy.iwlanLog.e(IWlanDataService.TAG, "responseDataCallList: request not found");
        }
    }
    ...
    private void responseDataRegistrationState(IWlanResponseInfo responseInfo, IWlanDataRegStateResult state) {
        ...
        if (rr != null) {
            ...
            mProxy.iwlanLog.e(IWlanDataService.TAG, "responseDataRegistrationState: request not found");
        }
    }
    ...
    private void responseQualifiedNetworksChanged(IWlanResponseInfo responseInfo,
        ...
        if (rr != null) {
            ...
            mProxy.iwlanLog.e(IWlanDataService.TAG, "responseQualifiedNetworksChanged: request not found");
        }
    }
}
