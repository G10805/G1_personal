...
ifeq ($(TARGET_ENABLE_TIMER_LISTENER), true)
QSEECOM_CFLAGS += -DTARGET_ENABLE_TIMER_LISTENER
endif #TARGET_ENABLE_TIMER_LISTENER

ifeq ($(TAGRET_ENABLE_SECURE_PROCESSOR_LISTENER), true)
QSEECOM_CFLAGS += -DTAGRET_ENABLE_SECURE_PROCESSOR_LISTENER
endif #TAGRET_ENABLE_SECURE_PROCESSOR_LISTENER

ifeq ($(TARGET_ENABLE_INTERRUPT_SERVICE_LISTENER), true)
QSEECOM_CFLAGS += -DTARGET_ENABLE_INTERRUPT_SERVICE_LISTENER
endif #TARGET_ENABLE_INTERRUPT_SERVICE_LISTENER
