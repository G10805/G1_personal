...
KEYMINT_DISABLE_DELETE_ALL_KEYS := true
endif # ifneq ($(TARGET_USES_QMAA_OVERRIDE_KMGK),true)
else # ifeq ($(TARGET_USES_QMAA),true)
# Non-QMAA mode configuration
...
# kalpeni/pitti specific defines
...
# pakala/sun specific defines
ifeq ($(TARGET_BOARD_PLATFORM),sun)
KMGK_USE_QTI_SERVICE := true
ENABLE_KEYMINT := true
ENABLE_STRONGBOX_KM := false
GATEKEEPER_IS_SECURITY_LEVEL_SPU := true
ENABLE_KMGK_FUZZER := true
endif
