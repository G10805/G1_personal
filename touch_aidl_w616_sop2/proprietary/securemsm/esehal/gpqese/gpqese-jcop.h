/**
 * Copyright (c) 2021,2023-24 Qualcomm Technologies, Inc.
 * All Rights Reserved.
...
#define SN300_OS_VERSION_ID      0x30
...
#define MAX_NUM_CHANNELS_STSAFE320    20
...
/**
 * @brief Read vendorId from GetAtr output.
 *
 * This function will read the vendorId field present in the GetAtr response.
 *
 * @return vendorId
 */

uint8_t getAtrVendorID();
