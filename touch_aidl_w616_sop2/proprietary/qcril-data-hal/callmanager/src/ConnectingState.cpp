          ...
          switch (netEvent) {
            case DSI_EVT_NET_IS_CONN:
            {
              ...
              if (callInfo.isEmbmsCall) {
                ...
                if(dsiGetDeviceName(callInfo.dsiHandle, device_name) == DSI_SUCCESS &&
                   qcril_data_get_ifindex(callInfo.deviceName.c_str(), &if_index) == DSI_SUCCESS)
                {
              ...
              if(!callInfo.isEmbmsCall &&
                ...
                if(dsiGetCurrentDataBearerTech(callInfo.dsiHandle, currentDataBearerRAT) == DSI_SUCCESS) {
            ...
            case DSI_EVT_NET_ERR_CALL_EXISTS:
            {
              ...
              dsiCheckIfCallExists(callInfo.dsiHandle,
