...
public:
  ...
  void handleEmbmsEnableDataRequestMessage();
  void handleEmbmsActivateTmgi(embms_activate_tmgi_req_msg_v01 req, std::shared_ptr<Message> msg);
  void handleEmbmsDeactivateTmgi(embms_deactivate_tmgi_req_msg_v01 req, std::shared_ptr<Message> msg);
  void handleEmbmsActivateDeactivateTmgi(embms_activate_deactivate_tmgi_req_msg_v01 req, std::shared_ptr<Message> msg);
  void handleEmbmsContentDescUpdate(embms_update_content_desc_req_msg_v01 req, std::shared_ptr<Message> msg);
  void handleEmbmsGetActiveTmgi(embms_get_active_tmgi_req_msg_v01 req, std::shared_ptr<Message> msg);
  void handleEmbmsGetAvailableTmgi(embms_get_available_tmgi_req_msg_v01 req, std::shared_ptr<Message> msg);
  void handleEmbmsSendInterestedList(embms_get_interested_tmgi_list_resp_msg_v01 req, std::shared_ptr<Message> msg);
