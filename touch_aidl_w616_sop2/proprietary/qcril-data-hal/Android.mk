...
LOCAL_CFLAGS               += -Wall -Werror -Wno-macro-redefined -Wno-unused-parameter -Wno-reorder-ctor -DFEATURE_DATA_LOG_QXDM -DFEATURE_QDP_LINUX_ANDROID
...
LOCAL_SHARED_LIBRARIES     += vendor.qti.hardware.data.iwlan@1.1
...
LOCAL_SHARED_LIBRARIES += android.hardware.radio-V1-ndk
LOCAL_SHARED_LIBRARIES += android.hardware.radio.data-V1-ndk
