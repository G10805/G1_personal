...
static inline char *StateToString(xm_sm_state state)
{
  ...
  else if (state == XPAN_Connecting)
    return "XPAN_Connecting";
  else if (state == XPAN_Connected)
    return "XPAN_Connected";
  else if (state == XPAN_Disconnecting)
