...
enum {
  ...
  ROME_VER_3_4 = QCA_BT_VER(ROME_SOC_ID_44, PROD_ID_ROME, ROME_PATCH_VER_0304),
};
...
class PatchDLManager {
 ...
 protected:
  ...
  int ReadNewHciEventWithTimer(unsigned char* buf, int size);
  ...
  void SetBtProperty();
  void SetBtSocProperty(const char* soc);
  void SetTokenKeyProperty(bool supported);
