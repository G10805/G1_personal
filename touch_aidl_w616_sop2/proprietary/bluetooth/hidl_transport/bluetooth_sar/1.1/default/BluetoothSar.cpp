...
#undef LOG_TAG
#define LOG_TAG "vendor.qti.hardware.bluetooth_sar@1.1-BluetoothSar"
namespace vendor {
namespace qti {
namespace hardware {
...
Return<void> BluetoothSar::setBluetoothTechBasedTxPowerCap(int8_t br_cap, int8_t edr_cap, int8_t ble_cap) {
