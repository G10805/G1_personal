...
PRODUCT_PACKAGES += android.hardware.bluetooth@1.1-service-qti-lazy
PRODUCT_PACKAGES += android.hardware.bluetooth@1.1-service-qti-lazy.rc
else
...
ifeq ($(BOARD_HAVE_QTI_BT_SERVICE_VER_1_1), true)
PRODUCT_PACKAGES += android.hardware.bluetooth@1.1-service-qti
PRODUCT_PACKAGES += android.hardware.bluetooth@1.1-service-qti.rc
else
...
PRODUCT_PACKAGES += android.hardware.bluetooth.audio-impl-qti
...
PRODUCT_PACKAGES_DEBUG += btftmdaemon
endif
...
#BTTPI
ifeq ($(TARGET_USES_QTI_BTTPI), true)
PRODUCT_PACKAGES += vendor.qti.hardware.bttpi-V1-ndk
PRODUCT_PACKAGES += vendor.qti.hardware.bttpi-impl
