...
ifneq ($(LINUX_OMX_TEST_ONLY_ENCODE), true)
# b/146051949
vtest-inc        += $(TOP)/system/memory/libion/include
vtest-inc        += $(TOP)/system/memory/libion/kernel-headers
...
ifeq ($(if test -f $(GPU_PP_PATH)/gpupostprocessing.h; then echo true; else echo false; fi;),true)
...
ifeq ($(if test -f $(C2DCC_PP_PATH)/C2DColorConverter.h; then echo true; else echo false; fi;),true)
...
ifeq ($(if test -f $(MMCC_PP_PATH)/MMColorConvert.h; then echo true; else echo false; fi;),true)
