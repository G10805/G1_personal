...
# -------------------------------------------------------------------------------------------------------
#             Populate memory optimized ACDB data files to file system for Scuba IDP Bolero/Rouleur Codec
# -------------------------------------------------------------------------------------------------------
ifeq ($(TARGET_1G_DDR_RAM), true)
include $(CLEAR_VARS)
LOCAL_MODULE            := IDP_Scuba_Bluetooth_cal_opt.acdb
LOCAL_MODULE_FILENAME   := Bluetooth_cal.acdb
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/bengal-scubaidp-snd-card
LOCAL_SRC_FILES         := IDP/bengal_scubaidp-mem-opt/Bluetooth_cal.acdb
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE            := IDP_Scuba_General_cal_opt.acdb
LOCAL_MODULE_FILENAME   := General_cal.acdb
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/bengal-scubaidp-snd-card
LOCAL_SRC_FILES         := IDP/bengal_scubaidp-mem-opt/General_cal.acdb
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE            := IDP_Scuba_Global_cal_opt.acdb
LOCAL_MODULE_FILENAME   := Global_cal.acdb
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/bengal-scubaidp-snd-card
LOCAL_SRC_FILES         := IDP/bengal_scubaidp-mem-opt/Global_cal.acdb
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE            := IDP_Scuba_Handset_cal_opt.acdb
LOCAL_MODULE_FILENAME   := Handset_cal.acdb
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/bengal-scubaidp-snd-card
LOCAL_SRC_FILES         := IDP/bengal_scubaidp-mem-opt/Handset_cal.acdb
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE            := IDP_Scuba_Hdmi_cal_opt.acdb
LOCAL_MODULE_FILENAME   := Hdmi_cal.acdb
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/bengal-scubaidp-snd-card
LOCAL_SRC_FILES         := IDP/bengal_scubaidp-mem-opt/Hdmi_cal.acdb
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE            := IDP_Scuba_Headset_cal_opt.acdb
LOCAL_MODULE_FILENAME   := Headset_cal.acdb
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/bengal-scubaidp-snd-card
LOCAL_SRC_FILES         := IDP/bengal_scubaidp-mem-opt/Headset_cal.acdb
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE            := IDP_Scuba_Speaker_cal_opt.acdb
LOCAL_MODULE_FILENAME   := Speaker_cal.acdb
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/bengal-scubaidp-snd-card
LOCAL_SRC_FILES         := IDP/bengal_scubaidp-mem-opt/Speaker_cal.acdb
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE            := IDP_Scuba_workspaceFile_opt.qwsp
LOCAL_MODULE_FILENAME   := workspaceFile.qwsp
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/bengal-scubaidp-snd-card
LOCAL_SRC_FILES         := IDP/bengal_scubaidp-mem-opt/workspaceFile.qwsp
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/bengal-scubaidp-snd-card
LOCAL_SRC_FILES         := IDP/bengal-scubaidp-snd-card/Bluetooth_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/bengal-scubaidp-snd-card
LOCAL_SRC_FILES         := IDP/bengal-scubaidp-snd-card/General_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/bengal-scubaidp-snd-card
LOCAL_SRC_FILES         := IDP/bengal-scubaidp-snd-card/Global_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/bengal-scubaidp-snd-card
LOCAL_SRC_FILES         := IDP/bengal-scubaidp-snd-card/Handset_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/bengal-scubaidp-snd-card
LOCAL_SRC_FILES         := IDP/bengal-scubaidp-snd-card/Hdmi_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/bengal-scubaidp-snd-card
LOCAL_SRC_FILES         := IDP/bengal-scubaidp-snd-card/Headset_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/bengal-scubaidp-snd-card
LOCAL_SRC_FILES         := IDP/bengal-scubaidp-snd-card/Speaker_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/IDP/bengal-scubaidp-snd-card
LOCAL_SRC_FILES         := IDP/bengal-scubaidp-snd-card/workspaceFile.qwsp
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES         := QRD/bengal-scubaqrd-snd-card/Bluetooth_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/bengal-scubaqrd-snd-card
LOCAL_SRC_FILES         := QRD/bengal-scubaqrd-snd-card/General_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/bengal-scubaqrd-snd-card
LOCAL_SRC_FILES         := QRD/bengal-scubaqrd-snd-card/Global_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/bengal-scubaqrd-snd-card
LOCAL_SRC_FILES         := QRD/bengal-scubaqrd-snd-card/Handset_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/bengal-scubaqrd-snd-card
LOCAL_SRC_FILES         := QRD/bengal-scubaqrd-snd-card/Hdmi_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/bengal-scubaqrd-snd-card
LOCAL_SRC_FILES         := QRD/bengal-scubaqrd-snd-card/Headset_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/bengal-scubaqrd-snd-card
LOCAL_SRC_FILES         := QRD/bengal-scubaqrd-snd-card/Speaker_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/acdbdata/QRD/bengal-scubaqrd-snd-card
LOCAL_SRC_FILES         := QRD/bengal-scubaqrd-snd-card/workspaceFile.qwsp
include $(BUILD_PREBUILT)
