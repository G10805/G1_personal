/*===========================================================================
    ...
    DEPENDENCIES:   None
                    ...
                    Copyright (c) 2012, 2016, 2020, 2024 Qualcomm Technologies, Inc.
                    All Rights Reserved.
...
#else
#define ACDB_DELTA_FILE_PATH "/etc/acdbdata/delta/"
#endif
...
uint32_t GetDeltaFileName(const char* pFilename, uint32_t fileNameLen __attribute__((__unused__)), char* pDeltaFileName, uint32_t dlen)
{
   ...
   if(deltaFileNameSize > dlen) {
       ACDB_DEBUG_LOG("[%s] delta file name size %u is more than memory given %u",
