 ...
 *
 * Copyright (c) 2010-2021 by Qualcomm Technologies, Inc.
 * All Rights Reserved.
 ...
 *
 * RETURN VALUE : ret, DIAG_INIT_SUCCESS when successful
 *                     DIAG_INIT_FAILURE on Diag_LSM_Init failure
...
{
    int32_t ret = DIAG_INIT_SUCCESS;
    if (!Diag_LSM_Init(NULL))
    {
      ret = DIAG_INIT_FAILURE;
    }
    else
    {
#ifndef ACDB_WIN32_SIM
