/**
  ...
  * None.
  *
  * Copyright (c) 2011-2017, 2024 by Qualcomm Technologies, Inc.
  * All Rights Reserved.
   ...
   )
{
   ...
   {
      ACDB_DEBUG_LOG("[ACPH Online]->[set_acdb_data]->Failed. Could not find number of indices of the table:[%d]\n", tblId);
