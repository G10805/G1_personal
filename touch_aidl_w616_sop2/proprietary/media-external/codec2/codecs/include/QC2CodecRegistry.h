 ...
 **************************************************************************************************
*/
#ifndef _QC2_COMPONENT_REGISTRY_H_
#define _QC2_COMPONENT_REGISTRY_H_
...
struct QC2CodecRegistry {
    ...
    static QC2Status BuildCodecForInterface(const std::string& name,
                                            ...
                                            std::shared_ptr<QC2Codec> * const codec);
 ...
 private:
    static QC2Status GetPipelineStagesForCodec(const std::string& name,
                                  std::vector<std::unique_ptr<QC2Codec>> *codecs);
...
#endif  // _QC2_COMPONENT_REGISTRY_H_
