...
#ifndef __ABA_FOSS_H__
#define __ABA_FOSS_H__
...
#define ABA_FOSS_VERSION \
  (ABA_FOSS_VERSION_MAJOR << 24 | ABA_FOSS_VERSION_MINOR << 16 | ABA_FOSS_VERSION_REVISION)
