 ...
 **************************************************************************************************
*/
#ifndef _QC2AUDIO_AUDIO_HW_QCELP_ENC_H_
#define _QC2AUDIO_AUDIO_HW_QCELP_ENC_H_
...
class QC2AudioHwQcelpEnc : public QC2AudioHwCodec {
 public:
    ...
    virtual ~QC2AudioHwQcelpEnc() = default;
 ...
 protected:
    ...
    std::shared_ptr<QC2QcelpEncConfig> mEncoderConfig;
...
#endif  // _QC2AUDIO_AUDIO_HW_QCELP_ENC_H_
