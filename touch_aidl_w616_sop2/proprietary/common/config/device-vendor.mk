...
ifeq ($(filter $(TARGET_BOARD_PLATFORM), msm8996 msm8998 sdm845 msmnile gen4 gen5 kona),$(TARGET_BOARD_PLATFORM))
...
PRODUCT_LIST += msmnile_gvmq_vcu
PRODUCT_LIST += msmnile_gvmq_s_u
PRODUCT_LIST += msmnile_au_s_u
PRODUCT_LIST += gen4_au
PRODUCT_LIST += gen4_gvm
PRODUCT_LIST += gen4_gvm_gy
PRODUCT_LIST += gen5_gvm_gy
PRODUCT_LIST += gen5_gvm
PRODUCT_LIST += gen4_gvm_microdroid
PRODUCT_LIST += qcs605
PRODUCT_LIST += qssi
...
ifeq ($(TARGET_BOARD_AUTO), true)
  target_base_product:=$(TARGET_BOARD_PLATFORM)$(TARGET_BOARD_SUFFIX)$(TARGET_BOARD_DERIVATIVE_SUFFIX)
endif
...
ifneq (, $(filter $(PRODUCT_LIST), $(target_base_product)))
  ...
  else ifneq ($(strip $(TARGET_BOARD_SUFFIX)$(TARGET_BOARD_DERIVATIVE_SUFFIX)),)
    PREBUILT_BOARD_PLATFORM_DIR := $(TARGET_BOARD_PLATFORM)$(TARGET_BOARD_SUFFIX)$(TARGET_BOARD_DERIVATIVE_SUFFIX)
  else
...
ifneq ($(filter $(TARGET_BOARD_PLATFORM), msm8953 msm8937 msmnile),$(TARGET_BOARD_PLATFORM))
ADSPRPC += adsprpcd
...
FASTCV += libdspCV_v66_skel
FASTCV += libdspCV_v66_skel.so
FASTCV += libdspCV_v68_skel
FASTCV += libdspCV_v68_skel.so
FASTCV += libdspCV_v73_skel
FASTCV += libdspCV_v73_skel.so
FASTCV += libdspCV_v75
FASTCV += libdspCV_v75_skel.so
FASTCV += libdspCV_skel
FASTCV += libdspCV_skel.so
FASTCV += libfastcvadsp_v66
FASTCV += libfastcvadsp_v66.so
FASTCV += libfastcvadsp_v68
FASTCV += libfastcvadsp_v68.so
FASTCV += libfastcvadsp_v73
FASTCV += libfastcvadsp_v73.so
FASTCV += libfastcvadsp_v75
FASTCV += libfastcvadsp_v75.so
FASTCV += libfastcvadsp_v66_skel
FASTCV += libfastcvadsp_v66_skel.so
FASTCV += libfastcvadsp_v68_skel
FASTCV += libfastcvadsp_v68_skel.so
FASTCV += libfastcvadsp_v73_skel
FASTCV += libfastcvadsp_v73_skel.so
FASTCV += libfastcvadsp_v75_skel
FASTCV += libfastcvadsp_v75_skel.so
FASTCV += libfastcvadsp_skel
FASTCV += libfastcvadsp_skel.so
FASTCV += libfastcvdsp_v66_skel
FASTCV += libfastcvdsp_v66_skel.so
FASTCV += libfastcvdsp_v68_skel
FASTCV += libfastcvdsp_v68_skel.so
FASTCV += libfastcvdsp_v73_skel
FASTCV += libfastcvdsp_v73_skel.so
FASTCV += libfastcvdsp_v75
FASTCV += libfastcvdsp_v75_skel.so
FASTCV += libfastcvdsp_skel
FASTCV += libfastcvdsp_skel.so
FASTCV += libfastcvadsp
FASTCV += libfastcvadsp.so
FASTCV += libworker_pool_v68
FASTCV += libworker_pool_v68.so
FASTCV += libworker_pool_v73
FASTCV += libworker_pool_v73.so
FASTCV += libworker_pool_v75
FASTCV += libworker_pool_v75.so
FASTCV += libworker_pool
FASTCV += libworker_pool.so
FASTCV += libapps_mem_heap.so
FASTCV += libapps_mem_heap
...
FASTCV += libfastcvopt
FASTCV += fastcv.sh
FASTCV += fastcv_simple_test
FASTCV += fastcv_nsp_simple_test
FASTCV += libfastcvNSPSimpleTest_skel
FASTCV += libfastcvNSPSimpleTest_skel.so

#FASTCV_TEST_BINARIES
FASTCV_INTERNAL += fastcv_test
FASTCV_INTERNAL += fastcv_test32
FASTCV_INTERNAL += fastcv_test32_opencv

#FASTADAS_LIBRARIES
FASTADAS := libfadas
FASTADAS += libfadas_dev
FASTADAS += libfadasGpu
FASTADAS += libfadasGpu_dev
FASTADAS += libnnpp
FASTADAS += libfadasNsp.so
FASTADAS += libfadasNsp_dev.so
FASTADAS += libnnpp_skel.so

#FASTADAS_APPS_NSP_LIBS
FASTADAS_APPS += libcqp_nsp_skel.so
FASTADAS_APPS += libfpe_nsp_skel.so
FASTADAS_APPS += libfpt_nsp_skel.so
FASTADAS_APPS += libfpt_trcks_nsp_skel.so
FASTADAS_APPS += libone_nsp_skel.so
FASTADAS_APPS += libp3_nsp_skel.so
FASTADAS_APPS += libpt_plr_nsp_skel.so
FASTADAS_APPS += libsvd_nsp_skel.so
FASTADAS_APPS += libuyvy_nsp_skel.so
FASTADAS_APPS += libuyvy_remap_nsp_skel.so
FASTADAS_APPS += libvyuy_remap_nsp_skel.so
FASTADAS_APPS += liblkf_skel.so
FASTADAS_APPS += libcqp_nsp_dev_skel.so
FASTADAS_APPS += libfpe_nsp_dev_skel.so
FASTADAS_APPS += libfpt_nsp_dev_skel.so
FASTADAS_APPS += libfpt_trcks_nsp_dev_skel.so
FASTADAS_APPS += libone_nsp_dev_skel.so
FASTADAS_APPS += libp3_nsp_dev_skel.so
FASTADAS_APPS += libpt_plr_nsp_dev_skel.so
FASTADAS_APPS += libsvd_nsp_dev_skel.so
FASTADAS_APPS += libuyvy_nsp_dev_skel.so
FASTADAS_APPS += libuyvy_remap_nsp_dev_skel.so
FASTADAS_APPS += libvyuy_remap_nsp_dev_skel.so
FASTADAS_APPS += liblkf_dev_skel.so

#FASTADAS_SAMPLE_APPS_SAFE
FASTADAS_APPS += cqp
FASTADAS_APPS += fpe
FASTADAS_APPS += fpt
FASTADAS_APPS += fpt_trcks
FASTADAS_APPS += one
FASTADAS_APPS += p3
FASTADAS_APPS += pt_plr
FASTADAS_APPS += svd
FASTADAS_APPS += uyvy
FASTADAS_APPS += uyvy_remap
FASTADAS_APPS += vyuy_remap
FASTADAS_APPS += calib
FASTADAS_APPS += filter
FASTADAS_APPS += linearkalmanfilter
FASTADAS_APPS += cqp_nsp
FASTADAS_APPS += fpe_nsp
FASTADAS_APPS += fpt_nsp
FASTADAS_APPS += fpt_trcks_nsp
FASTADAS_APPS += one_nsp
FASTADAS_APPS += p3_nsp
FASTADAS_APPS += pt_plr_nsp
FASTADAS_APPS += svd_nsp
FASTADAS_APPS += uyvy_nsp
FASTADAS_APPS += uyvy_remap_nsp
FASTADAS_APPS += vyuy_remap_nsp
FASTADAS_APPS += linearkalmanfilter_nsp
FASTADAS_APPS += cqp_gpu
FASTADAS_APPS += fpe_gpu
FASTADAS_APPS += fpt_gpu
FASTADAS_APPS += fpt_trcks_gpu
FASTADAS_APPS += one_gpu
FASTADAS_APPS += p3_gpu
FASTADAS_APPS += pt_plr_gpu
FASTADAS_APPS += svd_gpu
FASTADAS_APPS += uyvy_gpu
FASTADAS_APPS += uyvy_remap_gpu
FASTADAS_APPS += vyuy_remap_gpu
FASTADAS_APPS += filter_gpu
FASTADAS_APPS += linearkalmanfilter_gpu
FASTADAS_APPS += cqp_dev
FASTADAS_APPS += fpe_dev
FASTADAS_APPS += fpt_dev
FASTADAS_APPS += fpt_trcks_dev
FASTADAS_APPS += one_dev
FASTADAS_APPS += p3_dev
FASTADAS_APPS += pt_plr_dev
FASTADAS_APPS += svd_dev
FASTADAS_APPS += uyvy_dev
FASTADAS_APPS += uyvy_remap_dev
FASTADAS_APPS += vyuy_remap_dev
FASTADAS_APPS += uyvy_nv12_y_dev
FASTADAS_APPS += calib_dev
FASTADAS_APPS += filter_dev
FASTADAS_APPS += linearkalmanfilter_dev
FASTADAS_APPS += cqp_nsp_dev
FASTADAS_APPS += fpe_nsp_dev
FASTADAS_APPS += fpt_nsp_dev
FASTADAS_APPS += fpt_trcks_nsp_dev
FASTADAS_APPS += one_nsp_dev
FASTADAS_APPS += p3_nsp_dev
FASTADAS_APPS += pt_plr_nsp_dev
FASTADAS_APPS += svd_nsp_dev
FASTADAS_APPS += uyvy_nsp_dev
FASTADAS_APPS += uyvy_remap_nsp_dev
FASTADAS_APPS += vyuy_remap_nsp_dev
FASTADAS_APPS += linearkalmanfilter_nsp_dev
FASTADAS_APPS += cqp_gpu_dev
FASTADAS_APPS += fpe_gpu_dev
FASTADAS_APPS += fpt_gpu_dev
FASTADAS_APPS += fpt_trcks_gpu_dev
FASTADAS_APPS += one_gpu_dev
FASTADAS_APPS += p3_gpu_dev
FASTADAS_APPS += pt_plr_gpu_dev
FASTADAS_APPS += svd_gpu_dev
FASTADAS_APPS += uyvy_gpu_dev
FASTADAS_APPS += uyvy_remap_gpu_dev
FASTADAS_APPS += vyuy_remap_gpu_dev
FASTADAS_APPS += uyvy_nv12_y_gpu_dev
FASTADAS_APPS += filter_gpu_dev
FASTADAS_APPS += linearkalmanfilter_gpu_dev
FASTADAS_APPS += nn_pre_post_proc

#FASTADAS_APPS
FASTADAS_APPS += stones_640x448.pgm
FASTADAS_APPS += fpt_0000000.pgm
FASTADAS_APPS += fpt_0000001.pgm
FASTADAS_APPS += fpt_0000002.pgm
FASTADAS_APPS += A_0.data
FASTADAS_APPS += b_0.data
FASTADAS_APPS += img0.pgm
FASTADAS_APPS += img0_map_x.csv
FASTADAS_APPS += img0_map_y.csv
FASTADAS_APPS += img1.uyvy
FASTADAS_APPS += img2.pgm
FASTADAS_APPS += img3.10uyvy
FASTADAS_APPS += vector_0001_src.data
FASTADAS_APPS += 01_fisheye_1280x1086_uyvy422.yuv
FASTADAS_APPS += cam_props.csv
FASTADAS_APPS += img4.uyvy
FASTADAS_APPS += mapX.data
FASTADAS_APPS += mapY.data
FASTADAS_APPS += img4_2688x1520.vyuy
FASTADAS_APPS += img1_1920x1020.y8

#FASTADAS_APPS
FASTADAS_APPS += stones_640x448_dev
FASTADAS_APPS += fpt_0000000_dev
FASTADAS_APPS += fpt_0000001_dev
FASTADAS_APPS += fpt_0000002_dev
FASTADAS_APPS += A_0_dev
FASTADAS_APPS += b_0_dev
FASTADAS_APPS += img0_dev
FASTADAS_APPS += img0_map_x_dev
FASTADAS_APPS += img0_map_y_dev
FASTADAS_APPS += img1_dev
FASTADAS_APPS += img2_dev
FASTADAS_APPS += img3_dev
FASTADAS_APPS += vector_0001_src_dev
FASTADAS_APPS += 01_fisheye_1280x1086_uyvy422_dev
FASTADAS_APPS += cam_props_dev
FASTADAS_APPS += img4_dev
FASTADAS_APPS += mapX_dev
FASTADAS_APPS += mapY_dev
FASTADAS_APPS += img4_2688x1520_dev
FASTADAS_APPS += img1_1920x1020_dev

FASTADAS_APPS += 01_fisheye_1280x1086_uyvy422_nnpp
FASTADAS_APPS += img1_rgb_gt.ppm

#FASTADAS_INTERNAL_BINARIES_LIBS
FASTADAS_INTERNAL += libfadas_shim
FASTADAS_INTERNAL += libfadas_shim_dev
FASTADAS_INTERNAL += libfadas_shimNspIntf_dev_skel.so
FASTADAS_INTERNAL += libfadas_shimNspIntf_skel.so
FASTADAS_INTERNAL += unit
FASTADAS_INTERNAL += unit_dev
FASTADAS_INTERNAL += perf
FASTADAS_INTERNAL += perf_dev
...
ifeq ($(TARGET_BOARD_AUTO),true)
$(call inherit-product-if-exists, $(QC_PROP_ROOT)/qcx/product.mk)
$(call inherit-product-if-exists, $(QC_PROP_ROOT)/ais/product.mk)
$(call inherit-product-if-exists, $(QC_PROP_ROOT)/ais/qcc6/product.mk)
$(call inherit-product-if-exists, $(QC_PROP_ROOT)/commonsys/ais-sys/product.mk)
$(call inherit-product-if-exists, $(QC_PROP_ROOT)/commonsys/ais-sys/qcc6/product.mk)
endif
...
EARLY_SERVICES := early_services_init
EARLY_SERVICES += early_init.conf
EARLY_SERVICES += early_init_u.conf
EARLY_SERVICES += early_init_u_poipu.conf
#EARLY_SERVICES += init_early_test
#EARLY_SERVICES += init_early_gpio_test
#EARLY_SERVICES += init_early_spi_test
EARLY_SERVICES += early_chime
#EARLY_SERVICES += earlyVideo
#MM_GRAPHICS += libgsl_early
#MM_GRAPHICS += libC2D2_early
endif
...
#SKU_QWES
SKU_QWES_DBG += qwes_test
SKU_QWES += libskud
SKU_QWES += libqwesminksocket

LOG_MANAGER += log_manager
LOG_MANAGER += libfiletx
LOG_MANAGER += libedgeproc
LOG_MANAGER += libvsim
LOG_MANAGER += log_manager.json
LOG_MANAGER += logd.rc
LOG_MANAGER += libcsda
endif
...
SYSPROFILER += libQProfilerInterface
SYSPROFILER += sysprofiler.h
endif
...
VEHICLE_NETWORKS += libcwtest
VEHICLE_NETWORKS += libcan
VEHICLE_NETWORKS += candump
VEHICLE_NETWORKS += cansend
VEHICLE_NETWORKS += cangen
VEHICLE_NETWORKS += canplayer
VEHICLE_NETWORKS += cansniffer
...
VEHICLE_NETWORKS += qtilibpowerpolicy
VEHICLE_NETWORKS += QtiCarPowerService

VEHICLE_NETWORKS_DEBUG := qtipowerpolicytest
VEHICLE_NETWORKS += libqtikeylistener
VEHICLE_NETWORKS_DEBUG += qtikeylistener_test
...
#WLAN += spectraltool
#WLAN += android.hardware.net.nlinterceptor-service.default
...
PRODUCT_PACKAGES += $(FASTADAS)
ifeq ($(INSTALL_FASTADS_TEST_APPS),true)
PRODUCT_PACKAGES += $(FASTADAS_APPS)
endif
...
PRODUCT_PACKAGES_DEBUG += $(VEHICLE_NETWORKS_DEBUG)
...
PRODUCT_PACKAGES += $(SKU_QWES)
PRODUCT_PACKAGES += $(LOG_MANAGER)
endif
endif
...
FM_DBG += fmfactorytest
FM_DBG += fmfactorytestserver
...
QMI_DBG += qmi_test_mt_client_init_instance
...
SECUREMSM_DBG += qseecom_sample_client
...
PRODUCT_PACKAGES_DEBUG += $(FASTADAS_INTERNAL)

ifeq ($(ENABLE_C2C_SUPPORT),true)
PRODUCT_PACKAGES_DEBUG += $(SKU_QWES_DBG)
endif
