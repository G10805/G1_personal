...
ifneq (, $(filter $(PRODUCT_LIST), $(target_base_product)))
  ...
  ifneq ($(wildcard $(HY22_XML_CONF_PATH)),)
    PRODUCT_COPY_FILES += $(HY22_XML_CONF_PATH)/cdma_call_conf.xml:system_ext/etc/cdma_call_conf.xml
    PRODUCT_COPY_FILES += $(HY22_XML_CONF_PATH)/spn-conf.xml:system_ext/etc/spn-conf.xml
  ...
  ifneq ($(wildcard $(XML_CONF_PATH)),)
    ...
    PRODUCT_COPY_FILES += $(XML_CONF_PATH)/cdma_call_conf.xml:system_ext/etc/cdma_call_conf.xml
    PRODUCT_COPY_FILES += $(XML_CONF_PATH)/spn-conf.xml:system_ext/etc/spn-conf.xml
