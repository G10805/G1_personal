...
/* This file was generated with Tool version 6.14.7
   It was generated on: Mon Aug 21 2023 (Spin 0)
...
static const uint8_t wlfw_m3_segment_info_s_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_m3_segment_info_s_v01, type),

  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(wlfw_m3_segment_info_s_v01, addr),

  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(wlfw_m3_segment_info_s_v01, size),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_STRING,
  QMI_IDL_OFFSET8(wlfw_m3_segment_info_s_v01, name),
  QMI_WLFW_MAX_STR_LEN_V01,

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t wlfw_dev_mem_info_s_data_v01[] = {
  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(wlfw_dev_mem_info_s_v01, start),

  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(wlfw_dev_mem_info_s_v01, size),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t wlfw_host_mlo_chip_info_s_data_v01[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_host_mlo_chip_info_s_v01, chip_id),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_host_mlo_chip_info_s_v01, num_local_links),

  QMI_IDL_FLAGS_IS_ARRAY |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_host_mlo_chip_info_s_v01, hw_link_id),
  QMI_WLFW_MAX_NUM_MLO_LINKS_PER_CHIP_V01,

  QMI_IDL_FLAGS_IS_ARRAY |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_host_mlo_chip_info_s_v01, valid_mlo_link_id),
  QMI_WLFW_MAX_NUM_MLO_LINKS_PER_CHIP_V01,

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t wlfw_host_mlo_chip_v2_info_s_data_v01[] = {
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_host_mlo_chip_v2_info_s_v01, mlo_chip_info),
  QMI_IDL_TYPE88(0, 17),
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_host_mlo_chip_v2_info_s_v01, adj_mlo_num_chips),

  QMI_IDL_FLAGS_IS_ARRAY |QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_host_mlo_chip_v2_info_s_v01, adj_mlo_chip_info),
  QMI_WLFW_MAX_NUM_ADJ_MLO_CHIPS_V01,
  QMI_IDL_TYPE88(0, 17),
  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t wlfw_pmu_param_data_v01[] = {
  QMI_IDL_FLAGS_IS_ARRAY |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_pmu_param_v01, pin_name),
  QMI_WLFW_PMU_PIN_NAME_MAX_LEN_V01,

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_pmu_param_v01, wake_volt_valid),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_pmu_param_v01, wake_volt),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_pmu_param_v01, sleep_volt_valid),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_pmu_param_v01, sleep_volt),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t wlfw_pmu_cfg_data_v01[] = {
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_pmu_cfg_v01, pmu_param),
  QMI_WLFW_PMU_PARAMS_MAX_V01,
  QMI_IDL_OFFSET8(wlfw_pmu_cfg_v01, pmu_param) - QMI_IDL_OFFSET8(wlfw_pmu_cfg_v01, pmu_param_len),
  QMI_IDL_TYPE88(0, 19),
  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t wlfw_shadow_reg_v3_cfg_s_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_shadow_reg_v3_cfg_s_v01, addr),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t wlfw_share_mem_info_s_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_share_mem_info_s_v01, type),

  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(wlfw_share_mem_info_s_v01, start),

  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(wlfw_share_mem_info_s_v01, size),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t wlfw_host_pcie_link_info_s_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_host_pcie_link_info_s_v01, pci_link_speed),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_host_pcie_link_info_s_v01, pci_link_width),
...
static const uint8_t wlfw_ind_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, qdss_mem_ready_enable) - QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, qdss_mem_ready_enable_valid)),
  0x22,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, qdss_mem_ready_enable),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, m3_dump_upload_segments_req_enable) - QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, m3_dump_upload_segments_req_enable_valid)),
  0x23,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, m3_dump_upload_segments_req_enable),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, fw_ssr_enable) - QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, fw_ssr_enable_valid)),
  0x24,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, fw_ssr_enable)
};
...
static const uint8_t wlfw_wlan_mode_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_wlan_mode_req_msg_v01, hw_debug) - QMI_IDL_OFFSET8(wlfw_wlan_mode_req_msg_v01, hw_debug_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_wlan_mode_req_msg_v01, hw_debug),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_wlan_mode_req_msg_v01, xo_cal_data) - QMI_IDL_OFFSET8(wlfw_wlan_mode_req_msg_v01, xo_cal_data_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_wlan_mode_req_msg_v01, xo_cal_data),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_wlan_mode_req_msg_v01, wlan_en_delay) - QMI_IDL_OFFSET8(wlfw_wlan_mode_req_msg_v01, wlan_en_delay_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_wlan_mode_req_msg_v01, wlan_en_delay)
};
...
static const uint8_t wlfw_wlan_cfg_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_wlan_cfg_req_msg_v01, msi_cfg) - QMI_IDL_OFFSET16RELATIVE(wlfw_wlan_cfg_req_msg_v01, msi_cfg_valid)),
  0x16,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_wlan_cfg_req_msg_v01, shadow_reg_v3) - QMI_IDL_OFFSET16RELATIVE(wlfw_wlan_cfg_req_msg_v01, shadow_reg_v3_valid)),
  0x17,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(wlfw_wlan_cfg_req_msg_v01, shadow_reg_v3),
  QMI_WLFW_MAX_NUM_SHADOW_REG_V3_V01,
  QMI_IDL_OFFSET16RELATIVE(wlfw_wlan_cfg_req_msg_v01, shadow_reg_v3) - QMI_IDL_OFFSET16RELATIVE(wlfw_wlan_cfg_req_msg_v01, shadow_reg_v3_len),
  QMI_IDL_TYPE88(0, 21)
};
...
static const uint8_t wlfw_cap_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, rd_card_chain_cap) - QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, rd_card_chain_cap_valid)),
  0x1B,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_cap_resp_msg_v01, rd_card_chain_cap),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, dev_mem_info) - QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, dev_mem_info_valid)),
  0x1C,
  QMI_IDL_FLAGS_IS_ARRAY |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(wlfw_cap_resp_msg_v01, dev_mem_info),
  QMI_WLFW_MAX_DEV_MEM_NUM_V01,
  QMI_IDL_TYPE88(0, 16),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, foundry_name) - QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, foundry_name_valid)),
  0x1D,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(wlfw_cap_resp_msg_v01, foundry_name),
  QMI_WLFW_MAX_STR_LEN_V01,

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, hang_data_addr_offset) - QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, hang_data_addr_offset_valid)),
  0x1E,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_cap_resp_msg_v01, hang_data_addr_offset),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, hang_data_length) - QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, hang_data_length_valid)),
  0x1F,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_cap_resp_msg_v01, hang_data_length),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, bdf_dnld_method) - QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, bdf_dnld_method_valid)),
  0x20,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_cap_resp_msg_v01, bdf_dnld_method),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, hwid_bitmap) - QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, hwid_bitmap_valid)),
  0x21,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_cap_resp_msg_v01, hwid_bitmap),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, ol_cpr_cfg) - QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, ol_cpr_cfg_valid)),
  0x22,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(wlfw_cap_resp_msg_v01, ol_cpr_cfg),
  QMI_IDL_TYPE88(0, 20),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, regdb_mandatory) - QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, regdb_mandatory_valid)),
  0x23,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_cap_resp_msg_v01, regdb_mandatory),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, regdb_support) - QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, regdb_support_valid)),
  0x24,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_cap_resp_msg_v01, regdb_support),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, rxgainlut_support) - QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, rxgainlut_support_valid)),
  0x25,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_cap_resp_msg_v01, rxgainlut_support),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, he_channel_width_cap) - QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, he_channel_width_cap_valid)),
  0x26,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_cap_resp_msg_v01, he_channel_width_cap),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, phy_qam_cap) - QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, phy_qam_cap_valid)),
  0x27,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_cap_resp_msg_v01, phy_qam_cap)
};
...
static const uint8_t wlfw_cal_report_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_cal_report_req_msg_v01, cal_remove_supported) - QMI_IDL_OFFSET8(wlfw_cal_report_req_msg_v01, cal_remove_supported_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_cal_report_req_msg_v01, cal_remove_supported),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_cal_report_req_msg_v01, cal_file_download_size) - QMI_IDL_OFFSET8(wlfw_cal_report_req_msg_v01, cal_file_download_size_valid)),
  0x12,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(wlfw_cal_report_req_msg_v01, cal_file_download_size)
};
...
static const uint8_t wlfw_host_cap_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, host_build_type) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, host_build_type_valid)),
  0x20,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_host_cap_req_msg_v01, host_build_type),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, mlo_capable) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, mlo_capable_valid)),
  0x21,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_host_cap_req_msg_v01, mlo_capable),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, mlo_chip_id) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, mlo_chip_id_valid)),
  0x22,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_host_cap_req_msg_v01, mlo_chip_id),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, mlo_group_id) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, mlo_group_id_valid)),
  0x23,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_host_cap_req_msg_v01, mlo_group_id),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, max_mlo_peer) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, max_mlo_peer_valid)),
  0x24,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_host_cap_req_msg_v01, max_mlo_peer),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, mlo_num_chips) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, mlo_num_chips_valid)),
  0x25,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_host_cap_req_msg_v01, mlo_num_chips),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, mlo_chip_info) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, mlo_chip_info_valid)),
  0x26,
  QMI_IDL_FLAGS_IS_ARRAY |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(wlfw_host_cap_req_msg_v01, mlo_chip_info),
  QMI_WLFW_MAX_NUM_MLO_CHIPS_V01,
  QMI_IDL_TYPE88(0, 17),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, feature_list) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, feature_list_valid)),
  0x27,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_host_cap_req_msg_v01, feature_list),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, num_wlan_clients) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, num_wlan_clients_valid)),
  0x28,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_host_cap_req_msg_v01, num_wlan_clients),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, num_wlan_vaps) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, num_wlan_vaps_valid)),
  0x29,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_host_cap_req_msg_v01, num_wlan_vaps),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, wake_msi_addr) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, wake_msi_addr_valid)),
  0x2A,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_host_cap_req_msg_v01, wake_msi_addr),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, wlan_enable_delay) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, wlan_enable_delay_valid)),
  0x2B,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_host_cap_req_msg_v01, wlan_enable_delay),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, ddr_type) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, ddr_type_valid)),
  0x2C,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_host_cap_req_msg_v01, ddr_type),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, gpio_info) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, gpio_info_valid)),
  0x2D,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_host_cap_req_msg_v01, gpio_info),
  QMI_WLFW_MAX_NUM_GPIO_INFO_V01,
  QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, gpio_info) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, gpio_info_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, fw_ini_cfg_support) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, fw_ini_cfg_support_valid)),
  0x2E,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_host_cap_req_msg_v01, fw_ini_cfg_support),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, mlo_chip_v2_info) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, mlo_chip_v2_info_valid)),
  0x2F,
  QMI_IDL_FLAGS_IS_ARRAY |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(wlfw_host_cap_req_msg_v01, mlo_chip_v2_info),
  QMI_WLFW_MAX_NUM_MLO_V2_CHIPS_V01,
  QMI_IDL_TYPE88(0, 18),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, pcie_link_info) - QMI_IDL_OFFSET16RELATIVE(wlfw_host_cap_req_msg_v01, pcie_link_info_valid)),
  0x30,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(wlfw_host_cap_req_msg_v01, pcie_link_info),
  QMI_IDL_TYPE88(0, 23)
};
...
static const uint8_t wlfw_respond_mem_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_respond_mem_resp_msg_v01, share_mem) - QMI_IDL_OFFSET8(wlfw_respond_mem_resp_msg_v01, share_mem_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_respond_mem_resp_msg_v01, share_mem),
  QMI_WLFW_MAX_NUM_SHARE_MEM_V01,
  QMI_IDL_OFFSET8(wlfw_respond_mem_resp_msg_v01, share_mem) - QMI_IDL_OFFSET8(wlfw_respond_mem_resp_msg_v01, share_mem_len),
  QMI_IDL_TYPE88(0, 22)
};
...
static const uint8_t wlfw_fw_init_done_ind_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_fw_init_done_ind_msg_v01, hang_data_addr_offset) - QMI_IDL_OFFSET8(wlfw_fw_init_done_ind_msg_v01, hang_data_addr_offset_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_fw_init_done_ind_msg_v01, hang_data_addr_offset),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_fw_init_done_ind_msg_v01, hang_data_length) - QMI_IDL_OFFSET8(wlfw_fw_init_done_ind_msg_v01, hang_data_length_valid)),
  0x11,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(wlfw_fw_init_done_ind_msg_v01, hang_data_length)
};
...
static const uint8_t wlfw_cal_done_ind_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_cal_done_ind_msg_v01, cal_file_upload_size) - QMI_IDL_OFFSET8(wlfw_cal_done_ind_msg_v01, cal_file_upload_size_valid)),
  0x10,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(wlfw_cal_done_ind_msg_v01, cal_file_upload_size)
};
...
static const uint8_t wlfw_qdss_trace_mem_info_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_qdss_trace_mem_info_req_msg_v01, end) - QMI_IDL_OFFSET16RELATIVE(wlfw_qdss_trace_mem_info_req_msg_v01, end_valid)),
  0x10,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_qdss_trace_mem_info_req_msg_v01, end)
};
...
static const uint8_t wlfw_device_info_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_device_info_resp_msg_v01, bar_size) - QMI_IDL_OFFSET8(wlfw_device_info_resp_msg_v01, bar_size_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_device_info_resp_msg_v01, bar_size),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_device_info_resp_msg_v01, mhi_state_info_addr) - QMI_IDL_OFFSET8(wlfw_device_info_resp_msg_v01, mhi_state_info_addr_valid)),
  0x12,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(wlfw_device_info_resp_msg_v01, mhi_state_info_addr),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_device_info_resp_msg_v01, mhi_state_info_size) - QMI_IDL_OFFSET8(wlfw_device_info_resp_msg_v01, mhi_state_info_size_valid)),
  0x13,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_device_info_resp_msg_v01, mhi_state_info_size)
};
...
static const uint8_t wlfw_m3_dump_upload_segments_req_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_m3_dump_upload_segments_req_ind_msg_v01, pdev_id),

  0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_m3_dump_upload_segments_req_ind_msg_v01, no_of_valid_segments),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x03,
  QMI_IDL_FLAGS_IS_ARRAY |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_m3_dump_upload_segments_req_ind_msg_v01, m3_segment),
  QMI_WLFW_MAX_M3_SEGMENTS_SIZE_V01,
  QMI_IDL_TYPE88(0, 15)
};

static const uint8_t wlfw_subsys_restart_level_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_subsys_restart_level_req_msg_v01, restart_level_type) - QMI_IDL_OFFSET8(wlfw_subsys_restart_level_req_msg_v01, restart_level_type_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_subsys_restart_level_req_msg_v01, restart_level_type)
};

static const uint8_t wlfw_subsys_restart_level_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_subsys_restart_level_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t wlfw_ini_file_download_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_ini_file_download_req_msg_v01, file_type) - QMI_IDL_OFFSET8(wlfw_ini_file_download_req_msg_v01, file_type_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_ini_file_download_req_msg_v01, file_type),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_ini_file_download_req_msg_v01, total_size) - QMI_IDL_OFFSET8(wlfw_ini_file_download_req_msg_v01, total_size_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_ini_file_download_req_msg_v01, total_size),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_ini_file_download_req_msg_v01, seg_id) - QMI_IDL_OFFSET8(wlfw_ini_file_download_req_msg_v01, seg_id_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_ini_file_download_req_msg_v01, seg_id),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_ini_file_download_req_msg_v01, data) - QMI_IDL_OFFSET8(wlfw_ini_file_download_req_msg_v01, data_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_ini_file_download_req_msg_v01, data),
  ((QMI_WLFW_MAX_DATA_SIZE_V01) & 0xFF), ((QMI_WLFW_MAX_DATA_SIZE_V01) >> 8),
  QMI_IDL_OFFSET8(wlfw_ini_file_download_req_msg_v01, data) - QMI_IDL_OFFSET8(wlfw_ini_file_download_req_msg_v01, data_len),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_ini_file_download_req_msg_v01, end) - QMI_IDL_OFFSET16RELATIVE(wlfw_ini_file_download_req_msg_v01, end_valid)),
  0x14,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_ini_file_download_req_msg_v01, end)
};

static const uint8_t wlfw_ini_file_download_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_ini_file_download_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

/*
 * wlfw_phy_cap_req_msg is empty
 * static const uint8_t wlfw_phy_cap_req_msg_data_v01[] = {
 * };
 */

static const uint8_t wlfw_phy_cap_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_phy_cap_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_phy_cap_resp_msg_v01, num_phy) - QMI_IDL_OFFSET8(wlfw_phy_cap_resp_msg_v01, num_phy_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_phy_cap_resp_msg_v01, num_phy),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_phy_cap_resp_msg_v01, board_id) - QMI_IDL_OFFSET8(wlfw_phy_cap_resp_msg_v01, board_id_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_phy_cap_resp_msg_v01, board_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_phy_cap_resp_msg_v01, mlo_cap_v2_support) - QMI_IDL_OFFSET8(wlfw_phy_cap_resp_msg_v01, mlo_cap_v2_support_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_phy_cap_resp_msg_v01, mlo_cap_v2_support)
};

static const uint8_t wlfw_wlan_hw_init_cfg_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_wlan_hw_init_cfg_req_msg_v01, rf_subtype) - QMI_IDL_OFFSET8(wlfw_wlan_hw_init_cfg_req_msg_v01, rf_subtype_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_wlan_hw_init_cfg_req_msg_v01, rf_subtype)
};

static const uint8_t wlfw_wlan_hw_init_cfg_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_wlan_hw_init_cfg_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t wlfw_pcie_link_ctrl_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_pcie_link_ctrl_req_msg_v01, link_state_req)
};

static const uint8_t wlfw_pcie_link_ctrl_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_pcie_link_ctrl_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t wlfw_aux_uc_info_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(wlfw_aux_uc_info_req_msg_v01, addr),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_aux_uc_info_req_msg_v01, size)
};

static const uint8_t wlfw_aux_uc_info_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_aux_uc_info_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t wlfw_tme_lite_info_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_tme_lite_info_req_msg_v01, tme_file),

  0x02,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(wlfw_tme_lite_info_req_msg_v01, addr),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x03,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_tme_lite_info_req_msg_v01, size)
};

static const uint8_t wlfw_tme_lite_info_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_tme_lite_info_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t wlfw_fw_ssr_ind_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_fw_ssr_ind_msg_v01, reason_code)
};

static const uint8_t wlfw_bmps_ctrl_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_bmps_ctrl_req_msg_v01, bmps_state)
};

static const uint8_t wlfw_bmps_ctrl_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_bmps_ctrl_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

/*
 * wlfw_lpass_ssr_req_msg is empty
 * static const uint8_t wlfw_lpass_ssr_req_msg_data_v01[] = {
 * };
 */

static const uint8_t wlfw_lpass_ssr_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_lpass_ssr_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};
...
static const qmi_idl_type_table_entry  wlfw_type_table_v01[] = {
  ...
  {sizeof(wlfw_m3_segment_info_s_v01), wlfw_m3_segment_info_s_data_v01},
  {sizeof(wlfw_dev_mem_info_s_v01), wlfw_dev_mem_info_s_data_v01},
  {sizeof(wlfw_host_mlo_chip_info_s_v01), wlfw_host_mlo_chip_info_s_data_v01},
  {sizeof(wlfw_host_mlo_chip_v2_info_s_v01), wlfw_host_mlo_chip_v2_info_s_data_v01},
  {sizeof(wlfw_pmu_param_v01), wlfw_pmu_param_data_v01},
  {sizeof(wlfw_pmu_cfg_v01), wlfw_pmu_cfg_data_v01},
  {sizeof(wlfw_shadow_reg_v3_cfg_s_v01), wlfw_shadow_reg_v3_cfg_s_data_v01},
  {sizeof(wlfw_share_mem_info_s_v01), wlfw_share_mem_info_s_data_v01},
  {sizeof(wlfw_host_pcie_link_info_s_v01), wlfw_host_pcie_link_info_s_data_v01}
};
...
static const qmi_idl_message_table_entry wlfw_message_table_v01[] = {
  ...
  {sizeof(wlfw_fw_init_done_ind_msg_v01), wlfw_fw_init_done_ind_msg_data_v01},
  ...
  {sizeof(wlfw_cal_done_ind_msg_v01), wlfw_cal_done_ind_msg_data_v01},
  ...
  {sizeof(wlfw_m3_dump_upload_segments_req_ind_msg_v01), wlfw_m3_dump_upload_segments_req_ind_msg_data_v01},
  {sizeof(wlfw_subsys_restart_level_req_msg_v01), wlfw_subsys_restart_level_req_msg_data_v01},
  {sizeof(wlfw_subsys_restart_level_resp_msg_v01), wlfw_subsys_restart_level_resp_msg_data_v01},
  {sizeof(wlfw_ini_file_download_req_msg_v01), wlfw_ini_file_download_req_msg_data_v01},
  {sizeof(wlfw_ini_file_download_resp_msg_v01), wlfw_ini_file_download_resp_msg_data_v01},
  {sizeof(wlfw_phy_cap_req_msg_v01), 0},
  {sizeof(wlfw_phy_cap_resp_msg_v01), wlfw_phy_cap_resp_msg_data_v01},
  {sizeof(wlfw_wlan_hw_init_cfg_req_msg_v01), wlfw_wlan_hw_init_cfg_req_msg_data_v01},
  {sizeof(wlfw_wlan_hw_init_cfg_resp_msg_v01), wlfw_wlan_hw_init_cfg_resp_msg_data_v01},
  {sizeof(wlfw_pcie_link_ctrl_req_msg_v01), wlfw_pcie_link_ctrl_req_msg_data_v01},
  {sizeof(wlfw_pcie_link_ctrl_resp_msg_v01), wlfw_pcie_link_ctrl_resp_msg_data_v01},
  {sizeof(wlfw_aux_uc_info_req_msg_v01), wlfw_aux_uc_info_req_msg_data_v01},
  {sizeof(wlfw_aux_uc_info_resp_msg_v01), wlfw_aux_uc_info_resp_msg_data_v01},
  {sizeof(wlfw_tme_lite_info_req_msg_v01), wlfw_tme_lite_info_req_msg_data_v01},
  {sizeof(wlfw_tme_lite_info_resp_msg_v01), wlfw_tme_lite_info_resp_msg_data_v01},
  {sizeof(wlfw_fw_ssr_ind_msg_v01), wlfw_fw_ssr_ind_msg_data_v01},
  {sizeof(wlfw_bmps_ctrl_req_msg_v01), wlfw_bmps_ctrl_req_msg_data_v01},
  {sizeof(wlfw_bmps_ctrl_resp_msg_v01), wlfw_bmps_ctrl_resp_msg_data_v01},
  {sizeof(wlfw_lpass_ssr_req_msg_v01), 0},
  {sizeof(wlfw_lpass_ssr_resp_msg_v01), wlfw_lpass_ssr_resp_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry wlfw_service_command_messages_v01[] = {
  {QMI_WLFW_IND_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 0), 90},
  {QMI_WLFW_WLAN_MODE_REQ_V01, QMI_IDL_TYPE16(0, 5), 22},
  {QMI_WLFW_WLAN_CFG_REQ_V01, QMI_IDL_TYPE16(0, 7), 1110},
  {QMI_WLFW_CAP_REQ_V01, QMI_IDL_TYPE16(0, 9), 0},
  {QMI_WLFW_BDF_DOWNLOAD_REQ_V01, QMI_IDL_TYPE16(0, 11), 6182},
  {QMI_WLFW_CAL_REPORT_REQ_V01, QMI_IDL_TYPE16(0, 13), 43},
  ...
  {QMI_WLFW_HOST_CAP_REQ_V01, QMI_IDL_TYPE16(0, 35), 581},
  ...
  {QMI_WLFW_QDSS_TRACE_MEM_INFO_REQ_V01, QMI_IDL_TYPE16(0, 52), 892},
  ...
  {QMI_WLFW_SUBSYS_RESTART_LEVEL_REQ_V01, QMI_IDL_TYPE16(0, 87), 4},
  {QMI_WLFW_INI_FILE_DOWNLOAD_REQ_V01, QMI_IDL_TYPE16(0, 89), 6174},
  {QMI_WLFW_PHY_CAP_REQ_V01, QMI_IDL_TYPE16(0, 91), 0},
  {QMI_WLFW_WLAN_HW_INIT_CFG_REQ_V01, QMI_IDL_TYPE16(0, 93), 7},
  {QMI_WLFW_PCIE_LINK_CTRL_REQ_V01, QMI_IDL_TYPE16(0, 95), 7},
  {QMI_WLFW_AUX_UC_INFO_REQ_V01, QMI_IDL_TYPE16(0, 97), 18},
  {QMI_WLFW_TME_LITE_INFO_REQ_V01, QMI_IDL_TYPE16(0, 99), 25},
  {QMI_WLFW_BMPS_CTRL_REQ_V01, QMI_IDL_TYPE16(0, 102), 7},
  {QMI_WLFW_LPASS_SSR_REQ_V01, QMI_IDL_TYPE16(0, 104), 0}
};
...
static const qmi_idl_service_message_table_entry wlfw_service_response_messages_v01[] = {
  ...
  {QMI_WLFW_CAP_RESP_V01, QMI_IDL_TYPE16(0, 10), 1160},
  ...
  {QMI_WLFW_RESPOND_MEM_RESP_V01, QMI_IDL_TYPE16(0, 39), 171},
  ...
  {QMI_WLFW_DEVICE_INFO_RESP_V01, QMI_IDL_TYPE16(0, 74), 43},
  ...
  {QMI_WLFW_SUBSYS_RESTART_LEVEL_RESP_V01, QMI_IDL_TYPE16(0, 88), 7},
  {QMI_WLFW_INI_FILE_DOWNLOAD_RESP_V01, QMI_IDL_TYPE16(0, 90), 7},
  {QMI_WLFW_PHY_CAP_RESP_V01, QMI_IDL_TYPE16(0, 92), 25},
  {QMI_WLFW_WLAN_HW_INIT_CFG_RESP_V01, QMI_IDL_TYPE16(0, 94), 7},
  {QMI_WLFW_PCIE_LINK_CTRL_RESP_V01, QMI_IDL_TYPE16(0, 96), 7},
  {QMI_WLFW_AUX_UC_INFO_RESP_V01, QMI_IDL_TYPE16(0, 98), 7},
  {QMI_WLFW_TME_LITE_INFO_RESP_V01, QMI_IDL_TYPE16(0, 100), 7},
  {QMI_WLFW_BMPS_CTRL_RESP_V01, QMI_IDL_TYPE16(0, 103), 7},
  {QMI_WLFW_LPASS_SSR_RESP_V01, QMI_IDL_TYPE16(0, 105), 7}
};
...
static const qmi_idl_service_message_table_entry wlfw_service_indication_messages_v01[] = {
  ...
  {QMI_WLFW_FW_INIT_DONE_IND_V01, QMI_IDL_TYPE16(0, 41), 12},
  {QMI_WLFW_REJUVENATE_IND_V01, QMI_IDL_TYPE16(0, 42), 144},
  {QMI_WLFW_XO_CAL_IND_V01, QMI_IDL_TYPE16(0, 49), 4},
  {QMI_WLFW_CAL_DONE_IND_V01, QMI_IDL_TYPE16(0, 50), 11},
  ...
  {QMI_WLFW_M3_DUMP_UPLOAD_SEGMENTS_REQ_IND_V01, QMI_IDL_TYPE16(0, 86), 387},
  {QMI_WLFW_FW_SSR_IND_V01, QMI_IDL_TYPE16(0, 101), 7}
};
