...
int cnss_plat_read_file(char *filename, unsigned char **file_buf)
{
	...
	if (!filename) {
		wsvc_printf_err("%s: Filename is null", __func__);
		return -1;
	}
	...
	if (len <= 0 || len > CNSS_MAX_FILE_LEN) {
...
struct wlfw_device_name_string {
	const char *device_name;
	const char *file_suffix;
	enum wlfw_instance_id instance_id;
};

static struct wlfw_device_name_string g_wlfw_device_name_table[] = {
	{ "mcc", "", HASTINGS_ID },
	{ "integrated", "", HAWKEYE_ID },
	{ "qcn9000_pci0", "_qcn9000_pci0", PINE_1_ID },
	{ "qcn9000_pci1", "_qcn9000_pci1", PINE_2_ID },
	{ "qcn9000_pci2", "_qcn9000_pci2", PINE_3_ID },
	{ "qcn9000_pci3", "_qcn9000_pci3", PINE_4_ID },
	{ "qcn9224_pci0", "_qcn9224_pci0", WAIKIKI_1_ID },
	{ "qcn9224_pci1", "_qcn9224_pci1", WAIKIKI_2_ID },
	{ "qcn9224_pci2", "_qcn9224_pci2", WAIKIKI_3_ID },
	{ "qcn9224_pci3", "_qcn9224_pci3", WAIKIKI_4_ID },
	{ "qcn6122_pci0", "_qcn6122_pci0", SPRUCE_1_ID },
	{ "qcn6122_pci1", "_qcn6122_pci1", SPRUCE_2_ID },
	{ "qcn9160_pci0", "_qcn9160_pci0", YORK_1_ID },
	{ "qcn6432_pci0", "_qcn6432_pci0", PEBBLE_1_ID },
	{ "qcn6432_pci1", "_qcn6432_pci1", PEBBLE_2_ID },
	/* DO NOT ADD ANY ENTRY BELOW THIS, NEW ENTRIES SHOULD BE ADDED ABOVE */
	{ "", "", QMI_CLIENT_INSTANCE_ANY }
};

const char *get_device_name_by_instance_id(uint32_t instance_id)
{
	struct wlfw_device_name_string *table = g_wlfw_device_name_table;

	while (table->instance_id != QMI_CLIENT_INSTANCE_ANY) {
...
int get_instance_id_by_device_name(char *device_name, uint32_t *instance_id)
{
	struct wlfw_device_name_string *table = g_wlfw_device_name_table;

	/* device_name is NULL string for single target case.
	 * Return instance_id as 0 so that caller can get
	 * the first entry of gdata using get_gdata_by_instance_id.
	 */
	...
	while (table->instance_id != QMI_CLIENT_INSTANCE_ANY) {
		if (!strncmp(device_name, table->device_name,
			     MAX_DEVICE_NAME_LEN)) {
