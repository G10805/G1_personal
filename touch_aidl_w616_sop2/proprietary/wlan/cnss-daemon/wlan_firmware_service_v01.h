...
#define WLFW_V01_MAX_MESSAGE_ID 0x005E
/**
    @}
  */
...
typedef enum {
  ...
  QMI_WLFW_MLO_GLOBAL_MEM_V01 = 8, /**<  MLO GLOBAL INFO memory  */
  QMI_WLFW_PAGEABLE_MEM_V01 = 9, /**<  Pageable Memory Arena for Discrete targets  */
  QMI_WLFW_AFC_MEM_V01 = 10, /**<  AFC Memory region  */
...
/** @addtogroup wlfw_qmi_enums
  ...
  */
typedef enum {
  WLFW_SHARE_MEM_TYPE_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  QMI_WLFW_SHARE_MEM_CRASHDBG_V01 = 0, /**<  CRASHDBG data  */
  QMI_WLFW_SHARE_MEM_TXSAR_V01 = 1, /**<  TX SAR offset  */
  QMI_WLFW_SHARE_MEM_AFC_V01 = 2, /**<  AFC memory offset  */
  QMI_WLFW_SHARE_MEM_REMOTE_COPY_V01 = 3, /**<  remote copy memory offset  */
  QMI_WLFW_SHARE_MEM_MAX_V01 = 8,
  WLFW_SHARE_MEM_TYPE_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wlfw_share_mem_type_enum_v01;
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_enums
  ...
  */
typedef enum {
  WLFW_HE_CHANNEL_WIDTH_CAP_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  WLFW_PHY_HE_CHANNEL_WIDTH_CAP_UNSPECIFIED_V01 = 0, /**<  PHY HE CHANNEL capability invalid */
  WLFW_PHY_HE_CHANNEL_WIDTH_CAP_80MHZ_V01 = 1, /**<  PHY HE CHANNEL capability 80MHZ */
  WLFW_PHY_HE_CHANNEL_WIDTH_CAP_160MHZ_V01 = 2, /**<  PHY HE CHANNEL capability 160MHZ */
  WLFW_HE_CHANNEL_WIDTH_CAP_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wlfw_he_channel_width_cap_v01;
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_enums
  ...
  */
typedef enum {
  WLFW_PHY_QAM_CAP_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  WLFW_PHY_QAM_CAP_UNSPECIFIED_V01 = 0, /**<  PHY QAM CAP capability invalid */
  WLFW_PHY_QAM_CAP_1K_V01 = 1, /**<  PHY QAM CAP capability 1K */
  WLFW_PHY_QAM_CAP_4K_V01 = 2, /**<  PHY QAM CAP capability 4K */
  WLFW_PHY_QAM_CAP_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wlfw_phy_qam_cap_v01;
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_enums
  ...
  */
typedef enum {
  WLFW_M3_SEGMENT_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  ...
  WLFW_M3_SEGMENT_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wlfw_m3_segment_type_v01;
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_enums
  ...
  */
typedef enum {
  CNSS_FEATURE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  ...
  CNSS_FEATURE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}cnss_feature_v01;
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_enums
  ...
  */
typedef enum {
  WLFW_BDF_DNLD_METHOD_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  WLFW_DIRECT_BDF_COPY_V01 = 0, /**<  Memcpy BDF to reserved location
 Transfer BDF over QMI in chunks  */
  WLFW_SEND_BDF_OVER_QMI_V01 = 1,
  WLFW_BDF_DNLD_METHOD_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wlfw_bdf_dnld_method_v01;
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_enums
  ...
  */
typedef enum {
  WLFW_GPIO_INFO_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  WLAN_EN_GPIO_V01 = 0,
  BT_EN_GPIO_V01 = 1,
  HOST_SOL_GPIO_V01 = 2,
  TARGET_SOL_GPIO_V01 = 3,
  GPIO_TYPE_MAX_V01 = 4,
  WLFW_GPIO_INFO_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wlfw_gpio_info_type_v01;
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_enums
  ...
  */
typedef enum {
  WLFW_INI_FILE_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  WLFW_INI_CFG_FILE_V01 = 0, /**<  FW INI CFG file containing no. of vaps, peers etc. for each mem mode  */
  WLFW_CONN_ROAM_INI_V01 = 1, /**<  Connection Roaming INI File  */
  WLFW_INI_FILE_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wlfw_ini_file_type_v01;
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_enums
  ...
  */
typedef enum {
  WLFW_WLAN_RF_SUBTYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  WLFW_WLAN_RF_SLATE_V01 = 0,
  WLFW_WLAN_RF_APACHE_V01 = 1,
  WLFW_WLAN_RF_SUBTYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wlfw_wlan_rf_subtype_v01;
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_enums
  ...
  */
typedef enum {
  WLFW_PCIE_LINK_STATE_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  QMI_WLFW_PCIE_ALLOW_LOW_PWR_V01 = 0, /**<  PCIe allow low power link states  */
  QMI_WLFW_PCIE_PREVENT_LOW_PWR_V01 = 1, /**<  PCIe prevent low power link states  */
  WLFW_PCIE_LINK_STATE_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wlfw_pcie_link_state_enum_v01;
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_enums
  ...
  */
typedef enum {
  WLFW_TME_LITE_FILE_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  WLFW_TME_LITE_PATCH_FILE_V01 = 0, /**<  TME-Lite patch file  */
  WLFW_TME_LITE_OEM_FUSE_FILE_V01 = 1, /**<  TME-Lite OEM Fuse(sec.dat) file  */
  WLFW_TME_LITE_RPR_FILE_V01 = 2, /**<  TME-Lite ROM Patch request file  */
  WLFW_TME_LITE_DPR_FILE_V01 = 3, /**<  TME-Lite Debug Policy request file  */
  WLFW_TME_LITE_FILE_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wlfw_tme_lite_file_type_v01;
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_enums
  ...
  */
typedef enum {
  WLFW_BMPS_STATE_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  QMI_WLFW_BMPS_ENABLE_V01 = 0, /**<  Enable BMPS   */
  QMI_WLFW_BMPS_DISABLE_V01 = 1, /**<  Disable BMPS  */
  WLFW_BMPS_STATE_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wlfw_bmps_state_enum_v01;
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_enums
  ...
  */
typedef enum {
  WLFW_FW_SSR_REASON_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  WLFW_FW_SSR_REASON_DEFAULT_V01 = 0, /**<  Default FW SSR reason code   */
  WLFW_FW_SSR_REASON_XPAN_V01 = 1, /**<  FW SSR reason is due to XPAN  */
  WLFW_FW_SSR_REASON_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wlfw_fw_ssr_reason_v01;
/**
    @}
  */
...
#define QMI_WLFW_DIRECT_LINK_SUPPORT_V01 ((wlfw_fw_caps_v01)0x02ull) /**<  If set, FW supports DIRECT_LINK  */
#define QMI_WLFW_AUX_UC_SUPPORT_V01 ((wlfw_fw_caps_v01)0x04ull) /**<  If set, FW supports AUX UC  */
...
/** @addtogroup wlfw_qmi_aggregates
    @{
  */
/**  structure for M3 segments Dump information
 */
typedef struct {

  wlfw_m3_segment_type_v01 type;
...
}wlfw_m3_segment_info_s_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_aggregates
    @{
  */
/**  structure for device memory information
 */
typedef struct {
...
/** @addtogroup wlfw_qmi_aggregates
    @{
  */
/**  structure for passing MLO information
 */
typedef struct {
...
}wlfw_host_mlo_chip_info_s_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_aggregates
    @{
  */
/**  Structure for passing Adjacent MLO information
 */
typedef struct {

  wlfw_host_mlo_chip_info_s_v01 mlo_chip_info;

  uint8_t adj_mlo_num_chips;

  wlfw_host_mlo_chip_info_s_v01 adj_mlo_chip_info[QMI_WLFW_MAX_NUM_ADJ_MLO_CHIPS_V01];
}wlfw_host_mlo_chip_v2_info_s_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_aggregates
    @{
  */
/**  Struct for PMU params
 */
typedef struct {

  uint8_t pin_name[QMI_WLFW_PMU_PIN_NAME_MAX_LEN_V01];
  /**<   Use u32 for corebsp data structure alignment*/

  uint32_t wake_volt_valid;
  /**<   Voltage value in mV*/

  uint32_t wake_volt;

  uint32_t sleep_volt_valid;

  uint32_t sleep_volt;
}wlfw_pmu_param_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_aggregates
    @{
  */
/**  struct for Corebsp PMU config
 */
typedef struct {

  uint32_t pmu_param_len;  /**< Must be set to # of elements in pmu_param */
  wlfw_pmu_param_v01 pmu_param[QMI_WLFW_PMU_PARAMS_MAX_V01];
}wlfw_pmu_cfg_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_aggregates
    @{
  */
/**  structure for shadow register version 3
 */
typedef struct {

  uint32_t addr;
}wlfw_shadow_reg_v3_cfg_s_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_aggregates
    @{
  */
/**  structure for share memory information
 */
typedef struct {

  wlfw_share_mem_type_enum_v01 type;

  uint64_t start;

  uint64_t size;
}wlfw_share_mem_info_s_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_aggregates
    @{
  */
/**  Structure for passing PCIe Link information
 */
typedef struct {
...
}wlfw_host_pcie_link_info_s_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /* Optional */
  /*  Subscribe option of wlfw_m3_dump_upload_segments_req_ind_msg */
  uint8_t m3_dump_upload_segments_req_enable_valid;  /**< Must be set to true if m3_dump_upload_segments_req_enable is being passed */
  uint8_t m3_dump_upload_segments_req_enable;

  /* Optional */
  /*  Subscribe option of wlfw_fw_ssr_ind_msg */
  uint8_t fw_ssr_enable_valid;  /**< Must be set to true if fw_ssr_enable is being passed */
  uint8_t fw_ssr_enable;
...
typedef struct {
  ...
  /* Optional */
  /*  Delay(in ms) FW keep between WLAN_EN toggle */
  uint8_t wlan_en_delay_valid;  /**< Must be set to true if wlan_en_delay is being passed */
  uint32_t wlan_en_delay;
...
typedef struct {
  ...
  /* Optional */
  /*  Shadow Registers Version 3 Information */
  uint8_t shadow_reg_v3_valid;  /**< Must be set to true if shadow_reg_v3 is being passed */
  uint32_t shadow_reg_v3_len;  /**< Must be set to # of elements in shadow_reg_v3 */
  wlfw_shadow_reg_v3_cfg_s_v01 shadow_reg_v3[QMI_WLFW_MAX_NUM_SHADOW_REG_V3_V01];
...
typedef struct {
  ...
  /* Optional */
  /*  Proper voltage for open loop CPR **Deprecated */
  ...
  uint8_t dev_mem_info_valid;  /**< Must be set to true if dev_mem_info is being passed */
  wlfw_dev_mem_info_s_v01 dev_mem_info[QMI_WLFW_MAX_DEV_MEM_NUM_V01];

  /* Optional */
  /*  Foundry name of card */
  uint8_t foundry_name_valid;  /**< Must be set to true if foundry_name is being passed */
  ...
  /* Optional */
  /*  WLAN FW BDF CALDATA download approach */
  uint8_t bdf_dnld_method_valid;  /**< Must be set to true if bdf_dnld_method is being passed */
  wlfw_bdf_dnld_method_v01 bdf_dnld_method;

  /* Optional */
  /*  HW IDS GPIO bit map */
  uint8_t hwid_bitmap_valid;  /**< Must be set to true if hwid_bitmap is being passed */
  uint8_t hwid_bitmap;

  /* Optional */
  /*  OL CPR config */
  uint8_t ol_cpr_cfg_valid;  /**< Must be set to true if ol_cpr_cfg is being passed */
  wlfw_pmu_cfg_v01 ol_cpr_cfg;

  /* Optional */
  /*  REGDB mandatory or not */
  uint8_t regdb_mandatory_valid;  /**< Must be set to true if regdb_mandatory is being passed */
  uint8_t regdb_mandatory;

  /* Optional */
  /*  To indicate whether FW supports download of regdb.bin */
  uint8_t regdb_support_valid;  /**< Must be set to true if regdb_support is being passed */
  uint8_t regdb_support;

  /* Optional */
  /*  To indicate whether FW supports download of rxgainlut.bin */
  uint8_t rxgainlut_support_valid;  /**< Must be set to true if rxgainlut_support is being passed */
  uint8_t rxgainlut_support;

  /* Optional */
  /*  WLFW PHY HE CHANNEL WIDTH CAPABILITY */
  uint8_t he_channel_width_cap_valid;  /**< Must be set to true if he_channel_width_cap is being passed */
  wlfw_he_channel_width_cap_v01 he_channel_width_cap;

  /* Optional */
  /*  WLFW PHY QAM CAPABILITY */
  uint8_t phy_qam_cap_valid;  /**< Must be set to true if phy_qam_cap is being passed */
  wlfw_phy_qam_cap_v01 phy_qam_cap;
...
typedef struct {
  ...
  /* Optional */
  /*  Cal DB file size for consolidated Cal DB. Sent from host to fw before calibration. */
  uint8_t cal_file_download_size_valid;  /**< Must be set to true if cal_file_download_size is being passed */
  uint64_t cal_file_download_size;
...
typedef struct {
  ...
  /* Optional */
  /*  MLO Capable. Yes or No */
  uint8_t mlo_capable_valid;  /**< Must be set to true if mlo_capable is being passed */
  uint8_t mlo_capable;

  /* Optional */
  /*  CHIP ID if MLO capability is present */
  uint8_t mlo_chip_id_valid;  /**< Must be set to true if mlo_chip_id is being passed */
  uint16_t mlo_chip_id;

  /* Optional */
  /*  MLO Group ID if MLO capability is present */
  uint8_t mlo_group_id_valid;  /**< Must be set to true if mlo_group_id is being passed */
  uint8_t mlo_group_id;

  /* Optional */
  /*  Max MLO Peer if MLO capability is present */
  uint8_t max_mlo_peer_valid;  /**< Must be set to true if max_mlo_peer is being passed */
  uint16_t max_mlo_peer;

  /* Optional */
  /*  MLO Num Chips if MLO capability is present */
  uint8_t mlo_num_chips_valid;  /**< Must be set to true if mlo_num_chips is being passed */
  uint8_t mlo_num_chips;

  /* Optional */
  /*  MLO Chip Info if MLO capability is present */
  uint8_t mlo_chip_info_valid;  /**< Must be set to true if mlo_chip_info is being passed */
  wlfw_host_mlo_chip_info_s_v01 mlo_chip_info[QMI_WLFW_MAX_NUM_MLO_CHIPS_V01];

  /* Optional */
  /*  Feature List */
  uint8_t feature_list_valid;  /**< Must be set to true if feature_list is being passed */
  uint64_t feature_list;

  /* Optional */
  /*  Number of WLAN clients */
  uint8_t num_wlan_clients_valid;  /**< Must be set to true if num_wlan_clients is being passed */
  uint16_t num_wlan_clients;

  /* Optional */
  /*  Number of WLAN vaps */
  uint8_t num_wlan_vaps_valid;  /**< Must be set to true if num_wlan_vaps is being passed */
  uint8_t num_wlan_vaps;

  /* Optional */
  /*  Wake MSI GIC register address */
  uint8_t wake_msi_addr_valid;  /**< Must be set to true if wake_msi_addr is being passed */
  uint32_t wake_msi_addr;

  /* Optional */
  /*  Delay(in ms) FW keep between WLAN_EN toggle */
  uint8_t wlan_enable_delay_valid;  /**< Must be set to true if wlan_enable_delay is being passed */
  uint32_t wlan_enable_delay;

  /* Optional */
  /*  DDR Type */
  uint8_t ddr_type_valid;  /**< Must be set to true if ddr_type is being passed */
  uint32_t ddr_type;

  /* Optional */
  /*  GPIO Information */
  uint8_t gpio_info_valid;  /**< Must be set to true if gpio_info is being passed */
  uint32_t gpio_info_len;  /**< Must be set to # of elements in gpio_info */
  uint32_t gpio_info[QMI_WLFW_MAX_NUM_GPIO_INFO_V01];

  /* Optional */
  /*  To indicate whether FW INI CFG file will be downloaded */
  uint8_t fw_ini_cfg_support_valid;  /**< Must be set to true if fw_ini_cfg_support is being passed */
  uint8_t fw_ini_cfg_support;

  /* Optional */
  /*  MLO Chip Info if Adjacent MLO capability is present */
  uint8_t mlo_chip_v2_info_valid;  /**< Must be set to true if mlo_chip_v2_info is being passed */
  wlfw_host_mlo_chip_v2_info_s_v01 mlo_chip_v2_info[QMI_WLFW_MAX_NUM_MLO_V2_CHIPS_V01];

  /* Optional */
  /*  PCIe Link Information */
  uint8_t pcie_link_info_valid;  /**< Must be set to true if pcie_link_info is being passed */
  wlfw_host_pcie_link_info_s_v01 pcie_link_info;
...
typedef struct {
  ...
  uint8_t share_mem_valid;  /**< Must be set to true if share_mem is being passed */
  uint32_t share_mem_len;  /**< Must be set to # of elements in share_mem */
  wlfw_share_mem_info_s_v01 share_mem[QMI_WLFW_MAX_NUM_SHARE_MEM_V01];
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Indication Message; indicates client that FW initialization has completed & offset for
    hang event data */
typedef struct {
  ...
  uint8_t hang_data_length_valid;  /**< Must be set to true if hang_data_length is being passed */
  uint16_t hang_data_length;
}wlfw_fw_init_done_ind_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Optional */
  /*  Cal DB file size for consolidated Cal DB. Sent from FW to host after calibration. */
  uint8_t cal_file_upload_size_valid;  /**< Must be set to true if cal_file_upload_size is being passed */
  uint64_t cal_file_upload_size;
}wlfw_cal_done_ind_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Optional */
  /*  MHI state info address */
  uint8_t mhi_state_info_addr_valid;  /**< Must be set to true if mhi_state_info_addr is being passed */
  uint64_t mhi_state_info_addr;

  /* Optional */
  /*  MHI state info size */
  uint8_t mhi_state_info_size_valid;  /**< Must be set to true if mhi_state_info_size is being passed */
  uint32_t mhi_state_info_size;
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Indication Message; This command indicates client to Upload multiple M3 Dump Segments */
typedef struct {
  ...
  /* Mandatory */
  /*  Number of valid M3 segments */
  uint32_t no_of_valid_segments;

  /* Mandatory */
  /*  M3 segment info */
  wlfw_m3_segment_info_s_v01 m3_segment[QMI_WLFW_MAX_M3_SEGMENTS_SIZE_V01];
}wlfw_m3_dump_upload_segments_req_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Request Message; This command sends WLAN host subsystem restart level to FW. */
typedef struct {

  /* Optional */
  /*  Restart Level Type */
  uint8_t restart_level_type_valid;  /**< Must be set to true if restart_level_type is being passed */
  uint8_t restart_level_type;
}wlfw_subsys_restart_level_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Response Message; This command sends WLAN host subsystem restart level to FW. */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}wlfw_subsys_restart_level_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Request Message; This command sends specified INI file to FW */
typedef struct {

  /* Optional */
  /*  INI File Type */
  uint8_t file_type_valid;  /**< Must be set to true if file_type is being passed */
  wlfw_ini_file_type_v01 file_type;
  ...
  uint8_t end_valid;  /**< Must be set to true if end is being passed */
  uint8_t end;
}wlfw_ini_file_download_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Response Message; This command sends specified INI file to FW */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}wlfw_ini_file_download_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Request Message; This command asks for PHY's capabilities */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}wlfw_phy_cap_req_msg_v01;
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Response Message; This command asks for PHY's capabilities */
typedef struct {
  ...
  /* Optional */
  /*  Total PHY Number */
  uint8_t num_phy_valid;  /**< Must be set to true if num_phy is being passed */
  uint8_t num_phy;

  /* Optional */
  /*  Board id information */
  uint8_t board_id_valid;  /**< Must be set to true if board_id is being passed */
  uint32_t board_id;

  /* Optional */
  /*  Indicate MLO V2 Support */
  uint8_t mlo_cap_v2_support_valid;  /**< Must be set to true if mlo_cap_v2_support is being passed */
  uint32_t mlo_cap_v2_support;
}wlfw_phy_cap_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Request Message; This command informs WLAN FW about initial hw config like RF */
typedef struct {

  /* Optional */
  /*  RF subtype */
  uint8_t rf_subtype_valid;  /**< Must be set to true if rf_subtype is being passed */
  wlfw_wlan_rf_subtype_v01 rf_subtype;
}wlfw_wlan_hw_init_cfg_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Response Message; This command informs WLAN FW about initial hw config like RF */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}wlfw_wlan_hw_init_cfg_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** PCIeLowPowerstate Message; This command controls PCIe Link state */
typedef struct {

  /* Mandatory */
  wlfw_pcie_link_state_enum_v01 link_state_req;
}wlfw_pcie_link_ctrl_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Response Message; This command controls PCIe Link state */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}wlfw_pcie_link_ctrl_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Request Message; This command sends the AUX UC information to server. */
typedef struct {
  ...
  /*  Size of Memory in Bytes */
  uint32_t size;
}wlfw_aux_uc_info_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Response Message; This command sends the AUX UC information to server. */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}wlfw_aux_uc_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Request Message; This command sends the TME-L Patch information to server. */
typedef struct {

  /* Mandatory */
  /*  TME lite file type */
  wlfw_tme_lite_file_type_v01 tme_file;
  ...
  /*  Size of Memory in Bytes */
  uint32_t size;
}wlfw_tme_lite_info_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Response Message; This command sends the TME-L Patch information to server. */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}wlfw_tme_lite_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Indication Message; indicates that FW is in SSR mode */
typedef struct {

  /* Mandatory */
  wlfw_fw_ssr_reason_v01 reason_code;
}wlfw_fw_ssr_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** BPMSenable/disablestate Message; This command controls BMPS state */
typedef struct {

  /* Mandatory */
  wlfw_bmps_state_enum_v01 bmps_state;
}wlfw_bmps_ctrl_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Response Message; This command controls BMPS state */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}wlfw_bmps_ctrl_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Request Message; This command informs about LPASS crash to WLAN FW */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Response Message; This command informs about LPASS crash to WLAN FW */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}wlfw_lpass_ssr_resp_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_WLFW_AUX_UC_INFO_V01
//#define REMOVE_QMI_WLFW_BDF_DOWNLOAD_V01
//#define REMOVE_QMI_WLFW_BMPS_CTRL_V01
...
//#define REMOVE_QMI_WLFW_FW_SSR_IND_V01
...
//#define REMOVE_QMI_WLFW_INI_FILE_DOWNLOAD_V01
//#define REMOVE_QMI_WLFW_LPASS_SSR_V01
//#define REMOVE_QMI_WLFW_M3_DUMP_UPLOAD_DONE_REQ_V01
//#define REMOVE_QMI_WLFW_M3_DUMP_UPLOAD_REQ_IND_V01
//#define REMOVE_QMI_WLFW_M3_DUMP_UPLOAD_SEGMENTS_REQ_IND_V01
...
//#define REMOVE_QMI_WLFW_PCIE_LINK_CTRL_V01
//#define REMOVE_QMI_WLFW_PHY_CAP_V01
...
//#define REMOVE_QMI_WLFW_SUBSYS_RESTART_LEVEL_V01
//#define REMOVE_QMI_WLFW_TME_LITE_INFO_V01
...
//#define REMOVE_QMI_WLFW_WLAN_HW_INIT_CFG_V01
