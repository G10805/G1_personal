...
//commenting below header for Android T due to build issue
//bionic/libc/kernel/uapi/drm/msm_drm.h:90:9: error: expected member name or ';' after declaration specifiers
// __u32 or;
#ifndef ANDROID_T_ABOVE
