...
typedef struct
{
    qcarcam_buffer_t p_buffers;
    qcarcam_color_fmt_t format;
    unsigned int n_buffers;
    unsigned int width;
    unsigned int height;
} test_util_buffers_param_t;
...
typedef struct
{
    ...
    qcarcam_isp_usecase_config_t isp_config[QCARCAM_MAX_ISP_INSTANCES]; /// < Specifies ISP instance config
...
typedef qcarcam_ret_t (*power_event_callable)(test_util_pm_event_t event, void* usr_data);
