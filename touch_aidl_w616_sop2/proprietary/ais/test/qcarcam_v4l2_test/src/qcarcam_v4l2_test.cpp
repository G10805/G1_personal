...
static qcarcam_test_ctxt_t g_ctxt = {0};
test_cfg_t g_test_cfg = {0};
...
int main(int argc, char **argv)
{
    ...
    g_ctxt.numInputs = test_util_parse_xml_config_file(g_filename, xml_inputs, NUM_MAX_CAMERAS, &g_xml_cfg);
