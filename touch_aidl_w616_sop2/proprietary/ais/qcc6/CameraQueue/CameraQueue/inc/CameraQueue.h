 ...
 *
 * Copyright (c) 2011-2013, 2016-2017, 2021 Qualcomm Technologies, Inc.
 * All Rights Reserved.
...
typedef enum
{
    CAMERAQUEUE_LOCK_NONE = 0,  //No locking. Thread safe for single producer/single consumer usage
