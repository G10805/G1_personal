...
struct ImageProcessor {
  ...
  static int ConvertFormat(const android::hardware::camera::common::V1_0::helper::CameraMetadata& metadata,
...
bool SetExifTags(const android::hardware::camera::common::V1_0::helper::CameraMetadata& metadata, ExifUtils* utils);
}  // namespace arc
