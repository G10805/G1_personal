...
int Metadata::FillStaticMetadata(android::hardware::camera::common::V1_0::helper::CameraMetadata* metadata) {
  HAL_LOG_ENTER();
  if (!metadata) {
  ...
  for (auto& component : components_) {
    ...
    android::hardware::camera::common::V1_0::helper::CameraMetadata additional_metadata;
    // Populate the fields.
...
bool Metadata::IsValidRequest(const android::hardware::camera::common::V1_0::helper::CameraMetadata& metadata) {
  HAL_LOG_ENTER();
...
int Metadata::GetRequestTemplate(int template_type,
                                 android::hardware::camera::common::V1_0::helper::CameraMetadata* template_metadata) {
  HAL_LOG_ENTER();
...
int Metadata::SetRequestSettings(const android::hardware::camera::common::V1_0::helper::CameraMetadata& metadata) {
  HAL_LOG_ENTER();
...
int Metadata::FillResultMetadata(android::hardware::camera::common::V1_0::helper::CameraMetadata* metadata) {
  HAL_LOG_ENTER();
  if (!metadata) {
    HAL_LOGE("Can't fill null metadata.");
    return -EINVAL;
