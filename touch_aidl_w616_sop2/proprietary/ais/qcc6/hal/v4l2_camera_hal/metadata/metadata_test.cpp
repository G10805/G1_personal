...
class MetadataTest : public Test {
 protected:
  virtual void SetUp() {
    ...
    metadata_.reset(new android::hardware::camera::common::V1_0::helper::CameraMetadata());
    non_empty_metadata_.reset(new android::hardware::camera::common::V1_0::helper::CameraMetadata());
    uint8_t val = 1;
  ...
  // Metadata.
  std::unique_ptr<android::hardware::camera::common::V1_0::helper::CameraMetadata> metadata_;
  std::unique_ptr<android::hardware::camera::common::V1_0::helper::CameraMetadata> non_empty_metadata_;
