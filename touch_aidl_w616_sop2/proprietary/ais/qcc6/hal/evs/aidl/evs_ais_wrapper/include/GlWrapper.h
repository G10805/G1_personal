...
public:
    ...
    bool initialize(sp<IAutomotiveDisplayProxyService>& svc,
                    uint64_t displayId);
    void shutdown();
    ...
    void showWindow(sp<IAutomotiveDisplayProxyService>& svc,
                    uint64_t displayId);
    void hideWindow(sp<IAutomotiveDisplayProxyService>& svc,
                    uint64_t displayId);
