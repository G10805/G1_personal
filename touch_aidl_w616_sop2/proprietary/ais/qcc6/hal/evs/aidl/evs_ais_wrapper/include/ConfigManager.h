 ...
 *
 * Please note that the parameter sequence are to be maintained as in evs test app
 */
...
public:
     ...
     *         given camera identifier.
     */
    std::unique_ptr<ConfigManager::CameraInfo>& setCameraInfo(const std::string cameraId,
     ...
     *
     * @return bool
     *         Indicate external xml provided or not.
     */
    bool externalMetadataEnabled() {
...
private:
    ...
    /* External metadata supplied */
    bool mExternalMetadata = false;
