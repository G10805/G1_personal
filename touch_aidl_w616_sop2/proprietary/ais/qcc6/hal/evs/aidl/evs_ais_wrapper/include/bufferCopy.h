...
void fillRGBAFromUYVY(const ::aidl::android::hardware::automotive::evs::BufferDesc& tgtBuff,
                      uint8_t* tgt, void* imgData, unsigned imgStride);

void fillOutBufWithoutConversion(const BufferDesc& tgtBuff, uint8_t* tgt,
