...
class V4L2Wrapper {
 public:
  ...
  static V4L2Wrapper* NewV4L2Wrapper(int id, const V4L2CameraHAL::StreamConfigs_t& qcarcam_info);
...
//        device_->Disconnect();
  ...
  static QCarCamRet_e v4l2_ais_event_cb(const QCarCamHndl_t hndl, const uint32_t event_id, const QCarCamEventPayload_t *p_payload, void *pPrivateData);
...
//  uint32_t mClientCnt;
  ...
  V4L2Wrapper(int id_, const V4L2CameraHAL::StreamConfigs_t qcarcam_info);
  ...
  uint32_t getQcarcamToHalFormat(QCarCamColorFmt_e qcarcamFormat);
  ...
  int32_t DoC2dScale(buffer_info_t * dst_buff_info);
