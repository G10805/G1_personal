...
LOCAL_SHARED_LIBRARIES:= libais_client_qcc6 libais_log_proprietary_qcc6 \
    libais_test_util_proprietary_qcc6 liblog libxml2 libEGL libui libutils libcutils
...
LOCAL_INIT_RC := ais_v4l2_proxy_qcc6.rc

LOCAL_MODULE:= ais_v4l2_proxy_qcc6
...
#===================
include $(CLEAR_VARS)
LOCAL_MODULE:= ais_v4l2loopback_config_qcc6.xml
