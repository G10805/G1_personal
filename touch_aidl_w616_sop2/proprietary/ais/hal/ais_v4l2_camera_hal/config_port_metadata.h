...
#define CAMERA_CONFIG_JSON_FILE "/vendor/bin/ais_config_v4l2_camera_hal.json"
...
public:
    struct CameraInfo {
        ...
        // The camera device origin located w.r.t the vehicle body frame.
        std::string lens_pose_reference = "";
        // The orientation of the camera relative to the sensor coordinate system.
        std::vector<float> lens_pose_rotation = {};
        // Position of the camera device optical center.
        std::vector<float> lens_pose_translation = {};
        // Parameters for the camera device's intrinsic calibration.
