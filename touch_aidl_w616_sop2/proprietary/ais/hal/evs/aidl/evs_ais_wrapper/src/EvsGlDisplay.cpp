...
EvsGlDisplay::EvsGlDisplay(sp<IAutomotiveDisplayProxyService> pDisplayProxy,
                           uint64_t displayId) :
...
ScopedAStatus EvsGlDisplay::getDisplayInfo(DisplayDesc* _aidl_return) {
    ...
    mDisplayProxy->getDisplayInfo(mDisplayId, [_aidl_return](const auto& hidlMode, const auto& hidlState) {
