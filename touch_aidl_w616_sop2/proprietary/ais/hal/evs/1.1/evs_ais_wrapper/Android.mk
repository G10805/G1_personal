...
LOCAL_INIT_RC := android.hardware.automotive.evs@1.1-ais.rc
...
LOCAL_MODULE := android.hardware.automotive.evs@1.1-ais
...
#include $(CLEAR_VARS)
#LOCAL_MODULE := evs_sample_configuration_ais.xml
#LOCAL_MODULE_CLASS := ETC
#LOCAL_MODULE_PATH := $(TARGET_OUT_VENDOR)/etc/automotive/evs
