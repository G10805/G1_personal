...
bool ConfigManagerUtil::convertToPixelFormat(const string &format,
    ...
    if (!trimmed.compare("HAL_PIXEL_FORMAT_RGBA_8888")) {
        pixFormat =  HAL_PIXEL_FORMAT_RGBA_8888;
    } else if (!trimmed.compare("HAL_PIXEL_FORMAT_YCRCB_420_SP")) {
        pixFormat =  HAL_PIXEL_FORMAT_YCRCB_420_SP;
    } else if (!trimmed.compare("HAL_PIXEL_FORMAT_YCBCR_422_I")) {
        pixFormat =  HAL_PIXEL_FORMAT_YCBCR_422_I;
    } else if (!trimmed.compare("HAL_PIXEL_FORMAT_CbYCrY_422_I")) {
        pixFormat =  HAL_PIXEL_FORMAT_CbYCrY_422_I;
    } else {
        success = false;
    }
