...
public:
    ...
    EvsAISCamera(const char *deviceName, uint32_t frameWidth, uint32_t frameHeight, uint32_t frameFormat);
...
private:
    ...
    void fillRGBAFromUYVY(const BufferDesc& tgtBuff, uint8_t* tgt, void* imgData);
#ifndef CPU_CONVERSION
...
#endif
#endif
    qcarcam_color_fmt_t getHalToQcarcamFormat(uint32_t halFormat);
