...
#ifndef VENDOR_QTI_CAMERA_COMMON_1_0_CAMERAMODULE_H
#define VENDOR_QTI_CAMERA_COMMON_1_0_CAMERAMODULE_H
...
public:
    ...
    bool isSetTorchModeSupported(int cameraId) const;
    int setTorchMode(const char* camera_id, bool enable);
    int turnOnTorchWithStrengthLevel(const char* camera_id, int32_t torchStrength);
    int getTorchStrengthLevel(const char* camera_id, int32_t* strengthLevel);
