...
void GBMBuffer::fill_qcarcam_buffer(qcarcam_buffer_t& qcarcam_buf, bool is_align, uint32 format)
{
    switch (format)
    {
    case QCARCAM_FMT_UYVY_8:
