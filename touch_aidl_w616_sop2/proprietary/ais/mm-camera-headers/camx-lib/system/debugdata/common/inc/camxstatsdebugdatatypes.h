...
enum class CAMX_PACKED DebugDataTagID : UINT16
{
    ...
    TuningIPEModulesConfigRegisterV1,
    TuningIPEModulesConfigRegisterOfflineV1,
...
///  NOTE: The values defined in this enum MUST NOT change! If an ID is being deprecated - developers can rename the ID to
///        to indicate that it is deprecated - but should not remove it.
enum class CAMX_PACKED DebugDataTagType : UINT16
{
    ...
    TuningTypeEnd                       = TuningIFESensorConfig,
