...
#define CAMX_LOG_DUMP(group, fmt, ...)                                              \
    if (CamX::g_logInfo.groupsEnable[CamxLogDump] & group)                          \
    {                                                                               \
        CAMX_LOG(CamxLogDump, "[ DUMP]", group, fmt, ##__VA_ARGS__)                 \
    }
...
#define CAMX_LOG_CONFIG(group, fmt, ...)                                            \
    if (CamX::g_logInfo.groupsEnable[CamxLogConfig] & group)                        \
    {                                                                               \
        CAMX_LOG(CamxLogConfig, "[CONFIG]", group, fmt, ##__VA_ARGS__)              \
    }
...
#define CAMX_LOG_REQMAP(group, fmt, ...)                                            \
    if (CamX::g_logInfo.groupsEnable[CamxLogReqMap] & group)                        \
    {                                                                               \
        CAMX_LOG(CamxLogReqMap, "[REQMAP]", group, fmt, ##__VA_ARGS__)              \
    }
