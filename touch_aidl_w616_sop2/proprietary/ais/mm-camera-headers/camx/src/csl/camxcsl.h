...
typedef enum
{
    ...
    CSLCameraTitanSocSA8155   = 362,   ///< SA8155 SOC Id
    CSLCameraTitanSocSA8155P  = 367,   ///< SA8155P SOC Id
    ...
    CSLCameraTitanSocSA8295P  = 460,   ///< SA8295P SOC Id
    CSLCameraTitanSocSA8540P  = 461,   ///< SA8540P SOC Id
} CSLCameraFamilySoc;
...
typedef enum
{
    ...
    CSLTitan175V111 = 0x175111,           ///< Titan HW version for SA8195P
    CSLTitan175V120 = 0x175120,           ///< Titan HW version for SM7150/SM7150P V100
    CSLTitan175V200 = 0x175200,           ///< Titan HW version for SA8295P
    CSLTitanMax                           ///< Titan MAX
...
typedef struct
{
    ...
    INT32              offset;            ///< offset of the buffer.
    INT32              errorType;         ///< to be used in future to specify error type triggerring LDAR.
} CSLDumpRequestInfo;
...
/// @param  cslSyncId              CSL Sync Id that needs to be cancelled
...
///
/// @param  hCSL                 A handle to the CSL session.
/// @param  lastFlushedCSLSyncId Last CSL Sync id that needs to be cancelled
/// @param  lastFlushedRequestId The request id of the last flushed request
///
/// @return CamxResult indicating success or failure of the call.
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult CSLFlushLock(
    CSLHandle hCSL,
    UINT64    lastFlushedCSLSyncId,
