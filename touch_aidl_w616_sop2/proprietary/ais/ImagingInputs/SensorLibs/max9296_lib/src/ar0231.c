...
typedef enum
{
    AR0231_MODE_DEFAULT = 0,
    AR0231_MODE_12BIT_HDR_3EXP_30FPS = AR0231_MODE_DEFAULT,
    AR0231_MODE_12BIT_LINEAR_30FPS = 1,
    AR0231_MODE_12BIT_LINEAR_60FPS = 2,
    AR0231_MODE_12BIT_HDR_3EXP_15FPS = 3,
    AR0231_MODE_16BIT_HDR_3EXP_30FPS = 4, /*not verified*/
    AR0231_MODE_20BIT_HDR_3EXP_30FPS = 5, /*not verified*/
    AR0231_MODE_MAX = 6
}ar0231_mode_id_t;
...
#define _ar0231_start_delay_ 100
#define MAX9295_LINK_RESET_DELAY 100000
#define MAX9295_START_DELAY 20000

#define AR0231_SNSR_DEFAULT_ADDR    0x20
#define AR0231_CHIP_ID 0x354
...
#define AR0231_RESET_LOW_DELAY   75 /*75us from spec*/
#define AR0231_RESET_HIGH_DELAY  25000 /*25ms corresponds to roughly 650000 EXTCLK as per spec*/
...
#define AR0231_FINE_INTEGRATION_TIME 0x0752
...
{ \
    ...
    { 0x02BE, 0x80, AR0231_RESET_LOW_DELAY }, /*pull low then high */ \
    { 0x02BE, 0x90, AR0231_RESET_HIGH_DELAY }, /*set sensor_rst GPIO*/ \
    { 0x03F1, 0x89, _max9295_delay_ } \
}
...
////////////////////////////////////////////////////////////////////////////////
//                     AR0231_MODE_12BIT_HDR_3EXP_30FPS
////////////////////////////////////////////////////////////////////////////////
#define AR0231_12BIT_HDR_3EXP_PCLK 99000000 /*99MHz*/
#define AR0231_12BIT_HDR_3EXP_PLL_MULTIPLIER 0x2C
#define AR0231_12BIT_HDR_3EXP_PRE_PLL_CLK_DIV 2
#define AR0231_12BIT_HDR_3EXP_VT_SYS_CLK_DIV  1
#define AR0231_12BIT_HDR_3EXP_VT_PIX_CLK_DIV  6

#define AR0231_12BIT_HDR_3EXP_LINE_LENGTH_PCK_15FPS 0x139c
#define AR0231_12BIT_HDR_3EXP_LINE_LENGTH_PCK 0x9CE /*0x300C*/
#define AR0231_12BIT_HDR_3EXP_FRAME_LENGTH_LINES 0x522 /*0x300A*/

#define AR0231_12BIT_HDR_3EXP_X_ADDR_START 0
#define AR0231_12BIT_HDR_3EXP_X_ADDR_END   0x787
#define AR0231_12BIT_HDR_3EXP_Y_ADDR_START 0x0
#define AR0231_12BIT_HDR_3EXP_Y_ADDR_END   0x4B7
#define AR0231_12BIT_HDR_3EXP_EXTRA_DELAY 0x0

#define AR0231_12BIT_HDR_3EXP_SNSR_INIT \
{ \
    { 0x301A, 0x0018, 100 }, \
    ...
    { 0x302A, AR0231_12BIT_HDR_3EXP_VT_PIX_CLK_DIV, _ar0231_delay_ }, \
    { 0x302C, AR0231_12BIT_HDR_3EXP_VT_SYS_CLK_DIV, _ar0231_delay_ }, \
    { 0x302E, AR0231_12BIT_HDR_3EXP_PRE_PLL_CLK_DIV, _ar0231_delay_ }, \
    { 0x3030, AR0231_12BIT_HDR_3EXP_PLL_MULTIPLIER, _ar0231_delay_ }, \
    ...
    { 0x33E0, 0x0C80, _ar0231_delay_ }, \
    { 0x33E0, 0x0C80, _ar0231_delay_ }, \
    { 0x3004, AR0231_12BIT_HDR_3EXP_X_ADDR_START, _ar0231_delay_ }, \
    { 0x3008, AR0231_12BIT_HDR_3EXP_X_ADDR_END, _ar0231_delay_ }, \
    { 0x3002, AR0231_12BIT_HDR_3EXP_Y_ADDR_START, _ar0231_delay_ }, \
    { 0x3006, AR0231_12BIT_HDR_3EXP_Y_ADDR_END, _ar0231_delay_ }, \
    ...
    { 0x3082, 0x0008, _ar0231_delay_ }, \
    { 0x30BA, 0x11F2, _ar0231_delay_ }, \
    { 0x300C, AR0231_12BIT_HDR_3EXP_LINE_LENGTH_PCK, _ar0231_delay_ }, \
    { 0x300A, AR0231_12BIT_HDR_3EXP_FRAME_LENGTH_LINES, _ar0231_delay_ }, \
    ...
    { 0x3110, 0x0011, _ar0231_delay_ }, \
    { 0x3110, 0x0011, _ar0231_delay_ }, \
    { 0x3110, 0x0011, _ar0231_delay_ }, \
    { 0x3110, 0x0011, _ar0231_delay_ }, \
    { 0x301E, 0x10A8, _ar0231_delay_ }, \
    { 0x301E, 0x10A8, _ar0231_delay_ }, \
    { 0x301E, 0x10A8, _ar0231_delay_ }, \
    { 0x301E, 0x10A8, _ar0231_delay_ }, \
}

static struct camera_i2c_reg_array ar0231_12bit_hdr_3exp_init_array[] = AR0231_12BIT_HDR_3EXP_SNSR_INIT;

////////////////////////////////////////////////////////////////////////////////
//                     AR0231_MODE_12BIT_LINEAR_30FPS
//                     AR0231_MODE_12BIT_LINEAR_60FPS
////////////////////////////////////////////////////////////////////////////////

#define AR0231_12BIT_LINEAR_PCLK 99000000 /*99MHz*/
#define AR0231_12BIT_LINEAR_LINE_LENGTH_PCK_30FPS 2200 /*0x0898*/
#define AR0231_12BIT_LINEAR_LINE_LENGTH_PCK_60FPS 1100 /*0x0898*/
#define AR0231_12BIT_LINEAR_FRAME_LENGTH_LINES 1500 /*0x0A8C*/

#define AR0231_12BIT_LINEAR_COARSE_INTEGRATION_TIME 0x0288
#define AR0231_12BIT_LINEAR_FINE_INTEGRATION_TIME 0x032A

#define AR0231_12BIT_LINEAR_EXTRA_DELAY 0x0
#define AR0231_12BIT_LINEAR_X_ADDR_START 0
#define AR0231_12BIT_LINEAR_X_ADDR_END   0x787
#define AR0231_12BIT_LINEAR_Y_ADDR_START 0x0
#define AR0231_12BIT_LINEAR_Y_ADDR_END   0x4B7

#define AR0231_12BIT_LINEAR_SNSR_INIT \
{ \
    { 0x301A, 0x0018, 100 },         \
    ...
    { 0x33E0, 0x0C80, _ar0231_delay_ }, \
    { 0x33E0, 0x0C80, _ar0231_delay_ }, \
    { 0x3004, AR0231_12BIT_LINEAR_X_ADDR_START, _ar0231_delay_ }, \
    { 0x3008, AR0231_12BIT_LINEAR_X_ADDR_END, _ar0231_delay_ }, \
    { 0x3002, AR0231_12BIT_LINEAR_Y_ADDR_START, _ar0231_delay_ }, \
    { 0x3006, AR0231_12BIT_LINEAR_Y_ADDR_END, _ar0231_delay_ }, \
    { 0x3032, 0x0000, _ar0231_delay_ }, \
    { 0x3400, 0x0010, _ar0231_delay_ }, \
    { 0x3402, 0x0788, _ar0231_delay_ }, \
    { 0x3402, 0x0F10, _ar0231_delay_ }, \
    ...
    { 0x300C, AR0231_12BIT_LINEAR_LINE_LENGTH_PCK_30FPS, _ar0231_delay_ }, \
    { 0x300A, AR0231_12BIT_LINEAR_FRAME_LENGTH_LINES, _ar0231_delay_ }, \
    { 0x3042, AR0231_12BIT_LINEAR_EXTRA_DELAY, _ar0231_delay_ }, \
    { 0x3238, 0x0222, _ar0231_delay_ }, \
    { 0x3238, 0x0222, _ar0231_delay_ }, \
    { 0x3238, 0x0222, _ar0231_delay_ }, \
    { 0x3238, 0x0222, _ar0231_delay_ }, \
    { 0x3012, AR0231_12BIT_LINEAR_COARSE_INTEGRATION_TIME, _ar0231_delay_ }, \
    { 0x3014, AR0231_12BIT_LINEAR_FINE_INTEGRATION_TIME, _ar0231_delay_ }, \
    { 0x30B0, 0x0A00, _ar0231_delay_ }, \
...
static struct camera_i2c_reg_array ar0231_12bit_linear_init_array[] = AR0231_12BIT_LINEAR_SNSR_INIT;

////////////////////////////////////////////////////////////////////////////////
//                     AR0231_MODE_16BIT_HDR_3EXP_30FPS                       //
////////////////////////////////////////////////////////////////////////////////

//OnSemi Recommended

#define AR0231_16BIT_HDR_3EXP_REF_CLK 27000000
#define AR0231_16BIT_HDR_3EXP_PLL_MULTIPLIER 0x2C
#define AR0231_16BIT_HDR_3EXP_PRE_PLL_CLK_DIV 2
#define AR0231_16BIT_HDR_3EXP_VT_SYS_CLK_DIV  1
#define AR0231_16BIT_HDR_3EXP_VT_PIX_CLK_DIV  6
#define AR0231_16BIT_HDR_3EXP_PCLK 99000000 /*99MHz*/

#define AR0231_16BIT_HDR_3EXP_LINE_LENGTH_PCK 0x9CE /*0x300C*/
#define AR0231_16BIT_HDR_3EXP_FRAME_LENGTH_LINES 0x522 /*0x300A*/
#define AR0231_16BIT_HDR_3EXP_EXTRA_DELAY 0x0
#define AR0231_16BIT_HDR_3EXP_X_ADDR_START 0
#define AR0231_16BIT_HDR_3EXP_X_ADDR_END   0x787
#define AR0231_16BIT_HDR_3EXP_Y_ADDR_START 0x0
#define AR0231_16BIT_HDR_3EXP_Y_ADDR_END   0x4B7

#define AR0231_16BIT_HDR_3EXP_SNSR_INIT \
{ \
    { 0x301A, 0x0018, 100 }, \
    { 0x3092, 0x0C24, _ar0231_delay_ }, \
    { 0x337A, 0x0C80, _ar0231_delay_ }, \
    ...
    { 0x32DC, 0x370A, _ar0231_delay_ }, \
    { 0x30B0, 0x0800, _ar0231_delay_ }, \
    { 0x302A, AR0231_16BIT_HDR_3EXP_VT_PIX_CLK_DIV, _ar0231_delay_ }, \
    { 0x302C, AR0231_16BIT_HDR_3EXP_VT_SYS_CLK_DIV, _ar0231_delay_ }, \
    { 0x302E, AR0231_16BIT_HDR_3EXP_PRE_PLL_CLK_DIV, _ar0231_delay_ }, \
    { 0x3030, AR0231_16BIT_HDR_3EXP_PLL_MULTIPLIER, _ar0231_delay_ }, \
    { 0x3036, 0x000C, _ar0231_delay_ }, \
    { 0x3038, 0x0001, _ar0231_delay_ }, \
    { 0x30B0, 0x0800, _ar0231_delay_ }, \
    { 0x30A2, 0x0001, _ar0231_delay_ }, \
    ...
    { 0x33E0, 0x0C80, _ar0231_delay_ }, \
    { 0x33E0, 0x0C80, _ar0231_delay_ }, \
    { 0x3004, AR0231_16BIT_HDR_3EXP_X_ADDR_START, _ar0231_delay_ }, \
    { 0x3008, AR0231_16BIT_HDR_3EXP_X_ADDR_END, _ar0231_delay_ }, \
    { 0x3002, AR0231_16BIT_HDR_3EXP_Y_ADDR_START, _ar0231_delay_ }, \
    { 0x3006, AR0231_16BIT_HDR_3EXP_Y_ADDR_END, _ar0231_delay_ }, \
    { 0x3032, 0x0000, _ar0231_delay_ }, \
    { 0x3400, 0x0010, _ar0231_delay_ }, \
    { 0x3402, 0x0788, _ar0231_delay_ }, \
    { 0x3402, 0x0F10, _ar0231_delay_ }, \
    ...
    { 0x3082, 0x0008, _ar0231_delay_ }, \
    { 0x30BA, 0x11F2, _ar0231_delay_ }, \
    { 0x300C, AR0231_16BIT_HDR_3EXP_LINE_LENGTH_PCK, _ar0231_delay_ }, \
    { 0x300A, AR0231_16BIT_HDR_3EXP_FRAME_LENGTH_LINES, _ar0231_delay_ }, \
    { 0x3042, 0x0000, _ar0231_delay_ }, \
    { 0x3238, 0x0222, _ar0231_delay_ }, \
    { 0x3238, 0x0222, _ar0231_delay_ }, \
    { 0x3238, 0x0222, _ar0231_delay_ }, \
...
static struct camera_i2c_reg_array ar0231_16bit_hdr_3exp_init_array[] = AR0231_16BIT_HDR_3EXP_SNSR_INIT;

////////////////////////////////////////////////////////////////////////////////
//                     AR0231_MODE_20BIT_HDR_3EXP_30FPS                       //
////////////////////////////////////////////////////////////////////////////////
#define AR0231_20BIT_HDR_3EXP_PCLK 99000000 /*99MHz*/

#define AR0231_20BIT_HDR_3EXP_LINE_LENGTH_PCK 0x068A /*0x300C*/
#define AR0231_20BIT_HDR_3EXP_FRAME_LENGTH_LINES 0x522 /*0x300A*/

#define AR0231_20BIT_HDR_3EXP_SNSR_INIT \
{ \
    { 0x301A, 0x10D8, 100 }, \
    { 0x3092, 0x0C24, _ar0231_delay_ }, \
    { 0x337A, 0x0C80, _ar0231_delay_ }, \
    ...
    { 0x3082, 0x0008, _ar0231_delay_ }, \
    { 0x30BA, 0x11F2, _ar0231_delay_ }, \
    { 0x300C, AR0231_20BIT_HDR_3EXP_LINE_LENGTH_PCK, _ar0231_delay_ }, \
    { 0x300A, AR0231_20BIT_HDR_3EXP_FRAME_LENGTH_LINES, _ar0231_delay_ }, \
    { 0x3042, 0x0000, _ar0231_delay_ }, \
    { 0x3238, 0x0222, _ar0231_delay_ }, \
    { 0x3238, 0x0222, _ar0231_delay_ }, \
    { 0x3238, 0x0222, _ar0231_delay_ }, \
...
static struct camera_i2c_reg_array ar0231_20bit_hdr_3exp_init_array[] = AR0231_20BIT_HDR_3EXP_SNSR_INIT;

////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////

#define AR0231_SNSR_START \
{ \
    { 0x301A, 0x001C, _ar0231_start_delay_ }, \
}

#define AR0231_SNSR_STOP \
{ \
    { 0x301A, 0x0018, _ar0231_delay_ }, \
}
...
static int ar0231_apply_sensormode(max9296_context_t* ctxt, uint32 link, uint32 sensormode);
static int ar0231_apply_hdr_exposure(max9296_context_t* ctxt, uint32 link, qcarcam_hdr_exposure_config_t* hdr_exposure);

static max9296_sensor_t ar0231_info = {
    ...
    .apply_sensormode = ar0231_apply_sensormode,
...
static struct camera_i2c_reg_array ar0231_start_array[] = AR0231_SNSR_START;
static struct camera_i2c_reg_array ar0231_stop_array[] = AR0231_SNSR_STOP;
...
static ar0231_mode_t ar0231_modes[AR0231_MODE_MAX] =
{
        [AR0231_MODE_12BIT_HDR_3EXP_30FPS] =
        {
                .pipeline = {
                        ...
                        .mode =
                        {
                            ...
                            .res = {.width = AR0231_SENSOR_WIDTH, .height = AR0231_SENSOR_HEIGHT, .fps = 30.0f},
                            .channel_info = {.vc = 0, .dt = CSI_DT_RAW12, .cid = CID_VC0},
                        },
                },

                .init_array = ar0231_12bit_hdr_3exp_init_array,
                .size_init_array = STD_ARRAY_SIZE(ar0231_12bit_hdr_3exp_init_array),
                .pclk = AR0231_12BIT_HDR_3EXP_PCLK,
                .line_length_pck = AR0231_12BIT_HDR_3EXP_LINE_LENGTH_PCK,
                .frame_length_lines = AR0231_12BIT_HDR_3EXP_FRAME_LENGTH_LINES
        },
        [AR0231_MODE_12BIT_LINEAR_30FPS] =
        {
                .pipeline = {
                ...
                .init_array = ar0231_12bit_linear_init_array,
                .size_init_array = STD_ARRAY_SIZE(ar0231_12bit_linear_init_array),
                .pclk = AR0231_12BIT_LINEAR_PCLK,
                .line_length_pck = AR0231_12BIT_LINEAR_LINE_LENGTH_PCK_30FPS,
                .frame_length_lines = AR0231_12BIT_LINEAR_FRAME_LENGTH_LINES
        },
        [AR0231_MODE_12BIT_LINEAR_60FPS] =
        {
                .pipeline = {
                        ...
                        {
                            .fmt = QCARCAM_FMT_MIPIRAW_12,
                            .res = {.width = AR0231_SENSOR_WIDTH, .height = AR0231_SENSOR_HEIGHT, .fps = 60.0f},
                            .channel_info = {.vc = 0, .dt = CSI_DT_RAW12, .cid = CID_VC0},
                        },
                },
                ...
                .size_init_array = STD_ARRAY_SIZE(ar0231_12bit_linear_init_array),
                .pclk = AR0231_12BIT_LINEAR_PCLK,
                .line_length_pck = AR0231_12BIT_LINEAR_LINE_LENGTH_PCK_60FPS,
                .frame_length_lines = AR0231_12BIT_LINEAR_FRAME_LENGTH_LINES
        },
        [AR0231_MODE_16BIT_HDR_3EXP_30FPS] =
        {
                .pipeline = {
                        ...
                        .mode =
                        {
                            .fmt = QCARCAM_FMT_MIPIRAW_16,
                            .res = {.width = AR0231_SENSOR_WIDTH, .height = AR0231_SENSOR_HEIGHT, .fps = 30.0f},
                            .channel_info = {.vc = 0, .dt = CSI_DT_RAW16, .cid = CID_VC0},
                        },
                },

                .init_array = ar0231_16bit_hdr_3exp_init_array,
                .size_init_array = STD_ARRAY_SIZE(ar0231_16bit_hdr_3exp_init_array),
                .pclk = AR0231_16BIT_HDR_3EXP_PCLK,
                .line_length_pck = AR0231_16BIT_HDR_3EXP_LINE_LENGTH_PCK,
                .frame_length_lines = AR0231_16BIT_HDR_3EXP_FRAME_LENGTH_LINES
        },
        [AR0231_MODE_20BIT_HDR_3EXP_30FPS] =
        {
                .pipeline = {
                        ...
                        .mode =
                        {
                            .fmt = QCARCAM_FMT_MIPIRAW_20,
                            .res = {.width = AR0231_SENSOR_WIDTH, .height = AR0231_SENSOR_HEIGHT, .fps = 30.0f},
                            .channel_info = {.vc = 0, .dt = CSI_DT_RAW20, .cid = CID_VC0},
                        },
                },

                .init_array = ar0231_20bit_hdr_3exp_init_array,
                .size_init_array = STD_ARRAY_SIZE(ar0231_20bit_hdr_3exp_init_array),
                .pclk = AR0231_20BIT_HDR_3EXP_PCLK,
                .line_length_pck = AR0231_20BIT_HDR_3EXP_LINE_LENGTH_PCK,
                .frame_length_lines = AR0231_20BIT_HDR_3EXP_FRAME_LENGTH_LINES
        },
        [AR0231_MODE_12BIT_HDR_3EXP_15FPS] =
        {
                .pipeline = {
                        .id = MAXIM_PIPELINE_X,
                        .mode =
                        {
                            .fmt = QCARCAM_FMT_MIPIRAW_12,
                            .res = {.width = AR0231_SENSOR_WIDTH, .height = AR0231_SENSOR_HEIGHT, .fps = 15.0f},
                            .channel_info = {.vc = 0, .dt = CSI_DT_RAW12, .cid = CID_VC0},
                        },
                },
                ...
                .size_init_array = STD_ARRAY_SIZE(ar0231_12bit_hdr_3exp_init_array),
                .pclk = AR0231_12BIT_HDR_3EXP_PCLK,
                .line_length_pck = AR0231_12BIT_HDR_3EXP_LINE_LENGTH_PCK_15FPS,
                .frame_length_lines = AR0231_12BIT_HDR_3EXP_FRAME_LENGTH_LINES
        },
};
...
static float ar0231_dig_gain_global_max = 3.99f;

max9296_sensor_t* ar0231_get_sensor_info(void)
{
    return &ar0231_info;
}

static int ar0231_create_ctxt(max9296_sensor_info_t* pSensor)
{
    int rc = 0;
    ...
    if(pSensor->mode >= AR0231_MODE_16BIT_HDR_3EXP_30FPS)
    {
    ...
    if (pCtxt)
    {
        ...
        pCtxt->p_mode = &ar0231_modes[pSensor->mode];
...
static int ar0231_detect(max9296_context_t* ctxt, uint32 link)
{
    ...
    else if (pSensor->serializer_alias == pSensor->serializer_addr)
    {
        ...
        // Read mapped sensor to double check it can be accessed
        ar0231_ctxt->cam_sensor_reg_setting.reg_array = read_reg;
        ar0231_ctxt->cam_sensor_reg_setting.size = STD_ARRAY_SIZE(read_reg);
        ar0231_ctxt->cam_sensor_reg_setting.reg_array[0].reg_addr = 0x3000;
        rc = sensor_fcn_tbl->i2c_slave_read(pCtxt->ctrl, pSensor->sensor_alias, &ar0231_ctxt->cam_sensor_reg_setting);
        if (rc || ar0231_ctxt->cam_sensor_reg_setting.reg_array[0].reg_data != AR0231_CHIP_ID)
        {
            SENSOR_WARN("LINK %d failed to read sensor(0x%x), could not skip remap", link, pSensor->sensor_alias);
            isSkipRemap = FALSE;
        }
        else
        {
            SENSOR_WARN("LINK %d remote sensor(0x%x) accessed, skip remap", link, pSensor->sensor_alias);
            isSkipRemap = TRUE;
        }
    ...
    if (FALSE == isSkipRemap)
    {
        ...
        struct camera_i2c_reg_array remap_ser_2[] = {
            ...
            {0x0043, AR0231_SNSR_DEFAULT_ADDR, _ar0231_delay_},
        ...
        SENSOR_WARN("Detected Camera connected to Link %d, Ser ID[0x%x]: 0x%x",
            link, MSM_SER_CHIP_ID_REG_ADDR, ar0231_ctxt->cam_ser_reg_setting.reg_array[0].reg_data);
        ...
        ar0231_ctxt->cam_ser_reg_setting.reg_array = link ? max9295_gmsl_1 : max9295_gmsl_0;
        ar0231_ctxt->cam_ser_reg_setting.size = link ? STD_ARRAY_SIZE(max9295_gmsl_1) : STD_ARRAY_SIZE(max9295_gmsl_0);
        rc = sensor_fcn_tbl->i2c_slave_write_array(pCtxt->ctrl, pSensor->serializer_alias, &ar0231_ctxt->cam_ser_reg_setting);
        if (rc)
        {
            SERR("Failed to reset link %d and remap cam on serializer(0x%x)", link, pSensor->serializer_alias);
        ...
        //Serializer configuration necessary for accesing remote sensor
        struct camera_i2c_reg_array write_reg[] = {
            { 0x02BE, 0x90, _ar0231_delay_ }
        };

        ar0231_ctxt->cam_ser_reg_setting.reg_array = write_reg;
        ar0231_ctxt->cam_ser_reg_setting.size = STD_ARRAY_SIZE(write_reg);

        rc = pCtxt->platform_fcn_tbl.i2c_slave_write_array(pCtxt->ctrl,
                    pSensor->serializer_alias, &ar0231_ctxt->cam_ser_reg_setting);
        if (rc)
        {
            SERR("Failed to set camera serializer(0x%x)", pSensor->serializer_alias);
            return rc;
        }

        //Read remote sensor to double check if successful
        struct camera_i2c_reg_array tmp_reg[] = {{0, 0, 0}};

        ar0231_ctxt->cam_sensor_reg_setting.reg_array = tmp_reg;
        ar0231_ctxt->cam_sensor_reg_setting.size = STD_ARRAY_SIZE(tmp_reg);
        ar0231_ctxt->cam_sensor_reg_setting.reg_array[0].reg_addr = 0x3000;
        rc = pCtxt->platform_fcn_tbl.i2c_slave_read(pCtxt->ctrl,
                    pSensor->sensor_alias, &ar0231_ctxt->cam_sensor_reg_setting);
        if (rc || ar0231_ctxt->cam_sensor_reg_setting.reg_array[0].reg_data != AR0231_CHIP_ID)
        {
            SERR("Failed to detect remote sensor (0x%x)", pSensor->sensor_alias);
...
static int ar0231_get_link_cfg(max9296_context_t* ctxt, uint32 link, max9296_link_cfg_t* p_cfg)
{
    ...
    p_cfg->pipelines[0] = ar0231_modes[mode].pipeline;
...
static int ar0231_init_link(max9296_context_t* ctxt, uint32 link)
{
    ...
    max9296_sensor_info_t* pSensor = &pCtxt->max9296_sensors[link];
    ar0231_contxt_t* ar0231_ctxt = pSensor->pPrivCtxt;
    int rc;
    ...
    if (SENSOR_STATE_DETECTED == pSensor->state)
    {
        ...
        ar0231_ctxt->cam_ser_reg_setting.reg_array = link ? max9295_init_1 : max9295_init_0;
        ar0231_ctxt->cam_ser_reg_setting.size = link ? STD_ARRAY_SIZE(max9295_init_1) : STD_ARRAY_SIZE(max9295_init_0);
        ...
        CameraMicroSleep(AR0231_RESET_HIGH_DELAY);
        ...
        SHIGH("Remote SENSOR addr 0x%x", ar0231_ctxt->cam_sensor_reg_setting.reg_array[0].reg_data);

        ar0231_ctxt->cam_sensor_reg_setting.reg_array = ar0231_ctxt->p_mode->init_array;
        ar0231_ctxt->cam_sensor_reg_setting.size = ar0231_ctxt->p_mode->size_init_array;
        rc = pCtxt->platform_fcn_tbl.i2c_slave_write_array(
            pCtxt->ctrl,
            pSensor->sensor_alias,
            &ar0231_ctxt->cam_sensor_reg_setting);
        if (rc)
        {
        ...
        if (pSensor->mode == AR0231_MODE_12BIT_LINEAR_60FPS || pSensor->mode == AR0231_MODE_12BIT_HDR_3EXP_15FPS)
        {
            tmp_reg[0].reg_addr = 0x300C;
            tmp_reg[0].reg_data = ar0231_ctxt->p_mode->line_length_pck;
            ar0231_ctxt->cam_sensor_reg_setting.reg_array = tmp_reg;
            ar0231_ctxt->cam_sensor_reg_setting.size = STD_ARRAY_SIZE(tmp_reg);
            rc = pCtxt->platform_fcn_tbl.i2c_slave_write_array(
                pCtxt->ctrl,
...
static int ar0231_start_link(max9296_context_t* ctxt, uint32 link)
{
    ...
    if (SENSOR_STATE_INITIALIZED == pSensor->state)
    {
        ...
        SHIGH("start link %d ar0231", link);

        ar0231_ctxt->cam_sensor_reg_setting.reg_array = ar0231_start_array;
        ar0231_ctxt->cam_sensor_reg_setting.size = STD_ARRAY_SIZE(ar0231_start_array);
        rc = pCtxt->platform_fcn_tbl.i2c_slave_write_array(
                pCtxt->ctrl,
                pSensor->sensor_alias,
                &ar0231_ctxt->cam_sensor_reg_setting);
...
static int ar0231_stop_link(max9296_context_t* ctxt, uint32 link)
{
    ...
    if (SENSOR_STATE_STREAMING == pSensor->state)
    {
        ...
        ar0231_ctxt->cam_sensor_reg_setting.reg_array = ar0231_stop_array;
        ar0231_ctxt->cam_sensor_reg_setting.size = STD_ARRAY_SIZE(ar0231_stop_array);
        rc = pCtxt->platform_fcn_tbl.i2c_slave_write_array(
                pCtxt->ctrl,
                pSensor->sensor_alias,
                &ar0231_ctxt->cam_sensor_reg_setting);
...
static int ar0231_get_gain_table_idx(float real_gain)
{
    ...
    if (real_gain >= gain_table[last_idx].real_gain * ar0231_dig_gain_global_max)
    {
        idx = last_idx;
    }
    else
    {
        for (idx = 0; idx < gain_table_size; idx++)
        {
            if (real_gain < gain_table[idx].real_gain * ar0231_dig_gain_global_max)
            {
                break;
            }
        }
    ...
    return STD_MIN(idx, last_idx);
}

static int ar0231_calculate_exposure(max9296_context_t* ctxt, uint32 link, sensor_exposure_info_t* exposure_info)
{
    ar0231_contxt_t* ar0231_ctxt = ctxt->max9296_sensors[link].pPrivCtxt;

    exposure_info->exp_pclk_count = exposure_info->exposure_time*ar0231_ctxt->p_mode->pclk/1000;
    exposure_info->line_count = STD_MIN((unsigned int)((exposure_info->exposure_time * ar0231_ctxt->p_mode->pclk) /
            (ar0231_ctxt->p_mode->line_length_pck * 1000)), (ar0231_ctxt->p_mode->frame_length_lines - 1));

    SLOW("AEC - AR0231 : exp_time=%f => line_cnt=0x%x", exposure_info->exposure_time, exposure_info->line_count);
...
static int ar0231_apply_sensormode(max9296_context_t* ctxt, uint32 link, uint32 sensormode)
{
    max9296_context_t* pCtxt = ctxt;
    max9296_sensor_info_t* pSensor = &pCtxt->max9296_sensors[link];
    ar0231_contxt_t* ar0231_ctxt = (ar0231_contxt_t*)pSensor->pPrivCtxt;
    struct camera_i2c_reg_array *exp_reg_array = ar0231_ctxt->exp_reg_array;
    uint32 exp_size = 0;
    uint32 reg_value = 0;
    int rc = 0;
    ...
    {
        SERR("ar0231 %d apply sensormode in wrong state %d", link, pSensor->state);
        rc = CAMERA_EBADSTATE;
    }
    else
    {
        switch(sensormode)
        {
            case AR0231_MODE_12BIT_HDR_3EXP_30FPS:
                //change to 30FPS only here for now
                reg_value = AR0231_12BIT_HDR_3EXP_LINE_LENGTH_PCK;
                break;
            case AR0231_MODE_12BIT_HDR_3EXP_15FPS:
                //change to 15FPS only here for now
                reg_value = AR0231_12BIT_HDR_3EXP_LINE_LENGTH_PCK_15FPS;
                break;
            case AR0231_MODE_12BIT_LINEAR_30FPS:
            case AR0231_MODE_12BIT_LINEAR_60FPS:
            case AR0231_MODE_16BIT_HDR_3EXP_30FPS:
            case AR0231_MODE_20BIT_HDR_3EXP_30FPS:
                break;
            default:
                SENSOR_WARN("Invalid mode index");
                break;
        }

        ADD_I2C_REG_ARRAY(exp_reg_array, exp_size, 0x300c, reg_value, _ar0231_delay_);
        ar0231_ctxt->cam_sensor_reg_setting.reg_array = exp_reg_array;
        ar0231_ctxt->cam_sensor_reg_setting.size = exp_size;
        ...
        if (rc)
        {
            SERR("Failed to set sensor pclk 0x%x", pSensor->sensor_alias);
        }
        else
        {
            pSensor->mode = sensormode;
        }
    }
...
static int ar0231_apply_exposure(max9296_context_t* ctxt, uint32 link, sensor_exposure_info_t* exposure_info)
{
       ...
       exposure_info->exposure_mode_type == QCARCAM_EXPOSURE_AUTO)
    {
        ...
        unsigned int fine_integration_time = STD_MIN(exposure_info->exp_pclk_count - (exposure_info->line_count * ar0231_ctxt->p_mode->line_length_pck),
                (ar0231_ctxt->p_mode->line_length_pck-1));
        ...
        ADD_I2C_REG_ARRAY(exp_reg_array, exp_size, AR0231_REG_COARSE_INTEGRATION_TIME, (exposure_info->line_count & 0xffff), _ar0231_delay_);
        ADD_I2C_REG_ARRAY(exp_reg_array, exp_size, AR0231_REG_FINE_INTEGRATION_TIME, AR0231_FINE_INTEGRATION_TIME, _ar0231_delay_);
...
static int ar0231_apply_hdr_exposure(max9296_context_t* ctxt, uint32 link, qcarcam_hdr_exposure_config_t* hdr_exposure)
{
    ...
    case QCARCAM_EXPOSURE_LUX_IDX:
    {
        ...
        if (lux_idx >= ar0231_ctxt->num_steps)
        {
            SENSOR_ERROR("lux_index (%d) out of bounds (max = %d)", lux_idx, ar0231_ctxt->num_steps);
            return CAMERA_EBADPARM;
        }

        float exposure_time = ar0231_ctxt->exp_table[lux_idx].exp;
        float real_gain = ar0231_ctxt->exp_table[lux_idx].real_gain;

        unsigned int pclk_count = exposure_time * ar0231_ctxt->p_mode->pclk / 1000;
        unsigned int line_count = STD_MIN((unsigned int)(pclk_count / ar0231_ctxt->p_mode->line_length_pck)-1,
                (ar0231_ctxt->p_mode->frame_length_lines - 1));
    ...
    case QCARCAM_EXPOSURE_AUTO:
    {
        ...
        for (i = 0; i < 3; i++)
        {
            hdr_exp[i].pclk_count = hdr_exposure->exposure_time[i] * ar0231_ctxt->p_mode->pclk / 1000;
            hdr_exp[i].line_count = STD_MIN((unsigned int)(hdr_exp[i].pclk_count / ar0231_ctxt->p_mode->line_length_pck) + 1,
                    (ar0231_ctxt->p_mode->frame_length_lines - 1));
            hdr_exp[i].fine_integration_time = hdr_exp[i].pclk_count - (hdr_exp[i].line_count - 1) * ar0231_ctxt->p_mode->line_length_pck;
            SLOW("AEC - AR0231 : [%d] exp_time=%f => line_cnt=0x%x, fine_intergration_time=0x%x",
                i, hdr_exposure->exposure_time[i], hdr_exp[i].line_count, hdr_exp[i].fine_integration_time);
            ...
            SLOW("AEC - AR0231 :gain_idx = %d, gain=%0.2f, a_gain=%0.2f + d_gain=%0.2f",
                gain_idx, hdr_exposure->gain[i], gain_table[gain_idx].real_gain, hdr_exp[i].dig_gain);
        }
        ...
        ADD_I2C_REG_ARRAY(exp_reg_array, exp_size, AR0231_REG_FINE_INTEGRATION_TIME, (hdr_exp[0].fine_integration_time & 0xffff), _ar0231_delay_);
        ADD_I2C_REG_ARRAY(exp_reg_array, exp_size, AR0231_REG_FINE_INTEGRATION_TIME2, (hdr_exp[1].fine_integration_time & 0xffff), _ar0231_delay_);
        ADD_I2C_REG_ARRAY(exp_reg_array, exp_size, AR0231_REG_FINE_INTEGRATION_TIME3, (hdr_exp[2].fine_integration_time & 0xffff), _ar0231_delay_);
