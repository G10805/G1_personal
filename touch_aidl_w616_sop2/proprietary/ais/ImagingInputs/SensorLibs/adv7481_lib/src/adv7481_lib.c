...
static int adv7481_sensor_query_field_info(void* ctxt, boolean *p_is_even, uint64 *p_ts);
...
#define AIS_LOG_ADV_LIB_ERR(fmt...) AIS_LOG(AIS_MOD_ID_ADV7481_LIB, AIS_LOG_LVL_ERROR, fmt)
...
EXIT_FLAG:
    ...
    AIS_LOG_ADV_LIB(rc == 0 ? AIS_LOG_LVL_HIGH : AIS_LOG_LVL_ERROR,
...
EXIT_FLAG:
    ...
    AIS_LOG_ADV_LIB(rc == 0 ? AIS_LOG_LVL_MED : AIS_LOG_LVL_ERROR,
                    "X %s %p", __func__, ctxt, rc);
...
EXIT_FLAG:
    ...
    AIS_LOG_ADV_LIB(rc == 0 ? AIS_LOG_LVL_LOW : AIS_LOG_LVL_ERROR,
                    "X %s %p", __func__, ctxt, rc);
...
EXIT_FLAG:
    ...
    AIS_LOG_ADV_LIB(rc == 0 ? AIS_LOG_LVL_DBG : AIS_LOG_LVL_ERROR,
