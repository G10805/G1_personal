...
#define AIS_LOG_ADV_ERR(fmt...) AIS_LOG(AIS_MOD_ID_ADV7481_DRV, AIS_LOG_LVL_ERROR, fmt)
...
EXIT_FLAG:
    ...
    AIS_LOG_ADV(rc == 0 ? AIS_LOG_LVL_MED : AIS_LOG_LVL_ERROR,
...
EXIT_FLAG:
    ...
    AIS_LOG_ADV(rc == 0 ? AIS_LOG_LVL_LOW : AIS_LOG_LVL_ERROR,
                "X %s 0x%p %d", __func__, p_drv, rc);
...
EXIT_FLAG:
    ...
    AIS_LOG_ADV(rc == 0 ? AIS_LOG_LVL_DBG : AIS_LOG_LVL_ERROR,
...
EXIT_FLAG:
    ...
    AIS_LOG_ADV(rc == 0 ? AIS_LOG_LVL_HIGH : AIS_LOG_LVL_ERROR,
                "X %s 0x%p %d", __func__, p_drv, rc);
