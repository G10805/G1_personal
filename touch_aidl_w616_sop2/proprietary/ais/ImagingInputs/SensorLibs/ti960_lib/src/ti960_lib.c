...
#define AIS_LOG_TI_LIB(level, fmt...) AIS_LOG(SENSOR_LIB, level, fmt)
#define AIS_LOG_TI_LIB_ERR(fmt...) AIS_LOG(SENSOR_LIB, ERROR, fmt)
#define AIS_LOG_TI_LIB_WARN(fmt...) AIS_LOG(SENSOR_LIB, WARN, fmt)
#define AIS_LOG_TI_LIB_ALWAYS(fmt...) AIS_LOG(SENSOR_LIB, ALWAYS, fmt)
#define AIS_LOG_TI_LIB_INFO(fmt...) AIS_LOG(SENSOR_LIB, INFO, fmt)
#define AIS_LOG_TI_LIB_VERB(fmt...) AIS_LOG(SENSOR_LIB, VERB, fmt)
#define AIS_LOG_TI_LIB_DBG(fmt...) AIS_LOG(SENSOR_LIB, DBG, fmt)
...
static void* ti960_sensor_open_lib(void* ctrl, void* arg)
{
    ...
    if (pCtxt)
    {
        ...
        if (device_info->config->subdevId == 1)
        {
