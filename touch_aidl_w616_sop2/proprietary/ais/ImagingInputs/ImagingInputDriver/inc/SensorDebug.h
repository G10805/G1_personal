...
//#define ALLDEBUG_MSGS // Enabling this will cause delay in preview
    ...
    #define SENSOR_LOGMSG_LEVEL         MED
    #define SENSOR_HIGHMSG_LEVEL        HIGH
    #define SENSOR_MEDIUMMSG_LEVEL      MED
...
#else
    #define SENSOR_DEBUGMSG_LEVEL       MED
#endif
...
#else
    #ifdef ALLDEBUG_MSGS
        #define CAMSENSOR_DEBUG(x, ...) AIS_LOG(SENSOR_LIB, ALWAYS, ##__VA_ARGS__)
    #else
        #define CAMSENSOR_DEBUG(x, ...) AIS_LOG(SENSOR_LIB, x, ##__VA_ARGS__)
    #endif
#endif
