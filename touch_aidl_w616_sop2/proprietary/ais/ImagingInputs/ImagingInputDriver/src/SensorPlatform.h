...
public:
    ...
    virtual CameraResult SensorSlaveWriteI2cSetting_sync(struct camera_i2c_sync_cfg sync_cfg,
            struct camera_i2c_reg_setting_array_sync* reg_setting_array_sync, unsigned int size) = 0;
    ...
    virtual CameraResult SensorSlaveI2cBulkRead(unsigned short slave_addr,
            struct camera_i2c_bulk_reg_setting *reg_setting, boolean exec_pending_i2ccmds) = 0;
    ...
    virtual CameraResult SensorSlaveI2cBulkWriteRead (
            ...
            struct camera_i2c_bulk_reg_setting *read_reg_setting, boolean exec_pending_i2ccmds) = 0;
    ...
    virtual CameraResult SensorExecutePowerSetting(struct camera_power_setting *power_settings,
            unsigned short nSize, CameraPowerEventType mode) = 0;
     ...
     * ------------------------------------------------------------------------ */
    virtual CameraResult SensorSetupCciFrameSync(unsigned int fsync_freq) = 0;
     ...
     * ------------------------------------------------------------------------ */
    virtual CameraResult SensorTriggerCciFrameSync() = 0;
