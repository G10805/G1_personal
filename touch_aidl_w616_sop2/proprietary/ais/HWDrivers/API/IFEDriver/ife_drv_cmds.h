...
CMD(IFE_CMD_ID_ADDR_SYNC_CONFIG)
CMD(IFE_CMD_ID_GLOBAL_CSID_HALT) /**< For keeping all RDI paths at halt stage */
...
/// This is the command ID for the hardware capabilities retrieval structure.
/// @par Type:
///   Output only
/// @par Input Expected:
///   None
/// @par Output Expected:
///   Pointer to a ife_hw_capabilities_t structure
CMD(IFE_CMD_ID_GET_HW_CAPABILITIES)

/** get diag information */
CMD(IFE_CMD_ID_DIAG_INFO)
