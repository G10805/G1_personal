...
#ifndef _AIS_PPROC_USRDONE_H_
#define _AIS_PPROC_USRDONE_H_

#include "ais_proc_chain.h"

class AisPProcUsrDone : public AisPProc
{
public:
    /**
     * Create
     ...
     * @brief Create Node
     *
     * @return AisNodeUsrDone*
     */
    static AisPProcUsrDone* Create()
    {
        m_pNodeInstance = new AisPProcUsrDone();
...
private:
    static AisPProcUsrDone* m_pNodeInstance;
};

#endif /* _AIS_PPROC_USRDONE_H_ */
