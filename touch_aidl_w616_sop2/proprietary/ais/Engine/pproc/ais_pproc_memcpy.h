...
#ifndef _AIS_PPROC_MEMCPY_H_
#define _AIS_PPROC_MEMCPY_H_

#include "ais_proc_chain.h"

class AisPProcMemcpy : public AisPProc
{
public:
    /**
     * Create
     ...
     * @brief Create Node
     *
     * @return AisNodeMemcpy*
     */
    static AisPProcMemcpy* Create()
    {
        m_pNodeInstance = new AisPProcMemcpy();
...
private:
    static AisPProcMemcpy* m_pNodeInstance;
};

#endif /* _AIS_PPROC_MEMCPY_H_ */
