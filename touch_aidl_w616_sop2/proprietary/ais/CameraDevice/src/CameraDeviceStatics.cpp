...
static CameraDeviceManagerRegisteredType sStaticDevicesSA8195[] =
{
#ifndef AIS_WITH_HAL_CAMERA
    {{CAMERADEVICEID_IFE_0, CAMERA_DEVICE_CATEGORY_IFE}, ife_device_open},
    {{CAMERADEVICEID_IFELITE_1, CAMERA_DEVICE_CATEGORY_IFE}, ifelite_device_open},
    ...
    {{CAMERADEVICEID_IFELITE_2, CAMERA_DEVICE_CATEGORY_IFE}, ifelite_device_open},
    {{CAMERADEVICEID_IFELITE_3, CAMERA_DEVICE_CATEGORY_IFE}, ifelite_device_open},
    {{CAMERADEVICEID_CSIPHY_0, CAMERA_DEVICE_CATEGORY_CSIPHY}, csiphy_device_open},
    {{CAMERADEVICEID_CSIPHY_1, CAMERA_DEVICE_CATEGORY_CSIPHY}, csiphy_device_open},
    {{CAMERADEVICEID_CSIPHY_2, CAMERA_DEVICE_CATEGORY_CSIPHY}, csiphy_device_open},
    {{CAMERADEVICEID_CSIPHY_3, CAMERA_DEVICE_CATEGORY_CSIPHY}, csiphy_device_open},
...
static CameraDeviceManagerRegisteredType sStaticDevicesSA8295[] =
{
    {{CAMERADEVICEID_IFE_0, CAMERA_DEVICE_CATEGORY_IFE}, ife_device_open},
    {{CAMERADEVICEID_IFE_1, CAMERA_DEVICE_CATEGORY_IFE}, ife_device_open},
    {{CAMERADEVICEID_IFELITE_0, CAMERA_DEVICE_CATEGORY_IFE}, ifelite_device_open},
...
CameraDeviceManagerStaticTableType* CameraDeviceManagerGetStaticsTable(void)
{
    ...
    case CHIP_ID_SA8195P:
        sStaticDeviceTable.pDevices = sStaticDevicesSA8195;
        sStaticDeviceTable.nDevices = STD_ARRAY_SIZE(sStaticDevicesSA8195);
        break;
    case CHIP_ID_SA8295P:
    case CHIP_ID_SA8540P:
        sStaticDeviceTable.pDevices = sStaticDevicesSA8295;
        sStaticDeviceTable.nDevices = STD_ARRAY_SIZE(sStaticDevicesSA8295);
        break;
    default:
