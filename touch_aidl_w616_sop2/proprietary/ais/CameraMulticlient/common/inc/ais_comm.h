...
typedef struct
{
    ...
    qcarcam_input_v2_t inputs[MAX_NUM_AIS_INPUTS];
    unsigned int ret_size;
} s_ais_cmd_query_inputs_v2;
...
/**
 * command parameter for s_buffers_v2
 */
typedef struct
{
    int          cmd_id;
    ...
    qcarcam_buffer_v2_t buffer[QCARCAM_MAX_NUM_BUFFERS];
} s_ais_cmd_s_buffers_v2;
...
/**
 * command parameter for get_frame_v2
 */
typedef struct
{
    int          cmd_id;
...
typedef union
{
    ...
    s_ais_cmd_query_inputs_v2  query_inputs_v2;
    ...
    s_ais_cmd_s_buffers_v2     s_buffers_v2;
    ...
    s_ais_cmd_get_frame_v2     get_frame_v2;
