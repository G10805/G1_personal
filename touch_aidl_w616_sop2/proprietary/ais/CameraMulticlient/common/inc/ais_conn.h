...
typedef struct
{
    ...
    volatile int                full_data_recv; /**< specifies connection to recieve full data */

    //os specific connection
#if defined(_LINUX) || defined(__ANDROID__) || defined(__QNXNTO__)
 ...
 *
 */
int AIS_CONN_API(ais_conn_import)(s_ais_conn *p, long long *p_data_arr, unsigned int* p_flags, unsigned int* size_arr,
