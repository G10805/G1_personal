...
/*=============================================================================
 Copyright (c) 2009-2016, 2019, 2021 Qualcomm Technologies, Inc.
 All Rights Reserved.
...
#define EGL_IMAGE_EXT_BUFFER_STRIDE_QCOM                0x341D /* External memory stride for plane 0 */
...
#define EGL_IMAGE_EXT_BUFFER_DESCRIPTOR_LOW_QCOM        0x3428 /* External memory descriptor, either ION fd or PMEM handle */
#define EGL_IMAGE_EXT_BUFFER_DESCRIPTOR_HIGH_QCOM       0x3429
#define EGL_IMAGE_EXT_BUFFER_PLANE1_STRIDE_QCOM         0x342A /* External memory stride for plane 1 */
#define EGL_IMAGE_EXT_BUFFER_PLANE2_STRIDE_QCOM         0x342B /* External memory stride for plane 2 */
...
#ifndef EGL_QCOM_swap_buffers_with_CRC_region
#define EGL_QCOM_swap_buffers_with_CRC_region 1
#define EGL_SURFACE_CRC_QCOM                  0x312B
#ifdef EGL_EGLEXT_PROTOTYPES
EGLAPI EGLBoolean EGLAPIENTRY eglSetCRCRegionQCOM( EGLint x, EGLint y, EGLint width, EGLint height );
#endif /* EGL_EGLEXT_PROTOTYPES */
typedef EGLBoolean (EGLAPIENTRYP PFNEGLSETCRCREGIONQCOM) ( EGLint x, EGLint y, EGLint width, EGLint height );
#endif // EGL_QCOM_swap_buffers_with_CRC_region
