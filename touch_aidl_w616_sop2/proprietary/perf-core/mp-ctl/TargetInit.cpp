...
void invoke_tinyu_wa(uint16_t socid) {
  ...
  /*for taro kalama parrot diwali cape bengal khaje anorak pineapple crow sun cliffs pitti volcano ravelin*/
  if (socid == 367 || socid == 377 || socid == 405 || socid == 457 ||
      socid == 417 || socid == 420 || socid == 444 || socid == 445 ||
      ...
      socid == 557 || socid == 577 || socid == 603 || socid == 604 || socid == 583 ||
      ...
      socid == 568 || socid == 602 || socid == 653 || socid == 654) {
