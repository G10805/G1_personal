...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/6.2/dms/src/device_management_service_v01.c#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9
   It was generated on: Fri Nov 19 2021 (Spin 0)
...
static const uint8_t dms_e911_pending_type_data_v01[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_e911_pending_type_v01, is_pending),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_e911_pending_type_v01, subscription_id),
...
static const uint8_t dms_indication_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_indication_register_req_msg_v01, report_interactive_state_reqs) - QMI_IDL_OFFSET8(dms_indication_register_req_msg_v01, report_interactive_state_reqs_valid)),
  0x15,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_indication_register_req_msg_v01, report_interactive_state_reqs),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_indication_register_req_msg_v01, report_device_activity_state_reqs) - QMI_IDL_OFFSET8(dms_indication_register_req_msg_v01, report_device_activity_state_reqs_valid)),
  0x16,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_indication_register_req_msg_v01, report_device_activity_state_reqs),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_indication_register_req_msg_v01, report_device_state) - QMI_IDL_OFFSET8(dms_indication_register_req_msg_v01, report_device_state_valid)),
  0x17,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_indication_register_req_msg_v01, report_device_state),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_indication_register_req_msg_v01, report_imei_type_change) - QMI_IDL_OFFSET8(dms_indication_register_req_msg_v01, report_imei_type_change_valid)),
  0x18,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_indication_register_req_msg_v01, report_imei_type_change),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_indication_register_req_msg_v01, report_nonencrypt_imei) - QMI_IDL_OFFSET8(dms_indication_register_req_msg_v01, report_nonencrypt_imei_valid)),
  0x19,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_indication_register_req_msg_v01, report_nonencrypt_imei)
};
...
static const uint8_t dms_get_device_cap_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dms_get_device_cap_resp_msg_v01, rat_rel_info) - QMI_IDL_OFFSET16RELATIVE(dms_get_device_cap_resp_msg_v01, rat_rel_info_valid)),
  0x1E,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dms_get_device_cap_resp_msg_v01, hybrid_dsda_capability) - QMI_IDL_OFFSET16RELATIVE(dms_get_device_cap_resp_msg_v01, hybrid_dsda_capability_valid)),
  0x1F,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(dms_get_device_cap_resp_msg_v01, hybrid_dsda_capability)
};
...
static const uint8_t dms_set_operating_mode_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_set_operating_mode_req_msg_v01, e911_pending_info) - QMI_IDL_OFFSET8(dms_set_operating_mode_req_msg_v01, e911_pending_info_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dms_set_operating_mode_req_msg_v01, e911_pending_info),
  QMI_IDL_TYPE88(0, 38)
};
...
static const uint8_t dms_set_operating_mode_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_set_operating_mode_resp_msg_v01, fail_reason) - QMI_IDL_OFFSET8(dms_set_operating_mode_resp_msg_v01, fail_reason_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_set_operating_mode_resp_msg_v01, fail_reason)
};
...
static const uint8_t dms_psm_status_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_psm_status_ind_msg_v01, periodic_update_timer) - QMI_IDL_OFFSET8(dms_psm_status_ind_msg_v01, periodic_update_timer_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_psm_status_ind_msg_v01, periodic_update_timer),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_psm_status_ind_msg_v01, modem_only_timer) - QMI_IDL_OFFSET8(dms_psm_status_ind_msg_v01, modem_only_timer_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_psm_status_ind_msg_v01, modem_only_timer)
};

static const uint8_t dms_get_capability_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_capability_req_msg_v01, te_psm_capability) - QMI_IDL_OFFSET8(dms_get_capability_req_msg_v01, te_psm_capability_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_get_capability_req_msg_v01, te_psm_capability),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_capability_req_msg_v01, endc_mute_feature) - QMI_IDL_OFFSET8(dms_get_capability_req_msg_v01, endc_mute_feature_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_get_capability_req_msg_v01, endc_mute_feature),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_capability_req_msg_v01, endc_interactive_config) - QMI_IDL_OFFSET8(dms_get_capability_req_msg_v01, endc_interactive_config_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_get_capability_req_msg_v01, endc_interactive_config),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_capability_req_msg_v01, endc_throughput_threshold) - QMI_IDL_OFFSET8(dms_get_capability_req_msg_v01, endc_throughput_threshold_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_get_capability_req_msg_v01, endc_throughput_threshold)
};
...
static const uint8_t dms_get_capability_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_capability_resp_msg_v01, psm_capability) - QMI_IDL_OFFSET8(dms_get_capability_resp_msg_v01, psm_capability_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_get_capability_resp_msg_v01, psm_capability),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_capability_resp_msg_v01, endc_mute_feature_enable) - QMI_IDL_OFFSET8(dms_get_capability_resp_msg_v01, endc_mute_feature_enable_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_get_capability_resp_msg_v01, endc_mute_feature_enable),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_capability_resp_msg_v01, endc_interactive_config) - QMI_IDL_OFFSET8(dms_get_capability_resp_msg_v01, endc_interactive_config_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_get_capability_resp_msg_v01, endc_interactive_config),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_capability_resp_msg_v01, throughput_threshold_1) - QMI_IDL_OFFSET8(dms_get_capability_resp_msg_v01, throughput_threshold_1_valid)),
  0x13,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_get_capability_resp_msg_v01, throughput_threshold_1),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_capability_resp_msg_v01, throughput_threshold_2) - QMI_IDL_OFFSET8(dms_get_capability_resp_msg_v01, throughput_threshold_2_valid)),
  0x14,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_get_capability_resp_msg_v01, throughput_threshold_2)
};
...
/*
 * dms_get_app_priority_info_req_msg is empty
 * static const uint8_t dms_get_app_priority_info_req_msg_data_v01[] = {
 * };
 */

static const uint8_t dms_get_app_priority_info_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dms_get_app_priority_info_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_app_priority_info_resp_msg_v01, prioritized_app) - QMI_IDL_OFFSET8(dms_get_app_priority_info_resp_msg_v01, prioritized_app_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_get_app_priority_info_resp_msg_v01, prioritized_app),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_app_priority_info_resp_msg_v01, loaded_tech) - QMI_IDL_OFFSET8(dms_get_app_priority_info_resp_msg_v01, loaded_tech_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_get_app_priority_info_resp_msg_v01, loaded_tech)
};

static const uint8_t dms_send_user_input_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_send_user_input_req_msg_v01, auto_reg_consent) - QMI_IDL_OFFSET8(dms_send_user_input_req_msg_v01, auto_reg_consent_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_send_user_input_req_msg_v01, auto_reg_consent)
};

static const uint8_t dms_send_user_input_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dms_send_user_input_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t dms_set_capability_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_set_capability_req_msg_v01, endc_mute_feature_enable) - QMI_IDL_OFFSET8(dms_set_capability_req_msg_v01, endc_mute_feature_enable_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_set_capability_req_msg_v01, endc_mute_feature_enable),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_set_capability_req_msg_v01, endc_interactive_config) - QMI_IDL_OFFSET8(dms_set_capability_req_msg_v01, endc_interactive_config_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_set_capability_req_msg_v01, endc_interactive_config),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_set_capability_req_msg_v01, throughput_threshold_1) - QMI_IDL_OFFSET8(dms_set_capability_req_msg_v01, throughput_threshold_1_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_set_capability_req_msg_v01, throughput_threshold_1),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_set_capability_req_msg_v01, throughput_threshold_2) - QMI_IDL_OFFSET8(dms_set_capability_req_msg_v01, throughput_threshold_2_valid)),
  0x13,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_set_capability_req_msg_v01, throughput_threshold_2)
};

static const uint8_t dms_set_capability_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dms_set_capability_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_set_capability_resp_msg_v01, endc_mute_feature_enable) - QMI_IDL_OFFSET8(dms_set_capability_resp_msg_v01, endc_mute_feature_enable_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_set_capability_resp_msg_v01, endc_mute_feature_enable),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_set_capability_resp_msg_v01, endc_interactive_config) - QMI_IDL_OFFSET8(dms_set_capability_resp_msg_v01, endc_interactive_config_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_set_capability_resp_msg_v01, endc_interactive_config),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_set_capability_resp_msg_v01, throughput_threshold_1) - QMI_IDL_OFFSET8(dms_set_capability_resp_msg_v01, throughput_threshold_1_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_set_capability_resp_msg_v01, throughput_threshold_1),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_set_capability_resp_msg_v01, throughput_threshold_2) - QMI_IDL_OFFSET8(dms_set_capability_resp_msg_v01, throughput_threshold_2_valid)),
  0x13,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_set_capability_resp_msg_v01, throughput_threshold_2)
};

/*
 * dms_get_band_capability_ex_req_msg is empty
 * static const uint8_t dms_get_band_capability_ex_req_msg_data_v01[] = {
 * };
 */

static const uint8_t dms_get_band_capability_ex_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dms_get_band_capability_ex_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t dms_band_capability_ex_ind_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_band_capability_ex_ind_msg_v01, band_capability) - QMI_IDL_OFFSET8(dms_band_capability_ex_ind_msg_v01, band_capability_valid)),
  0x10,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(dms_band_capability_ex_ind_msg_v01, band_capability),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_band_capability_ex_ind_msg_v01, tds_band_capability) - QMI_IDL_OFFSET8(dms_band_capability_ex_ind_msg_v01, tds_band_capability_valid)),
  0x11,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(dms_band_capability_ex_ind_msg_v01, tds_band_capability),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_band_capability_ex_ind_msg_v01, supported_lte_bands) - QMI_IDL_OFFSET8(dms_band_capability_ex_ind_msg_v01, supported_lte_bands_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(dms_band_capability_ex_ind_msg_v01, supported_lte_bands),
  ((QMI_DMS_MAX_SUPPORTED_LTE_BANDS_V01) & 0xFF), ((QMI_DMS_MAX_SUPPORTED_LTE_BANDS_V01) >> 8),
  QMI_IDL_OFFSET8(dms_band_capability_ex_ind_msg_v01, supported_lte_bands) - QMI_IDL_OFFSET8(dms_band_capability_ex_ind_msg_v01, supported_lte_bands_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dms_band_capability_ex_ind_msg_v01, supported_nr5g_bands) - QMI_IDL_OFFSET16RELATIVE(dms_band_capability_ex_ind_msg_v01, supported_nr5g_bands_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(dms_band_capability_ex_ind_msg_v01, supported_nr5g_bands),
  ((QMI_DMS_MAX_SUPPORTED_NR5G_BANDS_V01) & 0xFF), ((QMI_DMS_MAX_SUPPORTED_NR5G_BANDS_V01) >> 8),
  QMI_IDL_OFFSET16RELATIVE(dms_band_capability_ex_ind_msg_v01, supported_nr5g_bands) - QMI_IDL_OFFSET16RELATIVE(dms_band_capability_ex_ind_msg_v01, supported_nr5g_bands_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dms_band_capability_ex_ind_msg_v01, band_capability_low) - QMI_IDL_OFFSET16RELATIVE(dms_band_capability_ex_ind_msg_v01, band_capability_low_valid)),
  0x14,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET16ARRAY(dms_band_capability_ex_ind_msg_v01, band_capability_low),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dms_band_capability_ex_ind_msg_v01, tds_band_capability_low) - QMI_IDL_OFFSET16RELATIVE(dms_band_capability_ex_ind_msg_v01, tds_band_capability_low_valid)),
  0x15,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET16ARRAY(dms_band_capability_ex_ind_msg_v01, tds_band_capability_low),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dms_band_capability_ex_ind_msg_v01, supported_lte_bands_low) - QMI_IDL_OFFSET16RELATIVE(dms_band_capability_ex_ind_msg_v01, supported_lte_bands_low_valid)),
  0x16,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(dms_band_capability_ex_ind_msg_v01, supported_lte_bands_low),
  ((QMI_DMS_MAX_SUPPORTED_LTE_BANDS_V01) & 0xFF), ((QMI_DMS_MAX_SUPPORTED_LTE_BANDS_V01) >> 8),
  QMI_IDL_OFFSET16RELATIVE(dms_band_capability_ex_ind_msg_v01, supported_lte_bands_low) - QMI_IDL_OFFSET16RELATIVE(dms_band_capability_ex_ind_msg_v01, supported_lte_bands_low_len),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dms_band_capability_ex_ind_msg_v01, supported_nr5g_bands_low) - QMI_IDL_OFFSET16RELATIVE(dms_band_capability_ex_ind_msg_v01, supported_nr5g_bands_low_valid)),
  0x17,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(dms_band_capability_ex_ind_msg_v01, supported_nr5g_bands_low),
  ((QMI_DMS_MAX_SUPPORTED_NR5G_BANDS_V01) & 0xFF), ((QMI_DMS_MAX_SUPPORTED_NR5G_BANDS_V01) >> 8),
  QMI_IDL_OFFSET16RELATIVE(dms_band_capability_ex_ind_msg_v01, supported_nr5g_bands_low) - QMI_IDL_OFFSET16RELATIVE(dms_band_capability_ex_ind_msg_v01, supported_nr5g_bands_low_len)
};

static const uint8_t dms_device_activity_state_request_ind_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_device_activity_state_request_ind_msg_v01, report_device_activity_state) - QMI_IDL_OFFSET8(dms_device_activity_state_request_ind_msg_v01, report_device_activity_state_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_device_activity_state_request_ind_msg_v01, report_device_activity_state)
};

static const uint8_t dms_device_activity_state_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_device_activity_state_req_msg_v01, activity_state)
};

static const uint8_t dms_device_activity_state_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dms_device_activity_state_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t dms_device_state_info_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_device_state_info_ind_msg_v01, init_state),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_device_state_info_ind_msg_v01, failure_reason) - QMI_IDL_OFFSET8(dms_device_state_info_ind_msg_v01, failure_reason_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_device_state_info_ind_msg_v01, failure_reason)
};

/*
 * dms_get_device_state_info_req_msg is empty
 * static const uint8_t dms_get_device_state_info_req_msg_data_v01[] = {
 * };
 */

static const uint8_t dms_get_device_state_info_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dms_get_device_state_info_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_device_state_info_resp_msg_v01, init_state) - QMI_IDL_OFFSET8(dms_get_device_state_info_resp_msg_v01, init_state_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_get_device_state_info_resp_msg_v01, init_state),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_device_state_info_resp_msg_v01, failure_reason) - QMI_IDL_OFFSET8(dms_get_device_state_info_resp_msg_v01, failure_reason_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dms_get_device_state_info_resp_msg_v01, failure_reason)
};

static const uint8_t dms_get_imei_info_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_imei_info_req_msg_v01, exempt_encrypt) - QMI_IDL_OFFSET8(dms_get_imei_info_req_msg_v01, exempt_encrypt_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_get_imei_info_req_msg_v01, exempt_encrypt)
};

static const uint8_t dms_get_imei_info_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dms_get_imei_info_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_imei_info_resp_msg_v01, tx_id) - QMI_IDL_OFFSET8(dms_get_imei_info_resp_msg_v01, tx_id_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_get_imei_info_resp_msg_v01, tx_id)
};

static const uint8_t dms_imei_info_ind_msg_data_v01[] = {
  0x01,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_FIRST_EXTENDED |   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_FLAGS_ARRAY_IS_LENGTHLESS |  QMI_IDL_FLAGS_ARRAY_IS_LENGTHLESS,
  QMI_IDL_OFFSET8(dms_imei_info_ind_msg_v01, imei),
  QMI_DMS_ENCRYPTED_IMEI_MAX_V01,
  QMI_IDL_OFFSET8(dms_imei_info_ind_msg_v01, imei) - QMI_IDL_OFFSET8(dms_imei_info_ind_msg_v01, imei_len),

  0x02,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(dms_imei_info_ind_msg_v01, imei_type),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dms_imei_info_ind_msg_v01, tx_id) - QMI_IDL_OFFSET16RELATIVE(dms_imei_info_ind_msg_v01, tx_id_valid)),
  0x10,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(dms_imei_info_ind_msg_v01, tx_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dms_imei_info_ind_msg_v01, imei_nonencrypted) - QMI_IDL_OFFSET16RELATIVE(dms_imei_info_ind_msg_v01, imei_nonencrypted_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(dms_imei_info_ind_msg_v01, imei_nonencrypted),
  QMI_DMS_IMEI_MAX_V01
};
...
static const qmi_idl_type_table_entry  dms_type_table_v01[] = {
  ...
  {sizeof(dms_e911_pending_type_v01), dms_e911_pending_type_data_v01}
};
...
static const qmi_idl_message_table_entry dms_message_table_v01[] = {
  ...
  {sizeof(dms_get_app_priority_info_req_msg_v01), 0},
  {sizeof(dms_get_app_priority_info_resp_msg_v01), dms_get_app_priority_info_resp_msg_data_v01},
  {sizeof(dms_send_user_input_req_msg_v01), dms_send_user_input_req_msg_data_v01},
  {sizeof(dms_send_user_input_resp_msg_v01), dms_send_user_input_resp_msg_data_v01},
  {sizeof(dms_set_capability_req_msg_v01), dms_set_capability_req_msg_data_v01},
  {sizeof(dms_set_capability_resp_msg_v01), dms_set_capability_resp_msg_data_v01},
  {sizeof(dms_get_band_capability_ex_req_msg_v01), 0},
  {sizeof(dms_get_band_capability_ex_resp_msg_v01), dms_get_band_capability_ex_resp_msg_data_v01},
  {sizeof(dms_band_capability_ex_ind_msg_v01), dms_band_capability_ex_ind_msg_data_v01},
  {sizeof(dms_device_activity_state_request_ind_msg_v01), dms_device_activity_state_request_ind_msg_data_v01},
  {sizeof(dms_device_activity_state_req_msg_v01), dms_device_activity_state_req_msg_data_v01},
  {sizeof(dms_device_activity_state_resp_msg_v01), dms_device_activity_state_resp_msg_data_v01},
  {sizeof(dms_device_state_info_ind_msg_v01), dms_device_state_info_ind_msg_data_v01},
  {sizeof(dms_get_device_state_info_req_msg_v01), 0},
  {sizeof(dms_get_device_state_info_resp_msg_v01), dms_get_device_state_info_resp_msg_data_v01},
  {sizeof(dms_get_imei_info_req_msg_v01), dms_get_imei_info_req_msg_data_v01},
  {sizeof(dms_get_imei_info_resp_msg_v01), dms_get_imei_info_resp_msg_data_v01},
  {sizeof(dms_imei_info_ind_msg_v01), dms_imei_info_ind_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry dms_service_command_messages_v01[] = {
  ...
  {QMI_DMS_INDICATION_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 5), 40},
  ...
  {QMI_DMS_SET_OPERATING_MODE_REQ_V01, QMI_IDL_TYPE16(0, 37), 12},
  ...
  {QMI_DMS_GET_CAPABILITY_REQ_V01, QMI_IDL_TYPE16(0, 121), 19},
  ...
  {QMI_DMS_GET_APP_PRIORITY_INFO_REQ_V01, QMI_IDL_TYPE16(0, 152), 0},
  {QMI_DMS_SEND_USER_INPUT_REQ_V01, QMI_IDL_TYPE16(0, 154), 4},
  {QMI_DMS_SET_CAPABILITY_REQ_V01, QMI_IDL_TYPE16(0, 156), 22},
  {QMI_DMS_GET_BAND_CAPABILITY_EX_REQ_V01, QMI_IDL_TYPE16(0, 158), 0},
  {QMI_DMS_DEVICE_ACTIVITY_STATE_REQ_V01, QMI_IDL_TYPE16(0, 162), 7},
  {QMI_DMS_GET_DEVICE_STATE_INFO_REQ_V01, QMI_IDL_TYPE16(0, 165), 0},
  {QMI_DMS_GET_IMEI_INFO_REQ_V01, QMI_IDL_TYPE16(0, 167), 4}
};
...
static const qmi_idl_service_message_table_entry dms_service_response_messages_v01[] = {
  ...
  {QMI_DMS_GET_DEVICE_CAP_RESP_V01, QMI_IDL_TYPE16(0, 8), 3647},
  ...
  {QMI_DMS_SET_OPERATING_MODE_RESP_V01, QMI_IDL_TYPE16(0, 38), 14},
  ...
  {QMI_DMS_GET_CAPABILITY_RESP_V01, QMI_IDL_TYPE16(0, 122), 36},
  ...
  {QMI_DMS_GET_APP_PRIORITY_INFO_RESP_V01, QMI_IDL_TYPE16(0, 153), 21},
  {QMI_DMS_SEND_USER_INPUT_RESP_V01, QMI_IDL_TYPE16(0, 155), 7},
  {QMI_DMS_SET_CAPABILITY_RESP_V01, QMI_IDL_TYPE16(0, 157), 29},
  {QMI_DMS_GET_BAND_CAPABILITY_EX_RESP_V01, QMI_IDL_TYPE16(0, 159), 7},
  {QMI_DMS_DEVICE_ACTIVITY_STATE_RESP_V01, QMI_IDL_TYPE16(0, 163), 7},
  {QMI_DMS_GET_DEVICE_STATE_INFO_RESP_V01, QMI_IDL_TYPE16(0, 166), 21},
  {QMI_DMS_GET_IMEI_INFO_RESP_V01, QMI_IDL_TYPE16(0, 168), 11}
};
...
static const qmi_idl_service_message_table_entry dms_service_indication_messages_v01[] = {
  ...
  {QMI_DMS_PSM_STATUS_IND_V01, QMI_IDL_TYPE16(0, 120), 28},
  ...
  {QMI_DMS_BAND_CAPABILITY_EX_IND_V01, QMI_IDL_TYPE16(0, 160), 3136},
  {QMI_DMS_DEVICE_ACTIVITY_STATE_REQUEST_IND_V01, QMI_IDL_TYPE16(0, 161), 4},
  {QMI_DMS_DEVICE_STATE_INFO_IND_V01, QMI_IDL_TYPE16(0, 164), 14},
  {QMI_DMS_IMEI_INFO_IND_V01, QMI_IDL_TYPE16(0, 169), 305}
};
