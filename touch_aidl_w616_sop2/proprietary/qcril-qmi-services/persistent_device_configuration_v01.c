...
GENERAL DESCRIPTION
  ...
  Copyright (c) 2012-2013, 2021 Qualcomm Technologies, Inc.
  All rights reserved.
  Confidential and Proprietary - Qualcomm Technologies, Inc.


  $Header: //components/rel/qmimsgs.mpss/6.0/pdc/src/persistent_device_configuration_v01.c#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9
   It was generated on: Thu Sep 30 2021 (Spin 0)
...
static const uint8_t pdc_remote_discover_info_type_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_remote_discover_info_type_v01, hw_mbn_discovery_info),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_remote_discover_info_type_v01, sw_mbn_discovery_info),
...
static const uint8_t pdc_indication_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_indication_register_req_msg_v01, reg_client_refresh) - QMI_IDL_OFFSET8(pdc_indication_register_req_msg_v01, reg_client_refresh_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(pdc_indication_register_req_msg_v01, reg_client_refresh),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_indication_register_req_msg_v01, reg_remote_discovery_event) - QMI_IDL_OFFSET8(pdc_indication_register_req_msg_v01, reg_remote_discovery_event_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(pdc_indication_register_req_msg_v01, reg_remote_discovery_event)
};
...
static const uint8_t pdc_remote_discover_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_remote_discover_req_msg_v01, ind_token) - QMI_IDL_OFFSET8(pdc_remote_discover_req_msg_v01, ind_token_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_remote_discover_req_msg_v01, ind_token)
};

static const uint8_t pdc_remote_discover_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(pdc_remote_discover_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t pdc_remote_discover_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_2_BYTE_ENUM,
  QMI_IDL_OFFSET8(pdc_remote_discover_ind_msg_v01, error),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_remote_discover_ind_msg_v01, remote_discovery_info) - QMI_IDL_OFFSET8(pdc_remote_discover_ind_msg_v01, remote_discovery_info_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(pdc_remote_discover_ind_msg_v01, remote_discovery_info),
  QMI_IDL_TYPE88(0, 3),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_remote_discover_ind_msg_v01, ind_token) - QMI_IDL_OFFSET8(pdc_remote_discover_ind_msg_v01, ind_token_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_remote_discover_ind_msg_v01, ind_token)
};

static const uint8_t pdc_remote_discovery_event_ind_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_remote_discovery_event_ind_msg_v01, remote_discovery_event)
};
...
static const qmi_idl_type_table_entry  pdc_type_table_v01[] = {
  ...
  {sizeof(pdc_remote_discover_info_type_v01), pdc_remote_discover_info_type_data_v01}
};
...
static const qmi_idl_message_table_entry pdc_message_table_v01[] = {
  ...
  {sizeof(pdc_remote_discover_req_msg_v01), pdc_remote_discover_req_msg_data_v01},
  {sizeof(pdc_remote_discover_resp_msg_v01), pdc_remote_discover_resp_msg_data_v01},
  {sizeof(pdc_remote_discover_ind_msg_v01), pdc_remote_discover_ind_msg_data_v01},
  {sizeof(pdc_remote_discovery_event_ind_msg_v01), pdc_remote_discovery_event_ind_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry pdc_service_command_messages_v01[] = {
  ...
  {QMI_PDC_INDICATION_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 2), 12},
  ...
  {QMI_PDC_REMOTE_DISCOVER_REQ_V01, QMI_IDL_TYPE16(0, 50), 7}
};
...
static const qmi_idl_service_message_table_entry pdc_service_response_messages_v01[] = {
  ...
  {QMI_PDC_REMOTE_DISCOVER_RESP_V01, QMI_IDL_TYPE16(0, 51), 7}
};
...
static const qmi_idl_service_message_table_entry pdc_service_indication_messages_v01[] = {
  ...
  {QMI_PDC_REMOTE_DISCOVER_IND_V01, QMI_IDL_TYPE16(0, 52), 23},
  {QMI_PDC_REMOTE_DISCOVERY_EVENT_IND_V01, QMI_IDL_TYPE16(0, 53), 7}
};
