...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/6.2/sar/src/specific_absorption_rate_v01.c#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t sar_rf_set_state_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sar_rf_set_state_req_msg_v01, compatibility_key) - QMI_IDL_OFFSET8(sar_rf_set_state_req_msg_v01, compatibility_key_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(sar_rf_set_state_req_msg_v01, compatibility_key),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sar_rf_set_state_req_msg_v01, oem_data) - QMI_IDL_OFFSET8(sar_rf_set_state_req_msg_v01, oem_data_valid)),
  0x11,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(sar_rf_set_state_req_msg_v01, oem_data),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sar_rf_set_state_req_msg_v01, concurrent_radio_state) - QMI_IDL_OFFSET8(sar_rf_set_state_req_msg_v01, concurrent_radio_state_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(sar_rf_set_state_req_msg_v01, concurrent_radio_state)
};
...
static const uint8_t sar_rf_get_state_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sar_rf_get_state_resp_msg_v01, sar_rf_state) - QMI_IDL_OFFSET8(sar_rf_get_state_resp_msg_v01, sar_rf_state_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(sar_rf_get_state_resp_msg_v01, sar_rf_state),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sar_rf_get_state_resp_msg_v01, oem_data) - QMI_IDL_OFFSET8(sar_rf_get_state_resp_msg_v01, oem_data_valid)),
  0x11,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(sar_rf_get_state_resp_msg_v01, oem_data),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sar_rf_get_state_resp_msg_v01, concurrent_radio_state) - QMI_IDL_OFFSET8(sar_rf_get_state_resp_msg_v01, concurrent_radio_state_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(sar_rf_get_state_resp_msg_v01, concurrent_radio_state)
};
...
static const uint8_t sar_set_usb_conn_state_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sar_set_usb_conn_state_req_msg_v01, usb_is_connected) - QMI_IDL_OFFSET8(sar_set_usb_conn_state_req_msg_v01, usb_is_connected_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sar_set_usb_conn_state_req_msg_v01, usb_is_connected)
};

static const uint8_t sar_set_usb_conn_state_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(sar_set_usb_conn_state_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

/*
 * sar_get_usb_conn_state_req_msg is empty
 * static const uint8_t sar_get_usb_conn_state_req_msg_data_v01[] = {
 * };
 */

static const uint8_t sar_get_usb_conn_state_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(sar_get_usb_conn_state_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sar_get_usb_conn_state_resp_msg_v01, usb_is_connected) - QMI_IDL_OFFSET8(sar_get_usb_conn_state_resp_msg_v01, usb_is_connected_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sar_get_usb_conn_state_resp_msg_v01, usb_is_connected)
};

static const uint8_t sar_set_beam_sub_array_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(sar_set_beam_sub_array_req_msg_v01, subarray_id_1),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(sar_set_beam_sub_array_req_msg_v01, subarray_id_2)
};

static const uint8_t sar_set_beam_sub_array_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(sar_set_beam_sub_array_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};
...
static const qmi_idl_message_table_entry sar_message_table_v01[] = {
  ...
  {sizeof(sar_set_usb_conn_state_req_msg_v01), sar_set_usb_conn_state_req_msg_data_v01},
  {sizeof(sar_set_usb_conn_state_resp_msg_v01), sar_set_usb_conn_state_resp_msg_data_v01},
  {sizeof(sar_get_usb_conn_state_req_msg_v01), 0},
  {sizeof(sar_get_usb_conn_state_resp_msg_v01), sar_get_usb_conn_state_resp_msg_data_v01},
  {sizeof(sar_set_beam_sub_array_req_msg_v01), sar_set_beam_sub_array_req_msg_data_v01},
  {sizeof(sar_set_beam_sub_array_resp_msg_v01), sar_set_beam_sub_array_resp_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry sar_service_command_messages_v01[] = {
  {QMI_SAR_RF_SET_STATE_REQ_MSG_V01, QMI_IDL_TYPE16(0, 0), 32},
  ...
  {QMI_SAR_SET_USB_CONN_STATE_REQ_V01, QMI_IDL_TYPE16(0, 17), 4},
  {QMI_SAR_GET_USB_CONN_STATE_REQ_V01, QMI_IDL_TYPE16(0, 19), 0},
  {QMI_SAR_SET_BEAM_SUB_ARRAY_REQ_V01, QMI_IDL_TYPE16(0, 21), 10}
};
...
static const qmi_idl_service_message_table_entry sar_service_response_messages_v01[] = {
  ...
  {QMI_SAR_RF_GET_STATE_RESP_MSG_V01, QMI_IDL_TYPE16(0, 3), 32},
  ...
  {QMI_SAR_SET_USB_CONN_STATE_RESP_V01, QMI_IDL_TYPE16(0, 18), 7},
  {QMI_SAR_GET_USB_CONN_STATE_RESP_V01, QMI_IDL_TYPE16(0, 20), 11},
  {QMI_SAR_SET_BEAM_SUB_ARRAY_RESP_V01, QMI_IDL_TYPE16(0, 22), 7}
};
