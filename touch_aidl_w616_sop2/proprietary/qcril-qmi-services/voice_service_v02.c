...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/6.4/voice/src/voice_service_v02.c#3 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t voice_silent_ui_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_silent_ui_type_v02, call_id),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_silent_ui_type_v02, silent_ui),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_original_call_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_original_call_type_v02, call_id),

  QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(voice_original_call_type_v02, original_call_type),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_crs_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_crs_type_v02, call_id),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_crs_type_v02, crs_type),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_sip_dtmf_info_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_sip_dtmf_info_type_v02, call_id),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_STRING,
  QMI_IDL_OFFSET8(voice_sip_dtmf_info_type_v02, dtmf_string),
  QMI_VOICE_SIP_DTMF_STRING_MAX_LEN_V02,

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_prog_info_notif_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_prog_info_notif_type_v02, call_id),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_prog_info_notif_type_v02, notif_type),

  QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(voice_prog_info_notif_type_v02, notif_reason),

  QMI_IDL_FLAGS_IS_ARRAY |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_prog_info_notif_type_v02, notif_text),
  QMI_VOICE_PROG_INFO_NOTIF_TEXT_MAX_LEN_V02,

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_ip_diversion_info_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_ip_diversion_info_type_v02, call_id),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(voice_ip_diversion_info_type_v02, ip_diversion_info),
  ((QMI_VOICE_IP_DIVERSION_INFO_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_IP_DIVERSION_INFO_MAX_LEN_V02) >> 8),
  QMI_IDL_OFFSET8(voice_ip_diversion_info_type_v02, ip_diversion_info) - QMI_IDL_OFFSET8(voice_ip_diversion_info_type_v02, ip_diversion_info_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_msim_additional_call_info_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_msim_additional_call_info_type_v02, call_id),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_msim_additional_call_info_type_v02, call_info),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_call_ecnam_icon_url_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_call_ecnam_icon_url_type_v02, call_id),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET8(voice_call_ecnam_icon_url_type_v02, ecnam_icon_url),
  ((QMI_VOICE_CALL_ECNAM_ICON_URL_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_CALL_ECNAM_ICON_URL_MAX_LEN_V02) >> 8),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_call_ecnam_info_url_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_call_ecnam_info_url_type_v02, call_id),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET8(voice_call_ecnam_info_url_type_v02, ecnam_info_url),
  ((QMI_VOICE_CALL_ECNAM_INFO_URL_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_CALL_ECNAM_INFO_URL_MAX_LEN_V02) >> 8),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_call_ecnam_card_url_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_call_ecnam_card_url_type_v02, call_id),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET8(voice_call_ecnam_card_url_type_v02, ecnam_card_url),
  ((QMI_VOICE_CALL_ECNAM_CARD_URL_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_CALL_ECNAM_CARD_URL_MAX_LEN_V02) >> 8),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_call_composer_org_hdr_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_call_composer_org_hdr_type_v02, call_id),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(voice_call_composer_org_hdr_type_v02, org_header),
  ((QMI_VOICE_CALL_COMP_ORG_HDR_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_CALL_COMP_ORG_HDR_MAX_LEN_V02) >> 8),
  QMI_IDL_OFFSET8(voice_call_composer_org_hdr_type_v02, org_header) - QMI_IDL_OFFSET8(voice_call_composer_org_hdr_type_v02, org_header_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_dc_call_info_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_dc_call_info_type_v02, call_id),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_dc_call_info_type_v02, is_dc_call),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_vos_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_vos_type_v02, call_id),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_vos_type_v02, vos_support),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t sip_vos_coordinate_type_data_v02[] = {
  QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(sip_vos_coordinate_type_v02, latitude),

  QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(sip_vos_coordinate_type_v02, longitude),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t sip_vos_move_info_type_data_v02[] = {
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(sip_vos_move_info_type_v02, start_coordinates),
  QMI_IDL_TYPE88(0, 122),
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(sip_vos_move_info_type_v02, end_coordinates),
  QMI_IDL_TYPE88(0, 122),
  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t sip_vos_touch_info_type_data_v02[] = {
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(sip_vos_touch_info_type_v02, touch_coordinates),
  QMI_IDL_TYPE88(0, 122),
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(sip_vos_touch_info_type_v02, touch_duration),
...
static const uint8_t voice_indication_register_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ecall_era_glonass_enabled_status_events) - QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ecall_era_glonass_enabled_status_events_valid)),
  0x2C,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ecall_era_glonass_enabled_status_events),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, network_detected_ecc_number_event) - QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, network_detected_ecc_number_event_valid)),
  0x2D,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, network_detected_ecc_number_event),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, iut_call_push_delay_events) - QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, iut_call_push_delay_events_valid)),
  0x2E,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, iut_call_push_delay_events),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, sip_dtmf_event) - QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, sip_dtmf_event_valid)),
  0x2F,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, sip_dtmf_event),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, notify_clir_mode_events) - QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, notify_clir_mode_events_valid)),
  0x30,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, notify_clir_mode_events)
};
...
static const uint8_t voice_dial_call_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, do_not_transmit_msd_call_connect) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, do_not_transmit_msd_call_connect_valid)),
  0x30,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, do_not_transmit_msd_call_connect),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, num_vehicle_xml_payloads) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, num_vehicle_xml_payloads_valid)),
  0x31,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, num_vehicle_xml_payloads),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, vehicle_xml_payload_ids) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, vehicle_xml_payload_ids_valid)),
  0x32,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, vehicle_xml_payload_ids),
  ((QMI_VOICE_VEHICLE_XML_PAYLOAD_IDS_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_VEHICLE_XML_PAYLOAD_IDS_MAX_LEN_V02) >> 8),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, iut_call_pull) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, iut_call_pull_valid)),
  0x33,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, iut_call_pull),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, iut_stn) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, iut_stn_valid)),
  0x34,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, iut_stn),
  QMI_VOICE_IUT_STN_MAX_LEN_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, iut_stn) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, iut_stn_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, emerg_service_urn) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, emerg_service_urn_valid)),
  0x35,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, emerg_service_urn),
  QMI_VOICE_EMERG_SERVICE_URN_MAX_LEN_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, emerg_service_urn) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, emerg_service_urn_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_caller_info_content_ext_type) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_caller_info_content_ext_type_valid)),
  0x36,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, ip_caller_info_content_ext_type),
  QMI_VOICE_IP_CALLER_INFO_CONTENT_EXT_TYPE_LENGTH_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_caller_info_content_ext_type) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_caller_info_content_ext_type_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_caller_info_ext) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_caller_info_ext_valid)),
  0x37,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, ip_caller_info_ext),
  QMI_VOICE_IP_CALLER_INFO_EXT_LENGTH_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_caller_info_ext) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_caller_info_ext_len),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_accept_info) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_accept_info_valid)),
  0x38,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_dial_call_req_msg_v02, ip_accept_info),
  QMI_VOICE_IP_ACCEPT_INFO_LENGTH_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_accept_info) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, ip_accept_info_len)
};
...
static const uint8_t voice_get_call_info_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, call_composer_circle_location) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, call_composer_circle_location_valid)),
  0x2F,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_get_call_info_resp_msg_v02, call_composer_circle_location),
  QMI_IDL_TYPE88(0, 101),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, is_dc_call) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, is_dc_call_valid)),
  0x30,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_get_call_info_resp_msg_v02, is_dc_call),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, vos_support) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, vos_support_valid)),
  0x31,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_get_call_info_resp_msg_v02, vos_support)
};
...
static const uint8_t voice_all_call_status_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_circle_location) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_circle_location_valid)),
  0x47,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, silent_ui) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, silent_ui_valid)),
  0x48,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, silent_ui),
  QMI_VOICE_CALL_INFO_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, silent_ui) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, silent_ui_len),
  QMI_IDL_TYPE88(0, 109),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, original_call_type) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, original_call_type_valid)),
  0x49,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, original_call_type),
  QMI_VOICE_CALL_INFO_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, original_call_type) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, original_call_type_len),
  QMI_IDL_TYPE88(0, 110),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, crs_type) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, crs_type_valid)),
  0x4A,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, crs_type),
  QMI_VOICE_CALL_INFO_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, crs_type) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, crs_type_len),
  QMI_IDL_TYPE88(0, 111),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, prog_info_notif) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, prog_info_notif_valid)),
  0x4B,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, prog_info_notif),
  QMI_VOICE_CALL_INFO_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, prog_info_notif) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, prog_info_notif_len),
  QMI_IDL_TYPE88(0, 113),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, ip_diversion_info) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, ip_diversion_info_valid)),
  0x4C,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, ip_diversion_info),
  QMI_VOICE_IP_DIVERSION_INFO_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, ip_diversion_info) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, ip_diversion_info_len),
  QMI_IDL_TYPE88(0, 114),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, msim_additional_call_info) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, msim_additional_call_info_valid)),
  0x4D,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, msim_additional_call_info),
  QMI_VOICE_CALL_INFO_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, msim_additional_call_info) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, msim_additional_call_info_len),
  QMI_IDL_TYPE88(0, 115),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_ecnam_icon_url) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_ecnam_icon_url_valid)),
  0x4E,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, call_ecnam_icon_url),
  QMI_VOICE_CALL_ECNAM_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_ecnam_icon_url) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_ecnam_icon_url_len),
  QMI_IDL_TYPE88(0, 116),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_ecnam_info_url) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_ecnam_info_url_valid)),
  0x4F,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, call_ecnam_info_url),
  QMI_VOICE_CALL_ECNAM_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_ecnam_info_url) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_ecnam_info_url_len),
  QMI_IDL_TYPE88(0, 117),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_ecnam_card_url) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_ecnam_card_url_valid)),
  0x50,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, call_ecnam_card_url),
  QMI_VOICE_CALL_ECNAM_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_ecnam_card_url) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_ecnam_card_url_len),
  QMI_IDL_TYPE88(0, 118),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_organization_header) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_organization_header_valid)),
  0x51,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, call_composer_organization_header),
  QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_organization_header) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_composer_organization_header_len),
  QMI_IDL_TYPE88(0, 119),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, dc_call_info) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, dc_call_info_valid)),
  0x52,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, dc_call_info),
  QMI_VOICE_CALL_INFO_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, dc_call_info) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, dc_call_info_len),
  QMI_IDL_TYPE88(0, 120),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, vos_support) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, vos_support_valid)),
  0x53,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, vos_support),
  QMI_VOICE_CALL_INFO_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, vos_support) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, vos_support_len),
...
static const uint8_t voice_get_all_call_info_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_circle_location) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, call_composer_circle_location_valid)),
  0x36,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, dc_call_info) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, dc_call_info_valid)),
  0x37,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_get_all_call_info_resp_msg_v02, dc_call_info),
  QMI_VOICE_CALL_INFO_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, dc_call_info) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, dc_call_info_len),
  QMI_IDL_TYPE88(0, 120),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, vos_support) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, vos_support_valid)),
  0x38,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_get_all_call_info_resp_msg_v02, vos_support),
  QMI_VOICE_CALL_INFO_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, vos_support) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, vos_support_len),
  QMI_IDL_TYPE88(0, 121)
};
...
static const uint8_t voice_get_call_barring_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_call_barring_req_msg_v02, service_class_ext) - QMI_IDL_OFFSET8(voice_get_call_barring_req_msg_v02, service_class_ext_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_get_call_barring_req_msg_v02, service_class_ext),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_call_barring_req_msg_v02, additional_ss_expected) - QMI_IDL_OFFSET8(voice_get_call_barring_req_msg_v02, additional_ss_expected_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_get_call_barring_req_msg_v02, additional_ss_expected)
};
...
static const uint8_t voice_get_call_barring_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_call_barring_resp_msg_v02, sip_error_code) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_barring_resp_msg_v02, sip_error_code_valid)),
  0x1A,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_get_call_barring_resp_msg_v02, sip_error_code),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_call_barring_resp_msg_v02, is_cb_password_required) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_barring_resp_msg_v02, is_cb_password_required_valid)),
  0x1B,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_get_call_barring_resp_msg_v02, is_cb_password_required)
};
...
static const uint8_t voice_get_clip_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_clip_resp_msg_v02, sip_error_code) - QMI_IDL_OFFSET16RELATIVE(voice_get_clip_resp_msg_v02, sip_error_code_valid)),
  0x18,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_get_clip_resp_msg_v02, sip_error_code),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_clip_resp_msg_v02, clip_domain_route) - QMI_IDL_OFFSET16RELATIVE(voice_get_clip_resp_msg_v02, clip_domain_route_valid)),
  0x19,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_get_clip_resp_msg_v02, clip_domain_route)
};
...
static const uint8_t voice_get_call_forwarding_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_call_forwarding_req_msg_v02, service_class_ext) - QMI_IDL_OFFSET8(voice_get_call_forwarding_req_msg_v02, service_class_ext_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_get_call_forwarding_req_msg_v02, service_class_ext),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_call_forwarding_req_msg_v02, additional_ss_expected) - QMI_IDL_OFFSET8(voice_get_call_forwarding_req_msg_v02, additional_ss_expected_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_get_call_forwarding_req_msg_v02, additional_ss_expected)
};
...
static const uint8_t voice_manage_ip_calls_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_manage_ip_calls_req_msg_v02, priority_speech_codec) - QMI_IDL_OFFSET16RELATIVE(voice_manage_ip_calls_req_msg_v02, priority_speech_codec_valid)),
  0x1D,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_manage_ip_calls_req_msg_v02, priority_speech_codec),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_manage_ip_calls_req_msg_v02, iut_stn) - QMI_IDL_OFFSET16RELATIVE(voice_manage_ip_calls_req_msg_v02, iut_stn_valid)),
  0x1E,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(voice_manage_ip_calls_req_msg_v02, iut_stn),
  QMI_VOICE_IUT_STN_MAX_LEN_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_manage_ip_calls_req_msg_v02, iut_stn) - QMI_IDL_OFFSET16RELATIVE(voice_manage_ip_calls_req_msg_v02, iut_stn_len),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_manage_ip_calls_req_msg_v02, iut_stn_number) - QMI_IDL_OFFSET16RELATIVE(voice_manage_ip_calls_req_msg_v02, iut_stn_number_valid)),
  0x1F,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(voice_manage_ip_calls_req_msg_v02, iut_stn_number),
  QMI_VOICE_IUT_STN_MAX_LEN_V02
};
...
static const uint8_t voice_modified_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, call_composer_capabilities) - QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, call_composer_capabilities_valid)),
  0x1C,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, call_composer_capabilities),
  QMI_IDL_TYPE88(0, 102),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, vos_support) - QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, vos_support_valid)),
  0x1D,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, vos_support)
};
...
static const uint8_t voice_modify_accept_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_modify_accept_ind_msg_v02, is_secure_call) - QMI_IDL_OFFSET8(voice_modify_accept_ind_msg_v02, is_secure_call_valid)),
  0x14,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_modify_accept_ind_msg_v02, is_secure_call),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_modify_accept_ind_msg_v02, call_modified_cause) - QMI_IDL_OFFSET8(voice_modify_accept_ind_msg_v02, call_modified_cause_valid)),
  0x15,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_modify_accept_ind_msg_v02, call_modified_cause),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_modify_accept_ind_msg_v02, vos_support) - QMI_IDL_OFFSET8(voice_modify_accept_ind_msg_v02, vos_support_valid)),
  0x16,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_modify_accept_ind_msg_v02, vos_support)
};
...
static const uint8_t voice_speech_codec_info_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_speech_codec_info_ind_msg_v02, call_id) - QMI_IDL_OFFSET8(voice_speech_codec_info_ind_msg_v02, call_id_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_speech_codec_info_ind_msg_v02, call_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_speech_codec_info_ind_msg_v02, audio_quality) - QMI_IDL_OFFSET8(voice_speech_codec_info_ind_msg_v02, audio_quality_valid)),
  0x14,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_speech_codec_info_ind_msg_v02, audio_quality)
};
...
static const uint8_t auto_rejected_incoming_call_end_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_circle_location) - QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_circle_location_valid)),
  0x16,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_circle_location),
  QMI_IDL_TYPE88(0, 101),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_ecnam_icon_url) - QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_ecnam_icon_url_valid)),
  0x17,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(auto_rejected_incoming_call_end_ind_msg_v02, call_ecnam_icon_url),
  ((QMI_VOICE_CALL_ECNAM_ICON_URL_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_CALL_ECNAM_ICON_URL_MAX_LEN_V02) >> 8),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_ecnam_info_url) - QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_ecnam_info_url_valid)),
  0x18,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(auto_rejected_incoming_call_end_ind_msg_v02, call_ecnam_info_url),
  ((QMI_VOICE_CALL_ECNAM_INFO_URL_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_CALL_ECNAM_INFO_URL_MAX_LEN_V02) >> 8),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_ecnam_card_url) - QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_ecnam_card_url_valid)),
  0x19,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(auto_rejected_incoming_call_end_ind_msg_v02, call_ecnam_card_url),
  ((QMI_VOICE_CALL_ECNAM_CARD_URL_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_CALL_ECNAM_CARD_URL_MAX_LEN_V02) >> 8),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, ip_caller_name) - QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, ip_caller_name_valid)),
  0x1A,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(auto_rejected_incoming_call_end_ind_msg_v02, ip_caller_name),
  QMI_VOICE_IP_CALLER_NAME_MAX_LEN_V02,
  QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, ip_caller_name) - QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, ip_caller_name_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_organization_header) - QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_organization_header_valid)),
  0x1B,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_organization_header),
  ((QMI_VOICE_CALL_COMP_ORG_HDR_MAX_LEN_V02) & 0xFF), ((QMI_VOICE_CALL_COMP_ORG_HDR_MAX_LEN_V02) >> 8),
  QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_organization_header) - QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_composer_organization_header_len),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, is_dc_call) - QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, is_dc_call_valid)),
  0x1C,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(auto_rejected_incoming_call_end_ind_msg_v02, is_dc_call)
};
...
static const uint8_t voice_ecall_hlap_timer_status_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t9_timer_status) - QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t9_timer_status_valid)),
  0x14,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t9_timer_status),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t10_timer_status) - QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t10_timer_status_valid)),
  0x15,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_ecall_hlap_timer_status_ind_msg_v02, t10_timer_status)
};
...
static const uint8_t voice_get_ecall_hlap_timer_status_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t9_timer_status) - QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t9_timer_status_valid)),
  0x14,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t9_timer_status),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t10_timer_status) - QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t10_timer_status_valid)),
  0x15,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_hlap_timer_status_resp_msg_v02, t10_timer_status)
};
...
static const uint8_t voice_iut_call_push_delay_ind_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_iut_call_push_delay_ind_msg_v02, call_id)
};

static const uint8_t voice_network_detected_ecc_number_ind_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_network_detected_ecc_number_ind_msg_v02, num) - QMI_IDL_OFFSET8(voice_network_detected_ecc_number_ind_msg_v02, num_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_network_detected_ecc_number_ind_msg_v02, num),
  QMI_IDL_TYPE88(0, 42),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_network_detected_ecc_number_ind_msg_v02, emerg_srv_categ) - QMI_IDL_OFFSET8(voice_network_detected_ecc_number_ind_msg_v02, emerg_srv_categ_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_network_detected_ecc_number_ind_msg_v02, emerg_srv_categ),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_network_detected_ecc_number_ind_msg_v02, emerg_service_urn) - QMI_IDL_OFFSET8(voice_network_detected_ecc_number_ind_msg_v02, emerg_service_urn_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_network_detected_ecc_number_ind_msg_v02, emerg_service_urn),
  QMI_VOICE_EMERG_SERVICE_URN_MAX_LEN_V02,
  QMI_IDL_OFFSET8(voice_network_detected_ecc_number_ind_msg_v02, emerg_service_urn) - QMI_IDL_OFFSET8(voice_network_detected_ecc_number_ind_msg_v02, emerg_service_urn_len)
};

static const uint8_t voice_sip_dtmf_req_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_sip_dtmf_req_msg_v02, dtmf_info),
  QMI_IDL_TYPE88(0, 112)
};

static const uint8_t voice_sip_dtmf_resp_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_sip_dtmf_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t voice_sip_dtmf_ind_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_sip_dtmf_ind_msg_v02, dtmf_info) - QMI_IDL_OFFSET8(voice_sip_dtmf_ind_msg_v02, dtmf_info_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_sip_dtmf_ind_msg_v02, dtmf_info),
  QMI_IDL_TYPE88(0, 112)
};

static const uint8_t voice_get_sups_operation_mode_req_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(voice_get_sups_operation_mode_req_msg_v02, reason)
};

static const uint8_t voice_get_sups_operation_mode_resp_msg_data_v02[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_get_sups_operation_mode_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_sups_operation_mode_resp_msg_v02, sups_operation_mode) - QMI_IDL_OFFSET8(voice_get_sups_operation_mode_resp_msg_v02, sups_operation_mode_valid)),
  0x10,
   QMI_IDL_1_BYTE_ENUM,
  QMI_IDL_OFFSET8(voice_get_sups_operation_mode_resp_msg_v02, sups_operation_mode)
};

static const uint8_t voice_notify_clir_mode_ind_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_notify_clir_mode_ind_msg_v02, is_ue_based_clir) - QMI_IDL_OFFSET8(voice_notify_clir_mode_ind_msg_v02, is_ue_based_clir_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_notify_clir_mode_ind_msg_v02, is_ue_based_clir)
};

/*
 * voice_release_audio_req_msg is empty
 * static const uint8_t voice_release_audio_req_msg_data_v02[] = {
 * };
 */

static const uint8_t voice_release_audio_resp_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_release_audio_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t voice_set_ecall_efs_config_req_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, voc_config) - QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, voc_config_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, voc_config),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, ecall_dial_num) - QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, ecall_dial_num_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, ecall_dial_num),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, canned_msd) - QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, canned_msd_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, canned_msd),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, digits) - QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, digits_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, digits),
  QMI_VOICE_ECALL_EFS_CONFIG_DIGITS_MAX_LEN_V02,
  QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, digits) - QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, digits_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, gnss_update_time_ms) - QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, gnss_update_time_ms_valid)),
  0x14,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, gnss_update_time_ms),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, test_only_callback_timer_ms) - QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, test_only_callback_timer_ms_valid)),
  0x15,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, test_only_callback_timer_ms),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, test_only_call_cleardown_timer_ms) - QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, test_only_call_cleardown_timer_ms_valid)),
  0x16,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, test_only_call_cleardown_timer_ms),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, test_only_session_timer_ms) - QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, test_only_session_timer_ms_valid)),
  0x17,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, test_only_session_timer_ms),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, ecall_usim_slot_id) - QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, ecall_usim_slot_id_valid)),
  0x18,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, ecall_usim_slot_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, ecall_msdversion) - QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, ecall_msdversion_valid)),
  0x19,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_set_ecall_efs_config_req_msg_v02, ecall_msdversion)
};

static const uint8_t voice_set_ecall_efs_config_resp_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_set_ecall_efs_config_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0)
};

/*
 * voice_get_ecall_efs_config_req_msg is empty
 * static const uint8_t voice_get_ecall_efs_config_req_msg_data_v02[] = {
 * };
 */

static const uint8_t voice_get_ecall_efs_config_resp_msg_data_v02[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, voc_config) - QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, voc_config_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, voc_config),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, ecall_dial_num) - QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, ecall_dial_num_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, ecall_dial_num),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, canned_msd) - QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, canned_msd_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, canned_msd),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, digits) - QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, digits_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, digits),
  QMI_VOICE_ECALL_EFS_CONFIG_DIGITS_MAX_LEN_V02,
  QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, digits) - QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, digits_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, gnss_update_time_ms) - QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, gnss_update_time_ms_valid)),
  0x14,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, gnss_update_time_ms),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, test_only_callback_timer_ms) - QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, test_only_callback_timer_ms_valid)),
  0x15,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, test_only_callback_timer_ms),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, test_only_call_cleardown_timer_ms) - QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, test_only_call_cleardown_timer_ms_valid)),
  0x16,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, test_only_call_cleardown_timer_ms),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, test_only_session_timer_ms) - QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, test_only_session_timer_ms_valid)),
  0x17,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, test_only_session_timer_ms),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, ecall_usim_slot_id) - QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, ecall_usim_slot_id_valid)),
  0x18,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, ecall_usim_slot_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, ecall_msdversion) - QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, ecall_msdversion_valid)),
  0x19,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_efs_config_resp_msg_v02, ecall_msdversion)
};

static const uint8_t voice_set_ecall_t10_timer_req_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_set_ecall_t10_timer_req_msg_v02, t10_timer)
};

static const uint8_t voice_set_ecall_t10_timer_resp_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_set_ecall_t10_timer_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0)
};

/*
 * voice_get_ecall_t10_timer_req_msg is empty
 * static const uint8_t voice_get_ecall_t10_timer_req_msg_data_v02[] = {
 * };
 */

static const uint8_t voice_get_ecall_t10_timer_resp_msg_data_v02[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_get_ecall_t10_timer_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_get_ecall_t10_timer_resp_msg_v02, t10_timer) - QMI_IDL_OFFSET8(voice_get_ecall_t10_timer_resp_msg_v02, t10_timer_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(voice_get_ecall_t10_timer_resp_msg_v02, t10_timer)
};

static const uint8_t voice_sip_vos_capability_ack_req_msg_data_v02[] = {
  0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_sip_vos_capability_ack_req_msg_v02, call_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_sip_vos_capability_ack_req_msg_v02, vos_support)
};

static const uint8_t voice_sip_vos_capability_ack_resp_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_sip_vos_capability_ack_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t voice_sip_vos_action_req_msg_data_v02[] = {
  0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_sip_vos_action_req_msg_v02, call_id),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_sip_vos_action_req_msg_v02, sip_vos_move_info) - QMI_IDL_OFFSET8(voice_sip_vos_action_req_msg_v02, sip_vos_move_info_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_sip_vos_action_req_msg_v02, sip_vos_move_info),
  QMI_IDL_TYPE88(0, 123),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_sip_vos_action_req_msg_v02, sip_vos_touch_info) - QMI_IDL_OFFSET8(voice_sip_vos_action_req_msg_v02, sip_vos_touch_info_valid)),
  0x11,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_sip_vos_action_req_msg_v02, sip_vos_touch_info),
  QMI_IDL_TYPE88(0, 124)
};

static const uint8_t voice_sip_vos_action_resp_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_sip_vos_action_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0)
};
...
static const qmi_idl_type_table_entry  voice_type_table_v02[] = {
  ...
  {sizeof(voice_silent_ui_type_v02), voice_silent_ui_type_data_v02},
  {sizeof(voice_original_call_type_v02), voice_original_call_type_data_v02},
  {sizeof(voice_crs_type_v02), voice_crs_type_data_v02},
  {sizeof(voice_sip_dtmf_info_type_v02), voice_sip_dtmf_info_type_data_v02},
  {sizeof(voice_prog_info_notif_type_v02), voice_prog_info_notif_type_data_v02},
  {sizeof(voice_ip_diversion_info_type_v02), voice_ip_diversion_info_type_data_v02},
  {sizeof(voice_msim_additional_call_info_type_v02), voice_msim_additional_call_info_type_data_v02},
  {sizeof(voice_call_ecnam_icon_url_type_v02), voice_call_ecnam_icon_url_type_data_v02},
  {sizeof(voice_call_ecnam_info_url_type_v02), voice_call_ecnam_info_url_type_data_v02},
  {sizeof(voice_call_ecnam_card_url_type_v02), voice_call_ecnam_card_url_type_data_v02},
  {sizeof(voice_call_composer_org_hdr_type_v02), voice_call_composer_org_hdr_type_data_v02},
  {sizeof(voice_dc_call_info_type_v02), voice_dc_call_info_type_data_v02},
  {sizeof(voice_vos_type_v02), voice_vos_type_data_v02},
  {sizeof(sip_vos_coordinate_type_v02), sip_vos_coordinate_type_data_v02},
  {sizeof(sip_vos_move_info_type_v02), sip_vos_move_info_type_data_v02},
  {sizeof(sip_vos_touch_info_type_v02), sip_vos_touch_info_type_data_v02}
};
...
static const qmi_idl_message_table_entry voice_message_table_v02[] = {
  ...
  {sizeof(voice_iut_call_push_delay_ind_msg_v02), voice_iut_call_push_delay_ind_msg_data_v02},
  {sizeof(voice_network_detected_ecc_number_ind_msg_v02), voice_network_detected_ecc_number_ind_msg_data_v02},
  {sizeof(voice_sip_dtmf_req_msg_v02), voice_sip_dtmf_req_msg_data_v02},
  {sizeof(voice_sip_dtmf_resp_msg_v02), voice_sip_dtmf_resp_msg_data_v02},
  {sizeof(voice_sip_dtmf_ind_msg_v02), voice_sip_dtmf_ind_msg_data_v02},
  {sizeof(voice_get_sups_operation_mode_req_msg_v02), voice_get_sups_operation_mode_req_msg_data_v02},
  {sizeof(voice_get_sups_operation_mode_resp_msg_v02), voice_get_sups_operation_mode_resp_msg_data_v02},
  {sizeof(voice_notify_clir_mode_ind_msg_v02), voice_notify_clir_mode_ind_msg_data_v02},
  {sizeof(voice_release_audio_req_msg_v02), 0},
  {sizeof(voice_release_audio_resp_msg_v02), voice_release_audio_resp_msg_data_v02},
  {sizeof(voice_set_ecall_efs_config_req_msg_v02), voice_set_ecall_efs_config_req_msg_data_v02},
  {sizeof(voice_set_ecall_efs_config_resp_msg_v02), voice_set_ecall_efs_config_resp_msg_data_v02},
  {sizeof(voice_get_ecall_efs_config_req_msg_v02), 0},
  {sizeof(voice_get_ecall_efs_config_resp_msg_v02), voice_get_ecall_efs_config_resp_msg_data_v02},
  {sizeof(voice_set_ecall_t10_timer_req_msg_v02), voice_set_ecall_t10_timer_req_msg_data_v02},
  {sizeof(voice_set_ecall_t10_timer_resp_msg_v02), voice_set_ecall_t10_timer_resp_msg_data_v02},
  {sizeof(voice_get_ecall_t10_timer_req_msg_v02), 0},
  {sizeof(voice_get_ecall_t10_timer_resp_msg_v02), voice_get_ecall_t10_timer_resp_msg_data_v02},
  {sizeof(voice_sip_vos_capability_ack_req_msg_v02), voice_sip_vos_capability_ack_req_msg_data_v02},
  {sizeof(voice_sip_vos_capability_ack_resp_msg_v02), voice_sip_vos_capability_ack_resp_msg_data_v02},
  {sizeof(voice_sip_vos_action_req_msg_v02), voice_sip_vos_action_req_msg_data_v02},
  {sizeof(voice_sip_vos_action_resp_msg_v02), voice_sip_vos_action_resp_msg_data_v02}
};
...
static const qmi_idl_service_message_table_entry voice_service_command_messages_v02[] = {
  ...
  {QMI_VOICE_GET_CALL_BARRING_REQ_V02, QMI_IDL_TYPE16(0, 34), 19},
  {QMI_VOICE_GET_CLIP_REQ_V02, QMI_IDL_TYPE16(0, 36), 0},
  {QMI_VOICE_GET_CLIR_REQ_V02, QMI_IDL_TYPE16(0, 38), 0},
  {QMI_VOICE_GET_CALL_FORWARDING_REQ_V02, QMI_IDL_TYPE16(0, 40), 19},
  ...
  {QMI_VOICE_MANAGE_IP_CALLS_REQ_V02, QMI_IDL_TYPE16(0, 80), 487},
  ...
  {QMI_VOICE_SIP_DTMF_REQ_V02, QMI_IDL_TYPE16(0, 144), 133},
  {QMI_VOICE_GET_SUPS_OPERATION_MODE_REQ_V02, QMI_IDL_TYPE16(0, 147), 4},
  {QMI_VOICE_RELEASE_AUDIO_REQ_V02, QMI_IDL_TYPE16(0, 150), 0},
  {QMI_VOICE_SET_ECALL_CONFIG_REQ_V02, QMI_IDL_TYPE16(0, 152), 76},
  {QMI_VOICE_GET_ECALL_CONFIG_REQ_V02, QMI_IDL_TYPE16(0, 154), 0},
  {QMI_VOICE_SET_ECALL_T10_TIMER_REQ_V02, QMI_IDL_TYPE16(0, 156), 7},
  {QMI_VOICE_GET_ECALL_T10_TIMER_REQ_V02, QMI_IDL_TYPE16(0, 158), 0},
  {QMI_VOICE_SIP_VOS_CAPABILITY_ACK_REQ_V02, QMI_IDL_TYPE16(0, 160), 8},
  {QMI_VOICE_SIP_VOS_ACTION_REQ_V02, QMI_IDL_TYPE16(0, 162), 26}
};
...
static const qmi_idl_service_message_table_entry voice_service_response_messages_v02[] = {
  ...
  {QMI_VOICE_GET_CALL_INFO_RESP_V02, QMI_IDL_TYPE16(0, 9), 3414},
  ...
  {QMI_VOICE_GET_ALL_CALL_INFO_RESP_V02, QMI_IDL_TYPE16(0, 26), 24814},
  ...
  {QMI_VOICE_GET_CALL_BARRING_RESP_V02, QMI_IDL_TYPE16(0, 35), 21533},
  {QMI_VOICE_GET_CLIP_RESP_V02, QMI_IDL_TYPE16(0, 37), 751},
  ...
  {QMI_VOICE_GET_ECALL_HLAP_TIMER_STATUS_RESP_V02, QMI_IDL_TYPE16(0, 138), 49},
  {QMI_VOICE_GET_ECALL_ERA_GLONASS_ENABLED_STATUS_RESP_V02, QMI_IDL_TYPE16(0, 141), 11},
  {QMI_VOICE_SIP_DTMF_RESP_V02, QMI_IDL_TYPE16(0, 145), 7},
  {QMI_VOICE_GET_SUPS_OPERATION_MODE_RESP_V02, QMI_IDL_TYPE16(0, 148), 11},
  {QMI_VOICE_RELEASE_AUDIO_RESP_V02, QMI_IDL_TYPE16(0, 151), 7},
  {QMI_VOICE_SET_ECALL_CONFIG_RESP_V02, QMI_IDL_TYPE16(0, 153), 7},
  {QMI_VOICE_GET_ECALL_CONFIG_RESP_V02, QMI_IDL_TYPE16(0, 155), 83},
  {QMI_VOICE_SET_ECALL_T10_TIMER_RESP_V02, QMI_IDL_TYPE16(0, 157), 7},
  {QMI_VOICE_GET_ECALL_T10_TIMER_RESP_V02, QMI_IDL_TYPE16(0, 159), 14},
  {QMI_VOICE_SIP_VOS_CAPABILITY_ACK_RESP_V02, QMI_IDL_TYPE16(0, 161), 7},
  {QMI_VOICE_SIP_VOS_ACTION_RESP_V02, QMI_IDL_TYPE16(0, 163), 7}
};
...
static const qmi_idl_service_message_table_entry voice_service_indication_messages_v02[] = {
  ...
  {QMI_VOICE_ALL_CALL_STATUS_IND_V02, QMI_IDL_TYPE16(0, 24), 50100},
  ...
  {QMI_VOICE_MODIFIED_IND_V02, QMI_IDL_TYPE16(0, 86), 138},
  {QMI_VOICE_MODIFY_ACCEPT_IND_V02, QMI_IDL_TYPE16(0, 87), 52},
  {QMI_VOICE_SPEECH_CODEC_INFO_IND_V02, QMI_IDL_TYPE16(0, 88), 32},
  ...
  {QMI_AUTO_REJECTED_INCOMING_CALL_END_IND_V02, QMI_IDL_TYPE16(0, 132), 2104},
  {QMI_VOICE_IP_CALLER_INFO_STATUS_IND_V02, QMI_IDL_TYPE16(0, 133), 8},
  {QMI_VOICE_ECALL_HLAP_TIMER_STATUS_IND_V02, QMI_IDL_TYPE16(0, 136), 42},
  {QMI_VOICE_ECALL_ERA_GLONASS_ENABLED_STATUS_IND_V02, QMI_IDL_TYPE16(0, 139), 4},
  {QMI_VOICE_IUT_CALL_PUSH_DELAY_IND_V02, QMI_IDL_TYPE16(0, 142), 4},
  {QMI_VOICE_NETWORK_DETECTED_ECC_NUM_IND_V02, QMI_IDL_TYPE16(0, 143), 229},
  {QMI_VOICE_SIP_DTMF_IND_V02, QMI_IDL_TYPE16(0, 146), 133},
  {QMI_VOICE_NOTIFY_CLIR_MODE_IND_V02, QMI_IDL_TYPE16(0, 149), 4}
};
