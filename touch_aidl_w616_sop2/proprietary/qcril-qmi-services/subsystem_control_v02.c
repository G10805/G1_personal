...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/6.0/ssctl/src/subsystem_control_v02.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9
   It was generated on: Mon Mar  9 2020 (Spin 0)
...
static const uint8_t qmi_ssctl_get_failure_reason_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_ssctl_get_failure_reason_resp_msg_v02, error_message) - QMI_IDL_OFFSET8(qmi_ssctl_get_failure_reason_resp_msg_v02, error_message_valid)),
  0x10,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qmi_ssctl_get_failure_reason_resp_msg_v02, ext_error_message) - QMI_IDL_OFFSET8(qmi_ssctl_get_failure_reason_resp_msg_v02, ext_error_message_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(qmi_ssctl_get_failure_reason_resp_msg_v02, ext_error_message),
  ((QMI_SSCTL_EXT_ERROR_MSG_LENGTH_V02) & 0xFF), ((QMI_SSCTL_EXT_ERROR_MSG_LENGTH_V02) >> 8),
  QMI_IDL_OFFSET8(qmi_ssctl_get_failure_reason_resp_msg_v02, ext_error_message) - QMI_IDL_OFFSET8(qmi_ssctl_get_failure_reason_resp_msg_v02, ext_error_message_len)
};
...
/*
 * qmi_ssctl_hibernation_req_msg is empty
 * static const uint8_t qmi_ssctl_hibernation_req_msg_data_v02[] = {
 * };
 */

static const uint8_t qmi_ssctl_hibernation_resp_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qmi_ssctl_hibernation_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0)
};

/*
 * qmi_ssctl_hibernation_ind_msg is empty
 * static const uint8_t qmi_ssctl_hibernation_ind_msg_data_v02[] = {
 * };
 */
...
static const qmi_idl_message_table_entry ssctl_message_table_v02[] = {
  ...
  {sizeof(qmi_ssctl_hibernation_req_msg_v02), 0},
  {sizeof(qmi_ssctl_hibernation_resp_msg_v02), qmi_ssctl_hibernation_resp_msg_data_v02},
  {sizeof(qmi_ssctl_hibernation_ind_msg_v02), 0}
};
...
static const qmi_idl_service_message_table_entry ssctl_service_command_messages_v02[] = {
  ...
  {QMI_SSCTL_HIBERNATION_REQ_V02, QMI_IDL_TYPE16(0, 11), 0}
};
...
static const qmi_idl_service_message_table_entry ssctl_service_response_messages_v02[] = {
  ...
  {QMI_SSCTL_GET_FAILURE_REASON_RESP_V02, QMI_IDL_TYPE16(0, 7), 362},
  {QMI_SSCTL_SUBSYS_EVENT_RESP_V02, QMI_IDL_TYPE16(0, 9), 7},
  {QMI_SSCTL_HIBERNATION_RESP_V02, QMI_IDL_TYPE16(0, 12), 7}
};
...
static const qmi_idl_service_message_table_entry ssctl_service_indication_messages_v02[] = {
  ...
  {QMI_SSCTL_HIBERNATION_READY_IND_V02, QMI_IDL_TYPE16(0, 13), 0}
};
