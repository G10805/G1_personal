...
typedef void (*acdb_deallocate_cal_v2_t)(int, int, int);
...
typedef struct acdb_service_data {
    ...
    acdb_deallocate_cal_v2_t           acdb_deallocate_cal_v2;
...
private:
    ...
    void acdb_loader_deallocate_cal(int capability, int use_case) override;
    void acdb_loader_deallocate_cal_v2(int capability, int use_case, int offset_index) override;
    ...
    void acdb_loader_send_audio_cal_v6(int acdb_id, int capability, int app_id,
            int sample_rate, int use_case, int afe_sample_rate, int cal_mode, int offset_index) override;
