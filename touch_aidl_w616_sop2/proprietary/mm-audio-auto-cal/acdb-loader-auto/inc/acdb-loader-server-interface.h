...
class Iacdb_loader_server: public ::android::IInterface {
    public:
        ...
        virtual void acdb_loader_deallocate_cal(int capability, int use_case) = 0;
        virtual void acdb_loader_deallocate_cal_v2(int capability, int use_case, int offset_index) = 0;
        ...
        virtual void acdb_loader_send_audio_cal_v6(int acdb_id, int capability, int app_id,
            int sample_rate, int use_case, int afe_sample_rate, int cal_mode, int offset_index) = 0;
