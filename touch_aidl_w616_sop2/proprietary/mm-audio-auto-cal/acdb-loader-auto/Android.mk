...
ifeq ($(call is-board-platform-in-list,msm8996 msm8937 msm8953 msm8998 apq8098_latv sdm660 sdm845 sdm670 qcs605 sdmshrike msmnile gen4 $(MSMSTEPPE) $(TRINKET) kona lito atoll bengal),true)
...
ifeq ($(call is-board-platform-in-list,sdmshrike msmnile gen4 $(MSMSTEPPE) $(TRINKET) kona lito atoll bengal),true)
...
ifeq ($(call is-board-platform-in-list,msm8909 msm8996 msm8937 msm8953 msm8998 apq8098_latv sdm660 sdm845 sdm670 qcs605 sdmshrike msmnile gen4 $(MSMSTEPPE) $(TRINKET) kona lito atoll bengal),true)
...
# ---------------------------------------------------------------------------------
#             Make the Shared library (libacdbloadersocketclient)
# ---------------------------------------------------------------------------------
...
LOCAL_MODULE            := libacdbloadersocketclient
LOCAL_MODULE_TAGS       := optional
LOCAL_CFLAGS            := $(libacdbloaderclient-def)
LOCAL_C_INCLUDES        := $(libacdbloaderclient-inc)
ifeq ($(call is-board-platform-in-list,sdmshrike msmnile gen4 $(MSMSTEPPE) $(TRINKET) kona lito atoll bengal),true)
...
ifeq ($(call is-board-platform-in-list,msm8909 msm8996 msm8937 msm8953 msm8998 apq8098_latv sdm660 sdm845 sdm670 qcs605 sdmshrike msmnile gen4 $(MSMSTEPPE) $(TRINKET) kona lito atoll bengal),true)
LOCAL_SRC_FILES         := src/acdb-loader-proxy-v2.c
endif
...
LOCAL_HEADER_LIBRARIES += libacdbloader_headers
LOCAL_HEADER_LIBRARIES += libaudcal_headers
LOCAL_SRC_FILES:= src/acdb-test.c
LOCAL_MODULE := acdb_test
