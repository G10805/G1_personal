...
public:
    ...
    /**
     * @brief Return the msg task used by izat manager
     * @details Return the msg task used by izat manager
     *
     * @param None
     * @return The msg task used by izat manager
     */
    virtual loc_util::MsgTask* getMsgTask() = 0;
    /**
     * @brief Destructor
     * @details Destructor
     */
