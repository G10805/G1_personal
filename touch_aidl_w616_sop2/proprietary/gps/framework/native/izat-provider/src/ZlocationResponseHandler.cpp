...
void ZlocationResponseHandler::reportLocation(const LocationReport* flpLocationReport,
        const ILocationProvider* provider) {
    Location locationReport = {};
    convertToLocation(static_cast<const FusedLocationReport*>(flpLocationReport), locationReport);
    return mIzatProvider->broadCastLocationWithZ(locationReport);
}
