...
class ZlocationResponseHandler : public ILocationResponse {
    public:
        ...
        virtual void reportLocation(const LocationReport*, const ILocationProvider*);
...
class NLPResponseListener : public IOSListener {
    public:
        ...
        inline virtual IzatListenerMask listensTo() const override {return IZAT_STREAM_NETWORK;}
        virtual void onLocationChanged (const IzatLocation *location,
...
class IzatProvider: public IzatProviderBase {
    public:
        ...
        static IzatProvider* getInstance();
    ...
    private:
        IzatProvider();
        static IzatProvider* sIzatProviderHandle;
