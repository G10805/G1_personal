...
#define LOG_CLIENT_LOCATION_DIAG_MSG_VERSION        (12)
#define LOG_CLIENT_SV_REPORT_DIAG_MSG_VERSION       (6)
#define LOG_CLIENT_NMEA_REPORT_DIAG_MSG_VERSION     (2)
#define LOG_CLIENT_MEASUREMENTS_DIAG_MSG_VERSION    (5)
...
public:
    GnssNmeaReport(uint64_t timestamp, uint32_t length, const char* nmea):
            mTimestamp(timestamp), mLength(length), mNmea(nmea),
            LocLoggerBase(),
            LocationClientApiDiag() {}
