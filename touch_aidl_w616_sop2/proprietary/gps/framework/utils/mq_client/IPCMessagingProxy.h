...
GENERAL DESCRIPTION
  ...
  Copyright (c) 2015-2016, 2022 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
struct IpcMutex {
    ...
    inline ~IpcMutex() {
        ...
        mMsgResponseMapMutex = nullptr;
    }
};

class IPCMessagingProxy :
        public IpcMutex, public IIPCMessagingRequest, public qc_loc_fw::MqClientControllerBase {
