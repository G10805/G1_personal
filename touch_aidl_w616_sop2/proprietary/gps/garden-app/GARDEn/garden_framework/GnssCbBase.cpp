...
=============================================================================*/
#define LOG_TAG "GARDEN_GnssCbBase"
...
void GnssCbBase::gnssLocationCb(const Location& location) {
...
void GnssCbBase::gnssSvStatusCb(const GnssSvNotification& svNotify) {
...
void GnssCbBase::gnssMeasurementsCb(
        const GnssMeasurementsNotification& gnssMeasurementsNotification) {
    gardenPrint("## %s]: () Number of Measurements: %d ##", __FUNCTION__,
            gnssMeasurementsNotification.count);
}

void GnssCbBase::gnssDataCb(const GnssDataNotification& dataNotify) {
...
void GnssCbBase::gnssNiNotifyCb(uint32_t id, const GnssNiNotification& notification) {
    GnssConfig data;
