...
GnssMultiClientLocationAPIClient::~GnssMultiClientLocationAPIClient() {
    lock_guard<std::mutex> lock(mGnssLock);
    if (mControlClient) {
...
void GnssMultiClientLocationAPIClient::onTrackingCb(const Location& location) {
...
void GnssMultiClientLocationAPIClient::onGnssNiCb(uint32_t id,
        const GnssNiNotification& gnssNiNotification) {
...
void GnssMultiClientLocationAPIClient::onGnssSvCb(const GnssSvNotification& gnssSvNotification) {
...
void GnssMultiClientLocationAPIClient::onCapabilitiesCb(LocationCapabilitiesMask capabilitiesMask) {
    LOC_LOGd("capabs: (0x%" PRIx64")", capabilitiesMask);
