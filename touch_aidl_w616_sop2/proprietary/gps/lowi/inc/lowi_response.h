...
public:
 ...
 /** true if single-sided ranging is supported */
  ...
  uint32 supportedCapsWigig;
    ...
    /** true if 11AZ NTB ranging is supported */
  bool isNtbSupp;

  /** true if 11AZ TB ranging is supported */
  bool isTbSupp;

  /** true if 11AZ MAC Security is supported */
  bool isMacSecSupp;

  /** true if 11AZ PHY Security is supported */
  bool isPhySecSupp;
...
/** This struct will hold any configuration from
  * controller to Wifidriver class.
  */
struct contConfig
{
  int32 user_6ghz_cfgs;
