...
enum QDgnssDataSource {
    ...
    /** External source injector 1 */
    CDFW_DATA_SOURCE_EXTERNAL = 3
};
...
enum QDgnssInjectDataPrecision {
    /** Inject data precision is unknown */
    CDFW_PRECISION_UNKNOWN                  = 0,
    /** Inject data precision is eDgnss(meter level) */
    CDFW_PRECISION_EDGNSS                   = 1,
    /** Inject data precision is RTK(decimeter level)*/
    CDFW_PRECISION_RTK                      = 2
};
