/******************************************************************************
    Copyright (c) 2007-2011, 2014, 2016, 2018-2022 Qualcomm Technologies, Inc.
    All Rights Reserved.
...
/** Major File Version */
#define EP_LOG_INTERFACE_FILE_MAJOR_VERSION  2
/** Minor File Version */
#define EP_LOG_INTERFACE_FILE_MINOR_VERSION  0

/* Engine Msg callback */
#define EP_1C54_DIAG_VERSION 3
/* Measurement msg Diag version*/
#define EP_1C5E_DIAG_VERSION 9
/* EP correction data version*/
#define EP_1C86_DIAG_VERSION 2
/* EPH Info Diag Version*/
#define EP_1C7B_DIAG_VERSION 7
/* PVT Diag MSG*/
#define EP_1C5B_DIAG_VERSION 13
/* IONO Params Info Diag Version*/
#define EP_1C8B_DIAG_VERSION 3
/* GLO ADD Params Info Diag Version*/
#define EP_1C8C_DIAG_VERSION 3
/* Control command Version*/
#define EP_1C56_DIAG_VERSION 5
/* Subscription info */
#define EP_1C57_DIAG_VERSION 5
/* Error info */
#define EP_1C58_DIAG_VERSION 2
/* Report status response Error info */
#define EP_1CBC_DIAG_VERSION 1
/* QWES data info */
#define EP_1CDA_DIAG_VERSION 2
...
/** BEIDOU B2A_Q RF Band - Pilot*/
#define EP_DIAG_GNSS_SIGNAL_BEIDOU_B2A_Q    ((epDiagGnssSignalTypeMask)0x00040000)
/**BEIDOU B2B_I RF Band - Data*/
#define EP_DIAG_GNSS_SIGNAL_BEIDOU_B2B_I    ((epDiagGnssSignalTypeMask)0x00080000)
/**BEIDOU B2B_Q RF Band - */
#define EP_DIAG_GNSS_SIGNAL_BEIDOU_B2B_Q    ((epDiagGnssSignalTypeMask)0x00100000)
...
#define EP_DIAG_GNSS_MAX_MEAS                  100

#define EP_DIAG_TRIANGLE_COV_MATRIX_SIZE       (12)

/** Max number of GNSS SV measurement usage */
#define EP_DIAG_GNSS_MAX_MEAS_USAGE            144
...
TYPEDEF_PACKED_STRUCT {
   ...
   */
    ...
    float intraSystemTimeBias3;

    float intraSystemTimeBias3Unc;
...
/** Different Ephemeris sources  */
typedef enum {
    /** ephemeris is from EFS (external file system) */
    EP_DIAG_EPH_SRC_EFS = 1,
    /** OTHER source of ephemeris(Not from EFS) */
    EP_DIAG_EPH_SRC_OTHER
} epDiagEphDataSource;
...
TYPEDEF_PACKED_STRUCT {
    ...
    /** source of Ephemeris
        Mandatory Field */
    epDiagEphDataSource ephDataSource;
...
/** Position Report uses vehicular data*/
#define EP_DIAG_POSITION_FLAG_VEH              ((epDiagPositionFlags)0x00001000)
/** Position Report uses visual data*/
#define EP_DIAG_POSITION_FLAG_VIS              ((epDiagPositionFlags)0x00002000)
...
TYPEDEF_PACKED_STRUCT {
    ...
    uint64_t isIntegrityRiskUsedValid: 1;
    uint64_t isProtectAlongTrackValid: 1;
    uint64_t isProtectCrossTrackValid: 1;
    uint64_t isProtectVerticalValid: 1;
    uint64_t : 15;
...
/** Position source is Visual Positioning Engine */
#define EP_DIAG_POSITION_SOURCE_VPE     ((epDiagPVTSourceType)0x04)
...
TYPEDEF_PACKED_STRUCT {
    ...
    epDiagMeasUsageInfo measUsageInfo[EP_DIAG_GNSS_MAX_MEAS_USAGE];
    ...
    */
    float upperTriangleFullCovMatrix[EP_DIAG_TRIANGLE_COV_MATRIX_SIZE];
    /** Integrity risk used for protection level parameters
        Unit of 2.5e-10. Valid range is 1 to 4e9-1. Other values will
        disable the Integrity Risk.
    */
    uint32_t integrityRiskUsed;
    /** Along-track protection level at specified integrity risk
        Unit: meter
    */
    float    protectAlongTrack;
    /** Cross-track protection level at specified integrity risk
        Unit: meter
    */
    float    protectCrossTrack;
    /** Vertical component protection level at specified integrity risk
        Unit: meter
    */
...
typedef enum {
   ...
   /** Set Integrity Risk in the engine */
    EP_DIAG_COMMAND_SET_INTEGRITY_RISK,
    /** Request the position engine to be put into pause state */
    EP_DIAG_COMMAND_PAUSE,
    /** Request the position engine to be put into resume state. */
    EP_DIAG_COMMAND_RESUME
} epDiagCommandType;
...
/** Set Integrity Risk command parameters  */
TYPEDEF_PACKED_STRUCT {
    /** Integrity risk level used for protection level calculation.
        The integrity risk is defined as a probability per epoch,
        in unit of 2.5e-10 (the actual integrity risk value is in
        the range of [2.5e-10, 1-2.5e-10]).
        If value of integrityRisk is NOT in the range of [1, 4e9-1],
        the PPE shall disable/invalidate the protection levels in the PVT report.
        Range:[1, 4e9-1] units
        Resolution: 2.5e-10 per unit
        Mandatory Field */
    uint32_t integrityRisk;
} epDiagSetIntegrityRiskStructType;
...
TYPEDEF_PACKED_STRUCT {
    ...
    union {
      ...
      /** Parameters for Set Integrity Risk command */
      epDiagSetIntegrityRiskStructType integrityRisk;
    } cmdReqParameter;
...
typedef uint8_t epDiagLicenseMsg;
/** epDiagLicenseInfo Msg type*/
typedef enum {
    /** query feature Status by Engine*/
    EP_FEATURE_STATUS_REQ = 1,
    /** Engine Request to Install License */
    EP_INSTALL_LICENSE_REQ = 3,
    /** provides feature Status to Engine*/
    EP_FEATURE_STATUS_RESP = 10,
    /** Provide status of Install License to Engine */
    EP_INSTALL_LICENSE_RESP = 12,
    /** get feature status from qwes*/
    EP_GET_FEATURE_STATUS_REQ = 30,
    /** get feature status from qwes*/
    EP_GET_FEATURE_STATUS_RESP = 31,
    /** Register for Sync callback */
    EP_SYNC_CB_REQ = 32,
    /** Sync callback response*/
    EP_SYNC_CB_RESP = 33
} epDiagLicenseMsgType;

TYPEDEF_PACKED_STRUCT {
    uint32_t lengthOfLicenseBuffer;
} epDiagRequestInstallLicenseReq;

typedef uint8_t epDiagFeatureStatus;
/** Feature status */
typedef enum {
    /** No license found */
    EP_DIAG_FEATURE_STATUS_NONE = 1,
    /** Valid license found */
    EP_DIAG_FEATURE_STATUS_OK,
    /** Expired license found */
    EP_DIAG_FEATURE_STATUS_EXPIRED
} epDiagFeatureStatusType;

typedef uint8_t epDiagLicenseType;
typedef enum {
   /** License type is unknown */
   EP_DIAG_LICENSE_UNDEFINED = 1,
   /** License type is Evaluation license */
   EP_DIAG_LICENSE_EVALUATION,
   /** License type is Commercial Production license */
   EP_DIAG_LICENSE_PRODUCTION
} epDiagLicenseTypeValue;

TYPEDEF_PACKED_STRUCT {
    epDiagFeatureStatus status;
    epDiagLicenseType licenseType;
} epDiagProvideFeatureStatusResp;

typedef uint8_t epDiagInstallLicenseStatus;
typedef enum {
    /** No license found */
    EP_DIAG_INSTALL_LICENSE_STATUS_NONE = 1,
    /** Valid license found */
    EP_DIAG_INSTALL_LICENSE_STATUS_OK,
    /** Invalid license Parameter
        Report this error to license server */
    EP_DIAG_ERROR_LICENSE_INVAILD_PARAMS,
    /** Invalid license Status
        Retry after reboot */
    EP_DIAG_ERROR_LICENSE_INVAILD_STATUS,
    /** Invalid license No Memory
        Retry after reboot */
    EP_DIAG_ERROR_LICENSE_NO_MEMORY,
    /** Expired license found
        Report this error to license server */
    EP_DIAG_ERROR_LICENSE_CERTIFICATE_EXPIRED,
    /** Incorrect OEM ID for License certificate
        Report this error to license server */
    EP_DIAG_ERROR_LICENSE_CERTIFICATE_OEM,
    /** Incorrect HW version for License certificate
        Report this error to license server */
    EP_DIAG_ERROR_LICENSE_CERTIFICATE_HWVERSION,
    /** Incorrect Device ID for License certificate
        Report this error to license server */
    EP_DIAG_ERROR_LICENSE_CERTIFICATE_DEVICEID,
    /** Incorrect PFM for License certificate
        Report this error to license server */
    EP_DIAG_ERROR_INVALID_PFM_EXTENSION,
    /** Incorrect PFMFILER for License certificate
        Retry after reboot */
    EP_DIAG_ERROR_PFMFILER_FAILD
} epDiagInstallLicenseStatusType;

TYPEDEF_PACKED_STRUCT {
    epDiagInstallLicenseStatus status;
} epDiagProvideInstallLicenseStatusResp;
...
TYPEDEF_PACKED_STRUCT {
    int32_t syncStatus;
} epDiagSyncRespStatus;

TYPEDEF_PACKED_STRUCT {
    epDiagLogGenericHeader header;
    epDiagLicenseMsg msgType; // refer epDiagLicenseMsgType
    union {
        /** msgType is set to EP_INSTALL_LICENSE_REQ */
        epDiagRequestInstallLicenseReq installLicenseReq;
        /** msgType is set to EP_FEATURE_STATUS_RESP */
        epDiagProvideFeatureStatusResp featureResp;
        /** msgType is set to EP_INSTALL_LICENSE_RESP */
        epDiagProvideInstallLicenseStatusResp installLicenseResp;
        /** msgType is set to EP_GET_FEATURE_STATUS_RESP*/
        epDiagProvideFeatureStatusResp getFeatureResp;
        /** msgType is set to EP_SYNC_CB_REQ */
        epDiagSyncRetVal syncRet;
        /** msgType is set to EP_SYNC_CB_RESP */
        epDiagSyncRespStatus syncRespStatus;
    } u;
} epDiagLicenseMsgInfo;
