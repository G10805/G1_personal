...
import vendor.qti.gnss.V4_3.ILocHidlWiFiDBReceiver.LocHidlApLocationData_4_3;
...
public class WiFiDBReceiver implements IzatService.ISystemEventListener {
    ...
    private WiFiDBReceiver(Context ctx) {
        ...
        if (LocIDLClientBase.getIDLServiceVersion().compareTo(IDLServiceVersion.V_AIDL) >= 0) {
            ...
            mIdlClient = new WiFiDBReceiverHidlClient(this);
        }
        if (null == mIdlClient) {
            Log.e(TAG, "WiFiDBReceiver construction fail: " + mIdlClient);
        }
    ...
    // ======================================================================
    // WiFiDBReceiver Java HIDL client
    // ======================================================================
    static class WiFiDBReceiverHidlClient extends WiFiDBReceiverIdlClient
        ...
        private void getWiFiDBReceiverIface() {
            if (null == mWiFiDBReceiverWrapper) {
                try {
                    ...
                    mWiFiDBReceiverWrapper = LocHidlWiFiDBReceiverWrapperFactory
                        .getWrapper(getIDLServiceVersion(), getGnssService());
            ...
            try {
                if (null != mWiFiDBReceiverWrapper) {
                    if (mVer.ordinal() >= IDLServiceVersion.V4_3.ordinal()) {
                        ArrayList<LocHidlApLocationData_4_3> apLocList =
                                new ArrayList<LocHidlApLocationData_4_3>();
                        for (APLocationData loc: locData) {
                            LocHidlApLocationData_4_3 apLoc = new LocHidlApLocationData_4_3();
                            apLoc.v1_0.mac_R48b = IDLClientUtils.hexMacToLong(loc.mMacAddress);
                            apLoc.v1_0.latitude = loc.mLatitude;
                            apLoc.v1_0.longitude = loc.mLongitude;
                            apLoc.v1_0.max_antenna_range = loc.mMaxAntenaRange;
                            apLoc.v1_0.horizontal_error = loc.mHorizontalError;
                            apLoc.v1_0.reliability = (byte) loc.mReliability;
                            apLoc.v1_0.valid_bits = (byte) loc.mValidBits;
                        ...
                        ((LocHidlWiFiDBReceiverWrapper43)mWiFiDBReceiverWrapper).
                            pushAPWiFiDB_4_3(apLocList, (short) apLocList.size(),
        ...
        // ======================================================================
        static class LocHidlWiFiDBReceiverWrapperFactory {
            private static final String TAG = "WiFiDBReceiverHIDLWrapperFactory";

            static LocHidlWiFiDBReceiverWrapper getWrapper(IDLServiceVersion idlVer,
                    vendor.qti.gnss.V1_0.ILocHidlGnss gnssService) {
                Log.i(TAG, "LocHidlWiFiDBReceiverWrapper ftry");
                LocHidlWiFiDBReceiverWrapper instance = null;

                if (null != gnssService) {
                    try {
                        if (idlVer.compareTo(IDLServiceVersion.V4_3) >= 0) {
                            Log.d(TAG, "LocHidlWiFiDBReceiverWrapper factory calling new 43");
                            vendor.qti.gnss.V4_3.ILocHidlWiFiDBReceiver wiFiDBReceiver =
                                ((vendor.qti.gnss.V4_3.ILocHidlGnss)gnssService)
                                .getExtensionLocHidlWiFiDBReceiver_4_3();
                            instance = new LocHidlWiFiDBReceiverWrapper43(wiFiDBReceiver);
        ...
        // ======================================================================
        // HIDL version 4.3 Wrapper
        // ======================================================================
        static class LocHidlWiFiDBReceiverWrapper43 extends LocHidlWiFiDBReceiverWrapper21 implements
            vendor.qti.gnss.V4_3.ILocHidlWiFiDBReceiver {

                public LocHidlWiFiDBReceiverWrapper43(ILocHidlWiFiDBReceiver wiFiDBReceiver)
                    throws RemoteException {
                        super(wiFiDBReceiver);
                    }

                public void pushAPWiFiDB_4_3(
                        ArrayList<LocHidlApLocationData_4_3> apLocList, short apLocListSize,
                        ArrayList<LocHidlApSpecialInfo> splList, short splListSize, int daysValid,
                        boolean isLookup) throws RemoteException {
                    ((vendor.qti.gnss.V4_3.ILocHidlWiFiDBReceiver)mWiFiDBReceiver).
                        pushAPWiFiDB_4_3(apLocList, apLocListSize,
                            splList, splListSize, daysValid, isLookup);
                }
            }
        ...
        class LocHidlWiFiDBReceiverCallback extends ILocHidlWiFiDBReceiverCallback.Stub {
            ...
            public void apListUpdateCallback_2_1(ArrayList<LocHidlApInfoExt> apInfoList,
                ...
                for (LocHidlApInfoExt apInfoHidl: apInfoList) {
                    ...
                    apInfo.mMacAddress =
                            IDLClientUtils.longMacToHex(apInfoHidl.base_apinfo_1_0.mac_R48b);
