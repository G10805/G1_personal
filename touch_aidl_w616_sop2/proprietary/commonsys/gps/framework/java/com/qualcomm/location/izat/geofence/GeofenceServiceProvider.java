...
public class GeofenceServiceProvider implements IzatService.ISystemEventListener {
    ...
    private GeofenceServiceProvider(Context ctx) {
        ...
        if (LocIDLClientBase.getIDLServiceVersion().compareTo(IDLServiceVersion.V_AIDL) >= 0) {
            ...
            mGeofenceServiceIdlClient = new GeofenceServiceHidlClient(this);
        }
     ...
     *   HIDL Client
     * =================================================*/
    private class GeofenceServiceHidlClient extends GeofenceServiceIdlClient
        ...
        private class GeofenceServiceCallback extends ILocHidlGeofenceServiceCallback.Stub {
            ...
            public void gnssGeofenceBreachCb(int count, ArrayList<Integer> idList,
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    Location locationObj = IDLClientUtils.translateHidlLocation(location);
