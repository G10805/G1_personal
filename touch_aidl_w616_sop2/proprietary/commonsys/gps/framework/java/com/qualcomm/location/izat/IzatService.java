...
public class IzatService extends Service {
    ...
    private GtpServiceProvider mGtpServiceProvider;
    ...
    public void onCreate() {
        ...
        sHandler = new Handler(IZatServiceContext.getInstance(mContext).getLooper());
        mSessionPolicyManager = new SessionPolicyManager(mContext);
        mQesdkTrackingServiceProvider =
                new QesdkTrackingServiceProvider(mContext, mSessionPolicyManager);
        mGtpServiceProvider =
    ...
    private final IIzatService.Stub mBinder = new IIzatService.Stub() {
        ...
        public IFlpService getFlpService() {
            if (mContext.checkCallingPermission(ACCESS_COARSE_LOCATION) !=
                ...
                throw new SecurityException("Requires COARSE_FINE_LOCATION permission");
            }
        ...
        public IGTPService getGTPService() {
            ...
            return mGtpServiceProvider.getGtpBinder();
        }
    };
