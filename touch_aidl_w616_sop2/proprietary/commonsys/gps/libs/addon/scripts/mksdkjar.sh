#!/bin/bash
#==========================================================================
# Copyright (c) 2013, 2015, 2017, 2020, 2022 Qualcomm Technologies, Inc.
# All Rights Reserved.
...
COMPILED_AIDL_CLASSES="$ANDROID_BUILD_TOP/out/soong/.intermediates/vendor/qcom/proprietary/commonsys/gps/libs/glue/izat.lib.glue/android_common/javac/classes"
COMPILED_SDK_CLASSES="$ANDROID_BUILD_TOP/out/soong/.intermediates/vendor/qcom/proprietary/commonsys/gps/libs/addon/com.qti.location.sdk/android_common/javac/classes"
