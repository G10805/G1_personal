...
public class IZatManager {
    ...
    private static final String SDK_Version = "12.0.0";
...
/** @cond */
            ...
            synchronized (sGtpServiceLock) {
                try {
                    ...
                    mService.requestLocationUpdates(
                            new GtpServiceCallbackWrapper(callback),
        ...
        public void requestPassiveLocationUpdates(IZatGtpServiceCallback callback) {
            synchronized (sGtpServiceLock) {
                try {
                    ...
                    mService.requestPassiveLocationUpdates(new GtpServiceCallbackWrapper(callback));
                } catch (RemoteException e) {
                    throw new RuntimeException("Failed to stop passive network positioning");
                }
            }
        }
    ...
    public class IZatGnssConfigServicesImpl implements IZatGnssConfigServices {
        ...
        public synchronized IZatSvConfigService getSvConfigService() {
            if ((mFlpFeatureMasks & FEATURE_BIT_CONSTELLATION_ENABLEMENT_IS_SUPPORTED)>0) {
