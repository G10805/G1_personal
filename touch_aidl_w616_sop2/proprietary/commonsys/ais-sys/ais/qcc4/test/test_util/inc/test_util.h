...
///
/// @return qcarcam_color_fmt_t with corresponding qcarcam color format.
///////////////////////////////////////////////////////////////////////////////
qcarcam_color_fmt_t test_util_get_qcarcam_format(test_util_color_fmt_t fmt);
...
///////////////////////////////////////////////////////////////////////////////
qcarcam_ret_t test_util_init_post_processing(test_util_pp_ctxt_t *pProc,
...
/// @return qcarcam_ret_t
///////////////////////////////////////////////////////////////////////////////
qcarcam_ret_t test_util_deinit_post_processing(test_util_pp_ctxt_t *pProc);
...
/// @return qcarcam_ret_t
///////////////////////////////////////////////////////////////////////////////
qcarcam_ret_t test_util_post_processing_process_frame(test_util_pp_ctxt_t *pProc, pp_job_t *pJob);
...
/// @return qcarcam_ret_t
///////////////////////////////////////////////////////////////////////////////
qcarcam_ret_t test_util_create_c2d_surface_processing(test_util_ctxt_t *p_ctxt, test_util_window_t *p_window, unsigned int idx);
...
///////////////////////////////////////////////////////////////////////////////
test_util_color_fmt_t test_util_get_test_format(qcarcam_color_fmt_t fmt);
...
///
/// @return qcarcam_color_fmt_t
///////////////////////////////////////////////////////////////////////////////
qcarcam_color_fmt_t test_util_get_color_format_from_name(char *pString);
...
/// @return QCARCAM_RET_OK if successful
///////////////////////////////////////////////////////////////////////////////
int test_util_parse_xml_config_file(const char *filename, test_util_xml_input_t *inputs, unsigned int max_num_inputs, test_util_global_config_t *global_config);
...
/// @return QCARCAM_RET_OK if successful
///////////////////////////////////////////////////////////////////////////////
qcarcam_ret_t test_util_init_cl_converter(test_util_ctxt_t *p_ctxt,
                                          test_util_window_t *in_user_ctxt,
                                          test_util_window_t *out_user_ctxt,
                                          void* pConverter,
...
/// @return QCARCAM_RET_OK if successful
///////////////////////////////////////////////////////////////////////////////
qcarcam_ret_t test_util_deinit_cl_converter(void* csc_handle,
                                            ClConverter_surface_t* source_surface,
                                            ClConverter_surface_t* target_surface);
