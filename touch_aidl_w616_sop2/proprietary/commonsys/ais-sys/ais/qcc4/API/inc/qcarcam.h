...
#define QCARCAM_VERSION_MINOR              13
...
qcarcam_ret_t qcarcam_query_inputs_v2(qcarcam_input_v2_t* p_inputs, unsigned int size, unsigned int* ret_size);

///////////////////////////////////////////////////////////////////////////////
/// qcarcam_query_diagnostics
///
/// @brief Queries diagnostic info.
///
/// @param p_diag_info     Pointer to user allocated memory to store diagnostic info.
...
/// @return QCARCAM_RET_OK if successful
///////////////////////////////////////////////////////////////////////////////
qcarcam_ret_t qcarcam_s_buffers_v2(qcarcam_hndl_t hndl, qcarcam_bufferlist_t* p_bufferlist);
...
/// @return QCARCAM_RET_OK if successful; QCARCAM_RET_TIMEOUT if timeout
///////////////////////////////////////////////////////////////////////////////
qcarcam_ret_t qcarcam_get_frame_v2(qcarcam_hndl_t hndl, qcarcam_frame_info_v2_t* p_frame_info,
        unsigned long long int timeout, unsigned int flags);
...
/// @return QCARCAM_RET_OK if successful
///////////////////////////////////////////////////////////////////////////////
qcarcam_ret_t qcarcam_release_frame_v2(qcarcam_hndl_t hndl, unsigned int id, unsigned int idx);
