...
class VideoTex final : public TexWrapper {
    friend VideoTex* createVideoTexture(
            ...
            EGLDisplay glDisplay, const uint32_t uiStreamId, bool useExternalMemory, android_pixel_format_t format);
...
VideoTex* createVideoTexture(
        ...
        std::unique_ptr<aidl::android::hardware::automotive::evs::Stream> streamCfg,
        EGLDisplay glDisplay, const uint32_t uiStreamId, bool useExternalMemory = false,
