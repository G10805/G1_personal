...
LOCAL_INIT_RC := evs_qcx_app.rc

LOCAL_MODULE:= evs_qcx_app
...
include $(CLEAR_VARS)
LOCAL_MODULE := config_qcarcam_qcx.json
...
include $(CLEAR_VARS)
LOCAL_MODULE := LabeledChecker_qcar_qcx.png
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/automotive/evs
...
include $(CLEAR_VARS)
LOCAL_MODULE := CarFromTop_qcar_qcx.png
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/automotive/evs
...
include $(CLEAR_VARS)
LOCAL_MODULE := evs_qcx_app_default_resources
LOCAL_REQUIRED_MODULES := \
    CarFromTop_qcar_qcx.png \
    LabeledChecker_qcar_qcx.png \
    config_qcarcam_qcx.json
