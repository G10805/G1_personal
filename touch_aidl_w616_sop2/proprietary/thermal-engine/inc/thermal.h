/*===========================================================================
  ...
  Copyright (c) 2010-2018, 2021,2023 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
#define TZ_CONFIG "/sys/kernel/debug/thermal/config"
#define TZ_DIR_FMT "thermal_zone%d"
#define THERMAL_TYPE "/sys/class/thermal/%s/type"
#define THERMAL_CDEV_TYPE "/sys/class/thermal/%s/cdev%d/type"
...
extern struct thermal_zone_list tz_list;
...
int modem_bw_backoff_request(int level);
...
static inline int modem_bw_backoff_request(int level)
{
	return -(EFAULT);
}
...
typedef void (*nl_trip_cb)(int tz_id, int trip_id, bool trip_up, void *data);
typedef void (*nl_temp_sample_cb)(int tz_id, int temp, void *data);
...
static inline int thermal_nl_register_temp_sample(nl_temp_sample_cb cb, void *data)
{
	return -1;
}
#endif
