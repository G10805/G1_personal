...
// clang-format off
/*
$Header: //components/rel/gpr.common/1.0/core/src/array_based/gpr_session_island.c#1 $
*/
// clang-format on
...
*/
GPR_INTERNAL uint32_t gpr_get_session(uint32_t my_port, gpr_module_entry_t **ret_entry, gpr_module_node_list_t *list_handle)
{
   if(NULL == list_handle)
   {
      return AR_EFAILED;
