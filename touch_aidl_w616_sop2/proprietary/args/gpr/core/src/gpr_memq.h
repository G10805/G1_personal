...
// clang-format off
/*
$Header: //components/rel/gpr.common/1.0/core/src/gpr_memq.h#8 $
*/
// clang-format on
...
GPR_EXTERNAL void gpr_memq_free (
  gpr_memq_block_t* block,
  void* mem_ptr
);

GPR_EXTERNAL uint32_t gpr_memq_node_set_metadata (
  gpr_memq_block_t* block,
  void* mem_ptr,
  uint32_t index,
  int32_t value
...
GPR_EXTERNAL uint32_t gpr_memq_node_get_metadata (
  gpr_memq_block_t* block,
  void* mem_ptr,
  uint32_t index,
  int32_t* metadata
