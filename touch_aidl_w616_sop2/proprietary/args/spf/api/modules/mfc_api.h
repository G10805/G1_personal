...
/*# @h2xmlp_parameter   {"PARAM_ID_MFC_RESAMPLER_CFG",
    ...
    @h2xmlp_description {ID for the parameter that configures the resampler in
                         ...
                         resampler or FIR resampler.
                         For an FIR resampler, clients can set additional FIR
                         resampler configuration fields.}
...
struct param_id_mfc_resampler_cfg_t
{
   ...
   /**< Specifies the type of resampler to use.
        ...
        If FIR is selected, the use_hw_rs, dynamic_mode, and delay_type fields
        are applicable, and they are cached and used. */

   /*#< @h2xmle_description {Specifies the resampler type to be used in MFC. \n
                             If IIR is selected, the use_hw_rs, dynamic_mode,
                             and delay_type fields are not applicable and are
                             ignored. \n
                             If FIR is selected, these fields are applicable,
   ...
   /*#< @h2xmle_description {Specifies whether to use the hardware or software
                             resampler for the FIR resampler. \n
                             ...
                             fields are saved and used. \n
                             For more details, see the AudioReach Module
                             User Guide (80-VN500-4).}
