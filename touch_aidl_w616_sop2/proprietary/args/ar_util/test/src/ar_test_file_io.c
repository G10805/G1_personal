...
void ar_test_file_read_only(void)
{
	int32_t status = AR_EOK;
	ar_fhandle fhandle = NULL;
	size_t bytes_read = 0;
...
void ar_test_file_write_only(void)
{
	int32_t status = AR_EOK;
	size_t bytes_read = 0;
	char_t data_read[50] = { 0 };
...
void ar_test_file_write_only_append(void)
{
	int32_t status = AR_EOK;
	size_t bytes_read = 0;
...
void ar_test_file_read_write_append(void)
{
	int32_t status = AR_EOK;
	size_t bytes_read = 0;
...
void ar_test_file_read_only_write(void)
{
...
void ar_test_file_read_write(void)
{
	int32_t status = AR_EOK;
	ar_fhandle fhandle = NULL;
	size_t fsize = 0;
