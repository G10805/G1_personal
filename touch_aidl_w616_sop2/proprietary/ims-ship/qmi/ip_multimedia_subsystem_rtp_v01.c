...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Mon Jul 25 2022 (Spin 0)
...
static const uint8_t imsrtp_media_stage_type_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsrtp_media_stage_type_v01, media_stage),

  QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(imsrtp_media_stage_type_v01, dyn_cfg_id),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t imsrtp_media_proxy_sub_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsrtp_media_proxy_sub_v01, rat),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsrtp_media_proxy_sub_v01, app_id),
...
static const uint8_t imsrtp_session_initialize_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(imsrtp_session_initialize_req_msg_v01, evs_config2_type) - QMI_IDL_OFFSET16RELATIVE(imsrtp_session_initialize_req_msg_v01, evs_config2_type_valid)),
  0x35,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(imsrtp_session_initialize_req_msg_v01, evs_config2_type),
  QMI_IDL_TYPE88(0, 12),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(imsrtp_session_initialize_req_msg_v01, media_proxy) - QMI_IDL_OFFSET16RELATIVE(imsrtp_session_initialize_req_msg_v01, media_proxy_valid)),
  0x36,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(imsrtp_session_initialize_req_msg_v01, media_proxy),
  QMI_IDL_TYPE88(0, 19)
};
...
static const uint8_t imsrtp_session_configure_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(imsrtp_session_configure_req_msg_v01, video_render_outsync) - QMI_IDL_OFFSET16RELATIVE(imsrtp_session_configure_req_msg_v01, video_render_outsync_valid)),
  0x42,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(imsrtp_session_configure_req_msg_v01, video_render_outsync),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(imsrtp_session_configure_req_msg_v01, media_stage_info) - QMI_IDL_OFFSET16RELATIVE(imsrtp_session_configure_req_msg_v01, media_stage_info_valid)),
  0x43,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(imsrtp_session_configure_req_msg_v01, media_stage_info),
  QMI_IDL_TYPE88(0, 18)
};
...
static const uint8_t imsrtp_set_handoff_status_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_set_handoff_status_req_msg_v01, handoff_cmd) - QMI_IDL_OFFSET8(imsrtp_set_handoff_status_req_msg_v01, handoff_cmd_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsrtp_set_handoff_status_req_msg_v01, handoff_cmd),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_set_handoff_status_req_msg_v01, media_proxy) - QMI_IDL_OFFSET8(imsrtp_set_handoff_status_req_msg_v01, media_proxy_valid)),
  0x11,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(imsrtp_set_handoff_status_req_msg_v01, media_proxy),
  QMI_IDL_TYPE88(0, 19)
};
...
static const uint8_t imsrtp_red_capability_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_capability_req_msg_v01, app_id),

  0x02,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_capability_req_msg_v01, call_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x03,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_capability_req_msg_v01, red_version_modem)
};

static const uint8_t imsrtp_red_capability_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(imsrtp_red_capability_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  0x03,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_capability_resp_msg_v01, app_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x04,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_capability_resp_msg_v01, call_id)
};

static const uint8_t imsrtp_red_capability_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, app_id),

  0x02,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, call_id),

  0x03,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, red_version_hlos),

  0x04,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, is_media_redundancy_enabled),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, is_media_quality_check_enabled) - QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, is_media_quality_check_enabled_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, is_media_quality_check_enabled),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, rsrp_start_threshold_lte) - QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, rsrp_start_threshold_lte_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, rsrp_start_threshold_lte),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, rsrp_stop_threshold_lte) - QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, rsrp_stop_threshold_lte_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, rsrp_stop_threshold_lte),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, rsrp_start_threshold_nr) - QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, rsrp_start_threshold_nr_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, rsrp_start_threshold_nr),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, rsrp_stop_threshold_nr) - QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, rsrp_stop_threshold_nr_valid)),
  0x14,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_capability_ind_msg_v01, rsrp_stop_threshold_nr)
};

static const uint8_t imsrtp_red_update_status_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_update_status_req_msg_v01, app_id),

  0x02,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_update_status_req_msg_v01, call_id),

  0x03,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_update_status_req_msg_v01, status),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_red_update_status_req_msg_v01, reason) - QMI_IDL_OFFSET8(imsrtp_red_update_status_req_msg_v01, reason_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_update_status_req_msg_v01, reason),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_red_update_status_req_msg_v01, remote_public_ip) - QMI_IDL_OFFSET8(imsrtp_red_update_status_req_msg_v01, remote_public_ip_valid)),
  0x11,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(imsrtp_red_update_status_req_msg_v01, remote_public_ip),
  QMI_IDL_TYPE88(0, 7),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_red_update_status_req_msg_v01, remote_public_port) - QMI_IDL_OFFSET8(imsrtp_red_update_status_req_msg_v01, remote_public_port_valid)),
  0x12,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_update_status_req_msg_v01, remote_public_port)
};

static const uint8_t imsrtp_red_update_status_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(imsrtp_red_update_status_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_red_update_status_resp_msg_v01, app_id) - QMI_IDL_OFFSET8(imsrtp_red_update_status_resp_msg_v01, app_id_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_update_status_resp_msg_v01, app_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_red_update_status_resp_msg_v01, call_id) - QMI_IDL_OFFSET8(imsrtp_red_update_status_resp_msg_v01, call_id_valid)),
  0x11,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_update_status_resp_msg_v01, call_id)
};

static const uint8_t imsrtp_red_start_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_start_ind_msg_v01, app_id),

  0x02,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_start_ind_msg_v01, call_id),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_red_start_ind_msg_v01, local_public_ip) - QMI_IDL_OFFSET8(imsrtp_red_start_ind_msg_v01, local_public_ip_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(imsrtp_red_start_ind_msg_v01, local_public_ip),
  QMI_IDL_TYPE88(0, 7),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_red_start_ind_msg_v01, local_public_port) - QMI_IDL_OFFSET8(imsrtp_red_start_ind_msg_v01, local_public_port_valid)),
  0x11,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_start_ind_msg_v01, local_public_port)
};

static const uint8_t imsrtp_red_stop_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_stop_ind_msg_v01, app_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(imsrtp_red_stop_ind_msg_v01, call_id)
};
...
static const qmi_idl_type_table_entry  imsrtp_type_table_v01[] = {
  ...
  {sizeof(imsrtp_media_stage_type_v01), imsrtp_media_stage_type_data_v01},
  {sizeof(imsrtp_media_proxy_sub_v01), imsrtp_media_proxy_sub_data_v01},
...
static const qmi_idl_message_table_entry imsrtp_message_table_v01[] = {
  ...
  {sizeof(imsrtp_red_capability_req_msg_v01), imsrtp_red_capability_req_msg_data_v01},
  {sizeof(imsrtp_red_capability_resp_msg_v01), imsrtp_red_capability_resp_msg_data_v01},
  {sizeof(imsrtp_red_capability_ind_msg_v01), imsrtp_red_capability_ind_msg_data_v01},
  {sizeof(imsrtp_red_update_status_req_msg_v01), imsrtp_red_update_status_req_msg_data_v01},
  {sizeof(imsrtp_red_update_status_resp_msg_v01), imsrtp_red_update_status_resp_msg_data_v01},
  {sizeof(imsrtp_red_start_ind_msg_v01), imsrtp_red_start_ind_msg_data_v01},
  {sizeof(imsrtp_red_stop_ind_msg_v01), imsrtp_red_stop_ind_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry imsrtp_service_command_messages_v01[] = {
  ...
  {QMI_IMSRTP_SESSION_INITIALIZE_REQ_V01, QMI_IDL_TYPE16(0, 6), 2092},
  {QMI_IMSRTP_SESSION_UNINITIALIZE_REQ_V01, QMI_IDL_TYPE16(0, 9), 8},
  {QMI_IMSRTP_SESSION_CONFIGURE_REQ_V01, QMI_IDL_TYPE16(0, 12), 2007},
  ...
  {QMI_IMSRTP_SET_HANDOFF_STATUS_REQ_V01, QMI_IDL_TYPE16(0, 82), 33},
  {QMI_IMSRTP_RX_DEALY_REQ_V01, QMI_IDL_TYPE16(0, 23), 9},
  {QMI_IMSRTP_RED_CAPABILITY_REQ_V01, QMI_IDL_TYPE16(0, 84), 14},
  {QMI_IMSRTP_RED_UPDATE_STATUS_REQ_V01, QMI_IDL_TYPE16(0, 87), 76}
};
...
static const qmi_idl_service_message_table_entry imsrtp_service_response_messages_v01[] = {
  ...
  {QMI_IMSRTP_RED_CAPABILITY_RESP_V01, QMI_IDL_TYPE16(0, 85), 16},
  {QMI_IMSRTP_RED_UPDATE_STATUS_RESP_V01, QMI_IDL_TYPE16(0, 88), 16}
};
...
static const qmi_idl_service_message_table_entry imsrtp_service_indication_messages_v01[] = {
  ...
  {QMI_IMSRTP_RED_CAPABILITY_IND_V01, QMI_IDL_TYPE16(0, 86), 38},
  {QMI_IMSRTP_RED_START_IND_V01, QMI_IDL_TYPE16(0, 89), 62},
  {QMI_IMSRTP_RED_STOP_IND_V01, QMI_IDL_TYPE16(0, 90), 9}
};
