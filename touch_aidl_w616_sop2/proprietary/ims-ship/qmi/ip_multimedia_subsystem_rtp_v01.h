...
#define IMSRTP_V01_IDL_MINOR_VERS 0x27
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define IMSRTP_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define IMSRTP_V01_MAX_MESSAGE_ID 0x004B
/**
    @}
  */
...
/**  RTCP report bitmask type. Indicates the type of RTCP report.
 */
...
typedef enum {
  ...
  IMSRTP_DCM_RAT_TDSCDMA_V01 = 14, /**<  TDSCDMA  */
  IMSRTP_DCM_RAT_CIWLAN_V01 = 15, /**<  CIWLAN.  */
...
/** @addtogroup imsrtp_qmi_enums
  ...
  */
typedef enum {
  IMSRTP_HANDOFF_CMD_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  IMS_RTP_CMD_UPDATE_HANDOFF_STATUS_V01 = 0, /**<  Update handoff status */
  IMS_RTP_CMD_CIWLAN_UPDATE_PROXY_V01 = 1, /**<  Update CIWLAN underlying rat */
  IMSRTP_HANDOFF_CMD_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}imsrtp_handoff_cmd_type_v01;
/**
    @}
  */
...
/** @addtogroup imsrtp_qmi_enums
  ...
  */
typedef enum {
  IMSRTP_RED_STATUS_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  IMS_RTP_RED_STATUS_ERROR_V01 = 0x00, /**<  Error status \n  */
  IMS_RTP_RED_STATUS_READY_V01 = 0x01, /**<  Ready for UL audio redundancy \n  */
  IMS_RTP_RED_STATUS_STARTED_V01 = 0x02, /**<  UL audio redundancy started \n  */
  IMS_RTP_RED_STATUS_STOPPED_V01 = 0x03, /**<  UL audio redundancy stopped \n  */
  IMS_RTP_RED_STATUS_RX_INACTIVITY_V01 = 0x04, /**<  DL audio redundancy inactivity detected \n  */
  IMS_RTP_RED_STATUS_RX_PT_MISMATCH_V01 = 0x05, /**<  DL audio redundancy payload type mismatch \n  */
  IMS_RTP_RED_STATUS_INVALID_V01 = 255, /**<  Invalid status \n  */
  IMSRTP_RED_STATUS_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}imsrtp_red_status_enum_v01;
/**
    @}
  */
...
/** @addtogroup imsrtp_qmi_enums
  ...
  */
typedef enum {
  IMSRTP_RED_REASON_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  IMS_RTP_RED_REASON_INVALID_V01 = 0x00, /**<  Invalid status \n  */
  IMS_RTP_RED_REASON_EXIT_CRITERIA_MET_V01 = 0x01, /**<  Modem exit criteria met \n  */
  IMS_RTP_RED_REASON_CALL_HELD_V01 = 0x02, /**<  Call put on hold \n  */
  IMS_RTP_RED_REASON_CLIENT_REQUESTED_V01 = 0x03, /**<  Due to client request \n  */
  IMS_RTP_RED_REASON_PRE_CHECK_FAILURE_V01 = 0x04, /**<  redundancy pre-check failure \n  */
  IMS_RTP_RED_REASON_WIFI_DISABLED_V01 = 0x05, /**<  Due to WiFi turned off \n  */
  IMSRTP_RED_REASON_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}imsrtp_red_reason_enum_v01;
/**
    @}
  */
...
/** @addtogroup imsrtp_qmi_enums
  ...
  */
typedef enum {
  IMSRTP_STAGE_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  IMS_RTP_STAGE_INVALID_V01 = 0, /**<  Invalid media stage */
  IMS_RTP_STAGE_EARLY_MEDIA_V01 = 1, /**<  Early media stage */
  IMS_RTP_STAGE_CALL_CONNECTED_V01 = 2, /**<  Call connected stage */
  IMSRTP_STAGE_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}imsrtp_stage_type_v01;
/**
    @}
  */
...
/** @addtogroup imsrtp_qmi_aggregates
  ...
  */
/**  DCM RAT type.
 DCM profile IP address type.
 APN type.
 First packet indication type.
 Hand off cmd type.
 Enumeration for audio redundancy status.
 Enumeration for reason for audio redundancy status.
 Media stage type.
 Media stage info structure
 */
typedef struct {

  imsrtp_stage_type_v01 media_stage;
  /**<   Indicate the media is in early dialog stage or connected stage*/

  uint16_t dyn_cfg_id;
  /**<   Indicate the dynamic configure index in qipcall configures.*/
}imsrtp_media_stage_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  imsrtp_dcm_rat_type_v01 rat;
  /**<   underlying rat which is used*/

  uint8_t app_id;
  /**<   rtp handle correspoding to underlying subscriptions*/
}imsrtp_media_proxy_sub_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Radio access technology associated with this profile. \begin{itemize1}
       ...
       \item IMSRTP_DCM_RAT_TDSCDMA -- TDSCDMA
       \item IMSRTP_DCM_RAT_CIWLAN -- CIWLAN
       \end{itemize1}
  ...
  */
  ...
  /* Optional */
  /*  Underlying RAT Type */
  uint8_t media_proxy_valid;  /**< Must be set to true if media_proxy is being passed */
  imsrtp_media_proxy_sub_v01 media_proxy;
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Media stage info of current active call. */
  uint8_t media_stage_info_valid;  /**< Must be set to true if media_stage_info is being passed */
  imsrtp_media_stage_type_v01 media_stage_info;
  /**<   Indicate the media is in early dialog stage or connected stage.
       If in early media stage, get the dynamic configure index.
  */
 ...
 */
  ...
  /* Optional */
  /*  Application Identifier */
  uint8_t handoff_cmd_valid;  /**< Must be set to true if handoff_cmd is being passed */
  imsrtp_handoff_cmd_type_v01 handoff_cmd;
  /**<   update handoff status or update CIWLAN proxy.*/
...
/** @addtogroup imsrtp_qmi_messages
    @{
  */
/** Request Message; To set audio redundancy capability */
typedef struct {
  ...
  /*  Call Identifier */
  uint16_t call_id;
  /**<   Unique identifier for the Call that both HLOS and Modem aware of. */

  /* Mandatory */
  /*  Media Redundancy Version */
  uint16_t red_version_modem;
  /**<   Identifier to indicate the version of media redundancy supported on modem side. */
}imsrtp_red_capability_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imsrtp_qmi_messages
    @{
  */
/** Response Message; To set audio redundancy capability */
typedef struct {
  ...
  uint16_t call_id;
  /**<   Unique identifier for the Call that both HLOS and Modem aware of. */
}imsrtp_red_capability_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imsrtp_qmi_messages
    @{
  */
/** Indication Message; To set audio redundancy capability */
typedef struct {
  ...
  /* Mandatory */
  /*  Media Redundancy Version */
  uint16_t red_version_hlos;
  /**<   Identifier to indicate the version of media redundancy supported on apps side. */

  /* Mandatory */
  /*  Media Redundancy Flag */
  uint8_t is_media_redundancy_enabled;
  /**<   Flag to indicate if audio redundancy is to be enabled for the call. */

  /* Optional */
  /*  Media Quality Check Flag */
  uint8_t is_media_quality_check_enabled_valid;  /**< Must be set to true if is_media_quality_check_enabled is being passed */
  uint8_t is_media_quality_check_enabled;
  /**<   Flag to indicate if media quality based check is enabled for the redundancy. */

  /* Optional */
  /*  Start rsrp threshold for LTE */
  uint8_t rsrp_start_threshold_lte_valid;  /**< Must be set to true if rsrp_start_threshold_lte is being passed */
  int8_t rsrp_start_threshold_lte;
  /**<   Unique identifier for the Call that both HLOS and Modem aware of. */

  /* Optional */
  /*  Stop rsrp threshold for LTE */
  uint8_t rsrp_stop_threshold_lte_valid;  /**< Must be set to true if rsrp_stop_threshold_lte is being passed */
  int8_t rsrp_stop_threshold_lte;
  /**<   Unique identifier for the Call that both HLOS and Modem aware of. */

  /* Optional */
  /*  Start rsrp threshold for NR */
  uint8_t rsrp_start_threshold_nr_valid;  /**< Must be set to true if rsrp_start_threshold_nr is being passed */
  int8_t rsrp_start_threshold_nr;
  /**<   Unique identifier for the Call that both HLOS and Modem aware of. */

  /* Optional */
  /*  Stop rsrp threshold for NR */
  uint8_t rsrp_stop_threshold_nr_valid;  /**< Must be set to true if rsrp_stop_threshold_nr is being passed */
  int8_t rsrp_stop_threshold_nr;
  /**<   Unique identifier for the Call that both HLOS and Modem aware of. */
}imsrtp_red_capability_ind_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  /*  Redundancy Status Type */
  imsrtp_red_status_enum_v01 status;
  /**<   Audio redundancy status.

 Valid values: \n
      - IMS_RTP_RED_STATUS_ERROR (0x00) --  Error status \n
      - IMS_RTP_RED_STATUS_READY (0x01) --  Ready for UL audio redundancy \n
      - IMS_RTP_RED_STATUS_STARTED (0x02) --  UL audio redundancy started \n
      - IMS_RTP_RED_STATUS_STOPPED (0x03) --  UL audio redundancy stopped \n
      - IMS_RTP_RED_STATUS_RX_INACTIVITY (0x04) --  DL audio redundancy inactivity detected \n
      - IMS_RTP_RED_STATUS_RX_PT_MISMATCH (0x05) --  DL audio redundancy payload type mismatch \n
      - IMS_RTP_RED_STATUS_INVALID (255) --  Invalid status \n
 */

  /* Optional */
  /*  Reason for audio redundancy status */
  uint8_t reason_valid;  /**< Must be set to true if reason is being passed */
  imsrtp_red_reason_enum_v01 reason;
  /**<   Reason for audio redundancy status.

 Valid values: \n
      - IMS_RTP_RED_REASON_INVALID (0x00) --  Invalid status \n
      - IMS_RTP_RED_REASON_EXIT_CRITERIA_MET (0x01) --  Modem exit criteria met \n
      - IMS_RTP_RED_REASON_CALL_HELD (0x02) --  Call put on hold \n
      - IMS_RTP_RED_REASON_CLIENT_REQUESTED (0x03) --  Due to client request \n
      - IMS_RTP_RED_REASON_PRE_CHECK_FAILURE (0x04) --  redundancy pre-check failure \n
      - IMS_RTP_RED_REASON_WIFI_DISABLED (0x05) --  Due to WiFi turned off \n
 */

  /* Optional */
  /*  Remote Public IP Address */
  uint8_t remote_public_ip_valid;  /**< Must be set to true if remote_public_ip is being passed */
  imsrtp_ip_addr_type_v01 remote_public_ip;
  /**<   Remote Public IP. */

  /* Optional */
  /*  Remote Public Port */
  uint8_t remote_public_port_valid;  /**< Must be set to true if remote_public_port is being passed */
  uint16_t remote_public_port;
  /**<   Remote public port. */
}imsrtp_red_update_status_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  uint16_t call_id;
  /**<   Unique identifier for the Call that both HLOS and Modem aware of. */
}imsrtp_red_update_status_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imsrtp_qmi_messages
    @{
  */
/** Indication Message; Indicates reception of start command to the client on the modem. */
typedef struct {
  ...
  uint8_t local_public_ip_valid;  /**< Must be set to true if local_public_ip is being passed */
  imsrtp_ip_addr_type_v01 local_public_ip;
  /**<   Local Public IP. */

  /* Optional */
  /*  Local Public Port */
  uint8_t local_public_port_valid;  /**< Must be set to true if local_public_port is being passed */
  uint16_t local_public_port;
  /**<   Local public port. */
}imsrtp_red_start_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup imsrtp_qmi_messages
    @{
  */
/** Indication Message; Indicates reception of stop command to the client on the modem. */
typedef struct {
  ...
  uint16_t call_id;
  /**<   Unique identifier for the Call that both HLOS and Modem aware of. */
}imsrtp_red_stop_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_IMSRTP_RED_CAPABILITY_V01
//#define REMOVE_QMI_IMSRTP_RED_START_IND_V01
//#define REMOVE_QMI_IMSRTP_RED_STOP_IND_V01
//#define REMOVE_QMI_IMSRTP_RED_UPDATE_STATUS_V01
...
#define QMI_IMSRTP_RED_CAPABILITY_REQ_V01 0x0048
#define QMI_IMSRTP_RED_CAPABILITY_RESP_V01 0x0048
#define QMI_IMSRTP_RED_CAPABILITY_IND_V01 0x0048
#define QMI_IMSRTP_RED_UPDATE_STATUS_REQ_V01 0x0049
#define QMI_IMSRTP_RED_UPDATE_STATUS_RESP_V01 0x0049
#define QMI_IMSRTP_RED_START_IND_V01 0x004A
#define QMI_IMSRTP_RED_STOP_IND_V01 0x004B
/**
    @}
  */
