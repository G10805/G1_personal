...
class UtilFunctions:
    ...
    def get_platform_version():
      ...
      if (str(platform_version).isdigit()):
...
class Constants:
    ...
    vintf_mapping_pf_tl = {11 : 17, 10 : 16, 9 : 15, 8 : 14, 7 : 13, 6 : 12, 5 : 11, 4 : 10}
    ...
    ## qiifa_py2 or qiifa_py3 does not load the json path
    ...
    AIDL_SUPPORTED_CREATE_ARGS = ["aidl","aidl_one","aidl_new","aidl_lst_gen"]
