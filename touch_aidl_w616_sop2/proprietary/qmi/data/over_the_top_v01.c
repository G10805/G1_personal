...
GENERAL DESCRIPTION
  ...
  Copyright (c) 2015-2018,2020-2021 Qualcomm Technologies, Inc.
  All rights reserved.
...
static const uint8_t ott_indication_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(ott_indication_register_req_msg_v01, report_link_latency) - QMI_IDL_OFFSET8(ott_indication_register_req_msg_v01, report_link_latency_valid)),
  0x14,
  QMI_IDL_GENERIC_1_BYTE,
...
static const uint8_t ott_get_link_latency_info_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(ott_get_link_latency_info_resp_msg_v01, dl_link_latency_est) - QMI_IDL_OFFSET8(ott_get_link_latency_info_resp_msg_v01, dl_link_latency_est_valid)),
  0x13,
   QMI_IDL_GENERIC_8_BYTE,
...
static const uint8_t ott_link_latency_info_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(ott_link_latency_info_ind_msg_v01, dl_link_latency_est) - QMI_IDL_OFFSET8(ott_link_latency_info_ind_msg_v01, dl_link_latency_est_valid)),
  0x11,
   QMI_IDL_GENERIC_8_BYTE,
...
static const qmi_idl_service_message_table_entry ott_service_command_messages_v01[] = {
  ...
  {QMI_OTT_INDICATION_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 4), 20},
...
static const qmi_idl_service_message_table_entry ott_service_response_messages_v01[] = {
  ...
  {QMI_OTT_GET_LINK_LATENCY_INFO_RESP_V01, QMI_IDL_TYPE16(0, 25), 37}
};
...
static const qmi_idl_service_message_table_entry ott_service_indication_messages_v01[] = {
  ...
  {QMI_OTT_LINK_LATENTCY_INFO_IND_V01, QMI_IDL_TYPE16(0, 26), 30}
};
