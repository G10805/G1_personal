...
#define OTT_V01_IDL_MINOR_VERS 0x05
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define OTT_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define OTT_V01_MAX_MESSAGE_ID 0x002F
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Uplink link latency report status. Values:\n
       - 0: Reporting off \n
       - 1: Reporting on
  */
  ...
  /**<   Downlink link latency report status. Values:\n
       - 0: Reporting off \n
       - 1: Reporting on
  */
  ...
  /**<   Uplink link latency estimation in microseconds.
       Present when uplink link latency report status is ON.
  */
  ...
  /**<   Downlink link latency estimation in microseconds.
       Present when downlink link latency report status is ON.
  */
