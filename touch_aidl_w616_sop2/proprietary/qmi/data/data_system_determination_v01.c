...
static const uint8_t dsd_ui_icon_band_info_type_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_ui_icon_band_info_type_v01, action),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_ui_icon_band_info_type_v01, mode),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_ui_icon_band_info_type_v01, band_list),
  QMI_DSD_UI_ICON_BAND_LIST_MAX_V01,
  QMI_IDL_OFFSET8(dsd_ui_icon_band_info_type_v01, band_list) - QMI_IDL_OFFSET8(dsd_ui_icon_band_info_type_v01, band_list_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t dsd_ui_icon_bandwidth_info_type_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_ui_icon_bandwidth_info_type_v01, action),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_ui_icon_bandwidth_info_type_v01, mode),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_ui_icon_bandwidth_info_type_v01, bandwidth),
...
static const uint8_t dsd_apn_access_pref_type_data_v01[] = {
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_STRING,
  QMI_IDL_OFFSET8(dsd_apn_access_pref_type_v01, apn_name),
  QMI_DSD_MAX_APN_LEN_V01,

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_apn_access_pref_type_v01, access_type),
  QMI_DSD_MAX_PREF_ACCESS_TYPE_V01,
  QMI_IDL_OFFSET8(dsd_apn_access_pref_type_v01, access_type) - QMI_IDL_OFFSET8(dsd_apn_access_pref_type_v01, access_type_len),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t dsd_http_header_info_type_data_v01[] = {
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_http_header_info_type_v01, name),
  ((QMI_DSD_MAX_HTTP_HEADER_CONTENT_INFO_LEN_V01) & 0xFF), ((QMI_DSD_MAX_HTTP_HEADER_CONTENT_INFO_LEN_V01) >> 8),
  QMI_IDL_OFFSET8(dsd_http_header_info_type_v01, name) - QMI_IDL_OFFSET8(dsd_http_header_info_type_v01, name_len),
  ...
  QMI_IDL_OFFSET16ARRAY(dsd_http_header_info_type_v01, value),
  ((QMI_DSD_MAX_HTTP_HEADER_CONTENT_INFO_LEN_V01) & 0xFF), ((QMI_DSD_MAX_HTTP_HEADER_CONTENT_INFO_LEN_V01) >> 8),
  QMI_IDL_OFFSET16RELATIVE(dsd_http_header_info_type_v01, value) - QMI_IDL_OFFSET16RELATIVE(dsd_http_header_info_type_v01, value_len),
...
static const uint8_t dsd_wlan_available_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dsd_wlan_available_req_msg_v01, country_code) - QMI_IDL_OFFSET16RELATIVE(dsd_wlan_available_req_msg_v01, country_code_valid)),
  0x26,
  QMI_IDL_FLAGS_IS_ARRAY |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(dsd_wlan_available_req_msg_v01, country_code),
  QMI_DSD_MAX_COUNTRY_CODE_LEN_V01,

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dsd_wlan_available_req_msg_v01, interface_name) - QMI_IDL_OFFSET16RELATIVE(dsd_wlan_available_req_msg_v01, interface_name_valid)),
  0x27,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(dsd_wlan_available_req_msg_v01, interface_name),
  QMI_DSD_MAX_WLAN_INTERFACE_NAME_LEN_V01,
  QMI_IDL_OFFSET16RELATIVE(dsd_wlan_available_req_msg_v01, interface_name) - QMI_IDL_OFFSET16RELATIVE(dsd_wlan_available_req_msg_v01, interface_name_len)
};
...
static const uint8_t dsd_notify_data_settings_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_notify_data_settings_req_msg_v01, wifi_switch) - QMI_IDL_OFFSET8(dsd_notify_data_settings_req_msg_v01, wifi_switch_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_notify_data_settings_req_msg_v01, wifi_switch),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_notify_data_settings_req_msg_v01, ciwlan_switch) - QMI_IDL_OFFSET8(dsd_notify_data_settings_req_msg_v01, ciwlan_switch_valid)),
  0x14,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_notify_data_settings_req_msg_v01, ciwlan_switch)
};
...
static const uint8_t dsd_get_data_settings_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_data_settings_resp_msg_v01, wifi_switch) - QMI_IDL_OFFSET8(dsd_get_data_settings_resp_msg_v01, wifi_switch_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_get_data_settings_resp_msg_v01, wifi_switch),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_data_settings_resp_msg_v01, ciwlan_switch) - QMI_IDL_OFFSET8(dsd_get_data_settings_resp_msg_v01, ciwlan_switch_valid)),
  0x14,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_get_data_settings_resp_msg_v01, ciwlan_switch)
};
...
static const uint8_t dsd_indication_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_ap_asst_apn_pref_sys_result) - QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_ap_asst_apn_pref_sys_result_valid)),
  0x1F,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_ap_asst_apn_pref_sys_result),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_ursp_access_type_preference_info) - QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_ursp_access_type_preference_info_valid)),
  0x20,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_ursp_access_type_preference_info),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_ap_asst_http_info) - QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_ap_asst_http_info_valid)),
  0x21,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_ap_asst_http_info),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_pref_apn_update) - QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_pref_apn_update_valid)),
  0x22,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_pref_apn_update),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_dds_recommendation) - QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_dds_recommendation_valid)),
  0x23,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_dds_recommendation),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_temp_dds_reco_cap) - QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_temp_dds_reco_cap_valid)),
  0x24,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_temp_dds_reco_cap),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_ciwlan_cap) - QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_ciwlan_cap_valid)),
  0x25,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_indication_register_req_msg_v01, report_ciwlan_cap)
};
...
static const uint8_t dsd_set_wqe_profile_quality_status_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_set_wqe_profile_quality_status_req_msg_v01, measurement_id) - QMI_IDL_OFFSET8(dsd_set_wqe_profile_quality_status_req_msg_v01, measurement_id_valid)),
  0x12,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(dsd_set_wqe_profile_quality_status_req_msg_v01, measurement_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_set_wqe_profile_quality_status_req_msg_v01, wifi_band) - QMI_IDL_OFFSET8(dsd_set_wqe_profile_quality_status_req_msg_v01, wifi_band_valid)),
  0x13,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_set_wqe_profile_quality_status_req_msg_v01, wifi_band)
};
...
static const uint8_t dsd_wqe_profile_init_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_wqe_profile_init_ind_msg_v01, measurement_id) - QMI_IDL_OFFSET8(dsd_wqe_profile_init_ind_msg_v01, measurement_id_valid)),
  0x13,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(dsd_wqe_profile_init_ind_msg_v01, measurement_id),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_wqe_profile_init_ind_msg_v01, wifi_rssi_5_ghz_threshold_low) - QMI_IDL_OFFSET8(dsd_wqe_profile_init_ind_msg_v01, wifi_rssi_5_ghz_threshold_low_valid)),
  0x14,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(dsd_wqe_profile_init_ind_msg_v01, wifi_rssi_5_ghz_threshold_low),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_wqe_profile_init_ind_msg_v01, wifi_rssi_5_ghz_threshold_high) - QMI_IDL_OFFSET8(dsd_wqe_profile_init_ind_msg_v01, wifi_rssi_5_ghz_threshold_high_valid)),
  0x15,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(dsd_wqe_profile_init_ind_msg_v01, wifi_rssi_5_ghz_threshold_high),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_wqe_profile_init_ind_msg_v01, wifi_rssi_6_ghz_threshold_low) - QMI_IDL_OFFSET8(dsd_wqe_profile_init_ind_msg_v01, wifi_rssi_6_ghz_threshold_low_valid)),
  0x16,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(dsd_wqe_profile_init_ind_msg_v01, wifi_rssi_6_ghz_threshold_low),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_wqe_profile_init_ind_msg_v01, wifi_rssi_6_ghz_threshold_high) - QMI_IDL_OFFSET8(dsd_wqe_profile_init_ind_msg_v01, wifi_rssi_6_ghz_threshold_high_valid)),
  0x17,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(dsd_wqe_profile_init_ind_msg_v01, wifi_rssi_6_ghz_threshold_high)
};
...
static const uint8_t dsd_set_3gpp_hplmn_list_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dsd_set_3gpp_hplmn_list_req_msg_v01, domestic_rplmn_list) - QMI_IDL_OFFSET16RELATIVE(dsd_set_3gpp_hplmn_list_req_msg_v01, domestic_rplmn_list_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dsd_set_3gpp_hplmn_list_req_msg_v01, international_rplmn_list) - QMI_IDL_OFFSET16RELATIVE(dsd_set_3gpp_hplmn_list_req_msg_v01, international_rplmn_list_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(dsd_set_3gpp_hplmn_list_req_msg_v01, international_rplmn_list),
  QMI_DSD_INTERNATIONAL_RPLMN_LIST_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(dsd_set_3gpp_hplmn_list_req_msg_v01, international_rplmn_list) - QMI_IDL_OFFSET16RELATIVE(dsd_set_3gpp_hplmn_list_req_msg_v01, international_rplmn_list_len),
  QMI_IDL_TYPE88(0, 29)
};
...
static const uint8_t dsd_get_3gpp_hplmn_list_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dsd_get_3gpp_hplmn_list_resp_msg_v01, domestic_rplmn_list) - QMI_IDL_OFFSET16RELATIVE(dsd_get_3gpp_hplmn_list_resp_msg_v01, domestic_rplmn_list_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dsd_get_3gpp_hplmn_list_resp_msg_v01, international_rplmn_list) - QMI_IDL_OFFSET16RELATIVE(dsd_get_3gpp_hplmn_list_resp_msg_v01, international_rplmn_list_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(dsd_get_3gpp_hplmn_list_resp_msg_v01, international_rplmn_list),
  QMI_DSD_INTERNATIONAL_RPLMN_LIST_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(dsd_get_3gpp_hplmn_list_resp_msg_v01, international_rplmn_list) - QMI_IDL_OFFSET16RELATIVE(dsd_get_3gpp_hplmn_list_resp_msg_v01, international_rplmn_list_len),
  QMI_IDL_TYPE88(0, 29)
};
...
static const uint8_t dsd_switch_dds_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_switch_dds_req_msg_v01, dds_switch_type) - QMI_IDL_OFFSET8(dsd_switch_dds_req_msg_v01, dds_switch_type_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_switch_dds_req_msg_v01, dds_switch_type),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_switch_dds_req_msg_v01, dds_recommendation_src) - QMI_IDL_OFFSET8(dsd_switch_dds_req_msg_v01, dds_recommendation_src_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_switch_dds_req_msg_v01, dds_recommendation_src)
};
...
static const uint8_t dsd_configure_dynamic_dds_switch_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_req_msg_v01, dds_recommendation_type) - QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_req_msg_v01, dds_recommendation_type_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_req_msg_v01, dds_recommendation_type),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_req_msg_v01, perm_rec_action) - QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_req_msg_v01, perm_rec_action_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_req_msg_v01, perm_rec_action),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_req_msg_v01, temp_rec_action) - QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_req_msg_v01, temp_rec_action_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_req_msg_v01, temp_rec_action)
};
...
static const uint8_t dsd_configure_dynamic_dds_switch_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_resp_msg_v01, configured_dds_switch_setting) - QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_resp_msg_v01, configured_dds_switch_setting_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_resp_msg_v01, configured_dds_switch_setting),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_resp_msg_v01, configured_dds_recommendation_type) - QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_resp_msg_v01, configured_dds_recommendation_type_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_resp_msg_v01, configured_dds_recommendation_type),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_resp_msg_v01, configured_perm_rec_status) - QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_resp_msg_v01, configured_perm_rec_status_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_resp_msg_v01, configured_perm_rec_status),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_resp_msg_v01, configured_temp_rec_status) - QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_resp_msg_v01, configured_temp_rec_status_valid)),
  0x13,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_configure_dynamic_dds_switch_resp_msg_v01, configured_temp_rec_status)
};
...
static const uint8_t dsd_ursp_access_type_preference_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dsd_ursp_access_type_preference_ind_msg_v01, tx_info),
  QMI_IDL_TYPE88(0, 3),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_ursp_access_type_preference_ind_msg_v01, apn_list) - QMI_IDL_OFFSET8(dsd_ursp_access_type_preference_ind_msg_v01, apn_list_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dsd_ursp_access_type_preference_ind_msg_v01, apn_list),
  QMI_DSD_MAX_APNS_V01,
  QMI_IDL_OFFSET8(dsd_ursp_access_type_preference_ind_msg_v01, apn_list) - QMI_IDL_OFFSET8(dsd_ursp_access_type_preference_ind_msg_v01, apn_list_len),
  QMI_IDL_TYPE88(0, 35)
};

static const uint8_t dsd_ap_asst_http_info_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dsd_ap_asst_http_info_ind_msg_v01, tx_info),
  QMI_IDL_TYPE88(0, 3),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_ap_asst_http_info_ind_msg_v01, http_content) - QMI_IDL_OFFSET8(dsd_ap_asst_http_info_ind_msg_v01, http_content_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_ap_asst_http_info_ind_msg_v01, http_content),
  ((QMI_DSD_MAX_HTTP_CONTENT_LEN_V01) & 0xFF), ((QMI_DSD_MAX_HTTP_CONTENT_LEN_V01) >> 8),
  QMI_IDL_OFFSET8(dsd_ap_asst_http_info_ind_msg_v01, http_content) - QMI_IDL_OFFSET8(dsd_ap_asst_http_info_ind_msg_v01, http_content_len),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dsd_ap_asst_http_info_ind_msg_v01, http_method) - QMI_IDL_OFFSET16RELATIVE(dsd_ap_asst_http_info_ind_msg_v01, http_method_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(dsd_ap_asst_http_info_ind_msg_v01, http_method),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dsd_ap_asst_http_info_ind_msg_v01, http_version) - QMI_IDL_OFFSET16RELATIVE(dsd_ap_asst_http_info_ind_msg_v01, http_version_valid)),
  0x12,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(dsd_ap_asst_http_info_ind_msg_v01, http_version),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dsd_ap_asst_http_info_ind_msg_v01, http_ssl_version) - QMI_IDL_OFFSET16RELATIVE(dsd_ap_asst_http_info_ind_msg_v01, http_ssl_version_valid)),
  0x13,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(dsd_ap_asst_http_info_ind_msg_v01, http_ssl_version),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dsd_ap_asst_http_info_ind_msg_v01, header_info) - QMI_IDL_OFFSET16RELATIVE(dsd_ap_asst_http_info_ind_msg_v01, header_info_valid)),
  0x14,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(dsd_ap_asst_http_info_ind_msg_v01, header_info),
  QMI_DSD_MAX_HTTP_HEADER_CONTENT_LEN_V01,
  QMI_IDL_OFFSET16RELATIVE(dsd_ap_asst_http_info_ind_msg_v01, header_info) - QMI_IDL_OFFSET16RELATIVE(dsd_ap_asst_http_info_ind_msg_v01, header_info_len),
  QMI_IDL_TYPE88(0, 36)
};

static const uint8_t dsd_notify_ap_asst_http_result_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(dsd_notify_ap_asst_http_result_req_msg_v01, tx_id),

  0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_notify_ap_asst_http_result_req_msg_v01, result_code),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_notify_ap_asst_http_result_req_msg_v01, status_code) - QMI_IDL_OFFSET8(dsd_notify_ap_asst_http_result_req_msg_v01, status_code_valid)),
  0x10,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(dsd_notify_ap_asst_http_result_req_msg_v01, status_code),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_notify_ap_asst_http_result_req_msg_v01, result_content) - QMI_IDL_OFFSET8(dsd_notify_ap_asst_http_result_req_msg_v01, result_content_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_notify_ap_asst_http_result_req_msg_v01, result_content),
  ((QMI_DSD_MAX_HTTP_CONTENT_LEN_V01) & 0xFF), ((QMI_DSD_MAX_HTTP_CONTENT_LEN_V01) >> 8),
  QMI_IDL_OFFSET8(dsd_notify_ap_asst_http_result_req_msg_v01, result_content) - QMI_IDL_OFFSET8(dsd_notify_ap_asst_http_result_req_msg_v01, result_content_len)
};

static const uint8_t dsd_notify_ap_asst_http_result_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dsd_notify_ap_asst_http_result_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t dsd_set_ui_icon_config_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, sib2_ui_icon_val) - QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, sib2_ui_icon_val_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, sib2_ui_icon_val),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, timer_scg_to_mcg) - QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, timer_scg_to_mcg_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, timer_scg_to_mcg),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, timer_idle_to_connect) - QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, timer_idle_to_connect_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, timer_idle_to_connect),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, timer_idle) - QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, timer_idle_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, timer_idle),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, uwb_nsa_band_list) - QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, uwb_nsa_band_list_valid)),
  0x14,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, uwb_nsa_band_list),
  QMI_IDL_TYPE88(0, 8),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, uwb_sa_band_list) - QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, uwb_sa_band_list_valid)),
  0x15,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dsd_set_ui_icon_config_req_msg_v01, uwb_sa_band_list),
  QMI_IDL_TYPE88(0, 8),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dsd_set_ui_icon_config_req_msg_v01, uwb_bandwidth) - QMI_IDL_OFFSET16RELATIVE(dsd_set_ui_icon_config_req_msg_v01, uwb_bandwidth_valid)),
  0x16,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(dsd_set_ui_icon_config_req_msg_v01, uwb_bandwidth),
  QMI_IDL_TYPE88(0, 9)
};

static const uint8_t dsd_set_ui_icon_config_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dsd_set_ui_icon_config_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

/*
 * dsd_get_ui_icon_config_req_msg is empty
 * static const uint8_t dsd_get_ui_icon_config_req_msg_data_v01[] = {
 * };
 */

static const uint8_t dsd_get_ui_icon_config_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, sib2_ui_icon_val) - QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, sib2_ui_icon_val_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, sib2_ui_icon_val),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, timer_scg_to_mcg) - QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, timer_scg_to_mcg_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, timer_scg_to_mcg),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, timer_idle_to_connect) - QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, timer_idle_to_connect_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, timer_idle_to_connect),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, timer_idle) - QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, timer_idle_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, timer_idle),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, uwb_nsa_band_list) - QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, uwb_nsa_band_list_valid)),
  0x14,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, uwb_nsa_band_list),
  QMI_IDL_TYPE88(0, 8),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, uwb_sa_band_list) - QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, uwb_sa_band_list_valid)),
  0x15,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dsd_get_ui_icon_config_resp_msg_v01, uwb_sa_band_list),
  QMI_IDL_TYPE88(0, 8),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(dsd_get_ui_icon_config_resp_msg_v01, uwb_bandwidth) - QMI_IDL_OFFSET16RELATIVE(dsd_get_ui_icon_config_resp_msg_v01, uwb_bandwidth_valid)),
  0x16,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(dsd_get_ui_icon_config_resp_msg_v01, uwb_bandwidth),
  QMI_IDL_TYPE88(0, 9)
};

static const uint8_t dsd_get_preferred_apn_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(dsd_get_preferred_apn_req_msg_v01, apn_type_mask),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dsd_get_preferred_apn_req_msg_v01, apn_name_list),
  QMI_DSD_MAX_APNS_V01,
  QMI_IDL_OFFSET8(dsd_get_preferred_apn_req_msg_v01, apn_name_list) - QMI_IDL_OFFSET8(dsd_get_preferred_apn_req_msg_v01, apn_name_list_len),
  QMI_IDL_TYPE88(0, 13)
};

static const uint8_t dsd_get_preferred_apn_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dsd_get_preferred_apn_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x03,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(dsd_get_preferred_apn_resp_msg_v01, transaction_id)
};

static const uint8_t dsd_preferred_apn_updated_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(dsd_preferred_apn_updated_ind_msg_v01, transaction_id),

  0x02,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(dsd_preferred_apn_updated_ind_msg_v01, apn_type_mask),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_preferred_apn_updated_ind_msg_v01, err_code) - QMI_IDL_OFFSET8(dsd_preferred_apn_updated_ind_msg_v01, err_code_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_preferred_apn_updated_ind_msg_v01, err_code),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_preferred_apn_updated_ind_msg_v01, apn_name) - QMI_IDL_OFFSET8(dsd_preferred_apn_updated_ind_msg_v01, apn_name_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_STRING,
  QMI_IDL_OFFSET8(dsd_preferred_apn_updated_ind_msg_v01, apn_name),
  QMI_DSD_MAX_APN_LEN_V01
};

static const uint8_t dsd_dds_recommendation_ind_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_dds_recommendation_ind_v01, recommended_dds),

  0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_dds_recommendation_ind_v01, source),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_dds_recommendation_ind_v01, switch_type) - QMI_IDL_OFFSET8(dsd_dds_recommendation_ind_v01, switch_type_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_dds_recommendation_ind_v01, switch_type),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_dds_recommendation_ind_v01, temp_rec_level) - QMI_IDL_OFFSET8(dsd_dds_recommendation_ind_v01, temp_rec_level_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_dds_recommendation_ind_v01, temp_rec_level),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_dds_recommendation_ind_v01, temp_dds_cause_code) - QMI_IDL_OFFSET8(dsd_dds_recommendation_ind_v01, temp_dds_cause_code_valid)),
  0x12,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(dsd_dds_recommendation_ind_v01, temp_dds_cause_code)
};

/*
 * dsd_get_dds_recommendation_req_msg is empty
 * static const uint8_t dsd_get_dds_recommendation_req_msg_data_v01[] = {
 * };
 */

static const uint8_t dsd_get_dds_recommendation_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, dds) - QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, dds_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, dds),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, source) - QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, source_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, source),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, switch_type) - QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, switch_type_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, switch_type),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, temp_rec_level) - QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, temp_rec_level_valid)),
  0x13,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, temp_rec_level),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, temp_dds_cause_code) - QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, temp_dds_cause_code_valid)),
  0x14,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(dsd_get_dds_recommendation_resp_msg_v01, temp_dds_cause_code)
};

static const uint8_t dsd_temp_dds_rec_capability_ind_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_temp_dds_rec_capability_ind_v01, temp_dds_rec_capability)
};

static const uint8_t dsd_get_capability_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_capability_req_msg_v01, temp_dds_rec_capability) - QMI_IDL_OFFSET8(dsd_get_capability_req_msg_v01, temp_dds_rec_capability_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_get_capability_req_msg_v01, temp_dds_rec_capability),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_capability_req_msg_v01, ciwlan_capability) - QMI_IDL_OFFSET8(dsd_get_capability_req_msg_v01, ciwlan_capability_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_get_capability_req_msg_v01, ciwlan_capability)
};

static const uint8_t dsd_get_capability_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dsd_get_capability_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_capability_resp_msg_v01, temp_dds_rec_capability) - QMI_IDL_OFFSET8(dsd_get_capability_resp_msg_v01, temp_dds_rec_capability_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_get_capability_resp_msg_v01, temp_dds_rec_capability),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dsd_get_capability_resp_msg_v01, ciwlan_capability) - QMI_IDL_OFFSET8(dsd_get_capability_resp_msg_v01, ciwlan_capability_valid)),
  0x11,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_get_capability_resp_msg_v01, ciwlan_capability)
};

static const uint8_t dsd_ciwlan_capability_ind_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dsd_ciwlan_capability_ind_v01, ciwlan_capability)
};
...
static const qmi_idl_type_table_entry  dsd_type_table_v01[] = {
  ...
  {sizeof(dsd_ui_icon_band_info_type_v01), dsd_ui_icon_band_info_type_data_v01},
  {sizeof(dsd_ui_icon_bandwidth_info_type_v01), dsd_ui_icon_bandwidth_info_type_data_v01},
  ...
  {sizeof(dsd_apn_access_pref_type_v01), dsd_apn_access_pref_type_data_v01},
  {sizeof(dsd_http_header_info_type_v01), dsd_http_header_info_type_data_v01}
};
...
static const qmi_idl_message_table_entry dsd_message_table_v01[] = {
  ...
  {sizeof(dsd_ursp_access_type_preference_ind_msg_v01), dsd_ursp_access_type_preference_ind_msg_data_v01},
  {sizeof(dsd_ap_asst_http_info_ind_msg_v01), dsd_ap_asst_http_info_ind_msg_data_v01},
  {sizeof(dsd_notify_ap_asst_http_result_req_msg_v01), dsd_notify_ap_asst_http_result_req_msg_data_v01},
  {sizeof(dsd_notify_ap_asst_http_result_resp_msg_v01), dsd_notify_ap_asst_http_result_resp_msg_data_v01},
  {sizeof(dsd_set_ui_icon_config_req_msg_v01), dsd_set_ui_icon_config_req_msg_data_v01},
  {sizeof(dsd_set_ui_icon_config_resp_msg_v01), dsd_set_ui_icon_config_resp_msg_data_v01},
  {sizeof(dsd_get_ui_icon_config_req_msg_v01), 0},
  {sizeof(dsd_get_ui_icon_config_resp_msg_v01), dsd_get_ui_icon_config_resp_msg_data_v01},
  {sizeof(dsd_get_preferred_apn_req_msg_v01), dsd_get_preferred_apn_req_msg_data_v01},
  {sizeof(dsd_get_preferred_apn_resp_msg_v01), dsd_get_preferred_apn_resp_msg_data_v01},
  {sizeof(dsd_preferred_apn_updated_ind_msg_v01), dsd_preferred_apn_updated_ind_msg_data_v01},
  {sizeof(dsd_dds_recommendation_ind_v01), dsd_dds_recommendation_ind_data_v01},
  {sizeof(dsd_get_dds_recommendation_req_msg_v01), 0},
  {sizeof(dsd_get_dds_recommendation_resp_msg_v01), dsd_get_dds_recommendation_resp_msg_data_v01},
  {sizeof(dsd_temp_dds_rec_capability_ind_v01), dsd_temp_dds_rec_capability_ind_data_v01},
  {sizeof(dsd_get_capability_req_msg_v01), dsd_get_capability_req_msg_data_v01},
  {sizeof(dsd_get_capability_resp_msg_v01), dsd_get_capability_resp_msg_data_v01},
  {sizeof(dsd_ciwlan_capability_ind_v01), dsd_ciwlan_capability_ind_data_v01}
};
...
static const qmi_idl_service_message_table_entry dsd_service_command_messages_v01[] = {
  {QMI_DSD_WLAN_AVAILABLE_REQ_V01, QMI_IDL_TYPE16(0, 9), 275},
  ...
  {QMI_DSD_SET_WQE_PROFILE_QUALITY_STATUS_REQ_V01, QMI_IDL_TYPE16(0, 63), 39},
  ...
  {QMI_DSD_SET_3GPP_HPLMN_LIST_REQ_V01, QMI_IDL_TYPE16(0, 77), 1040},
  {QMI_DSD_GET_3GPP_HPLMN_LIST_REQ_V01, QMI_IDL_TYPE16(0, 79), 0},
  {QMI_DSD_SWITCH_DDS_REQ_V01, QMI_IDL_TYPE16(0, 81), 21},
  ...
  {QMI_DSD_CONFIGURE_DYNAMIC_DDS_SWITCH_REQ_V01, QMI_IDL_TYPE16(0, 98), 28},
  ...
  {QMI_DSD_NOTIFY_AP_ASST_HTTP_RESULT_REQ_V01, QMI_IDL_TYPE16(0, 141), 1022},
  {QMI_DSD_SET_UI_ICON_CONFIG_REQ_V01, QMI_IDL_TYPE16(0, 143), 215},
  {QMI_DSD_GET_UI_ICON_CONFIG_REQ_V01, QMI_IDL_TYPE16(0, 145), 0},
  {QMI_DSD_GET_PREFERRED_APN_REQ_V01, QMI_IDL_TYPE16(0, 147), 1530},
  {QMI_DSD_GET_DDS_RECOMMENDATION_REQ_V01, QMI_IDL_TYPE16(0, 151), 0},
  {QMI_DSD_GET_CAPABILITY_REQ_V01, QMI_IDL_TYPE16(0, 154), 8}
};
...
static const qmi_idl_service_message_table_entry dsd_service_response_messages_v01[] = {
  ...
  {QMI_DSD_GET_DATA_SETTING_RESP_V01, QMI_IDL_TYPE16(0, 42), 30},
  ...
  {QMI_DSD_GET_3GPP_HPLMN_LIST_RESP_V01, QMI_IDL_TYPE16(0, 80), 1047},
  ...
  {QMI_DSD_CONFIGURE_DYNAMIC_DDS_SWITCH_RESP_V01, QMI_IDL_TYPE16(0, 99), 35},
  ...
  {QMI_DSD_NOTIFY_AP_ASST_HTTP_RESULT_RESP_V01, QMI_IDL_TYPE16(0, 142), 7},
  {QMI_DSD_SET_UI_ICON_CONFIG_RESP_V01, QMI_IDL_TYPE16(0, 144), 7},
  {QMI_DSD_GET_UI_ICON_CONFIG_RESP_V01, QMI_IDL_TYPE16(0, 146), 222},
  {QMI_DSD_GET_PREFERRED_APN_RESP_V01, QMI_IDL_TYPE16(0, 148), 12},
  {QMI_DSD_GET_DDS_RECOMMENDATION_RESP_V01, QMI_IDL_TYPE16(0, 152), 46},
  {QMI_DSD_GET_CAPABILITY_RESP_V01, QMI_IDL_TYPE16(0, 155), 15}
};
...
static const qmi_idl_service_message_table_entry dsd_service_indication_messages_v01[] = {
  ...
  {QMI_DSD_WQE_PROFILE_INIT_IND_V01, QMI_IDL_TYPE16(0, 67), 62},
  ...
  {QMI_DSD_URSP_ACCESS_TYPE_PREFERENCE_IND_V01, QMI_IDL_TYPE16(0, 139), 1841},
  {QMI_DSD_AP_ASST_HTTP_INFO_IND_V01, QMI_IDL_TYPE16(0, 140), 2069},
  {QMI_DSD_PREFERRED_APN_UPDATED_IND_V01, QMI_IDL_TYPE16(0, 149), 126},
  {QMI_DSD_DDS_RECOMMENDATION_IND_V01, QMI_IDL_TYPE16(0, 150), 39},
  {QMI_DSD_TEMP_DDS_REC_CAPABILITY_IND_V01, QMI_IDL_TYPE16(0, 153), 4},
  {QMI_DSD_CIWLAN_CAPABILITY_IND_V01, QMI_IDL_TYPE16(0, 156), 4}
};
