...
#define TAG "qmi_ril_peripheral_mng"
...
#ifndef QMI_RIL_UTF
int qmi_ril_peripheral_mng_init(const char *device_name,
...
int qmi_ril_peripheral_mng_register_pm_client_for_primary_modem(const char *device_name)
{
    enum pm_event event;
...
int qmi_ril_peripheral_mng_register_pm_client_for_secondary_modem(const char *device_name)
{
    enum pm_event event;
