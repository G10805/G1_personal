...
#define MAX_RADIO_ACCESS_SPECIFIERS 12 // RANs supported * 2
...
#define MAX_LINK_ADDRESSES 4
#define MAX_QOS_FILTER_ADDRESSES 10
#define MAX_QOS_SESSIONS 10
#define MAX_TRAFFIC_DESCRIPTORS 10
#define MAX_QOS_FILTERS 10
#define MAX_OS_APP_ID_LENGTH 272
#define MAX_CAG_NAME_LEN 50
#define MAX_SNPN_NID_LEN 6
#define MAX_OPERATOR_NUMERIC_LEN 6
...
typedef enum {
    ...
    RIL_E_SIMULTANEOUS_SMS_AND_CALL_NOT_ALLOWED = 67,
    /** NR 5G SMS Access is barred. */
    RIL_E_SMS_ACCESS_BARRED = 68,
    /** SMS is blocked due to call control, e.g., resource unavailablein the SMR entity. */
    RIL_E_SMS_BLOCKED_DUE_TO_CALL = 69,
    /** RF hardware related error */
    RIL_E_RF_HARDWARE_ISSUE = 70,
    /** RF software related error */
    RIL_E_RF_SOFTWARE_ISSUE = 71,
    ...
    /** Call forwarding service is not registered */
    RIL_E_CF_SERVICE_NOT_REGISTERED = 1014,
} RIL_Errno;
 ...
 */
typedef enum {
    RIL_CALL_ACTIVE = 0,     /**< Active */
    RIL_CALL_HOLDING = 1,    /**< Holding */
    RIL_CALL_DIALING = 2,    /**< Dialing. MO call only */
    RIL_CALL_ALERTING = 3,   /**< Alerting. MO call only */
    RIL_CALL_INCOMING = 4,   /**< Incoming. MT call only */
    RIL_CALL_WAITING = 5,    /**< Waiting. MT call only */
    RIL_CALL_END = 6         /**< End */
} RIL_CallState;
 ...
 */
typedef enum {
    RAF_UNKNOWN =  (1 <<  RADIO_TECH_UNKNOWN), /**< Unknown */
    RAF_GPRS = (1 << RADIO_TECH_GPRS), /**< GPRS */
    RAF_EDGE = (1 << RADIO_TECH_EDGE), /**< EDGE */
    RAF_UMTS = (1 << RADIO_TECH_UMTS), /**< UMTS */
    RAF_IS95A = (1 << RADIO_TECH_IS95A), /**< IS95A */
    RAF_IS95B = (1 << RADIO_TECH_IS95B), /**< IS95B */
    RAF_1xRTT = (1 << RADIO_TECH_1xRTT), /**< 1xRTT */
    RAF_EVDO_0 = (1 << RADIO_TECH_EVDO_0), /**< EVDO revision 0 */
    RAF_EVDO_A = (1 << RADIO_TECH_EVDO_A), /**< EVDO revision A */
    RAF_HSDPA = (1 << RADIO_TECH_HSDPA), /**< HSDPA */
    RAF_HSUPA = (1 << RADIO_TECH_HSUPA), /**< HSUPA */
    RAF_HSPA = (1 << RADIO_TECH_HSPA), /**< HSPA */
    RAF_EVDO_B = (1 << RADIO_TECH_EVDO_B), /**< EVDO revision B */
    RAF_EHRPD = (1 << RADIO_TECH_EHRPD), /**< eHRPD */
    RAF_LTE = (1 << RADIO_TECH_LTE), /**< LTE */
    RAF_HSPAP = (1 << RADIO_TECH_HSPAP), /**< HSPA+ */
    RAF_GSM = (1 << RADIO_TECH_GSM), /**< GSM */
    RAF_TD_SCDMA = (1 << RADIO_TECH_TD_SCDMA), /**< TD SCDMA */
    RAF_LTE_CA = (1 << RADIO_TECH_LTE_CA), /**< LTE CA */
    RAF_5G = (1 << RADIO_TECH_5G) /**< 5G */
 ...
 */
typedef enum {
    NR5G_EMC_NOT_SUPPORTED = 0, /**< Emergency services not supported */
    NR5G_EMC_SUPPORTED_NR = 1, /**< Emergency services supported in NR connected to 5GCN only */
    NR5G_EMC_SUPPORTED_EUTRA = 2, /**< Emergency services supported in E-UTRA connected to 5GCN only */
    NR5G_EMC_SUPPORTED_NR_AND_EUTRA = 3 /**< Emergency services supported in NR connected to 5GCN and E-UTRA connected to 5GCN */
} RIL_Nr5gEmcVal;
 ...
 */
typedef enum {
    NR5G_EMF_NOT_SUPPORTED = 0, /**< Emergency services fallback not supported */
    NR5G_EMF_SUPPORTED_NR = 1,  /**< Emergency services fallback supported in NR connected to 5GCN only */
    NR5G_EMF_SUPPORTED_EUTRA = 2, /**< Emergency services fallback supported in E-UTRA connected to 5GCN only */
    NR5G_EMF_SUPPORTED_NR_AND_EUTRA = 3 /**<Emergency services fallback supported in NR connected to 5GCN and E-UTRA connected to 5GCN */
} RIL_Nr5gEmfVal;
 ...
 */
typedef enum {
   CDMA_SUBSCRIPTION_SOURCE_INVALID = -1, /**< Invalid */
   CDMA_SUBSCRIPTION_SOURCE_RUIM_SIM = 0, /**< RUIM SIM */
   CDMA_SUBSCRIPTION_SOURCE_NV = 1        /**< NV */
} RIL_CdmaSubscriptionSource;

/**
 * MSIM Preference
 */
typedef enum Msim_Preference {
   MSIM_PREFERENCE_INVALID = -1,
   MSIM_PREFERENCE_DSDA = 0,
   MSIM_PREFERENCE_DSDS = 1
} Msim_Preference;
 ...
 */
typedef enum {
    CDMA_ROAMING_PREFERENCE_INVALID = -1,        /**< Invalid */
    CDMA_ROAMING_PREFERENCE_HOME_NETWORK = 0,    /**< Home network */
    CDMA_ROAMING_PREFERENCE_AFFILIATED_ROAM = 1, /**< Affiliated roaming network */
    CDMA_ROAMING_PREFERENCE_ANY_ROAM = 2         /**< Any roaming network */
 ...
 */
typedef enum {
    RIL_UUS_TYPE1_IMPLICIT = 0,     /**< Type 1 implicit */
    RIL_UUS_TYPE1_REQUIRED = 1,     /**< Type 2 required */
    RIL_UUS_TYPE1_NOT_REQUIRED = 2, /**< Type 1 not required */
    RIL_UUS_TYPE2_REQUIRED = 3,     /**< Type 2 required */
    RIL_UUS_TYPE2_NOT_REQUIRED = 4, /**< Type 2 not required */
    RIL_UUS_TYPE3_REQUIRED = 5,     /**< Type 3 required */
    RIL_UUS_TYPE3_NOT_REQUIRED = 6  /**< Type 3 not required */
} RIL_UUS_Type;
...
typedef enum {
    RIL_ADDRESS_PROPERTY_NONE = 0,
    /** Indicates this address is deprecated */
    RIL_ADDRESS_PROPERTY_DEPRECATED = 0x20,
} RIL_AddressProperty;

typedef struct {
    char *address;              /* A space-delimited list of addresses with optional "/" prefix length,
                                   e.g., "192.0.1.3" or "192.0.1.11/16 2001:db8::1/64".
                                   May not be empty, typically 1 IPv4 or 1 IPv6 or
                                   one of each. If the prefix length is absent the addresses
                                   are assumed to be point to point with IPv4 having a prefix
                                   length of 32 and IPv6 128. */
    int properties;             /* The properties of the link address. RIL_AddressProperty
                                   bitmask. */
    uint64_t deprecationTime;   /* The time, as reported by SystemClock.elapsedRealtime(),
                                   when this link address will be or was deprecated. -1 indicates
                                   this information is not available. At the time existing
                                   connections can still use this address until it expires,
                                   but new connections should use the new address.
                                   LONG_MAX(0x7FFFFFFFFFFFFFFF) indicates this link address
                                   will never be deprecated. */
    uint64_t expirationTime;    /* The time, as reported by SystemClock.elapsedRealtime(),
                                   when this link address will expire and be removed from the
                                   interface. -1 indicates this information is not available.
                                   LONG_MAX(0x7FFFFFFFFFFFFFFF) indicates this link address will
                                   never expire. */
} RIL_LinkAddress;

typedef struct {
    int32_t maxBitrateKbps;        /* Maximum bit rate possible on the bearer. */
    int32_t guaranteedBitrateKbps; /* Minimum bit rate that is guaranteed to be provided by the network. */
} RIL_QosBandwidth;

typedef struct {
    uint16_t qci;               /* Quality of Service Class Identifier, the allowed values are
                                   standard values(1-9, 65-68, 69-70, 75, 79-80, 82-85)
                                   and operator specific values in the range 128-254. */
    RIL_QosBandwidth downlink;
    RIL_QosBandwidth uplink;
} RIL_EpsQos;

typedef struct {
    uint16_t fiveQi;            /* 5G Quality of Service Identifier, the allowed values are
                                   standard values(1-9, 65-68, 69-70, 75, 79-80, 82-85)
                                   and operator specific values in the range 128-254. */
    RIL_QosBandwidth downlink;
    RIL_QosBandwidth uplink;
    uint8_t qfi;                /* QOS flow identifier of the QOS flow description in the range
                                   of 1 to 63 */
...
typedef enum {
    RIL_QOS_PROTOCOL_UNSPECIFIED = -1,     /* No protocol specified */
    RIL_QOS_PROTOCOL_TCP = 6,              /* Transmission Control Protocol */
    RIL_QOS_PROTOCOL_UDP = 17,             /* User Datagram Protocol */
    RIL_QOS_PROTOCOL_ESP = 50,             /* Encapsulating Security Payload Protocol */
    RIL_QOS_PROTOCOL_AH = 51,              /* Authentication Header */
} RIL_QosProtocol;

/**
 * Defines range of ports. start and end are the first and last port numbers
 * (inclusive) in the range. Both start and end are in 20 to 65535 range. A
 * single port shall be represented by the same start and end value.
 */
typedef struct {
    int32_t start;
    int32_t end;
...
typedef enum {
    RIL_QOS_FILTER_DIRECTION_DOWNLINK = 0,
    RIL_QOS_FILTER_DIRECTION_UPLINK = 1,
    RIL_QOS_FILTER_DIRECTION_BIDIRECTIONAL = 2,
} RIL_QosFilterDirection;

typedef struct {
    size_t localAddressesLength;
    char *localAddresses[MAX_QOS_FILTER_ADDRESSES];
    size_t remoteAddressesLength;
    char *remoteAddresses[MAX_QOS_FILTER_ADDRESSES];
    uint8_t localPortValid;           /* Whether localPort is valid (0 false, 1 true) */
    RIL_PortRange localPort;
    uint8_t remotePortValid;          /* Whether remotePort is valid (0 false, 1 true) */
    RIL_PortRange remotePort;
    RIL_QosProtocol protocol;
    uint8_t tosValid;                 /* Whether tos is valid (0 false, 1 true) */
    uint8_t tos;                      /* Type of service value or mask */
    uint8_t flowLabelValid;           /* Whether flowLabel is valid (0 false, 1 true) */
    uint32_t flowLabel;               /* IPv6 flow label */
    uint8_t spiValid;                 /* Whether spi is valid (0 false, 1 true) */
    uint32_t spi;                     /* IPSec security parameter index */
    RIL_QosFilterDirection direction;
    int32_t precedence;               /* The order in which the filter needs to be matched.
...
typedef struct {
    int32_t qosSessionId;             /* Unique ID of the QoS session within the data call */
    RIL_Qos qos;
    size_t qosFiltersLength;
    RIL_QosFilter qosFilters[MAX_QOS_FILTERS];
} RIL_QosSession;

/** The allowed failure modes on an IWLAN handover failure. */
typedef enum {
    RIL_HANDOVER_FAILURE_LEGACY = 0,
    RIL_HANDOVER_FAILURE_DO_FALLBACK = 1,
    RIL_HANDOVER_FAILURE_NO_FALLBACK_RETRY_HANDOVER = 2,
    RIL_HANDOVER_FAILURE_NO_FALLBACK_RETRY_SETUP_NORMAL = 3
} RIL_HandoverFailureMode;

typedef enum {
    RIL_SLICE_SERVICE_TYPE_NONE = 0,
    RIL_SLICE_SERVICE_TYPE_EMBB = 1,
    RIL_SLICE_SERVICE_TYPE_URLLC = 2,
    RIL_SLICE_SERVICE_TYPE_MIOT = 3,
} RIL_SliceServiceType;

typedef enum {
    RIL_SLICE_STATUS_UNKNOWN,
    RIL_SLICE_STATUS_CONFIGURED,
    RIL_SLICE_STATUS_ALLOWED,
    RIL_SLICE_STATUS_REJECTED_NOT_AVAILABLE_IN_PLMN,
    RIL_SLICE_STATUS_REJECTED_NOT_AVAILABLE_IN_REG_AREA,
    RIL_SLICE_STATUS_DEFAULT_CONFIGURED,
} RIL_SliceStatus;

/**
 * This struct represents a S-NSSAI
 */
typedef struct {
 ...
 * one of the optional values present.
 */
typedef struct {
    uint8_t dnnValid;
    char *dnn;
    uint8_t osAppIdValid;
    size_t osAppIdLength;
    uint8_t osAppId[MAX_OS_APP_ID_LENGTH];
...
typedef struct {
    int             status;     /* A RIL_DataCallFailCause, 0 which is PDP_FAIL_NONE if no error */
    int64_t             suggestedRetryTime; /* If status != 0, this fields indicates the suggested retry
                                           back-off timer value RIL wants to override the one
                                           pre-configured in FW.
                                           The unit is miliseconds.
                                           The value < 0 means no value is suggested.
                                           The value 0 means retry should be done ASAP.
                                           The value of 0x7fffffffffffffff means no retry. */
    int             cid;        /* Context ID, uniquely identifies this call */
    int             active;     /* 0=inactive, 1=active/physical link down, 2=active/physical link up */
    char *          type;       /* One of the PDP_type values in TS 27.007 section 10.1.1.
                                   For example, "IP", "IPV6", "IPV4V6", or "PPP". If status is
    ...
    int             mtuV6;      /* MTU received from network for IPV6
                                   Value <= 0 means network has either not sent a value or
                                   sent an invalid value */
    size_t          linkAddressesLength;
    RIL_LinkAddress linkAddresses[MAX_LINK_ADDRESSES]; /* List of link addresses.
                                   If the request was made using RIL_SetUpDataCallParams_Ursp,
                                   then this will be used instead of the addresses field above.
                                   ...
                                   length of 32 and IPv6 128. */
    RIL_Qos         defaultQos;
    size_t          qosSessionsLength;
    RIL_QosSession  qosSessions[MAX_QOS_SESSIONS];
    RIL_HandoverFailureMode handoverFailureMode;
    uint8_t sliceInfoValid;
    RIL_SliceInfo sliceInfo;
    size_t trafficDescriptorsLength;
    RIL_TrafficDescriptor trafficDescriptors[MAX_TRAFFIC_DESCRIPTORS];
} RIL_Data_Call_Response_v11;

/**
 * Radio technology family
 */
typedef enum {
    RADIO_TECH_FAMILY_UNKNOWN = 0, /**< Unknown */
 ...
 */
typedef enum {
    RIL_MEMORY_CAPACITY_EXCEEDED = 0xD3,  /**< Capacity exceeded */
    RIL_UNSPECIFIED_ERROR = 0XFF          /**< Unspecified error */
 ...
 */
typedef enum {
    RIL_OPERATOR_UNKNOWN,     /**< Unknown */
    RIL_OPERATOR_AVAILABLE,   /**< Available operator */
    RIL_OPERATOR_CURRENT,     /**< Current operator */
    RIL_OPERATOR_FORBIDDEN    /**< Current operator */
} RIL_OperatorStatus;
...
typedef enum {
    ...
    HOLD = 3
} RIL_DataThrottlingAction;

/**
 * Reason for the recently ended call
 */
typedef enum {
 ...
 * Registration state
 *
 * @noop Please note that registration state UNKNOWN is
 * @noop treated as "out of service" in the Android telephony.
 * @noop Registration state REG_DENIED must be returned if Location Update
 * @noop Reject (with cause 17 - Network Failure) is received
 * @noop repeatedly from the network, to facilitate
 * @noop "managed roaming"
 */
typedef enum {
 ...
 */
typedef enum {
    CDMA_OTA_PROVISION_STATUS_SPL_UNLOCKED,         /**< SPL unlocked */
    CDMA_OTA_PROVISION_STATUS_SPC_RETRIES_EXCEEDED, /**< SPC retries exceeded */
    CDMA_OTA_PROVISION_STATUS_A_KEY_EXCHANGED,      /**< A-key exchanged */
    CDMA_OTA_PROVISION_STATUS_SSD_UPDATED,          /**< SSD updated */
    CDMA_OTA_PROVISION_STATUS_NAM_DOWNLOADED,       /**< NAM downloaded */
    CDMA_OTA_PROVISION_STATUS_MDN_DOWNLOADED,       /**< MDN downloaded */
    CDMA_OTA_PROVISION_STATUS_IMSI_DOWNLOADED,      /**< IMSI downloaded */
    CDMA_OTA_PROVISION_STATUS_PRL_DOWNLOADED,       /**< PRL downloaded */
    CDMA_OTA_PROVISION_STATUS_COMMITTED,            /**< Commit successful */
    CDMA_OTA_PROVISION_STATUS_OTAPA_STARTED,        /**< OTAPA started */
    CDMA_OTA_PROVISION_STATUS_OTAPA_STOPPED,        /**< OTAPA stopped */
    CDMA_OTA_PROVISION_STATUS_OTAPA_ABORTED         /**< OTAPA aborted */
 ...
 */
typedef enum {
    RIL_SIGNAL_QUALITY_UNKNOWN = 0,   /**< Unknown */
    RIL_SIGNAL_QUALITY_LOW = 1,       /**< Low-quality PLMN signal */
    RIL_SIGNAL_QUALITY_HIGH = 2,      /**< High-quality PLMN signal */
} RIL_SignalQuality;
 ...
 */
typedef struct {
    uint8_t nid[MAX_SNPN_NID_LEN];    /**< SNPN identifier */
    char mcc[MAX_RIL_MCC_MNC_SIZE];   /* 3-digit Mobile Country Code, 0..999, INT_MAX if unknown  */
    char mnc[MAX_RIL_MCC_MNC_SIZE];   /* 3-digit Mobile Country Code, 0..999, INT_MAX if unknown  */
    int32_t signalStrength;           /* SNPN's signal strength information  */
    RIL_SignalQuality signalQuality;  /* Indicates the PLMN Signal Quality  LOW, HIGH or UNKNOWN  */
} RIL_SnpnInfo;
 ...
 */
typedef struct {
    char cagName[MAX_CAG_NAME_LEN];   /* Common Access Group Name corresponding to CAG Cell.  */
    uint32_t cagId;                   /* CAG ID of CAG Cell  */
    uint8_t cagOnlyAccess;            /* Indicates if PLMN is CAG only access.  */
    uint8_t cagInAllowedList;         /* Indicates the presence of [PLMN, CAG_ID] combination in the CAG info list. CAG info list (List of CAG Cells) */
} RIL_CagInfo;
...
typedef struct {
    ...
    int32_t bandwidth;
    int32_t band;
    uint8_t snpn_info_valid;    /* Indicates the SNPN Information is valid  */
    RIL_SnpnInfo snpn_info;     /* SNPN Networks Information */
    uint8_t cag_info_valid;     /* Indicates the CAG Cells Information is valid  */
    RIL_CagInfo cag_info;       /* CAG Cells Information  */
} RIL_CellIdentityNr;
...
typedef enum {
  ...
  RIL_CELL_INFO_TYPE_GSM    = 1,     /**< GSM */
  RIL_CELL_INFO_TYPE_CDMA   = 2,     /**< CDMA */
  RIL_CELL_INFO_TYPE_LTE    = 3,     /**< LTE */
  RIL_CELL_INFO_TYPE_WCDMA  = 4,     /**< WCDMA */
  RIL_CELL_INFO_TYPE_TD_SCDMA  = 5,  /**< TD SCDMA */
  RIL_CELL_INFO_TYPE_NR  = 6         /**< 5G NR */
} RIL_CellInfoType;
 ...
 */
typedef enum {
    RIL_TIMESTAMP_TYPE_UNKNOWN = 0,   /**< Unknown */
    RIL_TIMESTAMP_TYPE_ANTENNA = 1,   /**< Antenna */
    RIL_TIMESTAMP_TYPE_MODEM = 2,     /**< Modem */
    RIL_TIMESTAMP_TYPE_OEM_RIL = 3,   /**< OEM RIL */
    RIL_TIMESTAMP_TYPE_JAVA_RIL = 4,  /**< JAVA RIL */
} RIL_TimeStampType;
...
typedef struct {
    ...
    int32_t geranDtmSupported;            // dual transfer mode for GSM
...
typedef struct {
    uint8_t isVopsSupported;      // Indicates if VoNR is supported
    RIL_Nr5gEmcVal isEmcSupported;       // Indicates if VoNR emergency bearers are supported
    RIL_Nr5gEmfVal isEmfSupported;       // Indicates if VoNR emergency service fallback is supported
} NrVopsInfo;
...
typedef struct {
    ...
    uint8_t nrVopsInfoValid;              // Indicates if nrVopsInfo field is valid
    NrVopsInfo nrVopsInfo;                // Information about NR voice over PS
 ...
 */
typedef enum {
  RIL_CDMA_DISPLAY_INFO_REC,               /**< Display info record */
  RIL_CDMA_CALLED_PARTY_NUMBER_INFO_REC,   /**< Called party number info record */
  RIL_CDMA_CALLING_PARTY_NUMBER_INFO_REC,  /**< Calling party number info record */
  RIL_CDMA_CONNECTED_NUMBER_INFO_REC,      /**< Connected number info record */
  RIL_CDMA_SIGNAL_INFO_REC,                /**< Signal info record */
  RIL_CDMA_REDIRECTING_NUMBER_INFO_REC,    /**< Redirecting number info record */
  RIL_CDMA_LINE_CONTROL_INFO_REC,          /**< Line control info record */
  RIL_CDMA_EXTENDED_DISPLAY_INFO_REC,      /**< Extended display info record */
  RIL_CDMA_T53_CLIR_INFO_REC,              /**< T53 CLIR info record */
  RIL_CDMA_T53_RELEASE_INFO_REC,           /**< T53 Release info record */
  RIL_CDMA_T53_AUDIO_CONTROL_INFO_REC      /**< T53 Audio control info record */
 ...
 */
typedef enum {
  RIL_REDIRECTING_REASON_UNKNOWN = 0,  /**< Unknown */
  RIL_REDIRECTING_REASON_CALL_FORWARDING_BUSY = 1,  /**< Call forwarding busy */
  RIL_REDIRECTING_REASON_CALL_FORWARDING_NO_REPLY = 2,  /**< Call forwarding no reply */
  RIL_REDIRECTING_REASON_CALLED_DTE_OUT_OF_ORDER = 9,  /**< Called DTF out of order */
  RIL_REDIRECTING_REASON_CALL_FORWARDING_BY_THE_CALLED_DTE = 10,  /**< Call forwarding by called DTE */
  RIL_REDIRECTING_REASON_CALL_FORWARDING_UNCONDITIONAL = 15,  /**< Call forwarding unconditional */
  RIL_REDIRECTING_REASON_RESERVED  /**< Reserver */
 ...
 */
typedef enum {
    HANDOVER_STARTED = 0,    /**< SRVCC started */
    HANDOVER_COMPLETED = 1,  /**< SRVCC completed */
    HANDOVER_FAILED = 2,     /**< SRVCC failed */
    HANDOVER_CANCELED = 3    /**< SRVCC cancelled */
} RIL_SrvccState;
 ...
 */
typedef enum {
   RIL_HARDWARE_CONFIG_MODEM = 0,  /**< Modem */
   RIL_HARDWARE_CONFIG_SIM = 1,    /**< SIM */
 ...
 */
typedef enum {
   RIL_HARDWARE_CONFIG_STATE_ENABLED = 0,   /**< Enabled */
   RIL_HARDWARE_CONFIG_STATE_STANDBY = 1,   /**< Stand by */
   RIL_HARDWARE_CONFIG_STATE_DISABLED = 2,  /**< Disabled */
 ...
 */
typedef enum {
  SS_CFU,                  /**< Call forwarding unconditional */
  SS_CF_BUSY,              /**< Call forwarding when busy */
  SS_CF_NO_REPLY,          /**< Call forwarding when there is no reply */
  SS_CF_NOT_REACHABLE,     /**< Call forwarding when not reachable */
  SS_CF_ALL,               /**< All call forwarding */
  SS_CF_ALL_CONDITIONAL,   /**< All conditional forwarding */
  SS_CLIP,                 /**< Calling line identification presentation */
  SS_CLIR,                 /**< Calling line identification restriction */
  SS_COLP,                 /**< Connected line identification presentation */
  SS_COLR,                 /**< Connected line identification restriction */
  SS_WAIT,                 /**< Call waiting */
  SS_BAOC,                 /**< Call barring all outgoing */
  SS_BAOIC,                /**< Call barring outgoing internal */
  SS_BAOIC_EXC_HOME,       /**< Call barring outgoing external to home */
  SS_BAIC,                 /**< Call barring all incoming */
  SS_BAIC_ROAMING,         /**< Call barring roaming incoming */
  SS_ALL_BARRING,          /**< All calls are barred  */
  SS_OUTGOING_BARRING,     /**< All outgoing calls are barred */
  SS_INCOMING_BARRING,     /**< All incoming calls are barred */
  SS_INCOMING_BARRING_DN,  /**< Incoming calls from registered and activated numbers are barred */
  SS_INCOMING_BARRING_ANONYMOUS, /**< Incoming calls from anonymous numbers are barred  */
} RIL_SsServiceType;
 ...
 */
typedef enum {
  SS_ACTIVATION,    /**< Activation */
  SS_DEACTIVATION,  /**< Deactivation */
  SS_INTERROGATION, /**< Interrogation */
  SS_REGISTRATION,  /**< Registration */
  SS_ERASURE        /**< Erasure */
} RIL_SsRequestType;

/**
 * Supplementary service tele service type
 */
typedef enum {
  SS_ALL_TELE_AND_BEARER_SERVICES,  /**< Tele and bearer services */
  SS_ALL_TELESEVICES,               /**< All tele services */
  SS_TELEPHONY,                     /**< Telephony */
  SS_ALL_DATA_TELESERVICES,         /**< All data and tele services */
  SS_SMS_SERVICES,                  /**< SMS services */
  SS_ALL_TELESERVICES_EXCEPT_SMS    /** All tele services except SMS */
...
typedef enum {
    ...
    SS_FAX = 1 << 2,        /**< Fax */
    SS_SMS = 1 << 3,        /**< SMS */
    SS_DATA_SYNC = 1 << 4,  /**< Data sync */
    SS_DATA_ASYNC = 1 << 5, /**< Data async */
    SS_PACKET = 1 << 6,     /**< packet */
    SS_PAD = 1 << 7,        /**< PAD */
    SS_MAX = 1 << 7         /**< MAX */
} RIL_SuppServiceClass;
 ...
 */
typedef enum {
    GERAN_BAND_T380 = 1,      /**< GERAN_BAND_T380 */
    GERAN_BAND_T410 = 2,      /**< GERAN_BAND_T410 */
    GERAN_BAND_450 = 3,       /**< GERAN_BAND_450 */
    GERAN_BAND_480 = 4,       /**< GERAN_BAND_480 */
    GERAN_BAND_710 = 5,       /**< GERAN_BAND_710 */
    GERAN_BAND_750 = 6,       /**< GERAN_BAND_750 */
    GERAN_BAND_T810 = 7,      /**< GERAN_BAND_T810 */
    GERAN_BAND_850 = 8,       /**< GERAN_BAND_850 */
    GERAN_BAND_P900 = 9,      /**< GERAN_BAND_P900 */
    GERAN_BAND_E900 = 10,     /**< GERAN_BAND_E900 */
    GERAN_BAND_R900 = 11,     /**< GERAN_BAND_R900 */
    GERAN_BAND_DCS1800 = 12,  /**< GERAN_BAND_DCS1800 */
    GERAN_BAND_PCS1900 = 13,  /**< GERAN_BAND_PCS1900 */
    GERAN_BAND_ER900 = 14,    /**< GERAN_BAND_PCS1900 */
} RIL_GeranBands;
...
typedef struct {
    ...
    RIL_RadioAccessSpecifier* specifiers_latest;
} RIL_SysSelChannels;
 ...
 */
typedef enum {
    RIL_ACCESS_MODE_INVALID = 0,   /* INVALID Access Mode  */
    RIL_ACCESS_MODE_PLMN = 1,      /* PLMN Access Mode  */
    RIL_ACCESS_MODE_SNPN = 2,      /* SNPN Access Mode  */
} RIL_AccessMode;
 ...
 */
typedef enum {
    RIL_SEARCH_TYPE_INVALID = 0,        /* INVALID Search Type  */
    RIL_SEARCH_TYPE_PLMN_AND_CAG = 1,   /* PLMN+CAG Search Type  */
    RIL_SEARCH_TYPE_PLMN_ONLY = 2,      /* PLMN Only Search Type  */
} RIL_SearchType;
...
typedef struct {
    ...
    RIL_AccessMode accessMode;              // Indicates the current Access Mode
                                            // Set RIL_ACCESS_MODE_INVALID if access mode is not
                                            // valid

    RIL_SearchType searchType;              // Network Scan Search Type.
                                            // Set RIL_SEARCH_TYPE_INVALID if search type is not
                                            // valid
} RIL_NetworkScanRequest;

/**
 * Network scan parameter limits
 */
typedef enum {
    SCAN_MIN_INTERVAL = 5,
...
/**
 * Emergency callback modes
 */
typedef enum {
    RIL_EMERGENCY_CALLBACK_MODE_EXIT = 0,  /**< Enter to emergency callback mode */
    RIL_EMERGENCY_CALLBACK_MODE_ENTER = 1, /**< Exit from emergency callback mode */
} RIL_EmergencyCbMode;
...
typedef enum {
    /** UNKNOWN */
    ENHANCED_RADIO_TECH_UNKNOWN = 0,
    /** GPRS */
    ENHANCED_RADIO_TECH_GPRS = 1,
    /** EDGE */
    ENHANCED_RADIO_TECH_EDGE = 2,
    /** UMTS */
    ENHANCED_RADIO_TECH_UMTS = 3,
    /** IS95A */
    ENHANCED_RADIO_TECH_IS95A = 4,
    /** IS95B */
    ENHANCED_RADIO_TECH_IS95B = 5,
    /** RTT */
    ENHANCED_RADIO_TECH_1xRTT =  6,
    /** EVDO_0 */
    ENHANCED_RADIO_TECH_EVDO_0 = 7,
    /** EVDO_A */
    ENHANCED_RADIO_TECH_EVDO_A = 8,
    /** HSDPA */
    ENHANCED_RADIO_TECH_HSDPA = 9,
    /** HSUPA */
    ENHANCED_RADIO_TECH_HSUPA = 10,
    /** HSPA */
    ENHANCED_RADIO_TECH_HSPA = 11,
    /** EVDO_B */
    ENHANCED_RADIO_TECH_EVDO_B = 12,
    /** EHRPD */
    ENHANCED_RADIO_TECH_EHRPD = 13,
    /** LTE */
    ENHANCED_RADIO_TECH_LTE = 14,
    /** HSPAP */
    ENHANCED_RADIO_TECH_HSPAP = 15, // HSPA+
    /** GSM */
    ENHANCED_RADIO_TECH_GSM = 16, // Only supports voice
    /** TD_CDMA */
    ENHANCED_RADIO_TECH_TD_SCDMA = 17,
    /** IWLAN */
    ENHANCED_RADIO_TECH_IWLAN = 18,
    /** LTE_CA */
    ENHANCED_RADIO_TECH_LTE_CA = 19,
    /** 5G NSA*/
    ENHANCED_RADIO_TECH_NR_NSA = 20,
    /** 5G SA*/
    ENHANCED_RADIO_TECH_NR_SA = 21,
} EnhancedRadioTechnology;

typedef enum {
    ENHANCED_RAF_UNKNOWN =  (1 <<  ENHANCED_RADIO_TECH_UNKNOWN),
    ENHANCED_RAF_GPRS = (1 << ENHANCED_RADIO_TECH_GPRS),
    ENHANCED_RAF_EDGE = (1 << ENHANCED_RADIO_TECH_EDGE),
    ENHANCED_RAF_UMTS = (1 << ENHANCED_RADIO_TECH_UMTS),
    ENHANCED_RAF_IS95A = (1 << ENHANCED_RADIO_TECH_IS95A),
    ENHANCED_RAF_IS95B = (1 << ENHANCED_RADIO_TECH_IS95B),
    ENHANCED_RAF_1xRTT = (1 << ENHANCED_RADIO_TECH_1xRTT),
    ENHANCED_RAF_EVDO_0 = (1 << ENHANCED_RADIO_TECH_EVDO_0),
    ENHANCED_RAF_EVDO_A = (1 << ENHANCED_RADIO_TECH_EVDO_A),
    ENHANCED_RAF_HSDPA = (1 << ENHANCED_RADIO_TECH_HSDPA),
    ENHANCED_RAF_HSUPA = (1 << ENHANCED_RADIO_TECH_HSUPA),
    ENHANCED_RAF_HSPA = (1 << ENHANCED_RADIO_TECH_HSPA),
    ENHANCED_RAF_EVDO_B = (1 << ENHANCED_RADIO_TECH_EVDO_B),
    ENHANCED_RAF_EHRPD = (1 << ENHANCED_RADIO_TECH_EHRPD),
    ENHANCED_RAF_LTE = (1 << ENHANCED_RADIO_TECH_LTE),
    ENHANCED_RAF_HSPAP = (1 << ENHANCED_RADIO_TECH_HSPAP),
    ENHANCED_RAF_GSM = (1 << ENHANCED_RADIO_TECH_GSM),
    ENHANCED_RAF_TD_SCDMA = (1 << ENHANCED_RADIO_TECH_TD_SCDMA),
    ENHANCED_RAF_LTE_CA = (1 << ENHANCED_RADIO_TECH_LTE_CA),
    ENHANCED_RAF_NR_NSA = (1 << ENHANCED_RADIO_TECH_NR_NSA),
    ENHANCED_RAF_NR_SA = (1 << ENHANCED_RADIO_TECH_NR_SA),
} EnhancedRadioAccessFamily;
 ...
 *
 * Get System Selection parameters
 *
 * "data" is  NULL
 * "response" is RIL_SysSelChannels
 */
#define RIL_REQUEST_GET_SYSTEM_SELECTION_CHANNELS 219

/**
 * RIL_SEND_LPA_USER_REQUEST
 * Get Response from Euicc for request
 * Data depends on the request type
 * "Response" based on the request sent
*/

#define RIL_SEND_LPA_USER_REQUEST 220

/**
 * RIL_SEND_LPA_HTTP_REQUEST
 * Get Response from Euicc for request
 * Data depends on the request type
 * "Response" based on the request sent
*/

#define RIL_SEND_LPA_HTTP_REQUEST 251
 ...
 *
 * Indicates that an apn from a failed setupDataCall request is no longer
 * throttled.
 *
 * "data" is a string representing the apn
 */
#define RIL_UNSOL_UNTHROTTLE_APN 1057

/**
 * RIL_REQUEST_SET_DATA_THROTTLING
 *
 */
#define RIL_REQUEST_SET_DATA_THROTTLING 1058

/**
 * RIL_REQUEST_SETUP_DATA_CALL_URSP
 *
 */
#define RIL_REQUEST_SETUP_DATA_CALL_URSP 1059

/**
* LPA_UNSOL_ADD_PROFILE_PROGRESS_INDICCATION
*/
#define RIL_UNSOL_LPA_ADD_PROF_PROG_IND 1060

/**
* LPA_UNSOL_HTTP_TXN_IND
*/
#define RIL_UNSOL_LPA_HTTP_TXN_IND 1061
 ...
 *                          section 2.2. For example, "192.0.1.3" or "2001:db8::1". This parameter
 *                          must be ignored unless reason is RIL_RadioDataRequestReasons.HANDOVER.
 *                          7) sliceInfoValid, whether sliceInfo is applicable (0 false, 1 true)
 *                          8) sliceInfo, to be used for the data connection when a handover
 *                          occurs from EPDG to 5G. It is valid only when accessNetwork is
 *                          AccessNetwork:NGRAN.  If the slice passed from EPDG is rejected,
 *                          then the data failure cause must be DataCallFailCause:SLICE_REJECTED.
 *                          9) trafficDescriptorValid, whether TD is applicable (0 false, 1 true)
 *                          10) trafficDescriptor, TD for which data connection needs to be
 *                          established. It is used for URSP traffic matching. It includes an
 *                          optional DNN which, if present, must be used for traffic matching --
 *                          it does not specify the end point to be used for the data call. The end
 *                          point is specified by DataProfileInfo.apn; DataProfileInfo.apn must be
 *                          used as the end point if one is not specified through URSP rules.
 *                          11) matchAllRuleAllowed, uint8_t to indicate if using default match-all
 *                          URSP rule for this request is allowed. If 0, this request must
 *                          not use the match-all URSP rule and if a non-match-all rule is not
 *                          found (or if URSP rules are not available) it should return failure
 *                          with cause DataCallFailCause:MATCH_ALL_RULE_NOT_ALLOWED. This is
 *                          needed as some requests need to have a hard failure if the intention
 *                          cannot be met, for example, a zero-rating slice. (0 false, 1 true)
*/
typedef enum {
...
typedef struct {
    ...
    size_t  no_of_headers;
    UimLpaHttpCustomHeader *headers;
}UimLpaHttpTrnsReq;
...
}UimLpaAddProfFailCause;

typedef struct {
   UimAddProfStatusType  status;
   UimLpaAddProfFailCause cause;
   int32_t progress;
   UimLpaProfilePolicyMask   policyMask;
   int userConsentRequired;
   char * profileName;
}UimLpaAddProfProgressInd;

typedef struct {
   char *headerName;
   char *headerValue;
}UimLpaHttpCustomHdrType;
...
typedef struct {
    ...
    char *contentType;
    size_t no_of_headers;
    UimLpaHttpCustomHdrType *customHeaders;
    char *url;
}UimLpaHttpTxnIndype;
...
typedef struct {
    ...
    uint8_t sliceInfoValid;
    RIL_SliceInfo sliceInfo;
    uint8_t trafficDescriptorValid;
    RIL_TrafficDescriptor trafficDescriptor;
    uint8_t matchAllRuleAllowed;
} RIL_SetUpDataCallParams_Ursp;
