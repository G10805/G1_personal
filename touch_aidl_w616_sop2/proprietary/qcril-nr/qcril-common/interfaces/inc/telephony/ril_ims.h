...
/**
 * @file ril_ims.h
 * @brief Contains data structures related to IMS request
 */
...
enum RIL_IMS_RegistrationState {
  RIL_IMS_REG_STATE_UNKNOWN = 0,        /**< Unknown */
  RIL_IMS_REG_STATE_REGISTERED = 1,     /**< Registered */
  RIL_IMS_REG_STATE_NOT_REGISTERED = 2, /**< Not registered */
  RIL_IMS_REG_STATE_REGISTERING = 3,    /**< Registering */
};
...
struct RIL_IMS_Registration {
  RIL_IMS_RegistrationState state; /**< Registration state */
  uint32_t errorCode;              /** Returned when the state is NOT_REGISTERED
                                                   <br>Values:
                                                   <br>  - 3xx -- Redirection
                                                   <br>  - 4xx -- Client failure
                                                   <br>  - 5xx -- Server failure
                                                   <br>  - 6xx -- Global failure */
...
enum RIL_IMS_StatusType {
  RIL_IMS_STATUS_DISABLED = 0,          /**< Disabled */
  RIL_IMS_STATUS_PARTIALLY_ENABLED = 1, /**< Partially enabled */
  RIL_IMS_STATUS_ENABLED = 2,           /**< Enabled */
...
enum RIL_IMS_RttMode {
  RIL_IMS_RTT_DISABLED = 0, /**< Disabled */
  RIL_IMS_RTT_FULL = 1,     /**< Enabled */
};
...
struct RIL_IMS_AccessTechnologyStatus {
  RIL_RadioTechnology networkMode;   /** Network mode */
  ...
  uint32_t restrictCause;            /** Restrict cause */
...
struct RIL_IMS_SubConfigInfo {
  ...
  uint8_t *imsStackEnabled;    /**< Array indicating IMS Capability of the Device;
                                 <br>ex: [true, false] - Ims enabled on slot 1; disabled on slot 2 */
};
...
enum RIL_IMS_ToneOperation {
    RIL_IMS_TONE_OP_INVALID, /**< Invalid operation */
    RIL_IMS_TONE_OP_STOP,    /**< stop play ringback tone. */
    RIL_IMS_TONE_OP_START,   /**< start play ringback tone. */
};
...
enum RIL_IMS_CallState {
    RIL_IMS_CALLSTATE_UNKNOWN,    /**< Unknown */
    RIL_IMS_CALLSTATE_ACTIVE,     /**< Active */
    RIL_IMS_CALLSTATE_HOLDING,    /**< Holding */
    RIL_IMS_CALLSTATE_DIALING,    /**< Dialing. MO call only */
    RIL_IMS_CALLSTATE_ALERTING,   /**< Alerting. MO call only */
    RIL_IMS_CALLSTATE_INCOMING,   /**< Incoming. MT call only */
    RIL_IMS_CALLSTATE_WAITING,    /**< Waiting. MT call only */
...
enum RIL_IMS_CallDomain {
    RIL_IMS_CALLDOMAIN_UNKNOWN,   /**< Unknown */
    ...
    RIL_IMS_CALLDOMAIN_NOT_SET,   /**< Not set */
    RIL_IMS_CALLDOMAIN_INVALID,   /**< Invalid */
};
...
enum RIL_IMS_CallFailCause {
  ...
  RIL_IMS_FAILCAUSE_DSDA_CONCURRENT_CALL_NOT_POSSIBLE,
...
enum RIL_IMS_VerificationStatus {
  RIL_IMS_VERSTAT_UNKNOWN, /** Unknown */
...
enum RIL_IMS_MsimAdditionalInfoCode {
  RIL_IMS_MSIM_ADDITIONAL_INFO_NONE,
  RIL_IMS_MSIM_ADDITIONAL_INFO_CONCURRENT_CALL_NOT_POSSIBLE,
};

struct RIL_IMS_MsimAdditionalCallInfo {
  RIL_IMS_MsimAdditionalInfoCode additionalCode;
};
...
enum RIL_IMS_Codec {
  RIL_IMS_CODEC_NONE,
  RIL_IMS_CODEC_QCELP13K,
  RIL_IMS_CODEC_EVRC,
  RIL_IMS_CODEC_EVRC_B,
  RIL_IMS_CODEC_EVRC_WB,
  RIL_IMS_CODEC_EVRC_NW,
  RIL_IMS_CODEC_AMR_NB,
  RIL_IMS_CODEC_AMR_WB,
  RIL_IMS_CODEC_GSM_EFR,
  RIL_IMS_CODEC_GSM_FR,
  RIL_IMS_CODEC_GSM_HR,
  RIL_IMS_CODEC_G711U,
  RIL_IMS_CODEC_G723,
  RIL_IMS_CODEC_G711A,
  RIL_IMS_CODEC_G722,
  RIL_IMS_CODEC_G711AB,
  RIL_IMS_CODEC_G729,
  RIL_IMS_CODEC_EVS_NB,
  RIL_IMS_CODEC_EVS_WB,
  RIL_IMS_CODEC_EVS_SWB,
  RIL_IMS_CODEC_EVS_FB,
};

/**
 * Computed audio quality received based on codec and bitrate.
 */
enum RIL_IMS_ComputedAudioQuality {
  RIL_IMS_COMPUTED_AUDIO_QUALITY_NONE,
  RIL_IMS_COMPUTED_AUDIO_QUALITY_NO_HD,
  RIL_IMS_COMPUTED_AUDIO_QUALITY_HD,
  RIL_IMS_COMPUTED_AUDIO_QUALITY_HD_PLUS,
};

/**
 * Audio quality consits of codec and computed audio quality.
 */
struct RIL_IMS_AudioQuality {
  RIL_IMS_Codec codec;
  RIL_IMS_ComputedAudioQuality computedAudioQuality;
};
...
struct RIL_IMS_CallInfo {
    ...
    RIL_IMS_MsimAdditionalCallInfo  *msimAdditionalCallInfo;
    RIL_IMS_AudioQuality* imsAudioQuality;
};
...
enum RIL_IMS_ConfigItem {
     ...
     */
    RIL_IMS_CONFIG_ITEM_VOWIFI_ENTITLEMENT_ID,

     /** Value for this item is: (Int)
      * B2C Enrich Calling Preference
      * Values:
      *   - 0 -- DISABLED
      *   - 1 -- ENABLED
      *
      ...
      * if the value is not any of the above.
      */
    RIL_IMS_CONFIG_ITEM_B2C_ENRICHED_CALLING_SETTING,

    RIL_IMS_CONFIG_ITEM_INVALID
};

/**
 * IMS Config failure cause
 */
...
/**
 * Conference Participant Operation
 */
...
/**
 * IMS registration failure reason
 */
...
enum RIL_IMS_VerstatVerificationStatus {
  RIL_IMS_VERSTAT_VERIFICATION_STATUS_NONE,
  RIL_IMS_VERSTAT_VERIFICATION_STATUS_PASS,
  RIL_IMS_VERSTAT_VERIFICATION_STATUS_FAIL,
};

enum RIL_IMS_CallComposerPriority {
  RIL_IMS_CALL_COMPOSER_PRIORITY_INVALID,
  RIL_IMS_CALL_COMPOSER_PRIORITY_URGENT,
  RIL_IMS_CALL_COMPOSER_PRIORITY_NORMAL,
};

struct RIL_IMS_CallComposerLocation {
  double radius;  // 0 for point location, and -1 if location is not set
  double latitude;
  double longitude;
};

struct RIL_IMS_CallComposerInfo {
  RIL_IMS_CallComposerPriority priority;
  char* subject;
  RIL_IMS_CallComposerLocation location;
  char* imageUrl;
  char* organization;
};

struct RIL_IMS_EcnamInfo {
  char* name;
  char* iconUrl;
  char* infoUrl;
  char* cardUrl;
...
struct RIL_IMS_AutoCallRejectionInfo {
  ...
  char* number;
  RIL_IMS_VerstatVerificationStatus verificationStatus;
  RIL_IMS_CallComposerInfo* ccInfo;
...
/**
 * Geo locaiton data retrival status
 */
enum RIL_IMS_GeoLocationDataStatus {
  RIL_IMS_GEO_LOC_DATA_STATUS_UNKNOWN, /** Unknown */
...
/**
 * Voice capability on multi sims.
 */
enum RIL_IMS_MultiSimVoiceCapability {
  RIL_IMS_NONE,         /** None */
  RIL_IMS_DSSS,         /** Dual SIM Single Standby */
  RIL_IMS_DSDS,         /** Dual SIM Dual Standby */
  RIL_IMS_DSDA,         /** Dual SIM Dual Active */
  RIL_IMS_PSEUDO_DSDA,  /** Pseudo Dual SIM Dual Active */
};

struct RIL_IMS_PreAlertingCallInfo {
  uint32_t callId;
  RIL_IMS_CallComposerInfo* ccInfo;
  RIL_IMS_EcnamInfo* ecnamInfo;
};
 ...
 *
 * Request to exit emergency callback mode.
 *
 * "data" is NULL
 *
 * "response" is NULL
 ...
 *
 * "data" is uint32_t. serviceClass
 *
 * "response" is RIL_IMS_QueryCallWaitingResponse
 *
 * Valid errors:
 *  SUCCESS
 *  GENERIC_FAILURE
 ...
 *
 * "data" is RIL_IMS_CallWaitingSettings
 *
...
/**
 * RIL_IMS_REQUEST_SET_COLR
 *
 * Set COLR
 *
 * "data" is RIL_IMS_ColrInfo
 *
 * "response" is NULL
 *
 * Valid errors:
 ...
 *
 * Gets value for Ims Config item
 *
 * "data" is "RIL_IMS_ConfigInfo"
 *
 * "response" is "RIL_IMS_ConfigInfo"
 ...
 * Send SMS
 *
 * "data" is RIL_IMS_SmsMessage
 *
 * "response" is RIL_IMS_SendSmsResponse
 *
 * Valid errors:
 *  SUCCESS
 *  GENERIC_FAILURE
...
/**
 * RIL_IMS_REQUEST_ACK_SMS_REPORT
 *
 * Request ack SMS report
 *
 * "data" is NULL
 *
 * "response" is NULL
...
/**
 * RIL_IMS_REQUEST_REGISTER_MULTI_IDENTITY_LINES
 *
 * Request to set the Multi Line Identidy lines.
 *
...
/**
 * RIL_IMS_REQUEST_QUERY_VIRTUAL_LINE_INFO
 *
 * Quries virtual lines info.
 *
 * "data" is NULL
 *
 * "response" is RIL_IMS_QueryVirtualLineInfoResponse
 *
 * Valid errors:
 *  SUCCESS
 *  GENERIC_FAILURE
...
/**
 * RIL_IMS_REQUEST_QUERY_MULTI_SIM_VOICE_CAPABILITY
 *
 * Query multi sim voice capability
 *
 * "data" is null
 *
 * "response" is RIL_IMS_MultiSimVoiceCapability
 *
 * Valid errors:
 *  SUCCESS
 *  GENERIC_FAILURE
 */
#define RIL_IMS_REQUEST_QUERY_MULTI_SIM_VOICE_CAPABILITY 10045

/**
 * RIL_IMS_REQUEST_SEND_USSD
 *
 * Send a USSD message
 *
 ...
 *
 * The network reply should be reported via RIL_IMS_UNSOL_ON_USSD
 *
 * Only one USSD session may exist at a time, and the session is assumed
 * to exist until:
 *   a) The android system invokes RIL_IMS_REQUEST_CANCEL_USSD
 *   b) The implementation sends a RIL_IMS_UNSOL_ON_USSD with a type code
 ...
 *
 */
#define RIL_IMS_REQUEST_SEND_USSD 10046

/**
 * RIL_IMS_REQUEST_CANCEL_USSD
 *
 ...
 *  REQUEST_NOT_SUPPORTED
 */
#define RIL_IMS_REQUEST_CANCEL_USSD 10047
...
/**
 * RIL_IMS_UNSOL_SMS_STATUS_REPORTRIL_IMS_UNSOL_SMS_STATUS_REPORT
 *
 * Called when SMS status report is recieved.
 *
 * "data" is RIL_IMS_SmsStatusReport
 */
#define RIL_IMS_UNSOL_SMS_STATUS_REPORT 15023

/**
 * RIL_IMS_UNSOL_INCOMING_CALL_AUTO_REJECTED
 *
 * Notifies clients about a MT call being automatically rejected by the modem.
 *
 * "data" is RIL_IMS_AutoCallRejectionInfo
 */
#define RIL_IMS_UNSOL_INCOMING_CALL_AUTO_REJECTED 15024
 ...
 *
 * Sends the multi idendity pending info indication
 *
 * "data" is NULL
 */
...
/**
 * RIL_IMS_UNSOL_MULTI_SIM_VOICE_CAPABILITY_CHANGED
 *
 * Indicates to notify multi sim voice capability when modem is switched between
 * DSDS, PSEUDO_DSDA and DSDA.
 *
 * "data" is RIL_IMS_MultiSimVoiceCapability
 */
#define RIL_IMS_UNSOL_MULTI_SIM_VOICE_CAPABILITY_CHANGED 15032
 ...
 */
#define RIL_IMS_UNSOL_ON_USSD 15033

/**
 * RIL_IMS_UNSOL_PRE_ALERTING_CALL_INFO_AVAILABLE
 *
 * Indicates to notify pre alerting call information like callcomposer, ecnam.
 *
 * "data" is RIL_IMS_PreAlertingCallInfo
 */
#define RIL_IMS_UNSOL_PRE_ALERTING_CALL_INFO_AVAILABLE 15034
