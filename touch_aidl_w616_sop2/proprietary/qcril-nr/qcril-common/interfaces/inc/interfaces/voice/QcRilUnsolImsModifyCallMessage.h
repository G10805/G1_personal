...
class QcRilUnsolImsModifyCallMessage : public UnSolicitedMessage,
 ...
 public:
  ...
  bool hasVosSupport() { return mVosSupport ? true : false; }
  bool getVosSupport() { return *mVosSupport; }
  void setVosSupport(bool vosSupport) { mVosSupport = vosSupport; }
