...
enum class DtmfEvent {
  ...
  IP_INCOMING_DTMF_START, /*  Received an IP-start continuous DTMF message */
  IP_INCOMING_DTMF_STOP,  /*  Received an IP-stop continuous DTMF message */
};
inline std::string toString(const DtmfEvent &o) {
  ...
  if (o == DtmfEvent::IP_INCOMING_DTMF_START) {
    return "IP_INCOMING_DTMF_START";
  }
  if (o == DtmfEvent::IP_INCOMING_DTMF_STOP) {
    return "IP_INCOMING_DTMF_STOP";
  }
  return "<invalid>";
}
...
enum class CrsType {
  INVALID, //Local ring
  AUDIO, //Audio only CRS
  VIDEO, //Video only CRS
  VIDEO_AND_AUDIO, // Video CRS with audio
};
 ...
 */
enum class CallProgressInfoType {
  UNKNOWN,          /** Invalid if CallProgressInfo is not present. */
...
inline std::string toString(const CallProgressInfoType& o) {
  if (o == CallProgressInfoType::UNKNOWN) {
    return "UNKNOWN";
  }
  if (o == CallProgressInfoType::CALL_REJ_Q850) {
    return "CALL_REJ_Q850";
  }
  if (o == CallProgressInfoType::CALL_WAITING) {
    return "CALL_WAITING";
  }
  if (o == CallProgressInfoType::CALL_FORWARDING) {
    return "CALL_FORWARDING";
  }
  if (o == CallProgressInfoType::REMOTE_AVAILABLE) {
    return "REMOTE_AVAILABLE";
  }
  return "<invalid>";
}
/**
 * Progress Info of call
 */
class CallProgressInfo {
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(CallProgressInfoType, Type);
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(uint16_t, ReasonCode);
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(std::string, ReasonText);
};

inline std::string toString(const CallProgressInfo& o) {
  std::string os{"CallProgressInfo{"};
  os += "Type=";
  if (o.hasType()) {
    os += toString(o.getType());
  }
  os += ",ReasonCode=";
  if (o.hasReasonCode()) {
    os += std::to_string(o.getReasonCode());
  }
  os += ",ReasonText=";
  if (o.hasReasonText()) {
    os += o.getReasonText();
...
/**
 * MSIM additional information code.
 */
enum class MsimAdditionalInfoCode {
  NONE,                         /** No additional information. */
  CONCURRENT_CALL_NOT_POSSIBLE, /** Call failed, but may succeed if reattempted after concurrent
                                    calls on the other subscription end. */
};

inline std::string toString(const MsimAdditionalInfoCode& o) {
  if (o == MsimAdditionalInfoCode::NONE) {
    return "NONE";
  }
  if (o == MsimAdditionalInfoCode::CONCURRENT_CALL_NOT_POSSIBLE) {
    return "CONCURRENT_CALL_NOT_POSSIBLE";
  }
  return "<invalid>";
}
 ...
 */
class MsimAdditionalCallInfo {
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(MsimAdditionalInfoCode, AdditionalCode);
};

inline std::string toString(const MsimAdditionalCallInfo& o) {
  std::string os{ "MsimAdditionalCallInfo{" };
  os += "Additional Code=";
  if (o.hasAdditionalCode()) {
    os += toString(o.getAdditionalCode());
  }
  os += "}";
  return os;
}
...
/**
 * Computed audio quality received from lower layers based on codec and bit rate.
 */
enum class ComputedAudioQuality {
  NONE,
  NO_HD,
  HD,
  HD_PLUS,
...
inline std::string toString(const ComputedAudioQuality& o) {
  if (o == ComputedAudioQuality::NONE) {
    return "NONE";
  }
  if (o == ComputedAudioQuality::NO_HD) {
    return "NO_HD";
  }
  if (o == ComputedAudioQuality::HD) {
    return "HD";
  }
  if (o == ComputedAudioQuality::HD_PLUS) {
    return "HD_PLUS";
  }
  return "<invalid>";
}
...
inline std::string toString(const AudioCodec& o) {
  if (o == AudioCodec::NONE) {
    return "NONE";
  }
  if (o == AudioCodec::QCELP13K) {
    return "QCELP13K";
  }
  if (o == AudioCodec::EVRC) {
    return "EVRC";
  }
  if (o == AudioCodec::EVRC_B) {
    return "EVRC_B";
  }
  if (o == AudioCodec::EVRC_WB) {
    return "EVRC_WB";
  }
  if (o == AudioCodec::EVRC_NW) {
    return "EVRC_NW";
  }
  if (o == AudioCodec::AMR_NB) {
    return "AMR_NB";
  }
  if (o == AudioCodec::AMR_WB) {
    return "AMR_WB";
  }
  if (o == AudioCodec::GSM_EFR) {
    return "GSM_EFR";
  }
  if (o == AudioCodec::GSM_FR) {
    return "GSM_FR";
  }
  if (o == AudioCodec::GSM_HR) {
    return "GSM_HR";
  }
  if (o == AudioCodec::G711U) {
    return "G711U";
  }
  if (o == AudioCodec::G723) {
    return "G723";
  }
  if (o == AudioCodec::G711A) {
    return "G711A";
  }
  if (o == AudioCodec::G722) {
    return "G722";
  }
  if (o == AudioCodec::G711AB) {
    return "G711AB";
  }
  if (o == AudioCodec::G729) {
    return "G729";
  }
  if (o == AudioCodec::EVS_NB) {
    return "EVS_NB";
  }
  if (o == AudioCodec::EVS_WB) {
    return "EVS_WB";
  }
  if (o == AudioCodec::EVS_SWB) {
    return "EVS_SWB";
  }
  if (o == AudioCodec::EVS_FB) {
    return "EVS_FB";
  }
  return "<invalid>";
}
...
class CallInfo {
  ...
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(std::string, RedirNum);
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(uint32_t, RedirNumPresentation);
  ...
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(std::string, DiversionInfo);
  ...
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(AudioCodec, Codec);
  ...
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(bool, SilentUi);
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(CallType, OriginalCallType);
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(CrsType, CrsType);
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(CallProgressInfo, ProgressInfo);
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(MsimAdditionalCallInfo, MsimAdditionalCallInfo);
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(ComputedAudioQuality, ComputedAudioQuality);
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(bool, VosSupport);
 ...
 public:
  CallInfo() {
    ...
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(RedirNum);
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(RedirNumPresentation);
    ...
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(DiversionInfo);
    ...
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(SilentUi);
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(OriginalCallType);
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(CrsType);
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(ProgressInfo);
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(MsimAdditionalCallInfo);
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(ComputedAudioQuality);
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(VosSupport);
  }
  ~CallInfo() {}
  CallInfo(const CallInfo &from) {
    ...
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, RedirNum);
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, RedirNumPresentation);
    ...
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, DiversionInfo);
    ...
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, SilentUi);
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, OriginalCallType);
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, CrsType);
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, ProgressInfo);
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, MsimAdditionalCallInfo);
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, ComputedAudioQuality);
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, VosSupport);
  }
};
...
class Coordinate2D : public qcril::interfaces::BasePayload {
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(int, X);
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(int, Y);
public:
  Coordinate2D() {
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(X);
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(Y);
  }
  Coordinate2D(const Coordinate2D &from) {
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, X);
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, Y);
  }

  ~Coordinate2D() {}
};

inline std::string toString(const Coordinate2D& o) {
  std::string os;
  os += "{";
  os += ".X = " + std::to_string(o.getX());
  os += ".Y = " + std::to_string(o.getY());
  os += "}";
  return os;
}

class VosMoveInfo : public qcril::interfaces::BasePayload {
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(Coordinate2D, Start);
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(Coordinate2D, End);
public:
  VosMoveInfo() {
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(Start);
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(End);
  }
  VosMoveInfo(const VosMoveInfo &from) {
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, Start);
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, End);
  }

  ~VosMoveInfo() {}
};

inline std::string toString(const VosMoveInfo& o) {
  std::string os;
  os += "{";
  os += ".Start = " + toString(o.getStart());
  os += ".End = " + toString(o.getEnd());
  os += "}";
  return os;
}

class VosTouchInfo : public qcril::interfaces::BasePayload {
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(Coordinate2D, Touch);
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(int, TouchDuration);
public:
  VosTouchInfo() {
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(Touch);
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(TouchDuration);
  }
  VosTouchInfo(const VosTouchInfo &from) {
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, Touch);
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, TouchDuration);
  }

  ~VosTouchInfo() {}
};

inline std::string toString(const VosTouchInfo& o) {
  std::string os;
  os += "{";
  os += ".Touch = " + toString(o.getTouch());
  os += ".TouchDuration = " + std::to_string(o.getTouchDuration());
  os += "}";
  return os;
}

class VosActionInfo : public qcril::interfaces::BasePayload {
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(VosMoveInfo, VosMoveInfo);
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(VosTouchInfo, VosTouchInfo);
public:
  VosActionInfo() {
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(VosMoveInfo);
    QCRIL_INTERFACE_RESET_OPTIONAL_MEMBER_VAR(VosTouchInfo);
  }
  VosActionInfo(const VosActionInfo &from) {
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, VosMoveInfo);
    QCRIL_INTERFACE_COPY_OPTIONAL_MEMBER_VAR(from, VosTouchInfo);
  }

  ~VosActionInfo() {}
};

inline std::string toString(const VosActionInfo& o) {
  std::string os;
  os += "{";
  os += ".VosMoveInfo = " + toString(o.getVosMoveInfo());
  os += ".VosTouchInfo = " + toString(o.getVosTouchInfo());
  os += "}";
  return os;
}
