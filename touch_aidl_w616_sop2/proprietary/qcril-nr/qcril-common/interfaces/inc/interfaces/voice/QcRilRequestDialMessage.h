...
class QcRilRequestDialMessage : public QcRilRequestMessage {
 ...
 public:
  ...
  inline QcRilRequestDialMessage(message_id_ref msg_id, std::shared_ptr<MessageContext> context)
  ...
  const qcril::interfaces::CallComposerInfo &getCallComposerInfo() {
    return *mCallComposerInfo;
  }
  void setCallComposerInfo(const qcril::interfaces::CallComposerInfo &val) {
