...
android_ril_module::android_ril_module()
{
    ...
    if (is_adb_logging_enabled()) {
        qti::ril::logger::Logger::setDefault("android");
    } else {
        qti::ril::logger::Logger::setDefault("diag") || qti::ril::logger::Logger::setDefault("android");
    }
#endif
    using std::placeholders::_1;
    mMessageHandler = {HANDLER(AndroidRequestRegisterMessage, android_ril_module::handleRegisterRequest)};
}
