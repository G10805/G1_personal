...
#ifndef _QTI_RADIO_H_
#define _QTI_RADIO_H_
...
class QtiRadio : public Module {
 ...
 private:
  ...
  void handleNas5gConnectionIndMessage(std::shared_ptr<Nas5gConnectionIndMessage> msg);
  void handleNas5gStatusIndMessage(std::shared_ptr<Nas5gStatusIndMessage> msg);
  void handleNasEndcDcnrIndMessage(std::shared_ptr<NasEndcDcnrIndMessage> msg);
  void handleNas5gSignalStrengthIndMessage(std::shared_ptr<Nas5gSignalStrengthIndMessage> msg);
  void handleNas5gConfigInfoIndMessage(std::shared_ptr<Nas5gConfigInfoIndMessage> msg);
  void handleNasUpperLayerIndInfoIndMessage(std::shared_ptr<NasUpperLayerIndInfoIndMessage> msg);
#ifndef QMI_RIL_UTF
  void handleDataNrIconTypeIndMessage(std::shared_ptr<rildata::DataNrIconTypeIndMessage> msg);
#endif

  ::android::sp<QtiRadioServiceBase> mQtiRadioService = nullptr;
};
