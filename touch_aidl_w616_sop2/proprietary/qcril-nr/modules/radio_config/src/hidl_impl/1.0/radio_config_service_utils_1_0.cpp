...
#include "radio_config_service_utils_1_0.h"
...
(
  ...
  V1_0::SimSlotStatus      &slot_status
)
{
  switch(ril_slot_status.card_state)
  {
    case RIL_UIM_CARDSTATE_ABSENT:
      slot_status.cardState = android::hardware::radio::V1_0::CardState::ABSENT;
      break;

    case RIL_UIM_CARDSTATE_PRESENT:
      slot_status.cardState = android::hardware::radio::V1_0::CardState::PRESENT;
      break;

    default:
      slot_status.cardState = android::hardware::radio::V1_0::CardState::ERROR;
      break;
  }
  ...
  switch(ril_slot_status.slot_state)
  {
    case RIL_UIM_PHYSICAL_SLOT_STATE_ACTIVE:
      slot_status.slotState = android::hardware::radio::config::V1_0::SlotState::ACTIVE;
      break;

    default:
      slot_status.slotState = android::hardware::radio::config::V1_0::SlotState::INACTIVE;
      break;
  }

  slot_status.logicalSlotId = ril_slot_status.logical_slot;

  if (slot_status.cardState == android::hardware::radio::V1_0::CardState::PRESENT)
  {
    char * iccid = nullptr;
    char * atr   = nullptr;
