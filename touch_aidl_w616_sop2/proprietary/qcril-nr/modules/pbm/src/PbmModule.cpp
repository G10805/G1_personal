...
PbmModule::PbmModule() : AddPendingMessageList("PbmModule")  {
  ...
  mMessageHandler = {
    ...
    HANDLER(ClientConnectedMessage, PbmModule::handleRilConnectedUnsolMessage),
...
void PbmModule::handleRilConnectedUnsolMessage(std::shared_ptr<ClientConnectedMessage> msg) {
