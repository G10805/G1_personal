...
using namespace android::hardware::secure_element::V1_1;
using namespace android::hardware::secure_element::V1_2;
...
struct SecureElementImpl : public V1_2::ISecureElement, public hidl_death_recipient
{
  sp<V1_0::ISecureElementHalCallback> mClientCb = nullptr;
  sp<V1_1::ISecureElementHalCallback> mClientCb1_1 = nullptr;
  qtimutex::QtiSharedMutex mCallbackLock;
  qtimutex::QtiSharedMutex ch_id_list_lock;
  std::vector<uint8_t> ch_id_list;

  sp<V1_0::ISecureElementHalCallback> getISecureElementHalCallback();
  sp<V1_1::ISecureElementHalCallback> getISecureElementHalCallback_1_1();
  void clearCallbacks();

  void serviceDied( uint64_t, const ::android::wp<::android::hidl::base::V1_0::IBase> &);

  Return<void> init(const sp<V1_0::ISecureElementHalCallback>& clientCallback);
  ...
  Return<void> init_1_1(const sp<V1_1::ISecureElementHalCallback>& clientCallback1_1);

  Return<SecureElementStatus> reset();
...
)
{
  ...
  qmi_uim_rsp_data_type                    rsp_data;
  sp<V1_0::ISecureElementHalCallback>            callback         =
      (secureElementService == nullptr) ? nullptr
                                        : secureElementService->getISecureElementHalCallback();
  sp<V1_1::ISecureElementHalCallback>            callback_1_1         =
      (secureElementService == nullptr) ? nullptr
                                        : secureElementService->getISecureElementHalCallback_1_1();
      ...
      rsp_data.qmi_err_code == QMI_UIM_SERVICE_ERR_NONE)
  {
                                                                     ...
                                                                     QMI_UIM_CARD_STATE_PRESENT)
    {
      ...
      else if (callback_1_1 != nullptr)
      {
        Return<void> ret = callback_1_1->onStateChange_1_1(true,"Card has been detected");

        QCRIL_LOG_INFO("=DBG= onStateChange_1_1 informed to clients");
...
FUNCTION:  SecureElementImpl::init_1_1

===========================================================================*/
Return<void> SecureElementImpl::init_1_1
(
  const sp<V1_1::ISecureElementHalCallback>& clientCallback1_1
)
{
  QCRIL_LOG_INFO("SecureElementImpl::init_1_1");

  {
    std::unique_lock<qtimutex::QtiSharedMutex> lock(mCallbackLock);
    if (mClientCb1_1 != nullptr)
    {
      mClientCb1_1->unlinkToDeath(this);
    }
    mClientCb1_1 = clientCallback1_1;

    if (mClientCb1_1 != nullptr)
    {
      mClientCb1_1->linkToDeath(this, 0);
    }
...
sp<V1_0::ISecureElementHalCallback> SecureElementImpl::getISecureElementHalCallback() {
  std::shared_lock<qtimutex::QtiSharedMutex> lock(mCallbackLock);
  return mClientCb;
}

sp<V1_1::ISecureElementHalCallback> SecureElementImpl::getISecureElementHalCallback_1_1() {
  std::shared_lock<qtimutex::QtiSharedMutex> lock(mCallbackLock);
  return mClientCb1_1;
}
  ...
  if (uim_qmi_ind_msg_ptr != NULL)
  {
    switch(uim_qmi_ind_msg_ptr->get_ind_id())
    {
      ...
      case QMI_UIM_SRVC_DOWN_IND_MSG:
        ...
        {
          ret = callback_1_1->onStateChange_1_1(false,"SecureElement has not been initialised ");
          if (!ret.isOk())
          {
            QCRIL_LOG_ERROR("Unable to send indication. Exception : %s", ret.description().c_str());
          }
      ...
      case QMI_UIM_SRVC_STATUS_CHANGE_IND_MSG:
        {
                                                                    ...
                                                                    == QMI_UIM_CARD_STATE_PRESENT)
          {
            ...
            else if (callback_1_1 != nullptr && !card_accessible)
            {
              /* Delay the card insert time for 3 secs to delay non prov app activation requests */
              ...
              sleep(3);
              ret = callback_1_1->onStateChange_1_1(true,"Uim Card Status change Indication ");
          ...
          else
          {
            ...
            else if (callback_1_1 != nullptr && card_accessible)
            {
              ...
              ret = callback_1_1->onStateChange_1_1(false,"Uim Card State absent");
      ...
      case QMI_UIM_SRVC_RECOVERY_IND_MSG:
        ...
        else if (secureElementService != nullptr && callback_1_1 != nullptr)
        {
          /* Clear cached channel ids and send state change to false and true for recovery
             So that app can clear its data and can connect again */
          ret = callback_1_1->onStateChange_1_1(false,"Uim Service recovery Indication");
          ...
          ret = callback_1_1->onStateChange_1_1(true,"Card Status Indication Folowed by recovery");
      ...
      case QMI_UIM_SRVC_REFRESH_IND_MSG:
        ...
        else if (secureElementService != nullptr && callback_1_1 != nullptr)
        {
                                                             ...
                                                             == QMI_UIM_REFRESH_MODE_RESET)
          {
            if (card_accessible)
            {
              ret = callback_1_1->onStateChange_1_1(false,"Uim Refresh reset indication");
      ...
      case QMI_UIM_SRVC_SEND_APDU_IND_MSG:
        if (is_send_apdu_in_progress)
        {
          ...
          if (long_apdu_info.apdu_ptr == NULL)
          {
            ...
            long_apdu_info.apdu_ptr = (uint8_t *)qcril_malloc(apdu_ind_ptr->total_len);
            if (long_apdu_info.apdu_ptr == NULL)
            {
...
===========================================================================*/
Return<SecureElementStatus> SecureElementImpl::reset()
{
    qmi_uim_power_down_params_type power_down_params = {};
    qmi_uim_power_up_params_type   power_up_params = {};
    qmi_uim_rsp_data_type          rsp_data       = {};
    power_down_params.slot = (qmi_uim_slot_type)(qmi_ril_get_process_instance_id() + QMI_UIM_SLOT_1);

    secure_element_send_qmi_sync_msg(QCRIL_UIM_REQUEST_POWER_DOWN,
                                                  &power_down_params,
                                                  &rsp_data);
    ...
    if(rsp_data.qmi_err_code == QMI_UIM_SERVICE_ERR_NONE)
    {
        ...
        power_up_params.slot = (qmi_uim_slot_type)(qmi_ril_get_process_instance_id() + QMI_UIM_SLOT_1);
        power_up_params.mode =  QMI_UIM_CARD_MODE_TELECOM_CARD;
        secure_element_send_qmi_sync_msg(QCRIL_UIM_REQUEST_POWER_UP,
                                                  &power_up_params,
                                                  &rsp_data);
        if(rsp_data.qmi_err_code == QMI_UIM_SERVICE_ERR_NONE)
        {
        ...
        {
            QCRIL_LOG_ERROR("UimPowerUp Request Failed with error code %d",rsp_data.qmi_err_code);
            return SecureElementStatus::FAILED;
        }
    }
    else
    {
        QCRIL_LOG_ERROR("UimPowerDown Request Failed with error code %d",rsp_data.qmi_err_code);
        return SecureElementStatus::FAILED;
    }
