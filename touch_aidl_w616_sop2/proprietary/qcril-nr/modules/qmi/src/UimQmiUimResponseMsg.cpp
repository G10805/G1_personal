...
#include "modules/qmi/UimQmiUimResponseMsg.h"
#include "qcril_uim.h"
  ...
  *rsp_id_ptr = rsp_data_ptr->rsp_id;
  ...
  switch(rsp_data_ptr->rsp_id)
  {
    ...
    case  QMI_UIM_SRVC_GET_EUICC_INFO2_RSP_MSG:
      *total_size_ptr += rsp_data_ptr->rsp_data.euicc_info2_rsp.euicc_info2_len;
      break;
    default:
      break;
  }
  ...
  switch(rsp_data_ptr->rsp_id)
  {
    ...
    case QMI_UIM_SRVC_GBA_RSP_MSG:
      {
        uint8_t  * offset_ptr = (uint8_t*)&out_ptr->payload;
    ...
    case QMI_UIM_SRVC_GET_PROFILE_INFO_RSP_MSG:
      ...
      break;
    case QMI_UIM_SRVC_GET_EUICC_INFO2_RSP_MSG:
      if (rsp_data_ptr->rsp_data.euicc_info2_rsp.euicc_info2_len > 0)
      {
        out_ptr->qmi_rsp_data.rsp_data.euicc_info2_rsp.euicc_info2_ptr =
          (uint8*)&out_ptr->payload;
        memcpy(out_ptr->qmi_rsp_data.rsp_data.euicc_info2_rsp.euicc_info2_ptr,
               rsp_data_ptr->rsp_data.euicc_info2_rsp.euicc_info2_ptr,
               rsp_data_ptr->rsp_data.euicc_info2_rsp.euicc_info2_len);
      }
      else
      {
        out_ptr->qmi_rsp_data.rsp_data.euicc_info2_rsp.euicc_info2_ptr = nullptr;
      }
      break;
