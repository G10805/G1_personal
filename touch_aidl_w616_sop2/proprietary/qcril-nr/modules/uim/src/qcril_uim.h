...
{
  uint8_t        aid_len;
  uint8_t        aid_value[QMI_UIM_MAX_AID_LEN];
  uint8_t        iccid_len;
  uint8_t        iccid_data[QCRIL_UIM_ICCID_LEN];
  uint8_t        encrypted_pin1_len;
  uint8_t        encrypted_pin1[QMI_UIM_MAX_ENCRYPTED_PIN_LEN];
  uint8_t        slot;
...
typedef struct
{
  ...
  uint8_t                             sw1;
  uint8_t                             sw2;
  uint16_t                            select_resp_len;
  uint8_t                           * select_resp_ptr;
