...
)
{
  ...
  uint8_t                               slot                   = QMI_UIM_MAX_CARD_COUNT;
...
/*===========================================================================
  ...
  FUNCTION:  qcril_uim_lpa_get_euicc_info2_req

===========================================================================*/
static bool qcril_uim_lpa_get_euicc_info2_req
(
  std::shared_ptr<UimLpaReqMessage>   msg_ptr
)
{
  int                                   qmi_err_code = 0;
  qmi_uim_get_euicc_info2_req_type              euicc_info2_req;
  uint8                                 slot         = QMI_UIM_MAX_CARD_COUNT;

  memset(&euicc_info2_req, 0, sizeof(euicc_info2_req));
  ...
  if (!qcril_uim_lpa_convert_slot_id_to_slot_type(slot, &euicc_info2_req.slot))
  {
    return FALSE;
  }

  qmi_err_code = qcril_uim_send_qmi_async_msg(QCRIL_UIM_REQUEST_GET_EUICC_INFO2,
                                              &euicc_info2_req,
                                              msg_ptr);
...
)
{
  ...
  switch(resp_ptr->qmi_rsp_data.rsp_id)
  {
    ...
    case QMI_UIM_SRVC_GET_SET_SERVER_ADDRESS_RSP_MSG:
      ...
      break;
    case QMI_UIM_SRVC_GET_EUICC_INFO2_RSP_MSG:
      lpa_user_resp.euicc_info2_len = resp_ptr->qmi_rsp_data.rsp_data.euicc_info2_rsp.euicc_info2_len;
      lpa_user_resp.euicc_info2 = resp_ptr->qmi_rsp_data.rsp_data.euicc_info2_rsp.euicc_info2_ptr;
      break;
    default:
...
)
{
  ...
  switch(in_ptr->event)
  {
    ...
    case QCRIL_UIM_LPA_CONFIRM_CODE:
      ...
      break;
    case QCRIL_UIM_LPA_GET_EUICC_INFO2:
      result = qcril_uim_lpa_get_euicc_info2_req(req_ptr);
      break;
    default:
      break;
  }
