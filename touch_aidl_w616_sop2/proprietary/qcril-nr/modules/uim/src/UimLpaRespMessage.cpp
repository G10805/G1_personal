...
#******************************************************************************/
#include <string.h>
#include "interfaces/uim/UimLpaRespMessage.h"
    ...
    case UIM_LPA_USER_RESP_ID:
      if (data_ptr != nullptr)
      {
        ...
        if (out_ptr != nullptr)
        {
          ...
          out_ptr->euicc_info2_len = 0;
          if(usr_resp_ptr->euicc_info2 != nullptr && usr_resp_ptr->euicc_info2_len != 0)
          {
              out_ptr->euicc_info2 = new uint8_t[usr_resp_ptr->euicc_info2_len];

              if(out_ptr->euicc_info2 != nullptr)
              {
                  memcpy(out_ptr->euicc_info2,usr_resp_ptr->euicc_info2,usr_resp_ptr->euicc_info2_len);
                  out_ptr->euicc_info2_len = usr_resp_ptr->euicc_info2_len;
              }
           }
