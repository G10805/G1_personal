...
#include <interfaces/sms/QcRilEventSmsQueryWmsReadyMessage.h>
...
class SmsModule: public Module, public AddPendingMessageList {
    ...
    private:
        ...
        void handleSmsRawReadMessage(std::shared_ptr<QcRilEventSmsRawReadMessage> msg);
        void handleSmsQueryWmsReadyMessage(std::shared_ptr<QcRilEventSmsQueryWmsReadyMessage> msg);
        void handleSmsQueryFormatMessage(std::shared_ptr<QcRilSyncQuerySmsFormatMessage> msg);
        void handleSmsResetAckNeededForPowerOptMessage(
                std::shared_ptr<QcRilEventSmsResetAckNeededForPowerOptMessage> msg);
        void handleNasPowerOnOptUiReadyIndMessage(
                std::shared_ptr<NasPowerOnOptUiReadyIndMessage> msg);
        void handleUnsolOperationalStatusMessage(
