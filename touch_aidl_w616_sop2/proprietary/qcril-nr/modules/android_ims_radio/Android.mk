...
include $(CLEAR_VARS)
LOCAL_MODULE               := qcrilNrAndroidImsRadioHeaders
...
LOCAL_SRC_FILES            := src/AndroidImsRadioAidlModule.cpp
LOCAL_SRC_FILES            += src/aidl_impl/ims_radio_aidl_service.cpp
LOCAL_SRC_FILES            += src/aidl_impl/ims_radio_aidl_utils.cpp

LOCAL_MODULE               := qcrilNrAndroidImsRadio
