...
AndroidImsRadioAidlModule::AndroidImsRadioAidlModule() {
  ...
  mMessageHandler = {
    ...
    HANDLER(QcRilUnsolImsCallStatusMessage,
            AndroidImsRadioAidlModule::handleQcRilUnsolImsCallStatusMessage),
    ...
    HANDLER(QcRilUnsolImsExitEcbmIndication,
            AndroidImsRadioAidlModule::handleQcRilUnsolExitEcbmIndication),
    HANDLER(QcRilUnsolImsEnterEcbmIndication,
            AndroidImsRadioAidlModule::handleQcRilUnsolEnterEcbmIndication),
...
void AndroidImsRadioAidlModule::handleQcRilUnsolImsCallStatusMessage(
...
void AndroidImsRadioAidlModule::handleQcRilUnsolExitEcbmIndication(
...
void AndroidImsRadioAidlModule::handleQcRilUnsolEnterEcbmIndication(
...
#else
    status_t status = getServiceManager()->addService(String16(instance.c_str()),  mImsRadio->asBinder().get()->getBinder());
#endif
