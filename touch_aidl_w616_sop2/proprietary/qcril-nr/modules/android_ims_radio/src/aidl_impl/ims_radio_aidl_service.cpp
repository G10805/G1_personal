...
void ImsRadioAidlImpl::notifyOnRegistrationChanged(std::shared_ptr<QcRilUnsolImsRegStateMessage> msg) {
  ...
  imsRadiolog("<", "onRegistrationChanged: reg = " + ::android::internal::ToString(regInfo));
...
void ImsRadioAidlImpl::notifyOnCallStateChanged(std::shared_ptr<QcRilUnsolImsCallStatusMessage> msg) {
  if (!msg) {
  ...
  imsRadiolog("<", "onCallStateChanged: callList = " + ::android::internal::ToString(callList));
...
void ImsRadioAidlImpl::notifyOnRefreshViceInfo(std::shared_ptr<QcRilUnsolImsViceInfoMessage> msg) {
  ...
  imsRadiolog("<", "onRefreshViceInfo: viceInfo = " + android::internal::ToString(viceInfo));
...
void ImsRadioAidlImpl::notifyOnIncomingCallAutoRejected(
  ...
  // get call composer and eCNAM info if its available
  ...
  imsRadiolog("<", "onIncomingCallAutoRejected2: auto call rejection info = " +
                       ::android::internal::ToString(callRejInfo));
...
void ImsRadioAidlImpl::notifyOnSubConfigChanged(
  ...
  imsRadiolog("<", "notifyOnSubConfigChanged: status= " + ::android::internal::ToString(config));
...
void ImsRadioAidlImpl::notifyOnServiceStatusChange(
  ...
  imsRadiolog("<", "onServiceStatusChanged: srvStatusList= " +
...
void ImsRadioAidlImpl::notifyOnMultiSimVoiceCapabilityChanged(
  ...
  imsRadiolog("<", "onMultiSimVoiceCapabilityChanged: voiceCapability = " +
                       ::android::internal::ToString(voiceCapability));
  auto ret = indCb->onMultiSimVoiceCapabilityChanged(voiceCapability);
  if (!ret.isOk()) {
    QCRIL_LOG_ERROR("Unable to send response. Exception : %s", ret.getDescription().c_str());
  }
}
...
::ndk::ScopedAStatus ImsRadioAidlImpl::dial(int32_t in_token,
  ...
  imsRadiolog(">", "dial: token = " + std::to_string(in_token) +
                       " dialRequest: " + ::android::internal::ToString(in_dialRequest));
  auto msg = ims::utils::makeQcRilRequestImsDialMessage(getContext(in_token), in_dialRequest);
  if (msg == nullptr) {
    QCRIL_LOG_ERROR("msg is nullptr");
    sendDialResponse(in_token, aidlimports::ErrorCode::NO_MEMORY);
    return ndk::ScopedAStatus::ok();
  }
...
::ndk::ScopedAStatus ImsRadioAidlImpl::answer(int32_t in_token,
  ...
  auto msg = std::make_shared<QcRilRequestImsAnswerMessage>(getContext(in_token));
  if (msg == nullptr) {
    QCRIL_LOG_ERROR("msg is nullptr");
...
::ndk::ScopedAStatus ImsRadioAidlImpl::hangup(int32_t in_token,
  ...
  auto msg = std::make_shared<QcRilRequestImsHangupMessage>(getContext(in_token));
  if (msg == nullptr) {
    QCRIL_LOG_ERROR("msg is nullptr");
...
::ndk::ScopedAStatus ImsRadioAidlImpl::setServiceStatus(
  ...
  for (const auto& srvStatusInfo : in_srvStatusInfoList) {
    ...
    if ((srvStatusInfo.callType == aidlimports::CallType::VOICE) &&
        (networkMode == aidlimports::RadioTechType::NR5G)) {
      if (ims::utils::changeVonrFromAppSupported()) {
        msg->setVonrEnabled(status != aidlimports::StatusType::DISABLED);
      }
    }
    if ((srvStatusInfo.callType == aidlimports::CallType::VOICE) &&
...
::ndk::ScopedAStatus ImsRadioAidlImpl::conference(int32_t in_token) {
  ...
  auto msg = std::make_shared<QcRilRequestImsConferenceMessage>(getContext(in_token));
  if (msg == nullptr) {
    QCRIL_LOG_ERROR("msg is nullptr");
...
::ndk::ScopedAStatus ImsRadioAidlImpl::sendDtmf(int32_t in_token,
  ...
  auto msg = std::make_shared<QcRilRequestImsSendDtmfMessage>(getContext(in_token));
  if (msg == nullptr) {
    QCRIL_LOG_ERROR("msg is nullptr");
...
::ndk::ScopedAStatus ImsRadioAidlImpl::startDtmf(int32_t in_token,
  ...
  imsRadiolog(">", "startDtmf: token = " + std::to_string(in_token) + " dtmfInfo = " +
                       ::android::internal::ToString(in_dtmfInfo));
  auto msg = std::make_shared<QcRilRequestImsStartDtmfMessage>(getContext(in_token));
  if (msg == nullptr) {
    QCRIL_LOG_ERROR("msg is nullptr");
...
::ndk::ScopedAStatus ImsRadioAidlImpl::stopDtmf(int32_t in_token) {
  ...
  auto msg = std::make_shared<QcRilRequestImsStopDtmfMessage>(getContext(in_token));
  if (msg == nullptr) {
    QCRIL_LOG_ERROR("msg is nullptr");
...
::ndk::ScopedAStatus ImsRadioAidlImpl::queryCallForwardStatus(
  ...
  imsRadiolog(">", "queryCallForwardStatus: token = " + std::to_string(in_token) +
                       " callForwardInfo = " + ::android::internal::ToString(in_callForwardInfo));
...
::ndk::ScopedAStatus ImsRadioAidlImpl::explicitCallTransfer(
  ...
  auto msg = std::make_shared<QcRilRequestImsExplicitCallTransferMessage>(getContext(in_token));
  if (msg == nullptr) {
    QCRIL_LOG_ERROR("msg is nullptr");
...
::ndk::ScopedAStatus ImsRadioAidlImpl::sendGeolocationInfo(
  ...
  imsRadiolog(">", "sendGeolocationInfo: token=" + std::to_string(in_token) + " lat=" +
                       std::to_string(in_geoLocationInfo.lat) + " lon=" +
                       std::to_string(in_geoLocationInfo.lon) + " addressInfo=" +
                       ::android::internal::ToString(in_geoLocationInfo.addressInfo));
...
::ndk::ScopedAStatus ImsRadioAidlImpl::queryVirtualLineInfo(int32_t in_token,
  ...
  imsRadiolog(">", "queryVirtualLineInfo: token=" + std::to_string(in_token) +
                       " msisdn=" + ::android::internal::ToString(in_msisdn));
  if (in_msisdn.empty()) {
...
::ndk::ScopedAStatus ImsRadioAidlImpl::emergencyDial(
  ...
  auto msg =
      ims::utils::makeQcRilRequestImsDialMessage(getContext(in_token), in_dialRequest.dialRequest);
  if (msg == nullptr) {
    QCRIL_LOG_ERROR("msg is nullptr");
    sendDialResponse(in_token, aidlimports::ErrorCode::NO_MEMORY);
    return ndk::ScopedAStatus::ok();
...
void ImsRadioAidlImpl::sendGetRegistrationResponse(
  ...
  if (respCb) {
    imsRadiolog("<", "getImsRegistrationStateResponse: token = " + std::to_string(token) +
                         " errorCode = " + ::android::internal::ToString(errorCode) +
                         " reg = " + ::android::internal::ToString(reg));
...
void ImsRadioAidlImpl::sendQueryCallForwardStatusResponse(
  ...
  if (respCb) {
    imsRadiolog("<", "queryCallForwardStatusResponse: token = " + std::to_string(token) +
                         " errorCode = " + ::android::internal::ToString(errorCode) +
                         " outCfInfoList = " + android::internal::ToString(outCfInfoList) +
                         " errorDetails = " + android::internal::ToString(errorDetails));
...
void ImsRadioAidlImpl::sendQueryVirtualLinesResponse(
  ...
  if (respCb) {
    imsRadiolog("<", "sendQueryVirtualLinesResponse: token=" + std::to_string(token) +
                         " msisdn=" + ::android::internal::ToString(msisdn) +
