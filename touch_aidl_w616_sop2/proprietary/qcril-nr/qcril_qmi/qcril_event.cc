...
WakeLock eventWakeLock(QCRIL_WAKE_LOCK_NAME);
...
class qcril_event_module: public Module
{
    public:
        ...
        void handle_qcril_event(std::shared_ptr<QcrilEventMessage> msg) {
            ...
            eventWakeLock.release();
        }

        void handleRilRequestNvReadMessage(std::shared_ptr<RilRequestNvReadMessage> msg) {
          qcril_nv_request_oem_hook_nv_read(msg);
        }
        void handleRilRequestNvWriteMessage(std::shared_ptr<RilRequestNvWriteMessage> msg) {
          qcril_nv_request_oem_hook_nv_write(msg);
        }
        ...
        qcril_event_module() {
            ...
            mMessageHandler = {
                ...
                HANDLER(RilRequestNvReadMessage, qcril_event_module::handleRilRequestNvReadMessage),
                HANDLER(RilRequestNvWriteMessage, qcril_event_module::handleRilRequestNvWriteMessage),
            };
        }
