...
unordered_map<rildata::DataCallFailCause_t, V1_4::DataCallFailCause> dcFailCauseMap = {
    ...
    {rildata::DataCallFailCause_t::EMBMS_NOT_ENABLED, V1_4::DataCallFailCause::EMBMS_NOT_ENABLED},
    {rildata::DataCallFailCause_t::IRAT_HANDOVER_FAILED, V1_4::DataCallFailCause::IRAT_HANDOVER_FAILED},
    {rildata::DataCallFailCause_t::EMBMS_REGULAR_DEACTIVATION, V1_4::DataCallFailCause::EMBMS_REGULAR_DEACTIVATION},
