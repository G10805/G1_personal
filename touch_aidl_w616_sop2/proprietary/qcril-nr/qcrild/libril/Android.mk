...
LOCAL_SRC_FILES += RadioServiceModule.cpp
LOCAL_SRC_FILES += hidl_impl/radio_service_base.cpp
LOCAL_SRC_FILES += hidl_impl/1.0/radio_service_1_0.cpp
LOCAL_SRC_FILES += hidl_impl/1.0/radio_service_utils_1_0.cpp
LOCAL_SRC_FILES += hidl_impl/1.1/radio_service_1_1.cpp
LOCAL_SRC_FILES += hidl_impl/1.1/radio_service_utils_1_1.cpp
LOCAL_SRC_FILES += hidl_impl/1.2/radio_service_1_2.cpp
LOCAL_SRC_FILES += hidl_impl/1.2/radio_service_utils_1_2.cpp
LOCAL_SRC_FILES += hidl_impl/1.3/radio_service_1_3.cpp
LOCAL_SRC_FILES += hidl_impl/1.3/radio_service_utils_1_3.cpp
LOCAL_SRC_FILES += hidl_impl/1.4/radio_service_1_4.cpp
LOCAL_SRC_FILES += hidl_impl/1.4/radio_service_utils_1_4.cpp
LOCAL_SRC_FILES += hidl_impl/1.5/radio_service_1_5.cpp
LOCAL_SRC_FILES += hidl_impl/1.5/radio_service_utils_1_5.cpp
LOCAL_SRC_FILES += hidl_impl/1.6/radio_service_1_6.cpp
LOCAL_SRC_FILES += hidl_impl/1.6/radio_service_utils_1_6.cpp
