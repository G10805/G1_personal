...
qcril::interfaces::ConfigItem convertConfigItem(const RIL_IMS_ConfigItem in) {
  switch(in) {
    ...
    case RIL_IMS_CONFIG_ITEM_VOWIFI_ENTITLEMENT_ID:
      return qcril::interfaces::ConfigItem::VOWIFI_ENTITLEMENT_ID;
    case RIL_IMS_CONFIG_ITEM_B2C_ENRICHED_CALLING_SETTING:
      return qcril::interfaces::ConfigItem::B2C_ENRICHED_CALLING_SETTING;
