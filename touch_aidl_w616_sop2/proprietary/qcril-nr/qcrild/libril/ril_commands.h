...
*/
    ...
    {RIL_REQUEST_SETUP_DATA_CALL, NULL},
    ...
    {RIL_REQUEST_DATA_CALL_LIST, NULL},
    ...
    {RIL_REQUEST_ACKNOWLEDGE_INCOMING_GSM_SMS_WITH_PDU, NULL},
    {RIL_REQUEST_STK_SEND_ENVELOPE_WITH_STATUS, NULL},
    {RIL_REQUEST_VOICE_RADIO_TECH, NULL},
    {RIL_REQUEST_GET_CELL_INFO_LIST, NULL},
    {RIL_REQUEST_SET_UNSOL_CELL_INFO_LIST_RATE, NULL},
    {RIL_REQUEST_SET_INITIAL_ATTACH_APN, NULL},
    ...
    {RIL_REQUEST_NV_READ_ITEM, NULL},
    {RIL_REQUEST_NV_WRITE_ITEM, NULL},
    {RIL_REQUEST_NV_WRITE_CDMA_PRL, NULL},
    {RIL_REQUEST_NV_RESET_CONFIG, NULL},
    {RIL_REQUEST_SET_UICC_SUBSCRIPTION, NULL},
    {RIL_REQUEST_ALLOW_DATA, NULL},
    {RIL_REQUEST_GET_HARDWARE_CONFIG, NULL},
    {RIL_REQUEST_SIM_AUTHENTICATION, NULL},
    {RIL_REQUEST_GET_DC_RT_INFO, NULL},
    {RIL_REQUEST_SET_DC_RT_INFO_RATE, NULL},
    {RIL_REQUEST_SET_DATA_PROFILE, NULL},
    {RIL_REQUEST_SHUTDOWN, NULL},
    {RIL_REQUEST_GET_RADIO_CAPABILITY, NULL},
    {RIL_REQUEST_SET_RADIO_CAPABILITY, NULL},
    {RIL_REQUEST_START_LCE, NULL},
    {RIL_REQUEST_STOP_LCE, NULL},
    {RIL_REQUEST_PULL_LCEDATA, NULL},
    {RIL_REQUEST_GET_ACTIVITY_INFO, NULL},
    {RIL_REQUEST_SET_CARRIER_RESTRICTIONS, NULL},
    {RIL_REQUEST_GET_CARRIER_RESTRICTIONS, NULL},
    {RIL_REQUEST_SEND_DEVICE_STATE, NULL},
    {RIL_REQUEST_SET_UNSOLICITED_RESPONSE_FILTER, NULL},
    {RIL_REQUEST_SET_SIM_CARD_POWER, NULL},
    {RIL_REQUEST_SET_CARRIER_INFO_IMSI_ENCRYPTION, NULL},
    {RIL_REQUEST_SET_DATA_THROTTLING, NULL},
    {RIL_REQUEST_START_NETWORK_SCAN, NULL},
    {RIL_REQUEST_STOP_NETWORK_SCAN, NULL},
    {RIL_REQUEST_START_KEEPALIVE, NULL},
    {RIL_REQUEST_STOP_KEEPALIVE, NULL},
#endif
