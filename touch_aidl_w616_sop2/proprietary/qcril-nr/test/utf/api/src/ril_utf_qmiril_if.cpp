...
dms_get_device_cap_resp_msg_v01 *ril_utf_qmiril_if::update_default_qmi_dms_get_device_cap_resp_v01(qmi_result_type_v01 result, qmi_error_type_v01 error)
{
...
/*========================================================
  QMI_DMS_GET_DEVICE_STATE_INFO_REQ_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_dms_get_device_state_info_req_msg(void)
{
  payload = NULL ;//req msg is empty
  payload_len = 0;
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_request;
  service_id = QMI_DMS;
  msg_id = QMI_DMS_GET_DEVICE_STATE_INFO_REQ_V01;
  status = not_met;
}

/*========================================================
  QMI_DMS_GET_DEVICE_STATE_INFO_RESP_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_dms_get_device_state_info_resp_msg(void)
{
  payload = (void *) malloc(sizeof(dms_get_device_state_info_resp_msg_v01));
  payload_len = sizeof(dms_get_device_state_info_resp_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_response;
  msg_id = QMI_DMS_GET_DEVICE_STATE_INFO_RESP_V01;
  service_id = QMI_DMS;
}

void ril_utf_qmiril_if::set_qmi_dms_get_device_state_info_resp_result(
        qmi_result_type_v01 result, qmi_error_type_v01 error)
{
  dms_get_device_state_info_resp_msg_v01 *ptr =
    (dms_get_device_state_info_resp_msg_v01*)payload;
  ptr->resp.result = result;
  ptr->resp.error = error;
}

void ril_utf_qmiril_if::set_qmi_dms_get_device_state_info_resp_init_state(
        dms_device_init_state_enum_v01 state)
{
  dms_get_device_state_info_resp_msg_v01 *ptr =
    (dms_get_device_state_info_resp_msg_v01*)payload;
  ptr->init_state_valid = TRUE;
  ptr->init_state = state;
}

void ril_utf_qmiril_if::set_qmi_dms_get_device_state_info_resp_init_fail_reason(
        dms_device_state_fail_reason_enum_v01 reason)
{
  dms_get_device_state_info_resp_msg_v01 *ptr =
    (dms_get_device_state_info_resp_msg_v01*)payload;
  ptr->failure_reason_valid = TRUE;
  ptr->failure_reason = reason;
}
...
void ril_utf_qmiril_if::update_default_qmi_dms_set_operating_mod_req_v01(dms_operating_mode_enum_v01 o_mode)
{
  ...
  ptr->e911_pending_info_valid = TRUE;
  ptr->e911_pending_info.is_pending = FALSE;
}
...
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_ims_settings_get_supported_fields_req(uint16_t qmiMsgId)
{
...
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_ims_settings_get_supported_fields_resp(uint16_t qmiMsgId)
{
  ...
  qmi_resp->request_fields_len = index+1;
#endif
  // call_mode_pref SET_CONCURRENCY
  if (qmiMsgId != QMI_IMS_SETTINGS_SET_CONCURRENCY_CONFIG_RSP_V01)
  {
...
void ril_utf_qmiril_if::set_qmi_nas_get_system_selection_preference_resp_lte_band_pref_ext
  (lte_band_pref_mask_ext_type_v01 band_pref_ext)
{
  nas_get_system_selection_preference_resp_msg_v01 *ptr =
    (nas_get_system_selection_preference_resp_msg_v01 *) payload;
  ptr->lte_band_pref_ext_valid = TRUE;
  ptr->lte_band_pref_ext = band_pref_ext;
}

void ril_utf_qmiril_if::set_qmi_nas_get_system_selection_preference_resp_nr5g_band_pref
  (nas_nr5g_band_pref_mask_type_v01 band_pref_ext)
{
  nas_get_system_selection_preference_resp_msg_v01 *ptr =
    (nas_get_system_selection_preference_resp_msg_v01 *) payload;
  ptr->nr5g_sa_band_pref_valid = TRUE;
  ptr->nr5g_sa_band_pref = band_pref_ext;
}
...
void ril_utf_qmiril_if::set_qmi_nas_get_system_selection_preference_resp_nr5g_disable_mode
  (nas_nr5g_disable_mode_enum_type_v01 nr5g_disable_mode)
{
  nas_get_system_selection_preference_resp_msg_v01 *ptr =
    (nas_get_system_selection_preference_resp_msg_v01 *) payload;
  ptr->nr5g_disable_mode_valid = TRUE;
  ptr->nr5g_disable_mode = nr5g_disable_mode;
}
...
/*
 * Function: update_serving_mcc_ecc_from_qmi_pbm_list_ind_msg
 * This function always needs to be called after calling update_default_qmi_pbm_list_ind_msg
 */
void ril_utf_qmiril_if::update_serving_mcc_ecc_from_qmi_pbm_list_ind_msg(const char *number)
{
  pbm_emergency_list_ind_msg_v01 *ptr =
    (pbm_emergency_list_ind_msg_v01*) payload;
  ptr->serving_mcc_emer_nums_valid = TRUE;
  ptr->serving_mcc_emer_nums_len = 1;
  ptr->serving_mcc_emer_nums[0].emer_nums_len = 1;
  ptr->serving_mcc_emer_nums[0].emer_nums[0].emer_num_len = strlen(number);
  strlcpy(ptr->serving_mcc_emer_nums[0].emer_nums[0].emer_num, number,
    QMI_PBM_EMER_NUM_MAX_LENGTH_V01);
}
...
void ril_utf_qmiril_if::set_qmi_voice_set_config_req_auto_answer(uint8_t auto_answer)
{
  voice_set_config_req_msg_v02 *ptr = (voice_set_config_req_msg_v02 *) payload;
  ptr->auto_answer_valid = TRUE;
  ptr->auto_answer = auto_answer;
}
voice_preferred_voice_so_type_v02 &ril_utf_qmiril_if::set_qmi_voice_set_config_req_preferred_voice_so()
{
  voice_set_config_req_msg_v02 *ptr = (voice_set_config_req_msg_v02 *) payload;
  ptr->preferred_voice_so_valid = TRUE;
  return (ptr->preferred_voice_so);
}
voice_roam_timer_type_v02 &ril_utf_qmiril_if::set_qmi_voice_set_config_req_roam_timer()
{
  voice_set_config_req_msg_v02 *ptr = (voice_set_config_req_msg_v02 *) payload;
  ptr->roam_timer_valid = TRUE;
  return (ptr->roam_timer);
}
voice_air_timer_type_v02 &ril_utf_qmiril_if::set_qmi_voice_set_config_req_air_timer()
{
  voice_set_config_req_msg_v02 *ptr = (voice_set_config_req_msg_v02 *) payload;
  ptr->air_timer_valid = TRUE;
  return (ptr->air_timer);
}
/*========================================================
...
void ril_utf_qmiril_if::set_qmi_voice_get_config_req_air_timer(uint8_t val)
{
  voice_get_config_req_msg_v02 *ptr = (voice_get_config_req_msg_v02 *) payload;
  ptr->air_timer_valid = TRUE;
  ptr->air_timer = val;
...
void ril_utf_qmiril_if::set_qmi_voice_get_config_resp_auto_answer_status(uint8_t val)
{
  voice_get_config_resp_msg_v02 *ptr = (voice_get_config_resp_msg_v02 *)payload;
  ptr->auto_answer_status_valid = TRUE;
  ptr->auto_answer_status = val;
}
voice_preferred_voice_so_type_v02 &ril_utf_qmiril_if::set_qmi_voice_get_config_resp_current_preferred_voice_so()
{
  voice_get_config_resp_msg_v02 *ptr = (voice_get_config_resp_msg_v02 *)payload;
  ptr->current_preferred_voice_so_valid = TRUE;
  return (ptr->current_preferred_voice_so);
}
voice_roam_timer_type_v02 &ril_utf_qmiril_if::set_qmi_voice_get_config_resp_roam_timer_count()
{
  voice_get_config_resp_msg_v02 *ptr = (voice_get_config_resp_msg_v02 *)payload;
  ptr->roam_timer_count_valid = TRUE;
  return (ptr->roam_timer_count);
}
voice_air_timer_type_v02 &ril_utf_qmiril_if::set_qmi_voice_get_config_resp_air_timer_count()
{
  voice_get_config_resp_msg_v02 *ptr = (voice_get_config_resp_msg_v02 *)payload;
  ptr->air_timer_count_valid = TRUE;
  return (ptr->air_timer_count);
}
...
void ril_utf_qmiril_if::set_qmi_voice_dial_call_req_call_emerg_service_urn(uint32_t emerg_service_urn_len, uint8_t *emerg_service_urn)
{
  voice_dial_call_req_msg_v02 *ptr = (voice_dial_call_req_msg_v02 *) payload;
  if (emerg_service_urn_len && emerg_service_urn &&
      emerg_service_urn_len < QMI_VOICE_EMERG_SERVICE_URN_MAX_LEN_V02) {
    ptr->emerg_service_urn_valid = TRUE;
    ptr->emerg_service_urn_len = emerg_service_urn_len;
    memcpy(ptr->emerg_service_urn, emerg_service_urn, emerg_service_urn_len);
  }
}
...
void ril_utf_qmiril_if::set_qmi_voice_answer_call_req_rtt_mode(rtt_mode_type_v02 val)
{
  voice_answer_call_req_msg_v02 *ptr = (voice_answer_call_req_msg_v02 *) payload;
...
void ril_utf_qmiril_if::set_qmi_voice_ind_req_sups_events(uint8_t sups_events)
{
  voice_indication_register_req_msg_v02 *ptr = (voice_indication_register_req_msg_v02 *) payload;
  ptr->sups_events_valid = TRUE;
  ptr->sups_events = sups_events;
}
void ril_utf_qmiril_if::set_qmi_voice_ind_req_auto_rejected_incoming_call_end_event(uint8_t auto_rejected_incoming_call_end_event)
{
  voice_indication_register_req_msg_v02 *ptr = (voice_indication_register_req_msg_v02 *) payload;
  ptr->auto_rejected_incoming_call_end_event_valid = TRUE;
  ptr->auto_rejected_incoming_call_end_event = auto_rejected_incoming_call_end_event;
}
void ril_utf_qmiril_if::set_qmi_voice_ind_req_sip_dtmf_event(uint8_t sip_dtmf_event)
{
  voice_indication_register_req_msg_v02 *ptr = (voice_indication_register_req_msg_v02 *) payload;
  ptr->sip_dtmf_event_valid = TRUE;
  ptr->sip_dtmf_event = sip_dtmf_event;
}
void ril_utf_qmiril_if::set_qmi_voice_ind_req_notify_clir_mode_events(uint8_t notify_clir_mode_events)
{
  voice_indication_register_req_msg_v02 *ptr = (voice_indication_register_req_msg_v02 *) payload;
  ptr->notify_clir_mode_events_valid = TRUE;
  ptr->notify_clir_mode_events = notify_clir_mode_events;
}
void ril_utf_qmiril_if::set_qmi_voice_ind_req_network_detected_ecc_number_event(uint8_t network_detected_ecc_number_event)
{
  voice_indication_register_req_msg_v02 *ptr = (voice_indication_register_req_msg_v02 *) payload;
  ptr->network_detected_ecc_number_event_valid = TRUE;
  ptr->network_detected_ecc_number_event = network_detected_ecc_number_event;
}
#endif
...
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_voice_get_sups_operation_mode_req_msg(
      voice_reason_enum_v02 reason)
{
  payload = (void *) malloc(sizeof(voice_get_sups_operation_mode_req_msg_v02));
  payload_len = sizeof(voice_get_sups_operation_mode_req_msg_v02);
  if (payload) {
    memset(payload, 0x00, payload_len);
  }
  payload_type = ril_utf_qmi_request;
  service_id = QMI_VOICE;
  msg_id = QMI_VOICE_GET_SUPS_OPERATION_MODE_REQ_V02;
  voice_get_sups_operation_mode_req_msg_v02 *ptr = (voice_get_sups_operation_mode_req_msg_v02 *) payload;
  if (ptr) {
    ptr->reason = reason;
  }
}
...
/*========================================================
  QMI_VOICE_GET_SUPS_OPERATION_MODE_RESP_V02
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_voice_get_sups_operation_mode_resp_msg(
    qmi_result_type_v01 result, qmi_error_type_v01 error)
{
  payload = (void *) malloc(sizeof(voice_get_sups_operation_mode_resp_msg_v02));
  payload_len = sizeof(voice_get_sups_operation_mode_resp_msg_v02);
  if (payload) {
    memset(payload, 0x00, payload_len);
  }
  payload_type = ril_utf_qmi_response;
  service_id = QMI_VOICE;
  msg_id = QMI_VOICE_GET_SUPS_OPERATION_MODE_RESP_V02;

  voice_get_sups_operation_mode_resp_msg_v02 *ptr = (voice_get_sups_operation_mode_resp_msg_v02 *) payload;
  if (ptr) {
    ptr->resp.error = error;
    ptr->resp.result= result;
  }
...
void ril_utf_qmiril_if::set_qmi_voice_get_sups_operation_mode_resp_sups_operation_mode(
      sups_operation_mode_enum_v02 sups_operation_mode)
{
  voice_get_sups_operation_mode_resp_msg_v02 *ptr =
    (voice_get_sups_operation_mode_resp_msg_v02 *) payload;
  if (ptr) {
    ptr->sups_operation_mode_valid = TRUE;
    ptr->sups_operation_mode = sups_operation_mode;
  }
}
...
void ril_utf_qmiril_if::set_voice_get_call_barring_req_additional_ss_expected(boolean val)
{
  voice_get_call_barring_req_msg_v02 *ptr = (voice_get_call_barring_req_msg_v02 *) payload;
  ptr->additional_ss_expected_valid = TRUE;
  ptr->additional_ss_expected = val;
}
...
void ril_utf_qmiril_if::set_voice_get_call_forwarding_req_additional_ss_expected(boolean val)
{
  voice_get_call_forwarding_req_msg_v02 *ptr = (voice_get_call_forwarding_req_msg_v02 *) payload;
  ptr->additional_ss_expected_valid = TRUE;
  ptr->additional_ss_expected = val;
...
void ril_utf_qmiril_if::set_qmi_voice_get_call_forwarding_resp_failure_cause(qmi_sups_errors_enum_v02 val)
{
  voice_get_call_forwarding_resp_msg_v02 *ptr = (voice_get_call_forwarding_resp_msg_v02 *) payload;
  ptr->failure_cause_valid = TRUE;
  ptr->failure_cause = val;
...
voice_call_rtt_capabilities_info_type_v02* ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_rtt_capabilities_info(uint32_t len)
{
  voice_all_call_status_ind_msg_v02 *ptr = (voice_all_call_status_ind_msg_v02 *) payload;
  ptr->rtt_capabilities_info_valid = TRUE;
  ptr->rtt_capabilities_info_len = len;
  return (ptr->rtt_capabilities_info);
}
...
voice_ip_diversion_info_type_v02* ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_ip_diversion_info(uint32_t len)
{
  voice_all_call_status_ind_msg_v02 *ptr = (voice_all_call_status_ind_msg_v02 *) payload;
  ptr->ip_diversion_info_valid = TRUE;
  ptr->ip_diversion_info_len = len;
  return (ptr->ip_diversion_info);
}
...
voice_call_composer_org_hdr_type_v02*
ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_call_composer_organization(uint32_t len)
{
  voice_all_call_status_ind_msg_v02 *ptr = (voice_all_call_status_ind_msg_v02 *) payload;
  ptr->call_composer_organization_header_valid = TRUE;
  ptr->call_composer_organization_header_len = len;
  return (ptr->call_composer_organization_header);
}
...
voice_call_ecnam_icon_url_type_v02*
ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_ecnam_icon_url(uint32_t len) {
  voice_all_call_status_ind_msg_v02* ptr = (voice_all_call_status_ind_msg_v02*)payload;
  ptr->call_ecnam_icon_url_valid = TRUE;
  ptr->call_ecnam_icon_url_len = len;
  return (ptr->call_ecnam_icon_url);
}

voice_call_ecnam_info_url_type_v02*
ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_ecnam_info_url(uint32_t len) {
  voice_all_call_status_ind_msg_v02* ptr = (voice_all_call_status_ind_msg_v02*)payload;
  ptr->call_ecnam_info_url_valid = TRUE;
  ptr->call_ecnam_info_url_len = len;
  return (ptr->call_ecnam_info_url);
}

voice_call_ecnam_card_url_type_v02*
ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_ecnam_card_url(uint32_t len) {
  voice_all_call_status_ind_msg_v02* ptr = (voice_all_call_status_ind_msg_v02*)payload;
  ptr->call_ecnam_card_url_valid = TRUE;
  ptr->call_ecnam_card_url_len = len;
  return (ptr->call_ecnam_card_url);
}

voice_prog_info_notif_type_v02*
ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_prog_info_notif(uint32_t len)
{
  voice_all_call_status_ind_msg_v02 *ptr = (voice_all_call_status_ind_msg_v02 *) payload;
  ptr->prog_info_notif_valid = TRUE;
  ptr->prog_info_notif_len = len;
  return (ptr->prog_info_notif);
}

voice_silent_ui_type_v02* ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_silent_ui(uint32_t silent_ui_len)
{
  voice_all_call_status_ind_msg_v02 *ptr = (voice_all_call_status_ind_msg_v02 *) payload;
  ptr->silent_ui_valid = TRUE;
  ptr->silent_ui_len = silent_ui_len;
  return (ptr->silent_ui);
}

voice_original_call_type_v02* ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_original_call_type(uint32_t original_call_type_len)
{
  voice_all_call_status_ind_msg_v02 *ptr = (voice_all_call_status_ind_msg_v02 *) payload;
  ptr->original_call_type_valid = TRUE;
  ptr->original_call_type_len = original_call_type_len;
  return (ptr->original_call_type);
}

voice_crs_type_v02* ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_crs_type(uint32_t crs_type_len)
{
  voice_all_call_status_ind_msg_v02 *ptr = (voice_all_call_status_ind_msg_v02 *) payload;
  ptr->crs_type_valid = TRUE;
  ptr->crs_type_len = crs_type_len;
  return (ptr->crs_type);
}

voice_msim_additional_call_info_type_v02*
ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_msim_additional_call_info(
    uint32_t additional_call_info_len) {
  voice_all_call_status_ind_msg_v02* ptr = (voice_all_call_status_ind_msg_v02*)payload;
  ptr->msim_additional_call_info_valid = TRUE;
  ptr->msim_additional_call_info_len = additional_call_info_len;
  return (ptr->msim_additional_call_info);
}

voice_vos_type_v02*
ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_vos_support_type(uint32_t len)
{
  voice_all_call_status_ind_msg_v02 *ptr = (voice_all_call_status_ind_msg_v02 *) payload;
  ptr->vos_support_valid = TRUE;
  ptr->vos_support_len = len;
  return (ptr->vos_support);
}
...
void ril_utf_qmiril_if::set_qmi_voice_modified_ind_vos_support(uint8_t vos_support)
{
  voice_modified_ind_msg_v02 *ptr = (voice_modified_ind_msg_v02 *) payload;
  ptr->vos_support_valid = TRUE;
  ptr->vos_support = vos_support;
}
...
void ril_utf_qmiril_if::set_qmi_voice_modified_accept_ind_rtt_mode(rtt_mode_type_v02 rtt_mode)
{
  voice_modify_accept_ind_msg_v02 *ptr = (voice_modify_accept_ind_msg_v02 *) payload;
  ptr->rtt_mode_valid = TRUE;
  ptr->rtt_mode = rtt_mode;
}
void ril_utf_qmiril_if::set_qmi_voice_modified_accept_ind_vos_support(uint8_t vos_support)
{
  voice_modify_accept_ind_msg_v02 *ptr = (voice_modify_accept_ind_msg_v02 *) payload;
  ptr->vos_support_valid = TRUE;
  ptr->vos_support = vos_support;
...
void ril_utf_qmiril_if::set_qmi_voice_speech_codec_info_ind_audio_quality(
    voice_audio_quality_enum_v02 audio_quality) {
  voice_speech_codec_info_ind_msg_v02* ptr = (voice_speech_codec_info_ind_msg_v02*)payload;
  ptr->audio_quality_valid = TRUE;
  ptr->audio_quality = audio_quality;
}
...
/*========================================================
  QMI_VOICE_NETWORK_DETECTED_ECC_NUM_IND_V02
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_voice_network_detected_ecc_num_ind_msg()
{
  payload = (void *) malloc(sizeof(voice_network_detected_ecc_number_ind_msg_v02));
  payload_len = sizeof(voice_network_detected_ecc_number_ind_msg_v02);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_indication;
  service_id = QMI_VOICE;
  msg_id = QMI_VOICE_NETWORK_DETECTED_ECC_NUM_IND_V02;
}
voice_num_with_id_type_v02 *ril_utf_qmiril_if::set_qmi_voice_network_detected_ecc_num_ind_num(char *address)
{
  voice_network_detected_ecc_number_ind_msg_v02 *ptr = (voice_network_detected_ecc_number_ind_msg_v02 *) payload;
  ptr->num_valid = TRUE;
  if (address) {
    size_t address_len = strlen(address);
    if (address_len < QMI_VOICE_NUMBER_MAX_V02) {
      ptr->num.num_len = address_len;
      memcpy(ptr->num.num, address, ptr->num.num_len);
    }
  }
  return &(ptr->num);
}
void ril_utf_qmiril_if::set_qmi_voice_network_detected_ecc_num_ind_emerg_srv_categ(uint32_t emerg_srv_categ)
{
  voice_network_detected_ecc_number_ind_msg_v02 *ptr = (voice_network_detected_ecc_number_ind_msg_v02 *) payload;
  ptr->emerg_srv_categ_valid = TRUE;
  ptr->emerg_srv_categ = emerg_srv_categ;
}
void ril_utf_qmiril_if::set_qmi_voice_network_detected_ecc_num_ind_emerg_service_urn(uint32_t emerg_service_urn_len, uint8_t *emerg_service_urn)
{
  voice_network_detected_ecc_number_ind_msg_v02 *ptr = (voice_network_detected_ecc_number_ind_msg_v02 *) payload;
  if (emerg_service_urn_len && emerg_service_urn &&
      emerg_service_urn_len < QMI_VOICE_EMERG_SERVICE_URN_MAX_LEN_V02) {
...
/*========================================================
  QMI_VOICE_NOTIFY_CLIR_MODE_IND_V02
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_voice_notify_clir_mode_ind_msg()
{
  payload = (void *) malloc(sizeof(voice_notify_clir_mode_ind_msg_v02));
  payload_len = sizeof(voice_notify_clir_mode_ind_msg_v02);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_indication;
  service_id = QMI_VOICE;
  msg_id = QMI_VOICE_NOTIFY_CLIR_MODE_IND_V02;
}

void ril_utf_qmiril_if::set_qmi_voice_notify_clir_mode_ind_is_ue_based_clir(uint8_t is_ue_based_clir)
{
  voice_notify_clir_mode_ind_msg_v02 *ptr = (voice_notify_clir_mode_ind_msg_v02 *) payload;
  ptr->is_ue_based_clir_valid = TRUE;
  ptr->is_ue_based_clir = is_ue_based_clir;
}
...
void ril_utf_qmiril_if::set_qmi_nas_perform_network_scan_req_msg_scan_type(nas_nw_scan_type_enum_v01 val)
{
  nas_perform_network_scan_req_msg_v01 *ptr = (nas_perform_network_scan_req_msg_v01 *) payload;
...
void ril_utf_qmiril_if::set_qmi_nas_csg_nw_info_tlv_network_scan_resp_msg(uint16_t mcc, uint16_t mnc, nas_csg_list_cat_enum_v01 csg_list_cat, uint32_t id, uint32_t name_len, uint16_t *name)
{
  ...
  memcpy(ptr->csg_info[i].csg_info.name, name, name_len*2);
}
...
nas_csg_nw_iden_type_v01* ril_utf_qmiril_if::set_qmi_nas_system_selection_preference_req_csg_info()
{
  nas_set_system_selection_preference_req_msg_v01 *ptr = (nas_set_system_selection_preference_req_msg_v01 *) payload;
  ptr->csg_info_valid = TRUE;
  return &(ptr->csg_info);
...
lte_band_pref_mask_ext_type_v01* ril_utf_qmiril_if::set_qmi_nas_system_selection_preference_req_lte_band_pref()
{
  nas_set_system_selection_preference_req_msg_v01 *ptr = (nas_set_system_selection_preference_req_msg_v01 *) payload;
  ptr->lte_band_pref_ext_valid = TRUE;
  return &(ptr->lte_band_pref_ext);
}
nas_nr5g_band_pref_mask_type_v01* ril_utf_qmiril_if::set_qmi_nas_system_selection_preference_req_nr5g_band_pref()
{
  nas_set_system_selection_preference_req_msg_v01 *ptr = (nas_set_system_selection_preference_req_msg_v01 *) payload;
  ptr->nr5g_band_pref_valid = TRUE;
  return &(ptr->nr5g_band_pref);
}

void ril_utf_qmiril_if::set_qmi_nas_system_selection_preference_req_change_duration(nas_change_duration_enum_v01 chg_dur)
{
  nas_set_system_selection_preference_req_msg_v01 *ptr = (nas_set_system_selection_preference_req_msg_v01 *) payload;
  ptr->change_duration_valid = TRUE;
  ptr->change_duration = chg_dur;
}
...
nas_cdma_cell_info_type_v01 *ril_utf_qmiril_if::set_qmi_nas_get_cell_location_info_resp_cdma_info()
{
  nas_get_cell_location_info_resp_msg_v01 *ptr = (nas_get_cell_location_info_resp_msg_v01 *) payload;
  ptr->cdma_info_valid = TRUE;
  return &(ptr->cdma_info);
}
nas_lte_intra_freq_type_v01 *ril_utf_qmiril_if::set_qmi_nas_get_cell_location_info_resp_lte_intra()
{
  nas_get_cell_location_info_resp_msg_v01 *ptr = (nas_get_cell_location_info_resp_msg_v01 *) payload;
  ptr->lte_intra_valid = TRUE;
  return &(ptr->lte_intra);
}
nas_lte_inter_freq_type_v01 *ril_utf_qmiril_if::set_qmi_nas_get_cell_location_info_resp_lte_inter()
{
  nas_get_cell_location_info_resp_msg_v01 *ptr = (nas_get_cell_location_info_resp_msg_v01 *) payload;
  ptr->lte_inter_valid = TRUE;
  return &(ptr->lte_inter);
}
nas_lte_ngbr_gsm_type_v01 *ril_utf_qmiril_if::set_qmi_nas_get_cell_location_info_resp_lte_gsm()
{
  nas_get_cell_location_info_resp_msg_v01 *ptr = (nas_get_cell_location_info_resp_msg_v01 *) payload;
  ptr->lte_gsm_valid = TRUE;
  return &(ptr->lte_gsm);
}
nas_lte_ngbr_wcdma_type_v01 *ril_utf_qmiril_if::set_qmi_nas_get_cell_location_info_resp_lte_wcdma()
{
  nas_get_cell_location_info_resp_msg_v01 *ptr = (nas_get_cell_location_info_resp_msg_v01 *) payload;
  ptr->lte_wcdma_valid = TRUE;
  return &(ptr->lte_wcdma);
}
void ril_utf_qmiril_if::set_qmi_nas_get_cell_location_info_resp_umts_cell_id(uint32_t umts_cell_id)
{
  nas_get_cell_location_info_resp_msg_v01 *ptr = (nas_get_cell_location_info_resp_msg_v01 *) payload;
  ptr->umts_cell_id_valid = TRUE;
  ptr->umts_cell_id = umts_cell_id;
}
void ril_utf_qmiril_if::set_qmi_nas_get_cell_location_info_resp_nr5g_arfcn(uint32_t nr5g_arfcn)
{
  nas_get_cell_location_info_resp_msg_v01 *ptr = (nas_get_cell_location_info_resp_msg_v01 *) payload;
  ptr->nr5g_arfcn_valid = TRUE;
  ptr->nr5g_arfcn = nr5g_arfcn;
}
nas_nr5g_serving_cell_info_type_v01 *ril_utf_qmiril_if::set_qmi_nas_get_cell_location_info_resp_nr5g_serving_cell_info()
{
  nas_get_cell_location_info_resp_msg_v01 *ptr = (nas_get_cell_location_info_resp_msg_v01 *) payload;
  ptr->nr5g_serving_cell_info_valid = TRUE;
  return &(ptr->nr5g_serving_cell_info);
}
/*========================================================
...
========================================================*/
nas_get_rf_band_info_resp_msg_v01 *ril_utf_qmiril_if::update_default_qmi_nas_get_rf_band_info_resp_msg() {
  payload_type = ril_utf_qmi_response;
  service_id = QMI_NAS;
...
========================================================*/
nas_get_lte_cphy_ca_info_resp_msg_v01 *ril_utf_qmiril_if::update_default_nas_get_lte_cphy_ca_info_resp_msg() {
  payload_type = ril_utf_qmi_response;
  service_id = QMI_NAS;
  ...
  nas_get_lte_cphy_ca_info_resp_msg_v01 *ptr = (nas_get_lte_cphy_ca_info_resp_msg_v01 *) payload;
  return ptr;
}
...
void ril_utf_qmiril_if::set_qmi_nas_get_3gpp2_subscription_info_resp_nam_name(const char *name)
{
  nas_get_3gpp2_subscription_info_resp_msg_v01 *ptr = (nas_get_3gpp2_subscription_info_resp_msg_v01 *) payload;
  ptr->nam_name_valid = TRUE;
  ptr->nam_name_len = std::min<uint32_t>(strlen(name)+1, NAS_MAX_NAM_NAME_LEN_V01);
  memcpy(ptr->nam_name, name, ptr->nam_name_len);
}
...
char *ril_utf_qmiril_if::set_qmi_nas_get_3gpp2_subscription_info_resp_dir_num(uint32_t dir_num_len)
{
  nas_get_3gpp2_subscription_info_resp_msg_v01 *ptr = (nas_get_3gpp2_subscription_info_resp_msg_v01 *) payload;
  ptr->dir_num_valid = TRUE;
  ptr->dir_num_len = dir_num_len;
  return (ptr->dir_num);
}
...
nas_3gpp2_true_imsi_info_type_v01 &ril_utf_qmiril_if::set_qmi_nas_get_3gpp2_subscription_info_resp_true_imsi()
{
  nas_get_3gpp2_subscription_info_resp_msg_v01 *ptr = (nas_get_3gpp2_subscription_info_resp_msg_v01 *) payload;
  ptr->true_imsi_valid = TRUE;
  return (ptr->true_imsi);
}
nas_cdma_channel_info_type_v01 &ril_utf_qmiril_if::set_qmi_nas_get_3gpp2_subscription_info_resp_cdma_channel_info()
{
  nas_get_3gpp2_subscription_info_resp_msg_v01 *ptr = (nas_get_3gpp2_subscription_info_resp_msg_v01 *) payload;
  ptr->cdma_channel_info_valid = TRUE;
  return (ptr->cdma_channel_info);
}

/*
  QMI_NAS_SET_3GPP2_SUBSCRIPTION_INFO_REQ_MSG_V01
*/
void ril_utf_qmiril_if::update_default_qmi_nas_set_3gpp2_subscription_info_req_msg(uint8_t nam_id)
{
  payload = (void *) malloc(sizeof(nas_set_3gpp2_subscription_info_req_msg_v01));
  payload_len = sizeof(nas_set_3gpp2_subscription_info_req_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_request;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_SET_3GPP2_SUBSCRIPTION_INFO_REQ_MSG_V01;

  nas_set_3gpp2_subscription_info_req_msg_v01 *ptr = (nas_set_3gpp2_subscription_info_req_msg_v01 *) payload;
  ptr->nam_id = nam_id;
}
nas_3gpp2_min_based_info_type_v01 *ril_utf_qmiril_if::set_qmi_nas_set_3gpp2_subscription_info_req_min_based_info()
{
  nas_set_3gpp2_subscription_info_req_msg_v01 *ptr = (nas_set_3gpp2_subscription_info_req_msg_v01 *) payload;
  ptr->min_based_info_valid = TRUE;
  return &(ptr->min_based_info);
}
nas_3gpp2_true_imsi_info_type_v01 &ril_utf_qmiril_if::set_qmi_nas_set_3gpp2_subscription_info_req_true_imsi()
{
  nas_set_3gpp2_subscription_info_req_msg_v01 *ptr = (nas_set_3gpp2_subscription_info_req_msg_v01 *) payload;
  ptr->true_imsi_valid = TRUE;
  return (ptr->true_imsi);
}
nas_cdma_channel_info_type_v01 &ril_utf_qmiril_if::set_qmi_nas_set_3gpp2_subscription_info_req_cdma_channel_info()
{
  nas_set_3gpp2_subscription_info_req_msg_v01 *ptr = (nas_set_3gpp2_subscription_info_req_msg_v01 *) payload;
  ptr->cdma_channel_info_valid = TRUE;
  return (ptr->cdma_channel_info);
}
nas_3gpp2_home_sid_nid_info_type_v01 *ril_utf_qmiril_if::set_qmi_nas_set_3gpp2_subscription_info_req_cdma_sys_id(uint32_t cdma_sys_id_len)
{
  nas_set_3gpp2_subscription_info_req_msg_v01 *ptr = (nas_set_3gpp2_subscription_info_req_msg_v01 *) payload;
  ptr->cdma_sys_id_valid = TRUE;
  ptr->cdma_sys_id_len = cdma_sys_id_len;
...
char *ril_utf_qmiril_if::set_qmi_nas_set_3gpp2_subscription_info_req_dir_num(uint32_t dir_num_len)
{
  nas_set_3gpp2_subscription_info_req_msg_v01 *ptr = (nas_set_3gpp2_subscription_info_req_msg_v01 *) payload;
  ptr->dir_num_valid = TRUE;
  ptr->dir_num_len = dir_num_len;
...
void ril_utf_qmiril_if::set_qmi_nas_set_3gpp2_subscription_info_req_nam_name(const char *name)
{
  nas_set_3gpp2_subscription_info_req_msg_v01 *ptr = (nas_set_3gpp2_subscription_info_req_msg_v01 *) payload;
  ptr->nam_name_valid = TRUE;
  ptr->nam_name_len = std::min<uint32_t>(strlen(name), NAS_MAX_NAM_NAME_LEN_V01);
  memcpy(ptr->nam_name, name, ptr->nam_name_len);
}

/*
  QMI_NAS_SET_3GPP2_SUBSCRIPTION_INFO_RESP_MSG_V01
*/
void ril_utf_qmiril_if::upate_default_qmi_nas_set_3gpp2_subscription_info_resp_msg(qmi_result_type_v01 result,qmi_error_type_v01 error)
{
  payload = (void *) malloc(sizeof(nas_set_3gpp2_subscription_info_resp_msg_v01));
  payload_len = sizeof(nas_set_3gpp2_subscription_info_resp_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_response;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_SET_3GPP2_SUBSCRIPTION_INFO_RESP_MSG_V01;

  nas_set_3gpp2_subscription_info_resp_msg_v01 *ptr = (nas_set_3gpp2_subscription_info_resp_msg_v01 *) payload;
  ptr->resp.error = error;
  ptr->resp.result= result;
}
...
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_nas_get_home_network_req_msg()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_qmi_request;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_GET_HOME_NETWORK_REQ_MSG_V01;
}
/*========================================================
...
nas_cdma_system_id_type_v01 &ril_utf_qmiril_if::set_qmi_nas_get_home_network_resp_home_system_id()
{
  nas_get_home_network_resp_msg_v01 *ptr = (nas_get_home_network_resp_msg_v01 *) payload;
  ptr->home_system_id_valid = TRUE;
  return (ptr->home_system_id);
}

/*========================================================
  QMI_NAS_GET_MOB_CAI_REV_REQ_MSG_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_nas_get_mob_cai_rev_req_msg()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_qmi_request;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_GET_MOB_CAI_REV_REQ_MSG_V01;
}
...
void ril_utf_qmiril_if::set_qmi_nas_get_mob_cai_rev_resp_cai_rev(uint8_t cai_rev)
{
  nas_get_mob_cai_rev_resp_v01 *ptr = (nas_get_mob_cai_rev_resp_v01 *) payload;
  ptr->cai_rev_valid = TRUE;
  ptr->cai_rev = cai_rev;
}
...
========================================================*/
nas_system_selection_preference_ind_msg_v01* ril_utf_qmiril_if::update_default_qmi_nas_system_selection_preference_ind_msg()
{
  ...
  return (nas_system_selection_preference_ind_msg_v01*)payload;
}
...
void ril_utf_qmiril_if::set_qmi_nas_system_selection_preference_ind_access_mode(nas_access_mode_enum_type_v01 val)
{
  nas_system_selection_preference_ind_msg_v01 *ptr = (nas_system_selection_preference_ind_msg_v01 *) payload;
  ptr->access_mode_valid = TRUE;
  ptr->access_mode = val;
}
#ifdef RIL_UTF_L_MASTER
...
#endif
nas_csg_nw_iden_type_v01 *ril_utf_qmiril_if::set_qmi_nas_system_selection_preference_ind_csg_info()
{
  nas_system_selection_preference_ind_msg_v01 *ptr = (nas_system_selection_preference_ind_msg_v01 *) payload;
  ptr->csg_info_valid = TRUE;
  return &(ptr->csg_info);
...
void ril_utf_qmiril_if::update_default_qmi_nas_get_network_time_req_msg_v01()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_qmi_request;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_GET_NETWORK_TIME_REQ_MSG_V01;
  status = not_met;
}

void ril_utf_qmiril_if::update_default_qmi_nas_get_network_time_resp_msg_v01(void)
{
  payload = (void *) malloc(sizeof(nas_get_network_time_resp_msg_v01));
  payload_len = sizeof(nas_get_network_time_resp_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_response;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_GET_NETWORK_TIME_RESP_MSG_V01;
}

void ril_utf_qmiril_if::set_qmi_nas_get_network_time_resp_result(qmi_result_type_v01 result,qmi_error_type_v01 error)
{
  nas_get_network_time_resp_msg_v01 *ptr = (nas_get_network_time_resp_msg_v01*) payload;
  ptr->resp.error = error;
  ptr->resp.result= result;
}

nas_network_time_type_v01* ril_utf_qmiril_if::set_qmi_nas_get_network_time_resp_nas_3gpp_time()
{
  nas_get_network_time_resp_msg_v01 *ptr = (nas_get_network_time_resp_msg_v01*) payload;
  ptr->nas_3gpp_time_valid = TRUE;
  return &(ptr->nas_3gpp_time);
}

/*========================================================
  QMI_NAS_NR5G_RRC_UTC_TIME_UPDATE_IND_MSG_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_nas_nr_sib9_network_time_ind()
{
  payload = (void *) malloc(sizeof(nas_nr5g_rrc_utc_time_update_ind_msg_v01));
  payload_len = sizeof(nas_nr5g_rrc_utc_time_update_ind_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_indication;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_NR5G_RRC_UTC_TIME_UPDATE_IND_MSG_V01;

}
void ril_utf_qmiril_if::set_qmi_nas_nr_sib9_network_time_ind_nr_sib9_acquired
  (nas_tri_state_boolean_type_v01 utc_sib9_acquired)
{
  nas_nr5g_rrc_utc_time_update_ind_msg_v01 *ptr =
    (nas_nr5g_rrc_utc_time_update_ind_msg_v01*) payload;

  ptr->utc_sib9_acquired_valid = TRUE;
  ptr->utc_sib9_acquired = utc_sib9_acquired;
}
void ril_utf_qmiril_if::set_qmi_nas_nr_sib9_network_time_ind_daylight_saving_time
  (nas_nr5g_rrc_utc_dayLightSaving_type_e_v01 dayLightSavingTime)
{
  nas_nr5g_rrc_utc_time_update_ind_msg_v01 *ptr =
    (nas_nr5g_rrc_utc_time_update_ind_msg_v01*) payload;

  ptr->dayLightSavingTime_valid = TRUE;
  ptr->dayLightSavingTime = dayLightSavingTime;
}
void ril_utf_qmiril_if::set_qmi_nas_nr_sib9_network_time_ind_leapSeconds
  (uint16_t leapSeconds)
{
  nas_nr5g_rrc_utc_time_update_ind_msg_v01 *ptr =
    (nas_nr5g_rrc_utc_time_update_ind_msg_v01*) payload;

  ptr->leapSeconds_valid = TRUE;
  ptr->leapSeconds = leapSeconds;
}
void ril_utf_qmiril_if::set_qmi_nas_nr_sib9_network_time_ind_localTime_Offset
  (uint16_t localTimeOffset)
{
  nas_nr5g_rrc_utc_time_update_ind_msg_v01 *ptr =
    (nas_nr5g_rrc_utc_time_update_ind_msg_v01*) payload;

  ptr->localTimeOffset_valid = TRUE;
  ptr->localTimeOffset = localTimeOffset;
}
void ril_utf_qmiril_if::set_qmi_nas_nr_sib9_network_time_ind_abs_time
  (uint16_t abs_time)
{
  nas_nr5g_rrc_utc_time_update_ind_msg_v01 *ptr =
    (nas_nr5g_rrc_utc_time_update_ind_msg_v01*) payload;
...
void ril_utf_qmiril_if::set_qmi_nas_nr_sib9_network_time_ind_universal_time
  (nas_lte_sib16_julian_time_type_v01 universal_time)
{
  nas_nr5g_rrc_utc_time_update_ind_msg_v01 *ptr =
    (nas_nr5g_rrc_utc_time_update_ind_msg_v01*) payload;

  ptr->universal_time_valid = TRUE;
  ptr->universal_time = universal_time;
}
...
/*========================================================
  QMI_NAS_GET_NR_SIB9_NETWORK_TIME_REQ_MSG_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_nas_get_nr_sib9_network_time_req_msg_v01()
{
  payload = NULL;
  payload_len = 0;
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_request;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_GET_NR5G_RRC_UTC_TIME_REQ_V01;
}
/*========================================================
  QMI_NAS_GET_NR_SIB9_NETWORK_TIME_RESP_MSG_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_nas_get_nr_sib9_network_time_resp_msg_v01
  (qmi_result_type_v01 result,qmi_error_type_v01 error)
{
  payload = (void *) malloc(sizeof(nas_get_nr5g_rrc_utc_time_resp_msg_v01));
  payload_len = sizeof(nas_get_nr5g_rrc_utc_time_resp_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_response;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_GET_NR5G_RRC_UTC_TIME_REQ_V01;

  nas_get_nr5g_rrc_utc_time_resp_msg_v01 *ptr =
    (nas_get_nr5g_rrc_utc_time_resp_msg_v01*) payload;
  ptr->resp.error = error;
  ptr->resp.result= result;
}
...
void ril_utf_qmiril_if::set_qmi_dms_ind_req_report_device_state(uint8_t device_state)
{
  dms_indication_register_req_msg_v01 *ptr = (dms_indication_register_req_msg_v01 *) payload;
  ptr->report_device_state_valid = TRUE;
  ptr->report_device_state = device_state;
}

void ril_utf_qmiril_if::set_qmi_dms_ind_req_report_imei_type(uint8_t enable)
{
  dms_indication_register_req_msg_v01 *ptr = (dms_indication_register_req_msg_v01 *) payload;
  ptr->report_imei_type_change_valid = TRUE;
  ptr->report_imei_type_change = enable;
}

void ril_utf_qmiril_if::set_qmi_dms_ind_req_report_nonencrypt_imei(uint8_t enable)
{
  dms_indication_register_req_msg_v01 *ptr = (dms_indication_register_req_msg_v01 *) payload;
  ptr->report_nonencrypt_imei_valid = TRUE;
  ptr->report_nonencrypt_imei = enable;
}
...
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_pdc_indication_register_req_v01(void)
{
  payload = (void *) malloc(sizeof(pdc_indication_register_req_msg_v01));
  payload_len = sizeof(pdc_indication_register_req_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_request;
  service_id = QMI_PDC;
  msg_id = QMI_PDC_INDICATION_REGISTER_REQ_V01;
  status = not_met;
}

/*========================================================
  QMI_PDC_INDICATION_REGISTER_RESP_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_pdc_indication_register_resp_v01(void)
{
  payload = (void *) malloc(sizeof(pdc_indication_register_resp_msg_v01));
  payload_len = sizeof(pdc_indication_register_resp_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_response;
  service_id = QMI_PDC;
  msg_id = QMI_PDC_INDICATION_REGISTER_RESP_V01;
}

void ril_utf_qmiril_if::set_qmi_pdc_indication_register_resp_msg_v01_result
  (qmi_result_type_v01 result, qmi_error_type_v01 error)
{
  pdc_indication_register_resp_msg_v01 *ptr =
    (pdc_indication_register_resp_msg_v01 *) payload;
  ptr->resp.result = result;
  ptr->resp.error = error;
}
...
void ril_utf_qmiril_if::update_default_qmi_wms_raw_send_req_msg_3gpp2(RIL_CDMA_SMS_Message *cdma_sms_msg, wms_message_format_enum_v01 format, uint8_t sms_on_ims)
{
  ...
  if(cdma_sms_msg != NULL)
  {
    ...
    {
        ptr->follow_on_dc_valid = TRUE;
        ptr->follow_on_dc = WMS_FOLLOW_ON_DC_ON_V01;
    }
...
void ril_utf_qmiril_if::set_qmi_wms_raw_send_req_link_control_mode(wms_link_control_mode_enum_v01 link_control_mode)
{
  wms_raw_send_req_msg_v01 *ptr = (wms_raw_send_req_msg_v01 *) payload;
  ptr->link_control_mode_valid = TRUE;
  ptr->link_control_mode = link_control_mode;
}
...
void ril_utf_qmiril_if::set_qmi_wms_event_report_ind_transfer_route_mt_message(
    wms_ack_indicator_enum_v01 ack_indicator, uint32_t transaction_id,
    wms_message_format_enum_v01 format, size_t data_len, uint8_t* data) {
  wms_event_report_ind_msg_v01* ptr = (wms_event_report_ind_msg_v01*)payload;
  ptr->transfer_route_mt_message_valid = TRUE;
  ptr->transfer_route_mt_message.ack_indicator = ack_indicator;
  ptr->transfer_route_mt_message.transaction_id = transaction_id;
  ...
  if (data != nullptr && data_len) {
    ptr->transfer_route_mt_message.data_len =
        std::min(sizeof(ptr->transfer_route_mt_message.data_len), data_len);
    memcpy(ptr->transfer_route_mt_message.data, data, ptr->transfer_route_mt_message.data_len);
  }
#endif
  ptr->transfer_route_mt_message.data_len = data_len;
  memcpy(ptr->transfer_route_mt_message.data, data, data_len);
}
...
void ril_utf_qmiril_if::update_default_qmi_imsa_ind_reg_req_v01(imsa_ind_reg_req_msg_v01 *msg)
{
  ...
  if (msg) {
    ...
    ptr->gps_config = 1;
    ptr->scbm_mode_update_config_valid = TRUE;
    ptr->scbm_mode_update_config = 1;
    ptr->voice_capability_update_config_valid = TRUE;
    ptr->voice_capability_update_config = 1;
    ptr->c_iwlan_status_config_valid = TRUE;
    ptr->c_iwlan_status_config = 1;
  }
}
...
/*========================================================
  QMI_IMSA_SCBM_MODE_UPDATE_IND_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_imsa_sms_callback_mode_ind(imsa_scbm_mode_update_type_v01 sms_callback_mode)
{
  payload = (void *) malloc(sizeof(imsa_scbm_mode_update_ind_msg_v01));
  payload_len = sizeof(imsa_scbm_mode_update_ind_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_indication;
  service_id = QMI_IMSA;
  msg_id = QMI_IMSA_SCBM_MODE_UPDATE_IND_V01;
  imsa_scbm_mode_update_ind_msg_v01 *ptr = (imsa_scbm_mode_update_ind_msg_v01 *) payload;
  ptr->scbm_mode_update_type = sms_callback_mode;
}
...
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_rfrpe_set_rfm_scenario_req(uint32_t scenarios_len, uint32_t *scenarios)
{
  payload_len = sizeof(rfrpe_set_scenario_req_v01);
  payload = malloc(payload_len);
  if (payload) {
    memset(payload, 0x00, payload_len);
    rfrpe_set_scenario_req_v01 *ptr = (rfrpe_set_scenario_req_v01 *)payload;
    ptr->scenarios_len = scenarios_len;
    if (scenarios_len && scenarios) {
      for(uint32_t i = 0; i < scenarios_len; i++) {
        ptr->scenarios[i] = scenarios[i];
      }
    }
  }
  payload_type = ril_utf_qmi_request;
  service_id = QMI_RFRPE;
  msg_id = QMI_RFRPE_SET_RFM_SCENARIO_REQ_V01;
}

/*========================================================
  QMI_RFRPE_SET_RFM_SCENARIO_RESP_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_rfrpe_set_rfm_scenario_resp(qmi_result_type_v01 result, qmi_error_type_v01 error)
{
  payload_len = sizeof(rfrpe_set_scenario_resp_v01);
  payload = malloc(payload_len);
  if (payload) {
    memset(payload, 0x00, payload_len);
  }
  payload_type = ril_utf_qmi_response;
  service_id = QMI_RFRPE;
  msg_id = QMI_RFRPE_SET_RFM_SCENARIO_RESP_V01;
  rfrpe_set_scenario_resp_v01 *ptr = (rfrpe_set_scenario_resp_v01 *)payload;
  if (ptr) {
    ptr->resp.error = error;
    ptr->resp.result= result;
  }
...
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_rfrpe_get_rfm_scenario_req()
{
  payload_len = 0;
  payload = nullptr;
  payload_type = ril_utf_qmi_request;
  service_id = QMI_RFRPE;
  msg_id = QMI_RFRPE_GET_RFM_SCENARIO_REQ_V01;
}

/*========================================================
  QMI_RFRPE_GET_RFM_SCENARIO_RESP_V01
========================================================*/
rfrpe_get_rfm_scenarios_resp_v01 *ril_utf_qmiril_if::update_default_qmi_rfrpe_get_rfm_scenario_resp(qmi_result_type_v01 result, qmi_error_type_v01 error)
{
  payload_len = sizeof(rfrpe_get_rfm_scenarios_resp_v01);
  payload = malloc(payload_len);
  if (payload) {
    memset(payload, 0x00, payload_len);
  }
  payload_type = ril_utf_qmi_response;
  service_id = QMI_RFRPE;
  msg_id = QMI_RFRPE_GET_RFM_SCENARIO_RESP_V01;
  rfrpe_get_rfm_scenarios_resp_v01 *ptr = (rfrpe_get_rfm_scenarios_resp_v01 *)payload;
  if (ptr) {
    ptr->resp.error = error;
    ptr->resp.result= result;
  }
...
uint32_t *ril_utf_qmiril_if::set_qmi_rfrpe_get_rfm_scenario_resp_active_scenarios(uint32_t active_scenarios_len)
{
  rfrpe_get_rfm_scenarios_resp_v01* ptr = (rfrpe_get_rfm_scenarios_resp_v01*)payload;
  ptr->active_scenarios_valid = TRUE;
  ptr->active_scenarios_len = active_scenarios_len;
  return (ptr->active_scenarios);
}

/*========================================================
  QMI_RFRPE_GET_PROVISIONED_TABLE_REVISION_REQ_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_rfrpe_get_provisioned_table_revision_req()
{
  payload_len = 0;
  payload = nullptr;
  payload_type = ril_utf_qmi_request;
  service_id = QMI_RFRPE;
  msg_id = QMI_RFRPE_GET_PROVISIONED_TABLE_REVISION_REQ_V01;
}

/*========================================================
  QMI_RFRPE_GET_PROVISIONED_TABLE_REVISION_RESP_V01
========================================================*/
rfrpe_get_provisioned_table_revision_resp_v01 *ril_utf_qmiril_if::update_default_qmi_rfrpe_get_provisioned_table_revision_resp(qmi_result_type_v01 result, qmi_error_type_v01 error)
{
  payload_len = sizeof(rfrpe_get_provisioned_table_revision_resp_v01);
  payload = malloc(payload_len);
  if (payload) {
    memset(payload, 0x00, payload_len);
  }
  payload_type = ril_utf_qmi_response;
  service_id = QMI_RFRPE;
  msg_id = QMI_RFRPE_GET_PROVISIONED_TABLE_REVISION_RESP_V01;
  rfrpe_get_provisioned_table_revision_resp_v01 *ptr = (rfrpe_get_provisioned_table_revision_resp_v01 *)payload;
  if (ptr) {
    ptr->resp.error = error;
    ptr->resp.result= result;
  }
...
/*=========================================================
   QMI_UIM_PROVISIONING_REQ_V01
=========================================================*/
qmi_uim_provisioning_req_msg_v01* ril_utf_qmiril_if::update_default_qmi_uim_provisioning_req_v01(void)
{
  payload = (qmi_uim_provisioning_req_msg_v01* )malloc(sizeof(qmi_uim_provisioning_req_msg_v01));
  payload_len = sizeof(qmi_uim_provisioning_req_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_request;
  msg_id = QMI_UIM_PROVISIONING_REQ_V01;
  service_id = QMI_UIM;

  return (qmi_uim_provisioning_req_msg_v01*) payload;
}

/*========================================================
  QMI_UIM_PROVISIONING_RESP_V01
========================================================*/
qmi_uim_provisioning_resp_msg_v01* ril_utf_qmiril_if::update_default_qmi_uim_provisioning_resp_v01(qmi_result_type_v01 result, qmi_error_type_v01 error)
{
  payload = (qmi_uim_provisioning_resp_msg_v01* )malloc(sizeof(qmi_uim_provisioning_resp_msg_v01));
  payload_len = sizeof(qmi_uim_provisioning_resp_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_response;
  msg_id = QMI_UIM_PROVISIONING_RESP_V01;
  service_id = QMI_UIM;

  qmi_uim_provisioning_resp_msg_v01 *ptr = (qmi_uim_provisioning_resp_msg_v01 *) payload;
  ptr->resp.result = result;
  ptr->resp.error = error;

  return (qmi_uim_provisioning_resp_msg_v01*) payload;
}

/*========================================================
  QMI_IMSA_DUAL_SIMS_VOICE_CAPABILITY_IND_V01
========================================================*/
imsa_dual_sim_voice_capability_ind_msg_v01*
ril_utf_qmiril_if::update_default_qmi_imsa_dual_sim_voice_capability_ind(
    imsa_dual_sim_voice_capability_type_v01 voiceCapability) {
  payload = (void*)malloc(sizeof(imsa_dual_sim_voice_capability_ind_msg_v01));
  assert(payload != nullptr);
  payload_len = sizeof(imsa_dual_sim_voice_capability_ind_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_indication;
  service_id = QMI_IMSA;
  msg_id = QMI_IMSA_DUAL_SIMS_VOICE_CAPABILITY_IND_V01;

  imsa_dual_sim_voice_capability_ind_msg_v01* ptr =
      (imsa_dual_sim_voice_capability_ind_msg_v01*)payload;
  ptr->voice_capability_type = voiceCapability;

  return ptr;
}

/*========================================================
  QMI_IMS_SETTINGS_GET_DUAL_SIM_VOICE_CAPABILITY_REQ_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_imss_request_get_dual_sim_voice_capability(void) {
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_qmi_request;
  service_id = QMI_IMSS;
  msg_id = QMI_IMS_SETTINGS_GET_DUAL_SIM_VOICE_CAPABILITY_REQ_V01;
}

/*========================================================
  QMI_IMS_SETTINGS_GET_DUAL_SIM_VOICE_CAPABILITY_RSP_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_imss_request_get_dual_sim_voice_capability_resp(
    qmi_result_type_v01 result, qmi_error_type_v01 error) {
  payload = (ims_settings_get_dual_sim_voice_capability_rsp_msg_v01*)malloc(
      sizeof(ims_settings_get_dual_sim_voice_capability_rsp_msg_v01));
  assert(payload != nullptr);
  payload_len = sizeof(ims_settings_get_dual_sim_voice_capability_rsp_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_response;
  service_id = QMI_IMSS;
  msg_id = QMI_IMS_SETTINGS_GET_DUAL_SIM_VOICE_CAPABILITY_RSP_V01;

  ims_settings_get_dual_sim_voice_capability_rsp_msg_v01* ptr =
      (ims_settings_get_dual_sim_voice_capability_rsp_msg_v01*)payload;
  ptr->resp.error = error;
  ptr->resp.result = result;
}

void ril_utf_qmiril_if::set_qmi_imss_request_get_dual_sim_voice_capability_resp_voice_capability(
    ims_settings_voice_capability_on_dual_sims_enum_v01 voiceCapability) {
  ims_settings_get_dual_sim_voice_capability_rsp_msg_v01* ptr =
      (ims_settings_get_dual_sim_voice_capability_rsp_msg_v01*)payload;
  ptr->voice_capability_resp_valid = TRUE;
  ptr->voice_capability_resp = voiceCapability;
}

/*========================================================
  QMI_IMSA_C_IWLAN_STATUS_IND_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_imsa_c_iwlan_status_ind_msg(void)
{
  payload = (void *) malloc(sizeof(imsa_c_iwlan_status_ind_msg_v01));
  payload_len = sizeof(imsa_c_iwlan_status_ind_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_indication;
  service_id = QMI_IMSA;
  msg_id = QMI_IMSA_C_IWLAN_STATUS_IND_V01;
}

void ril_utf_qmiril_if::set_qmi_imsa_c_iwlan_status_ind_c_iwlan_feature_exit_needed(boolean show)
{
  imsa_c_iwlan_status_ind_msg_v01 *ptr = (imsa_c_iwlan_status_ind_msg_v01*)payload;
  ptr->c_iwlan_feature_exit_needed_valid = TRUE;
  ptr->c_iwlan_feature_exit_needed = show;
}

/*========================================================
  QMI_VOICE_SIP_VOS_CAPABILITY_ACK_REQ_V02
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_voice_sip_vos_capability_ack_req_msg(void)
{
  payload = (void *)malloc(sizeof(voice_sip_vos_capability_ack_req_msg_v02));
  payload_len = sizeof(voice_sip_vos_capability_ack_req_msg_v02);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_request;
  service_id = QMI_VOICE;
  msg_id = QMI_VOICE_SIP_VOS_CAPABILITY_ACK_REQ_V02;
}

void ril_utf_qmiril_if::set_qmi_voice_sip_vos_capability_ack_req(uint8_t call_id, uint8_t vos_support)
{
  voice_sip_vos_capability_ack_req_msg_v02 *ptr =
      (voice_sip_vos_capability_ack_req_msg_v02 *)payload;
  ptr->call_id = call_id;
  ptr->vos_support = vos_support;
}

/*========================================================
  QMI_VOICE_SIP_VOS_CAPABILITY_ACK_RESP_V02
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_voice_sip_vos_capability_ack_resp_msg(void)
{
  payload = (void *)malloc(sizeof(voice_sip_vos_capability_ack_resp_msg_v02));
  payload_len = sizeof(voice_sip_vos_capability_ack_resp_msg_v02);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_response;
  service_id = QMI_VOICE;
  msg_id = QMI_VOICE_SIP_VOS_CAPABILITY_ACK_RESP_V02;
}

void ril_utf_qmiril_if::set_qmi_voice_sip_vos_capability_ack_resp(qmi_result_type_v01 result,
                                                                  qmi_error_type_v01 error) {
  voice_sip_vos_capability_ack_resp_msg_v02 *ptr =
      (voice_sip_vos_capability_ack_resp_msg_v02 *)payload;
  ptr->resp.error = error;
  ptr->resp.result= result;
}
...
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_voice_sip_vos_action_msg(void)
{
  payload = (void *)malloc(sizeof(voice_sip_vos_action_req_msg_v02));
  payload_len = sizeof(voice_sip_vos_action_req_msg_v02);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_request;
  service_id = QMI_VOICE;
  msg_id = QMI_VOICE_SIP_VOS_ACTION_REQ_V02;
}

void ril_utf_qmiril_if::set_qmi_voice_sip_vos_move_msg(uint8_t call_id, int16_t start_latitude,
    int16_t start_longitude, int16_t end_latitude, int16_t end_longitude)
{
  voice_sip_vos_action_req_msg_v02 *ptr = (voice_sip_vos_action_req_msg_v02 *)payload;
  ptr->call_id = call_id;
  ptr->sip_vos_move_info_valid = 0x01;
  ptr->sip_vos_move_info.start_coordinates.latitude = start_latitude;
  ptr->sip_vos_move_info.start_coordinates.longitude = start_longitude;
  ptr->sip_vos_move_info.end_coordinates.latitude = end_latitude;
  ptr->sip_vos_move_info.end_coordinates.longitude = end_longitude;
  ptr->sip_vos_touch_info_valid = 0x00;
}

void ril_utf_qmiril_if::set_qmi_voice_sip_vos_touch_msg(uint8_t call_id, int16_t touch_latitude,
    int16_t touch_longitude, uint32_t touch_duration)
{
  voice_sip_vos_action_req_msg_v02 *ptr = (voice_sip_vos_action_req_msg_v02 *)payload;
  ptr->call_id = call_id;
  ptr->sip_vos_move_info_valid = 0x00;
  ptr->sip_vos_touch_info_valid = 0x01;
  ptr->sip_vos_touch_info.touch_coordinates.latitude = touch_latitude;
  ptr->sip_vos_touch_info.touch_coordinates.longitude = touch_longitude;
  ptr->sip_vos_touch_info.touch_duration = touch_duration;
}

/*========================================================
  QMI_VOICE_SIP_VOS_ACTION_RESP_V02
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_voice_sip_vos_action_resp_msg(void)
{
  payload = (void *)malloc(sizeof(voice_sip_vos_action_resp_msg_v02));
  payload_len = sizeof(voice_sip_vos_action_resp_msg_v02);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_response;
  service_id = QMI_VOICE;
  msg_id = QMI_VOICE_SIP_VOS_ACTION_RESP_V02;
}

void ril_utf_qmiril_if::set_qmi_voice_sip_vos_action_resp(qmi_result_type_v01 result,
                                                          qmi_error_type_v01 error)
{
  voice_sip_vos_action_resp_msg_v02 *ptr = (voice_sip_vos_action_resp_msg_v02 *)payload;
  ptr->resp.error = error;
  ptr->resp.result= result;
}
