 ...
 */
  ...
  */
  ...
  dms_get_device_cap_resp_msg_v01 *update_default_qmi_dms_get_device_cap_resp_v01(qmi_result_type_v01 result, qmi_error_type_v01 error);
  ...
  */
  void update_default_qmi_dms_get_device_state_info_req_msg(void);

  /*
     QMI_DMS_GET_DEVICE_STATE_INFO_RESP_V01
  */
  void update_default_qmi_dms_get_device_state_info_resp_msg(void);
  void set_qmi_dms_get_device_state_info_resp_result(qmi_result_type_v01 result, qmi_error_type_v01 error);
  void set_qmi_dms_get_device_state_info_resp_init_state(dms_device_init_state_enum_v01 state);
  void set_qmi_dms_get_device_state_info_resp_init_fail_reason(dms_device_state_fail_reason_enum_v01 reason);
...
//  void set_qmi_nas_get_system_selection_preference_resp_roam_pref(nas_roam_pref_enum_v01 roam_pref);
  ...
  void set_qmi_nas_get_system_selection_preference_resp_lte_band_pref_ext(lte_band_pref_mask_ext_type_v01 band_pref_ext);
  void set_qmi_nas_get_system_selection_preference_resp_nr5g_band_pref(nas_nr5g_band_pref_mask_type_v01 band_pref_ext);
//  void set_qmi_nas_get_system_selection_preference_resp_net_sel_pref(nas_net_sel_pref_enum_v01 net_sel_pref);
 ...
 // void set_qmi_nas_get_system_selection_preference_resp_srv_reg_restriction(nas_srv_reg_restriction_enum_v01 srv_reg_restriction);
  ...
  void set_qmi_nas_get_system_selection_preference_resp_nr5g_disable_mode(nas_nr5g_disable_mode_enum_type_v01 nr5g_disable_mode);
 ...
 */
  ...
  void set_qmi_voice_set_config_req_auto_answer(uint8_t auto_answer);
  voice_preferred_voice_so_type_v02 &set_qmi_voice_set_config_req_preferred_voice_so();
  voice_roam_timer_type_v02 &set_qmi_voice_set_config_req_roam_timer();
  voice_air_timer_type_v02 &set_qmi_voice_set_config_req_air_timer();
...
*/
  ...
  void set_qmi_voice_get_config_req_air_timer(uint8_t val);
...
*/
  ...
  void set_qmi_voice_get_config_resp_auto_answer_status(uint8_t val);
  voice_preferred_voice_so_type_v02 &set_qmi_voice_get_config_resp_current_preferred_voice_so();
  voice_roam_timer_type_v02 &set_qmi_voice_get_config_resp_roam_timer_count();
  voice_air_timer_type_v02 &set_qmi_voice_get_config_resp_air_timer_count();
...
*/
  ...
  void set_qmi_voice_dial_call_req_call_emerg_service_urn(uint32_t emerg_service_urn_len, uint8_t *emerg_service_urn);
...
*/
  ...
  void set_qmi_voice_answer_call_req_rtt_mode(rtt_mode_type_v02 val);
...
*/
  ...
  void set_qmi_voice_ind_req_sups_events(uint8_t sups_events);
  void set_qmi_voice_ind_req_auto_rejected_incoming_call_end_event(uint8_t auto_rejected_incoming_call_end_event);
  void set_qmi_voice_ind_req_sip_dtmf_event(uint8_t sip_dtmf_event);
  void set_qmi_voice_ind_req_notify_clir_mode_events(uint8_t notify_clir_mode_events);
  void set_qmi_voice_ind_req_network_detected_ecc_number_event(uint8_t network_detected_ecc_number_event);
...
*/
  ...
  */
  void update_default_qmi_voice_get_sups_operation_mode_req_msg(voice_reason_enum_v02 reason);

  /*
    QMI_VOICE_GET_SUPS_OPERATION_MODE_RESP_V02
   */
  void update_default_qmi_voice_get_sups_operation_mode_resp_msg(qmi_result_type_v01 result,
                                                                 qmi_error_type_v01 error);
  void set_qmi_voice_get_sups_operation_mode_resp_sups_operation_mode(
...
*/
  ...
  void set_voice_get_call_barring_req_additional_ss_expected(boolean val);
/*
...
*/
  ...
  */
  ...
  void set_voice_get_call_forwarding_req_additional_ss_expected(boolean val);
/*
...
*/
  ...
  void set_qmi_voice_get_call_forwarding_resp_failure_cause(qmi_sups_errors_enum_v02 val);
...
*/
  ...
  set_qmi_voice_all_call_status_ind_call_composer_organization(uint32_t len);
  // ecnam info related
  voice_call_ecnam_icon_url_type_v02* set_qmi_voice_all_call_status_ind_ecnam_icon_url(uint32_t len);
  voice_call_ecnam_info_url_type_v02* set_qmi_voice_all_call_status_ind_ecnam_info_url(uint32_t len);
  voice_call_ecnam_card_url_type_v02* set_qmi_voice_all_call_status_ind_ecnam_card_url(uint32_t len);

  voice_prog_info_notif_type_v02*
  set_qmi_voice_all_call_status_ind_prog_info_notif(uint32_t len);
  ...
  voice_call_rtt_capabilities_info_type_v02* set_qmi_voice_all_call_status_ind_rtt_capabilities_info(uint32_t len);
  ...
  voice_ip_diversion_info_type_v02* set_qmi_voice_all_call_status_ind_ip_diversion_info(uint32_t len);
  ...
  voice_silent_ui_type_v02* set_qmi_voice_all_call_status_ind_silent_ui(uint32_t silent_ui_len);
  voice_original_call_type_v02*
  set_qmi_voice_all_call_status_ind_original_call_type(uint32_t original_call_type_len);
  voice_crs_type_v02* set_qmi_voice_all_call_status_ind_crs_type(uint32_t crs_type_len);
  voice_msim_additional_call_info_type_v02*
  set_qmi_voice_all_call_status_ind_msim_additional_call_info(uint32_t len);
  voice_vos_type_v02* set_qmi_voice_all_call_status_ind_vos_support_type(uint32_t len);
/*
...
*/
  ...
  void set_qmi_voice_modified_ind_vos_support(uint8_t vos_support);
...
*/
  ...
  void set_qmi_voice_modified_accept_ind_audio_attrib(voice_call_attribute_type_mask_v02 audio_attrib);
  void set_qmi_voice_modified_accept_ind_video_attrib(voice_call_attribute_type_mask_v02 video_attrib);
  void set_qmi_voice_modified_accept_ind_rtt_mode(rtt_mode_type_v02 rtt_mode);
  void set_qmi_voice_modified_accept_ind_vos_support(uint8_t vos_support);
/*
...
*/
  ...
  void set_qmi_voice_speech_codec_info_ind_audio_quality(voice_audio_quality_enum_v02 audio_quality);
...
*/
  void update_default_qmi_voice_network_detected_ecc_num_ind_msg();
  voice_num_with_id_type_v02 *set_qmi_voice_network_detected_ecc_num_ind_num(char *address);
  void set_qmi_voice_network_detected_ecc_num_ind_emerg_srv_categ(uint32_t emerg_srv_categ);
  void set_qmi_voice_network_detected_ecc_num_ind_emerg_service_urn(uint32_t emerg_service_urn_len, uint8_t *emerg_service_urn);
...
*/
  void update_default_qmi_voice_notify_clir_mode_ind_msg();
  void set_qmi_voice_notify_clir_mode_ind_is_ue_based_clir(uint8_t is_ue_based_clir);
...
*/
  ...
  void set_qmi_nas_perform_network_scan_req_msg_scan_type(nas_nw_scan_type_enum_v01 val);
...
*/
  ...
  nas_csg_nw_iden_type_v01 *set_qmi_nas_system_selection_preference_req_csg_info();
  ...
  lte_band_pref_mask_ext_type_v01 *set_qmi_nas_system_selection_preference_req_lte_band_pref();
  nas_nr5g_band_pref_mask_type_v01 *set_qmi_nas_system_selection_preference_req_nr5g_band_pref();
  void set_qmi_nas_system_selection_preference_req_change_duration(nas_change_duration_enum_v01 chg_dur);
/*
...
*/
  ...
  nas_cdma_cell_info_type_v01 *set_qmi_nas_get_cell_location_info_resp_cdma_info();
  nas_lte_intra_freq_type_v01 *set_qmi_nas_get_cell_location_info_resp_lte_intra();
  nas_lte_inter_freq_type_v01 *set_qmi_nas_get_cell_location_info_resp_lte_inter();
  nas_lte_ngbr_gsm_type_v01 *set_qmi_nas_get_cell_location_info_resp_lte_gsm();
  nas_lte_ngbr_wcdma_type_v01 *set_qmi_nas_get_cell_location_info_resp_lte_wcdma();
  void set_qmi_nas_get_cell_location_info_resp_umts_cell_id(uint32_t umts_cell_id);
  void set_qmi_nas_get_cell_location_info_resp_nr5g_arfcn(uint32_t nr5g_arfcn);
  nas_nr5g_serving_cell_info_type_v01 *set_qmi_nas_get_cell_location_info_resp_nr5g_serving_cell_info();
...
*/
nas_get_rf_band_info_resp_msg_v01 *update_default_qmi_nas_get_rf_band_info_resp_msg();
...
*/
nas_get_lte_cphy_ca_info_resp_msg_v01 *update_default_nas_get_lte_cphy_ca_info_resp_msg();
...
void set_qmi_nas_get_3gpp2_subscription_info_resp_nam_name(const char *name);
...
nas_3gpp2_true_imsi_info_type_v01 &set_qmi_nas_get_3gpp2_subscription_info_resp_true_imsi();
nas_cdma_channel_info_type_v01 &set_qmi_nas_get_3gpp2_subscription_info_resp_cdma_channel_info();
char *set_qmi_nas_get_3gpp2_subscription_info_resp_dir_num(uint32_t dir_num_len);

/*
  QMI_NAS_SET_3GPP2_SUBSCRIPTION_INFO_REQ_MSG_V01
*/
void update_default_qmi_nas_set_3gpp2_subscription_info_req_msg(uint8_t nam_id);
nas_3gpp2_min_based_info_type_v01 *set_qmi_nas_set_3gpp2_subscription_info_req_min_based_info();
nas_3gpp2_true_imsi_info_type_v01 &set_qmi_nas_set_3gpp2_subscription_info_req_true_imsi();
nas_cdma_channel_info_type_v01 &set_qmi_nas_set_3gpp2_subscription_info_req_cdma_channel_info();
nas_3gpp2_home_sid_nid_info_type_v01 *set_qmi_nas_set_3gpp2_subscription_info_req_cdma_sys_id(uint32_t cdma_sys_id_len);
char *set_qmi_nas_set_3gpp2_subscription_info_req_dir_num(uint32_t dir_num_len);
void set_qmi_nas_set_3gpp2_subscription_info_req_nam_name(const char *name);
/*
  QMI_NAS_SET_3GPP2_SUBSCRIPTION_INFO_RESP_MSG_V01
*/
void upate_default_qmi_nas_set_3gpp2_subscription_info_resp_msg(qmi_result_type_v01 result,qmi_error_type_v01 error);
...
*/
void update_default_qmi_nas_get_home_network_req_msg();
/*
...
nas_cdma_system_id_type_v01 &set_qmi_nas_get_home_network_resp_home_system_id();
/*
  QMI_NAS_GET_MOB_CAI_REV_REQ_MSG_V01
*/
void update_default_qmi_nas_get_mob_cai_rev_req_msg();
/*
...
void set_qmi_nas_get_mob_cai_rev_resp_cai_rev(uint8_t cai_rev);
...
void update_serving_mcc_ecc_from_qmi_pbm_list_ind_msg(const char *number);
...
*/
nas_system_selection_preference_ind_msg_v01* update_default_qmi_nas_system_selection_preference_ind_msg();
...
void set_qmi_nas_system_selection_preference_ind_access_mode(nas_access_mode_enum_type_v01 val);
#ifdef RIL_UTF_L_MASTER
void set_qmi_nas_system_selection_preference_ind_rat_disabled_mask(mode_pref_mask_type_v01 mask);
#endif
nas_csg_nw_iden_type_v01 *set_qmi_nas_system_selection_preference_ind_csg_info();
...
/*
  QMI_NAS_NR_SIB9_NETWORK_TIME_IND_V01
*
void update_default_qmi_nas_nr_sib9_network_time_ind();
void set_qmi_nas_nr_sib9_network_time_ind_nr_sib9_acquired(nas_tri_state_boolean_type_v01 utc_sib9_acquired);
void set_qmi_nas_nr_sib9_network_time_ind_abs_time(uint64_t abs_time);
*/
/*
...
*/
void update_default_qmi_nas_get_nr_sib9_network_time_req_msg_v01();
/*
  QMI_NAS_GET_NR_SIB9_NETWORK_TIME_RESP_MSG_V01
*/
void update_default_qmi_nas_get_nr_sib9_network_time_resp_msg_v01(qmi_result_type_v01 result,qmi_error_type_v01 error);
...
void set_qmi_dms_ind_req_report_device_state(uint8_t device_state);
void set_qmi_dms_ind_req_report_imei_type(uint8_t enable);
void set_qmi_dms_ind_req_report_nonencrypt_imei(uint8_t enable);
...
void set_qmi_wms_raw_send_req_link_control_mode(wms_link_control_mode_enum_v01 link_control_mode);
...
#endif
void set_qmi_wms_event_report_ind_transfer_route_mt_message(
...
*/
void update_default_qmi_imsa_sms_callback_mode_ind(imsa_scbm_mode_update_type_v01 sms_callback_mode);
#endif
...
========================================================*/
void update_default_qmi_pdc_indication_register_req_v01(void);
void update_default_qmi_pdc_indication_register_resp_v01(void);
void set_qmi_pdc_indication_register_resp_msg_v01_result
  (qmi_result_type_v01 result, qmi_error_type_v01 error);

/*========================================================
  QMI_RFRPE_SET_RFM_SCENARIO_REQ_V01
========================================================*/
void update_default_qmi_rfrpe_set_rfm_scenario_req(uint32_t scenarios_len, uint32_t *scenarios);

/*========================================================
  QMI_RFRPE_SET_RFM_SCENARIO_RESP_V01
========================================================*/
void update_default_qmi_rfrpe_set_rfm_scenario_resp(qmi_result_type_v01 result, qmi_error_type_v01 error);

/*========================================================
  QMI_RFRPE_GET_RFM_SCENARIO_REQ_V01
========================================================*/
void update_default_qmi_rfrpe_get_rfm_scenario_req();

/*========================================================
  QMI_RFRPE_GET_RFM_SCENARIO_RESP_V01
========================================================*/
rfrpe_get_rfm_scenarios_resp_v01 *update_default_qmi_rfrpe_get_rfm_scenario_resp(qmi_result_type_v01 result, qmi_error_type_v01 error);
uint32_t *set_qmi_rfrpe_get_rfm_scenario_resp_active_scenarios(uint32_t active_scenarios_len);

/*========================================================
  QMI_RFRPE_GET_PROVISIONED_TABLE_REVISION_REQ_V01
========================================================*/
void update_default_qmi_rfrpe_get_provisioned_table_revision_req();

/*========================================================
  QMI_RFRPE_GET_PROVISIONED_TABLE_REVISION_RESP_V01
========================================================*/
rfrpe_get_provisioned_table_revision_resp_v01 *update_default_qmi_rfrpe_get_provisioned_table_revision_resp(qmi_result_type_v01 result, qmi_error_type_v01 error);
...
void update_default_qmi_ims_settings_get_supported_fields_req(uint16_t qmiMsgId);
void update_default_qmi_ims_settings_get_supported_fields_resp(uint16_t qmiMsgId=QMI_IMS_SETTINGS_SET_IMS_SERVICE_ENABLE_CONFIG_RSP_V01);
...
========================================================*/
qmi_uim_provisioning_req_msg_v01* update_default_qmi_uim_provisioning_req_v01(void);

/*========================================================
  QMI_UIM_PROVISIONING_RESP_V01
========================================================*/
qmi_uim_provisioning_resp_msg_v01* update_default_qmi_uim_provisioning_resp_v01(qmi_result_type_v01 result, qmi_error_type_v01 error);

/*========================================================
  QMI_IMSA_DUAL_SIMS_VOICE_CAPABILITY_IND_V01
========================================================*/
imsa_dual_sim_voice_capability_ind_msg_v01* update_default_qmi_imsa_dual_sim_voice_capability_ind(
    imsa_dual_sim_voice_capability_type_v01 voiceCapability);

/*========================================================
  QMI_IMS_SETTINGS_GET_DUAL_SIM_VOICE_CAPABILITY_REQ_V01
========================================================*/
void update_default_qmi_imss_request_get_dual_sim_voice_capability(void);

/*========================================================
  QMI_IMS_SETTINGS_GET_DUAL_SIM_VOICE_CAPABILITY_RSP_V01
========================================================*/
void update_default_qmi_imss_request_get_dual_sim_voice_capability_resp(qmi_result_type_v01 result,
                                                        qmi_error_type_v01 error);
void set_qmi_imss_request_get_dual_sim_voice_capability_resp_voice_capability(
    ims_settings_voice_capability_on_dual_sims_enum_v01 voiceCapability);

/*========================================================
  QMI_IMSA_C_IWLAN_STATUS_IND_V01
========================================================*/
void update_default_qmi_imsa_c_iwlan_status_ind_msg(void);
void set_qmi_imsa_c_iwlan_status_ind_c_iwlan_feature_exit_needed(boolean show);

void update_default_qmi_nas_nr_sib9_network_time_ind();

void set_qmi_nas_nr_sib9_network_time_ind_nr_sib9_acquired(nas_tri_state_boolean_type_v01 utc_sib9_acquired);

void set_qmi_nas_nr_sib9_network_time_ind_daylight_saving_time(nas_nr5g_rrc_utc_dayLightSaving_type_e_v01 dayLightSavingTime);

void set_qmi_nas_nr_sib9_network_time_ind_leapSeconds(uint16_t leapSeconds);

void set_qmi_nas_nr_sib9_network_time_ind_abs_time(uint16_t abs_time);

void set_qmi_nas_nr_sib9_network_time_ind_universal_time(nas_lte_sib16_julian_time_type_v01 universal_time);

void set_qmi_nas_nr_sib9_network_time_ind_localTime_Offset(uint16_t localTimeOffset);

void update_default_qmi_nas_get_network_time_req_msg_v01();

void update_default_qmi_nas_get_network_time_resp_msg_v01();

void set_qmi_nas_get_network_time_resp_result(qmi_result_type_v01 result, qmi_error_type_v01 error);

nas_network_time_type_v01* set_qmi_nas_get_network_time_resp_nas_3gpp_time();

/*========================================================
  QMI_VOICE_SIP_VOS_CAPABILITY_ACK_REQ_V02
========================================================*/
void update_default_qmi_voice_sip_vos_capability_ack_req_msg(void);
void set_qmi_voice_sip_vos_capability_ack_req(uint8_t call_id, uint8_t vos_support);

/*========================================================
  QMI_VOICE_SIP_VOS_CAPABILITY_ACK_RESP_V02
========================================================*/
void update_default_qmi_voice_sip_vos_capability_ack_resp_msg(void);
void set_qmi_voice_sip_vos_capability_ack_resp(qmi_result_type_v01 result,
                                               qmi_error_type_v01 error);

/*========================================================
  QMI_VOICE_SIP_VOS_ACTION_REQ_V02
========================================================*/
void update_default_qmi_voice_sip_vos_action_msg(void);
void set_qmi_voice_sip_vos_move_msg(uint8_t call_id,
                                    int16_t start_latitude, int16_t start_longitude,
                                    int16_t end_latitude, int16_t end_longitude);
void set_qmi_voice_sip_vos_touch_msg(uint8_t call_id,
                                     int16_t touch_latitude, int16_t touch_longitude,
                                     uint32_t touch_duration);

/*========================================================
  QMI_VOICE_SIP_VOS_ACTION_RESP_V02
========================================================*/
void update_default_qmi_voice_sip_vos_action_resp_msg(void);
void set_qmi_voice_sip_vos_action_resp(qmi_result_type_v01 result, qmi_error_type_v01 error);
