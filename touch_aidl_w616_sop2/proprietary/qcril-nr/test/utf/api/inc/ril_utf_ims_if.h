...
//==================================================
  ...
  */
  ...
  void set_ims_request_answer_rtt_mode(ims_RttMode rttMode);
  ...
  */
  ...
  void set_ims_request_modify_call_confirm_rtt_mode(ims_RttMode rttMode);
  ...
  */
  ...
  void set_ims_unsol_modify_call_call_details_rtt_mode(ims_RttMode rttMode);
  void set_ims_unsol_modify_call_call_details_vos_support(bool isVosSupported);
  ...
  */
  ims_AutoCallRejectionInfo2* update_ims_unsol_call_auto_rejection_ind2(
...
void set_ims_request_set_supp_svc_response_resp_provisionStatus(ims_ServiceClassProvisionStatus status);
  ...
  */
  ...
  ims_SmsSendResponse* update_default_ims_send_sms_response();
  ...
  */
  ims_PreAlertingCallInfo* update_default_ims_unsol_pre_alerting_call_info();
   ...
   */
  void update_default_ims_unsol_conference_call_state_completed();

  /*
    ims_MsgId_UNSOL_SMS_CALLBACK_MODE_CHANGED
   */
  void update_default_ims_unsol_sms_callback_mode_changed(
      enum ims_SmsCallbackModeStatus smsCallbackModeStatus);

  /*
    ims_MsgId_UNSOL_C_IWLAN_EXIT_NOTIFICATION
   */
  void update_default_ims_unsol_c_iwlan_notification(ims_CIWlan_Notification show);

  /*
    ims_MsgId_UNSOL_INCOMING_DTMF_START
  */
  ims_Dtmf* update_default_ims_unsol_incoming_dtmf_start();

  /*
    ims_MsgId_UNSOL_INCOMING_DTMF_STOP
  */
  ims_Dtmf* update_default_ims_unsol_incoming_dtmf_stop();

  /*
    ims_MsgId_REQUEST_QUERY_MULTI_SIM_VOICE_CAPABILITY
   */
  void update_default_ims_query_multi_sim_voice_capability();
  ims_MultiSimVoiceCapability* update_default_ims_query_multi_sim_voice_capability_resp();
  void set_ims_request_ims_query_multi_sim_voice_capability_resp_voice_capability(
      ims_Voice_Capability voiceCapability);

  /*
    ims_MsgId_UNSOL_MULTI_SIM_VOICE_CAPABILITY_CHANGED
  */
  void update_default_ims_unsol_multi_sim_voice_capability_changed(
      ims_Voice_Capability voiceCapability);

  /*
    ims_MsgId_REQUEST_SEND_VOS_SUPPORT_STATUS
   */
  void update_default_ims_send_vos_support_status(void);
  void set_ims_request_send_vos_support_status_support_status(bool isVosSupported);
  void update_default_ims_send_vos_support_status_resp(void);

  /*
    ims_MsgId_REQUEST_SEND_VOS_ACTION_INFO
   */
  void update_default_ims_send_vos_action_info(void);
  void set_ims_request_send_vos_move_info_move_info(int16_t startx, int16_t starty,
                                                    int16_t endx, int16_t endy);
  void set_ims_request_send_vos_touch_info_touch_info(int16_t touchx, int16_t touchy,
                                                      uint32_t touchDuration);
  void update_default_ims_send_vos_action_info_resp(void);
