...
*/
void update_default_ril_unsol_sib9_new_msg(char *ascii_hex_string);
...
*/
RIL_CDMA_SMS_Message *update_default_ril_unsol_response_cdma_new_sms();
...
*/
void update_default_ril_request_radio_power(int on, int emergency, int preferredSub);
...
*/
RIL_CDMA_SMS_Message* update_default_ril_request_cdma_send_sms_expect_more();
RIL_SMS_Response* update_default_ril_request_cdma_send_sms_expect_more_resp();
/*
...
void set_ril_request_get_current_calls_resp_redirected_number(int call_slot, char *number);
...
*/
void update_default_ril_request_get_system_selection_channels(void);
RIL_SysSelChannels* update_default_ril_request_get_system_selection_channels_resp();

/*
    RIL_REQUEST_SET_SYSTEM_SELECTION_CHANNELS
*/
ril_request_set_sys_channels_t *update_default_ril_request_set_system_selection_channels(
    ril_request_set_sys_channels_t *req = nullptr);
void update_default_ril_request_set_system_selection_channels_resp();
} AndroidTelTestnode;
