...
static const ril_utf_q_element_t_type ril_utf_q_element_t_name[] = {
    ...
    {ril_utf_dsi_request, "DSI_REQUEST"},
    {ril_utf_dsi_response, "DSI_RESPONSE"},
    {ril_utf_dsi_indication, "DSI_INDICATION"},
    {ril_utf_qdp_request, "QDP_REQUEST"},
    {ril_utf_qdp_response, "QDP_RESPONSE"}
};
