...
void ril_utf_bootup_helper(Testcase &t, int boot_config)
{
  ...
  */
  ...
  // Expect: QMI_VOICE_INDICATION_REGISTER_REQ
  QMI_node.update_default_qmi_voice_ind_reg_req_msg();
  QMI_node.set_qmi_voice_ind_req_sups_events(0x01);
  t.expect(QMI_node);
  ...
  // Expect: QMI_VOICE_INDICATION_REGISTER_REQ
  QMI_node.update_default_qmi_voice_ind_reg_req_msg();
  QMI_node.set_qmi_voice_ind_req_auto_rejected_incoming_call_end_event(0x01);
  t.expect(QMI_node);
  ...
  // Expect: QMI_VOICE_INDICATION_REGISTER_REQ
  QMI_node.update_default_qmi_voice_ind_reg_req_msg();
  QMI_node.set_qmi_voice_ind_req_sip_dtmf_event(0x01);
  t.expect(QMI_node);
  ...
  // Expect: QMI_VOICE_INDICATION_REGISTER_REQ
  QMI_node.update_default_qmi_voice_ind_reg_req_msg();
  QMI_node.set_qmi_voice_ind_req_notify_clir_mode_events(0x01);
  t.expect(QMI_node);
  ...
  // Expect: QMI_VOICE_INDICATION_REGISTER_REQ
  QMI_node.update_default_qmi_voice_ind_reg_req_msg();
  QMI_node.set_qmi_voice_ind_req_network_detected_ecc_number_event(0x01);
  t.expect(QMI_node);
  ...
  // Expect: QMI_VOICE_INDICATION_REGISTER_REQ
  QMI_node.update_default_qmi_voice_ind_reg_req_msg();
  QMI_node.set_qmi_voice_ind_req_reg_dtmf_events(0x01);
  t.expect(QMI_node);
  ...
  // Expect: QMI_VOICE_GET_SUPS_OPERATION_MODE_REQ_V02
  QMI_node.update_default_qmi_voice_get_sups_operation_mode_req_msg(VOICE_REASON_CLIR_V02);
  t.expect(QMI_node);

  // Inject: QMI_VOICE_GET_SUPS_OPERATION_MODE_RESP_V02
  QMI_node.update_default_qmi_voice_get_sups_operation_mode_resp_msg(QMI_RESULT_SUCCESS_V01, QMI_ERR_NONE_V01);
  QMI_node.set_qmi_voice_get_sups_operation_mode_resp_sups_operation_mode(UE_BASED_SUPS_V02);
  t.inject(QMI_node);
  ...
  QMI_node.set_qmi_dms_ind_req_report_device_state(0x01);
  QMI_node.set_qmi_dms_ind_req_report_imei_type(0x01);
  QMI_node.set_qmi_dms_ind_req_report_nonencrypt_imei(0x01);
  t.expect(QMI_node);
  ...
  // Expect: QMI_PDC_INDICATION_REGISTER_REQ_V01
  QMI_node.update_default_qmi_pdc_indication_register_req_v01();
  t.expect(QMI_node);

  // Inject: QMI_PDC_INDICATION_REGISTER_RESP_V01
  QMI_node.update_default_qmi_pdc_indication_register_resp_v01();
  QMI_node.set_qmi_pdc_indication_register_resp_msg_v01_result(QMI_RESULT_SUCCESS_V01, QMI_ERR_NONE_V01);
  t.inject(QMI_node);
  ...
  if(SSR_BOOT != boot_config)
  {
    ...
    QMI_node.update_default_qmi_ims_settings_get_supported_fields_req(QMI_IMS_SETTINGS_SET_IMS_SERVICE_ENABLE_CONFIG_REQ_V01);
    t.expect(QMI_node);
    ...
    // Expect: QMI_IMS_SETTINGS_GET_SUPPORTED_FIELDS_REQ_V01
    QMI_node.update_default_qmi_ims_settings_get_supported_fields_req(QMI_IMS_SETTINGS_SET_CONCURRENCY_CONFIG_REQ_V01);
    t.expect(QMI_node);

    // Inject: QMI_IMS_SETTINGS_GET_SUPPORTED_FIELDS_RESP_V01
    QMI_node.update_default_qmi_ims_settings_get_supported_fields_resp(QMI_IMS_SETTINGS_SET_CONCURRENCY_CONFIG_RSP_V01);
    t.inject(QMI_node);
  }
  ...
  QMI_node.set_qmi_nas_get_system_selection_preference_resp_nr5g_disable_mode(NAS_NR5G_DISABLE_MODE_NONE_V01);
  ...
  QMI_node.set_default_qmi_nas_config_sig_info2_req_msg_v01_cdma_rssi_delta(65535);
  QMI_node.set_default_qmi_nas_config_sig_info2_req_msg_v01_gsm_rssi_delta(65535);
  QMI_node.set_default_qmi_nas_config_sig_info2_req_msg_v01_hdr_ecio_delta(10);
  QMI_node.set_default_qmi_nas_config_sig_info2_req_msg_v01_hdr_rssi_delta(65535);
  ...
  QMI_node.set_default_qmi_nas_config_sig_info2_req_msg_v01_lte_rssi_delta(65535);
  ...
  QMI_node.set_default_qmi_nas_config_sig_info2_req_msg_v01_wcdma_rssi_delta(65535);
  ...
  // Expect: QMI_NAS_GET_NR_SIB9_NETWORK_TIME_REQ_MSG_V01
  QMI_node.update_default_qmi_nas_get_nr_sib9_network_time_req_msg_v01();
  t.expect(QMI_node);

  // Inject: QMI_NAS_GET_NR_SIB9_NETWORK_TIME_RESP_MSG_V01
  QMI_node.update_default_qmi_nas_get_nr_sib9_network_time_resp_msg_v01(QMI_RESULT_SUCCESS_V01, QMI_ERR_NONE_V01);
  t.inject(QMI_node);
...
//  t.expect(IMS_node);
  ...
  // Expect: QMI_UIM_PROVISIONING_REQ_V01
  QMI_node.update_default_qmi_uim_provisioning_req_v01();
  QMI_node.set_expect_skip_verification_status(false);
  t.expect(QMI_node);

  // Inject: QMI_UIM_PROVISIONING_RESP_V01
  QMI_node.update_default_qmi_uim_provisioning_resp_v01(QMI_RESULT_SUCCESS_V01, QMI_ERR_NONE_V01);
  t.inject(QMI_node);
...
//  t.expect(IMS_node);
  ...
  RIL_node.update_default_ril_request_radio_power(TRUE, FALSE, FALSE);
  t.inject(RIL_node);
  ...
  */
  ...
  // Expect: QMI_DMS_GET_DEVICE_STATE_INFO_REQ_V01
  QMI_node.update_default_qmi_dms_get_device_state_info_req_msg();
  t.expect(QMI_node);

  if (boot_config == DEFAULT_BOOT || boot_config == PDC_BOOT ||
        boot_config == SSR_BOOT || boot_config == DEVICE_STATE_SUCCESS_BOOT)
  {
  if (boot_config == DEVICE_STATE_SUCCESS_BOOT)
  {
  // Inject: QMI_DMS_GET_DEVICE_STATE_INFO_RESP_V01
  QMI_node.update_default_qmi_dms_get_device_state_info_resp_msg();
  QMI_node.set_qmi_dms_get_device_state_info_resp_result(QMI_RESULT_SUCCESS_V01, QMI_ERR_NONE_V01);
  QMI_node.set_qmi_dms_get_device_state_info_resp_init_state(DMS_INIT_STATE_READY_V01);
  }
  else
  {
  // Inject: QMI_DMS_GET_DEVICE_STATE_INFO_RESP_V01
  QMI_node.update_default_qmi_dms_get_device_state_info_resp_msg();
  QMI_node.set_qmi_dms_get_device_state_info_resp_result(QMI_RESULT_FAILURE_V01, QMI_ERR_GENERAL_V01);
  }
  t.inject(QMI_node);
...
//  t.expect(IMS_node);
  ...
  t.add_func_exec(connect_to_i_ims_aidl_radio);
...
void ril_utf_bootup_radio_power_fail_helper(Testcase &t)
{
  QMIRILTestnode QMI_node;
  AndroidTelTestnode RIL_node;
  IMSTestnode IMS_node;
  ...
  QMI_node.update_default_qmi_dms_get_device_state_info_resp_msg();
  QMI_node.set_qmi_dms_get_device_state_info_resp_result(QMI_RESULT_SUCCESS_V01, QMI_ERR_NONE_V01);
  QMI_node.set_qmi_dms_get_device_state_info_resp_init_state(DMS_INIT_STATE_FAILED_V01);
  QMI_node.set_qmi_dms_get_device_state_info_resp_init_fail_reason(DMS_DEVICE_STATE_FAIL_RF_HW_V01);
  t.inject(QMI_node);

  // Expect: RIL_REQUEST_RADIO_POWER (resp)
  RIL_node.update_default_ril_request_radio_power_resp();
  RIL_node.set_ril_error_value(RIL_E_RF_HARDWARE_ISSUE);
  t.expect(RIL_node);
}
...
test_result qmi_ril_test_bootup_002()
{
  // this part need to be included for all test cases
  // test ID and attributes for each test case are set here
  ...
  t.set_start();
  ril_utf_bootup_helper(t, DEVICE_STATE_SUCCESS_BOOT);
  t.set_end();
...
test_result qmi_ril_test_bootup_003()
{
  // this part need to be included for all test cases
  // test ID and attributes for each test case are set here
  ...
  t.set_start();
  ril_utf_bootup_radio_power_fail_helper(t);
  t.set_end();
