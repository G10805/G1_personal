...
test_result ril_utf_ims_service_enable_config_ind_old_002(user_specified_attrib_t attr)
{
  ...
  t.execute();
  t.print_summary();
  imss_0x008F_supported_fields[2] = 0xFF;
  return t.get_test_result();
}
...
test_result ril_utf_ims_config_set_ims_config_002(user_specified_attrib_t attr)
{
  ...
  db_property_set("persist.vendor.radio.disable_modem_cfg", "true");
...
test_result ril_utf_ims_config_ims_service_enable_config_001(user_specified_attrib_t attr)
{
  ...
  std::vector<ImsConfigRequest> testReqVector {
     ...
     ImsConfigRequest(
      [](ims_ConfigMsg &req) -> void {
        req.has_item = TRUE;
        req.item = ims_ConfigItem_CONFIG_ITEM_VOWIFI_ENTITLEMENT_ID;
        req.stringValue.arg = strdup("TEST_ID");
      },
      [](ims_settings_set_ims_service_enable_config_req_msg_v01 &req) -> void {
        req.wifi_provisioning_id_valid = TRUE;
        strlcpy((char *)req.wifi_provisioning_id, "TEST_ID", strlen("TEST_ID")+1);
      },
      [](ims_settings_get_ims_service_enable_config_rsp_msg_v01 &resp) -> void {
        resp.wifi_provisioning_id_valid = TRUE;
        strlcpy((char *)resp.wifi_provisioning_id, "TEST_ID", strlen("TEST_ID")+1);
      }),
     ImsConfigRequest(
      [](ims_ConfigMsg &req) -> void {
        req.has_item = TRUE;
        req.item = ims_ConfigItem_CONFIG_ITEM_B2C_ENRICHED_CALLING_ID;
        req.has_intValue = TRUE;
        req.intValue = 1;  //ENABLED
      },
      [](ims_settings_set_ims_service_enable_config_req_msg_v01 &req) -> void {
        req.b2c_enriched_calling_config_enabled_valid = TRUE;
        req.b2c_enriched_calling_config_enabled = TRUE;
      },
      [](ims_settings_get_ims_service_enable_config_rsp_msg_v01 &resp) -> void {
        resp.b2c_enriched_calling_config_enabled_valid = TRUE;
        resp.b2c_enriched_calling_config_enabled = TRUE;
      }),
     ImsConfigRequest(
      [](ims_ConfigMsg &req) -> void {
        req.has_item = TRUE;
      ...
      [](ims_settings_set_ims_service_enable_config_req_msg_v01 &req) -> void {
        req.b2c_enriched_calling_config_enabled_valid = TRUE;
        req.b2c_enriched_calling_config_enabled = FALSE;
      },
      [](ims_settings_get_ims_service_enable_config_rsp_msg_v01 &resp) -> void {
        resp.b2c_enriched_calling_config_enabled_valid = TRUE;
        resp.b2c_enriched_calling_config_enabled = FALSE;
      }),
  };
...
/**==
@testname: ril_utf_ims_unsol_sms_callback_mode_status_001
@description: onSmsCallbackModeChanged
==**/
test_result ril_utf_ims_unsol_sms_callback_mode_status_001(user_specified_attrib_t attr) {
  Testcase t;
  QMIRILTestnode QMI_node;
  IMSTestnode IMS_node;
  ...
  t.set_test_id(__func__);
  t.set_test_attribute("IMS");
  t.set_test_description("onSmsCallbackModeChanged");
  if (!t.isAttributeMatch(attr)) {
    test_result ret;
    return ret;
  }

  // Inject: QMI_IMSA_SCBM_MODE_UPDATE_IND_V01
  QMI_node.update_default_qmi_imsa_sms_callback_mode_ind(IMSA_SCBM_MODE_ENTER_V01);
  t.inject(QMI_node);

  // Expect: ims_MsgId_UNSOL_SMS_CALLBACK_MODE_STATUS
  IMS_node.update_default_ims_unsol_sms_callback_mode_changed(
      ims_SmsCallbackModeStatus_ENTER);
  t.expect(IMS_node);

  // Inject: QMI_IMSA_SCBM_MODE_UPDATE_IND_V01
  QMI_node.update_default_qmi_imsa_sms_callback_mode_ind(IMSA_SCBM_MODE_EXIT_V01);
  t.inject(QMI_node);

  // Expect: ims_MsgId_UNSOL_SMS_CALLBACK_MODE_STATUS
  IMS_node.update_default_ims_unsol_sms_callback_mode_changed(
      ims_SmsCallbackModeStatus_EXIT);
  t.expect(IMS_node);
...
/**==
@testname: ril_utf_ims_unsol_incoming_dtmf_001
@description: onIncomingDtmf
==**/
test_result ril_utf_ims_unsol_incoming_dtmf_001(user_specified_attrib_t attr) {
  Testcase t;
  QMIRILTestnode QMI_node;
  IMSTestnode IMS_node;
  ...
  t.set_test_id(__func__);
  t.set_test_attribute("IMS");
  t.set_test_description("onIncomingDtmf");
  if (!t.isAttributeMatch(attr)) {
    test_result ret;
    return ret;
  }
  ...
  dtmf_info->call_id = 0;
  dtmf_info->dtmf_event = DTMF_EVENT_IP_INCOMING_DTMF_START_V02;
  dtmf_info->digit_buffer_len = 1;
  strlcpy(dtmf_info->digit_buffer, "1", strlen("1") + 1);
  t.inject(QMI_node);

  // Expect: ims_MsgId_UNSOL_INCOMING_DTMF_START
  auto ims_dtmf = IMS_node.update_default_ims_unsol_incoming_dtmf_start();
  ims_dtmf->dtmf.arg = (char*)malloc(strlen("1") + 1);
  if (ims_dtmf->dtmf.arg != nullptr) {
    strlcpy((char*)ims_dtmf->dtmf.arg, "1", strlen("1") + 1);
  }
  ims_dtmf->callId = 0;
  t.expect(IMS_node);
  ...
  dtmf_info->call_id = 0;
  dtmf_info->dtmf_event = DTMF_EVENT_IP_INCOMING_DTMF_STOP_V02;
  dtmf_info->digit_buffer_len = 1;
  strlcpy(dtmf_info->digit_buffer, "1", strlen("1") + 1);
  t.inject(QMI_node);

  // Expect: ims_MsgId_UNSOL_INCOMING_DTMF_STOP
  ims_dtmf = IMS_node.update_default_ims_unsol_incoming_dtmf_stop();
  ims_dtmf->dtmf.arg = (char*)malloc(strlen("1") + 1);
  if (ims_dtmf->dtmf.arg != nullptr) {
    strlcpy((char*)ims_dtmf->dtmf.arg, "1", strlen("1") + 1);
  }
...
void unsol_multi_sim_voice_capability(Testcase& t, IMSTestnode& IMS_node, QMIRILTestnode& QMI_node,
                                      imsa_dual_sim_voice_capability_type_v01 imsaVoiceCapability,
                                      ims_Voice_Capability voiceCapability) {
  // Inject: QMI_IMSA_DUAL_SIMS_VOICE_CAPABILITY_IND_V01
  QMI_node.update_default_qmi_imsa_dual_sim_voice_capability_ind(imsaVoiceCapability);
  t.inject(QMI_node);

  // Expect: ims_MsgId_UNSOL_MULTI_SIM_VOICE_CAPABILITY_CHANGED
  IMS_node.update_default_ims_unsol_multi_sim_voice_capability_changed(voiceCapability);
  t.expect(IMS_node);
}

/**==
@testname: ril_utf_ims_unsol_multi_sim_voice_capability
@description: onMultiSimVoiceCapabilityChanged
==**/
test_result ril_utf_ims_unsol_multi_sim_voice_capability(user_specified_attrib_t attr) {
  Testcase t;
  QMIRILTestnode QMI_node;
  IMSTestnode IMS_node;
  ...
  t.set_test_id(__func__);
  t.set_test_attribute("IMS");
  t.set_test_description("onMultiSimVoiceCapabilityChanged");
  if (!t.isAttributeMatch(attr)) {
    test_result ret;
    return ret;
  }

  // Validate QMI_IMSA_DUAL_SIMS_VOICE_CAPABILITY_IND_V01 with IMSA_VOICE_CAPABILITY_NONE_MODE_V01
  unsol_multi_sim_voice_capability(t, IMS_node, QMI_node, IMSA_VOICE_CAPABILITY_NONE_MODE_V01,
                                   ims_Voice_Capability_NONE);

  // Validate QMI_IMSA_DUAL_SIMS_VOICE_CAPABILITY_IND_V01 with IMSA_VOICE_CAPABILITY_DSSS_MODE_V01
  unsol_multi_sim_voice_capability(t, IMS_node, QMI_node, IMSA_VOICE_CAPABILITY_DSSS_MODE_V01,
                                   ims_Voice_Capability_DSSS);

  // Validate QMI_IMSA_DUAL_SIMS_VOICE_CAPABILITY_IND_V01 with IMSA_VOICE_CAPABILITY_DSDS_MODE_V01
  unsol_multi_sim_voice_capability(t, IMS_node, QMI_node, IMSA_VOICE_CAPABILITY_DSDS_MODE_V01,
                                   ims_Voice_Capability_DSDS);

  // Validate QMI_IMSA_DUAL_SIMS_VOICE_CAPABILITY_IND_V01 with
  // IMSA_VOICE_CAPABILITY_PSEUDO_DSDA_MODE_V01
  unsol_multi_sim_voice_capability(t, IMS_node, QMI_node, IMSA_VOICE_CAPABILITY_PSEUDO_DSDA_MODE_V01,
                                   ims_Voice_Capability_PSEUDO_DSDA);

  // Validate QMI_IMSA_DUAL_SIMS_VOICE_CAPABILITY_IND_V01 with IMSA_VOICE_CAPABILITY_DSDA_MODE_V01
  unsol_multi_sim_voice_capability(t, IMS_node, QMI_node, IMSA_VOICE_CAPABILITY_DSDA_MODE_V01,
                                   ims_Voice_Capability_DSDA);
...
void query_multi_sim_voice_capability(
    Testcase& t, IMSTestnode& IMS_node, QMIRILTestnode& QMI_node,
    ims_settings_voice_capability_on_dual_sims_enum_v01 imsSettingsVoiceCapability,
    ims_Voice_Capability voiceCapability) {
  // Inject: ims_MsgId_REQUEST_QUERY_MULTI_SIM_VOICE_CAPABILITY
  IMS_node.update_default_ims_query_multi_sim_voice_capability();
  t.inject(IMS_node);

  // Expect: QMI_IMS_SETTINGS_GET_DUAL_SIM_VOICE_CAPABILITY_REQ_V01
  QMI_node.update_default_qmi_imss_request_get_dual_sim_voice_capability();
  t.expect(QMI_node);

  // Inject: QMI_IMS_SETTINGS_GET_DUAL_SIM_VOICE_CAPABILITY_RSP_V01
  QMI_node.update_default_qmi_imss_request_get_dual_sim_voice_capability_resp(
      QMI_RESULT_SUCCESS_V01, QMI_ERR_NONE_V01);
  QMI_node.set_qmi_imss_request_get_dual_sim_voice_capability_resp_voice_capability(
      imsSettingsVoiceCapability);
  t.inject(QMI_node);

  // Expect: ims_MsgId_REQUEST_QUERY_MULTI_SIM_VOICE_CAPABILITY(resp)
  IMS_node.update_default_ims_query_multi_sim_voice_capability_resp();
  IMS_node.set_ims_request_ims_query_multi_sim_voice_capability_resp_voice_capability(
      voiceCapability);
  t.expect(IMS_node);
}

/**==
@testname: ril_utf_ims_query_multi_sim_voice_capability
@description: When RIL receives an REQUEST_QUERY_MULTI_SIM_VOICE_CAPABILITY request, it sends the
message down to IMSS
==**/
test_result ril_utf_ims_query_multi_sim_voice_capability(user_specified_attrib_t attr) {
  Testcase t;
  QMIRILTestnode QMI_node;
  IMSTestnode IMS_node;
  ...
  // Validate ims_MsgId_REQUEST_QUERY_MULTI_SIM_VOICE_CAPABILITY failure.
  // Inject: ims_MsgId_REQUEST_QUERY_MULTI_SIM_VOICE_CAPABILITY
  IMS_node.update_default_ims_query_multi_sim_voice_capability();
  t.inject(IMS_node);
  ...
  // Inject: QMI_IMS_SETTINGS_GET_DUAL_SIM_VOICE_CAPABILITY_RSP_V01
  QMI_node.update_default_qmi_imss_request_get_dual_sim_voice_capability_resp(
      QMI_RESULT_FAILURE_V01, QMI_ERR_GENERAL_V01);
  t.inject(QMI_node);
  ...
  // Validate ims_MsgId_REQUEST_QUERY_MULTI_SIM_VOICE_CAPABILITY success with
  // IMS_SETTINGS_VOICE_CAPABILITY_NONE_MODE_V01
  query_multi_sim_voice_capability(
      t, IMS_node, QMI_node, IMS_SETTINGS_VOICE_CAPABILITY_NONE_MODE_V01, ims_Voice_Capability_NONE);

  // Validate ims_MsgId_REQUEST_QUERY_MULTI_SIM_VOICE_CAPABILITY success with
  // IMS_SETTINGS_VOICE_CAPABILITY_DSSS_MODE_V01
  query_multi_sim_voice_capability(
      t, IMS_node, QMI_node, IMS_SETTINGS_VOICE_CAPABILITY_DSSS_MODE_V01, ims_Voice_Capability_DSSS);

  // Validate ims_MsgId_REQUEST_QUERY_MULTI_SIM_VOICE_CAPABILITY success with
  // IMS_SETTINGS_VOICE_CAPABILITY_DSDS_MODE_V01
  query_multi_sim_voice_capability(
      t, IMS_node, QMI_node, IMS_SETTINGS_VOICE_CAPABILITY_DSDS_MODE_V01, ims_Voice_Capability_DSDS);

  // Validate ims_MsgId_REQUEST_QUERY_MULTI_SIM_VOICE_CAPABILITY success with
  // IMS_SETTINGS_VOICE_CAPABILITY_PSEUDO_DSDA_MODE_V01
  query_multi_sim_voice_capability(t, IMS_node, QMI_node,
                                   IMS_SETTINGS_VOICE_CAPABILITY_PSEUDO_DSDA_MODE_V01,
                                   ims_Voice_Capability_PSEUDO_DSDA);

  // Validate ims_MsgId_REQUEST_QUERY_MULTI_SIM_VOICE_CAPABILITY success with
  // IMS_SETTINGS_VOICE_CAPABILITY_DSDA_MODE_V01
  query_multi_sim_voice_capability(
      t, IMS_node, QMI_node, IMS_SETTINGS_VOICE_CAPABILITY_DSDA_MODE_V01, ims_Voice_Capability_DSDA);
...
/**==
@testname: ril_utf_ims_send_vos_support_status
@description: sendVosSupportStatus
==**/
test_result ril_utf_ims_send_vos_support_status(user_specified_attrib_t attr) {
  Testcase t;
  QMIRILTestnode QMI_node;
  IMSTestnode IMS_node;
  ...
  // Validate ims_MsgId_REQUEST_SEND_VOS_SUPPORT_STATUS failure.
  // Inject: ims_MsgId_REQUEST_SEND_VOS_SUPPORT_STATUS
  IMS_node.update_default_ims_send_vos_support_status();
  IMS_node.set_ims_request_send_vos_support_status_support_status(true);
  t.inject(IMS_node);

  // Expect: QMI_VOICE_SIP_VOS_CAPABILITY_ACK_REQ_V02
  QMI_node.update_default_qmi_voice_sip_vos_capability_ack_req_msg();
  QMI_node.set_qmi_voice_sip_vos_capability_ack_req(0xFF, 1);
  t.expect(QMI_node);

  // Inject: QMI_VOICE_SIP_VOS_CAPABILITY_ACK_RESP_V02
  QMI_node.update_default_qmi_voice_sip_vos_capability_ack_resp_msg();
  QMI_node.set_qmi_voice_sip_vos_capability_ack_resp(QMI_RESULT_FAILURE_V01, QMI_ERR_GENERAL_V01);
  t.inject(QMI_node);

  // Expect: ims_MsgId_REQUEST_SEND_VOS_SUPPORT_STATUS(resp)
  IMS_node.update_default_ims_send_vos_support_status_resp();
  IMS_node.set_ims_error_value(ims_Error_E_GENERIC_FAILURE);
  t.expect(IMS_node);

  // Validate ims_MsgId_REQUEST_SEND_VOS_SUPPORT_STATUS success.
  // Inject: ims_MsgId_REQUEST_SEND_VOS_SUPPORT_STATUS
  IMS_node.update_default_ims_send_vos_support_status();
  IMS_node.set_ims_request_send_vos_support_status_support_status(true);
  t.inject(IMS_node);
  ...
  // Inject: QMI_VOICE_SIP_VOS_CAPABILITY_ACK_RESP_V02
  QMI_node.update_default_qmi_voice_sip_vos_capability_ack_resp_msg();
  QMI_node.set_qmi_voice_sip_vos_capability_ack_resp(QMI_RESULT_SUCCESS_V01, QMI_ERR_NONE_V01);
  t.inject(QMI_node);
...
/**==
@testname: ril_utf_ims_send_vos_action_info_move
@description: move info in sendVosActionInfo
==**/
test_result ril_utf_ims_send_vos_action_info_move(user_specified_attrib_t attr) {
  Testcase t;
  QMIRILTestnode QMI_node;
  IMSTestnode IMS_node;
  ...
  // Validate ims_MsgId_REQUEST_SEND_VOS_ACTION_INFO move failure.
  IMS_node.update_default_ims_send_vos_action_info();
  IMS_node.set_ims_request_send_vos_move_info_move_info(10, 20, 30 ,40);
  t.inject(IMS_node);

  // Expect: QMI_VOICE_SIP_VOS_ACTION_REQ_V02
  QMI_node.update_default_qmi_voice_sip_vos_action_msg();
  QMI_node.set_qmi_voice_sip_vos_move_msg(0xFF, 10, 20, 30 ,40);
  t.expect(QMI_node);

  // Inject: QMI_VOICE_SIP_VOS_ACTION_RESP_V02
  QMI_node.update_default_qmi_voice_sip_vos_action_resp_msg();
  QMI_node.set_qmi_voice_sip_vos_action_resp(QMI_RESULT_FAILURE_V01, QMI_ERR_GENERAL_V01);
  t.inject(QMI_node);

  // Expect: ims_MsgId_REQUEST_SEND_VOS_ACTION_INFO(resp)
  IMS_node.update_default_ims_send_vos_action_info_resp();
  IMS_node.set_ims_error_value(ims_Error_E_GENERIC_FAILURE);
  t.expect(IMS_node);

  // Validate ims_MsgId_REQUEST_SEND_VOS_ACTION_INFO move success.
  // Inject: ims_MsgId_REQUEST_SEND_VOS_ACTION_INFO
  IMS_node.update_default_ims_send_vos_action_info();
  IMS_node.set_ims_request_send_vos_move_info_move_info(10, 20, 30 ,40);
  t.inject(IMS_node);
  ...
  // Inject: QMI_VOICE_SIP_VOS_ACTION_RESP_V02
  QMI_node.update_default_qmi_voice_sip_vos_action_resp_msg();
  QMI_node.set_qmi_voice_sip_vos_action_resp(QMI_RESULT_SUCCESS_V01, QMI_ERR_NONE_V01);
  t.inject(QMI_node);
...
/**==
@testname: ril_utf_ims_send_vos_action_info_touch
@description: touch info in sendVosActionInfo
==**/
test_result ril_utf_ims_send_vos_action_info_touch(user_specified_attrib_t attr) {
  Testcase t;
  QMIRILTestnode QMI_node;
  IMSTestnode IMS_node;
  ...
  // Validate ims_MsgId_REQUEST_SEND_VOS_ACTION_INFO touch failure.
  IMS_node.update_default_ims_send_vos_action_info();
  IMS_node.set_ims_request_send_vos_touch_info_touch_info(50, 60, 70);
  t.inject(IMS_node);

  // Expect: QMI_VOICE_SIP_VOS_ACTION_REQ_V02
  QMI_node.update_default_qmi_voice_sip_vos_action_msg();
  QMI_node.set_qmi_voice_sip_vos_touch_msg(0xFF, 50, 60, 70);
  t.expect(QMI_node);
  ...
  // Validate ims_MsgId_REQUEST_SEND_VOS_ACTION_INFO touch success.
  // Inject: ims_MsgId_REQUEST_SEND_VOS_ACTION_INFO
  IMS_node.update_default_ims_send_vos_action_info();
  IMS_node.set_ims_request_send_vos_touch_info_touch_info(50, 60, 70);
  t.inject(IMS_node);
...
/**==
@testname: ril_utf_ims_c_iwlan_notification
==**/
test_result ril_utf_ims_c_iwlan_notification(user_specified_attrib_t attr) {
  Testcase t;
  QMIRILTestnode QMI_node;
  IMSTestnode IMS_node;
  ...
  // Expect: QMI_IMSA_C_IWLAN_STATUS_IND_V01
  QMI_node.update_default_qmi_imsa_c_iwlan_status_ind_msg();
  QMI_node.set_qmi_imsa_c_iwlan_status_ind_c_iwlan_feature_exit_needed(true);
  t.inject(QMI_node);

  // Expect: ims_MsgId_UNSOL_C_IWLAN_NOTIFICATION
  IMS_node.update_default_ims_unsol_c_iwlan_notification(ims_CIWlan_Notification_DISABLE_CIWLAN);
  t.expect(IMS_node);

  // Expect: QMI_IMSA_C_IWLAN_STATUS_IND_V01
  QMI_node.update_default_qmi_imsa_c_iwlan_status_ind_msg();
  QMI_node.set_qmi_imsa_c_iwlan_status_ind_c_iwlan_feature_exit_needed(false);
  t.inject(QMI_node);

  // Expect: ims_MsgId_UNSOL_C_IWLAN_NOTIFICATION
  IMS_node.update_default_ims_unsol_c_iwlan_notification(ims_CIWlan_Notification_NONE);
  t.expect(IMS_node);
