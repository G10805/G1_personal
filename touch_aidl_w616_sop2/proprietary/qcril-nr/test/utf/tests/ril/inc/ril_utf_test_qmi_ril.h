/******************************************************************************
#  Copyright (c) 2013, 2019, 2023 Qualcomm Technologies, Inc.
#  All Rights Reserved.
...
#define SSR_BOOT 1
#define PDC_BOOT 2
#define DEVICE_STATE_SUCCESS_BOOT 3
#define DEVICE_STATE_FAILURE_BOOT 4
#define DEVICE_STATE_WAIT_BOOT 5
...
test_result ril_utf_test_mo_call_redir_num_001(user_specified_attrib_t attr);
test_result ril_utf_test_mo_call_redir_num_002(user_specified_attrib_t attr);
...
test_result ril_utf_test_clir_001(user_specified_attrib_t attr);
test_result ril_utf_test_clir_002(user_specified_attrib_t attr);
...
test_result ril_utf_ims_mt_call_013(user_specified_attrib_t attr);
test_result ril_utf_ims_mt_call_014(user_specified_attrib_t attr);
test_result ril_utf_ims_mt_call_015(user_specified_attrib_t attr);
test_result ril_utf_ims_mt_call_016(user_specified_attrib_t attr);
test_result ril_utf_ims_mt_call_017(user_specified_attrib_t attr);
test_result ril_utf_ims_mt_call_018(user_specified_attrib_t attr);
...
test_result ril_utf_ims_mo_call_014(user_specified_attrib_t attr);
test_result ril_utf_ims_mo_call_015(user_specified_attrib_t attr);
test_result ril_utf_ims_mo_call_016(user_specified_attrib_t attr);
test_result ril_utf_ims_mo_call_017(user_specified_attrib_t attr);
test_result ril_utf_ims_mo_call_018(user_specified_attrib_t attr);
...
test_result ril_utf_ims_auto_rejected_incoming_call_with_ecnam_001(user_specified_attrib_t attr);
test_result ril_utf_ims_auto_rejected_incoming_call_with_call_composer_ecnam_001(
    user_specified_attrib_t attr);
test_result ril_utf_ims_auto_rejected_incoming_call_with_call_composer_b2c_ec_001(
    user_specified_attrib_t attr);
...
test_result ril_utf_ims_srvcc_004(user_specified_attrib_t attr);
test_result ril_utf_ims_srvcc_005(user_specified_attrib_t attr);
...
test_result ril_utf_ims_clir_001(user_specified_attrib_t attr);
test_result ril_utf_ims_clir_002(user_specified_attrib_t attr);
test_result ril_utf_ims_clir_003(user_specified_attrib_t attr);
test_result ril_utf_ims_clir_004(user_specified_attrib_t attr);
...
test_result ril_utf_ims_supp_service_status_011(user_specified_attrib_t attr);
...
test_result ril_utf_cdma_sms_mo(user_specified_attrib_t attr);
test_result ril_utf_cdma_sms_mo_expect_more(user_specified_attrib_t attr);
...
test_result ril_utf_sms_mt_3gpp2_001(user_specified_attrib_t attr);
...
test_result ril_utf_ims_mt_3gpp2_sms_001(user_specified_attrib_t attr);
...
test_result ril_utf_test_query_network_selection_mode_3(user_specified_attrib_t attr);
...
test_result ril_utf_test_emergency_list_unsol_3(user_specified_attrib_t attr);
...
test_result ril_utf_test_qcril_req_hook_get_max_data_allowed_req(user_specified_attrib_t attr);
test_result ril_utf_test_qcril_req_hook_get_l_plus_l_feature_support_status_req(user_specified_attrib_t attr);
test_result ril_utf_test_qcril_req_hook_nv_read_001(user_specified_attrib_t attr);
test_result ril_utf_test_qcril_req_hook_nv_read_002(user_specified_attrib_t attr);
test_result ril_utf_test_qcril_req_hook_nv_read_003(user_specified_attrib_t attr);
test_result ril_utf_test_qcril_req_hook_nv_write_001(user_specified_attrib_t attr);
test_result ril_utf_test_qcril_req_hook_nv_write_002(user_specified_attrib_t attr);
...
test_result ril_utf_test_nr_sib9_testcase(user_specified_attrib_t attr);
