/******************************************************************************
#  Copyright (c) 2013, 2022-2023 Qualcomm Technologies, Inc.
#  All Rights Reserved.
...
test_result ril_utf_ims_mo_volte_remote_upgrade_vt_007(user_specified_attrib_t attr);
test_result ril_utf_ims_mo_volte_remote_upgrade_vt_008(user_specified_attrib_t attr);
test_result ril_utf_ims_mt_volte_remote_upgrade_rtt_001(user_specified_attrib_t attr);
test_result ril_utf_ims_mt_volte_remote_upgrade_rtt_002(user_specified_attrib_t attr);
...
test_result ril_utf_ims_set_call_forward_status_008(user_specified_attrib_t attr);
test_result ril_utf_ims_set_call_forward_status_009(user_specified_attrib_t attr);
...
test_result ril_utf_ims_query_call_forward_status_008(user_specified_attrib_t attr);
...
// VOS call test cases
test_result ril_utf_ims_send_vos_support_status_001(user_specified_attrib_t attr);
test_result ril_utf_ims_send_vos_support_status_002(user_specified_attrib_t attr);
test_result ril_utf_ims_send_vos_action_info_001(user_specified_attrib_t attr);
test_result ril_utf_ims_send_vos_action_info_002(user_specified_attrib_t attr);
...
test_result ril_utf_ims_call_audio_codec(user_specified_attrib_t attr);
test_result ril_utf_ims_call_computed_audio_quality(user_specified_attrib_t attr);
