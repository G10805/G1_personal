...
private:
    ::android::sp<vendor::qti::hardware::radio::qtiradio::V2_6::IQtiRadio> utfQtiRadio;
    bool bFirstCall;
};
...
void AndroidQtiRadio::Register(RIL_RadioFunctions *callbacks) {
    ...
    utfQtiRadio = vendor::qti::hardware::radio::qtiradio::V2_6::IQtiRadio::getService("slot1");
    if (utfQtiRadio != nullptr) {
        RIL_UTF_DEBUG("type of utfQtiRadio is %s", typeid(*utfQtiRadio).name());
        // create the HIDL clients
        ::android::sp<IQtiRadioResponseClientImpl> respClient = new IQtiRadioResponseClientImpl();
        ::android::sp<IQtiRadioIndicationClientImpl> indClient = new IQtiRadioIndicationClientImpl();
