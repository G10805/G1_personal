...
void AndroidIRadio::setDataAPIs(::android::sp<IRadioResponseClientImpl> respClient, ::android::sp<IRadioIndicationClientImpl> indClient,
...
void AndroidIRadio::Register(RIL_RadioFunctions *callbacks) {
    ...
    if (utfIRadio != nullptr) {
        ...
        if (dataRespClient != nullptr && dataIndClient != nullptr) {
            ...
            ::android::sp<IRadioResponseClientImpl> respClient = new IRadioResponseClientImpl();
            ::android::sp<IRadioIndicationClientImpl> indClient = new IRadioIndicationClientImpl();
...
int AndroidIRadio::OnRequest(int request, void *data, size_t datalen,
    ...
    case  RIL_REQUEST_CDMA_SEND_SMS:
        ...
        if (utfIRadio != nullptr) {
            V1_0::CdmaSmsMessage sms;
            auto payload = static_cast<RIL_CDMA_SMS_Message *>(data);
            convertRilCdmaSmstoHidl(*payload, sms);
            utfIRadio->sendCdmaSms(*static_cast<int32_t*>(t), sms);
            return 0;
        } else {
            return 1;
        }
    case  RIL_REQUEST_CDMA_SEND_SMS_EXPECT_MORE:
        ...
        if (utfIRadio != nullptr) {
            ...
            auto payload = static_cast<RIL_CDMA_SMS_Message *>(data);
            convertRilCdmaSmstoHidl(*payload, sms);
            utfIRadio->sendCdmaSmsExpectMore(*static_cast<int32_t*>(t), sms);
            return 0;
        } else {
            return 1;
        }
    ...
    case RIL_REQUEST_GET_CURRENT_CALLS:
        if (utfIRadio != nullptr) {
            utfIRadio->getCurrentCalls_1_6(*static_cast<int32_t*>(t));
            return 0;
        } else {
            return 1;
        }
    ...
    case RIL_REQUEST_RADIO_POWER:
        if (utfIRadio != nullptr) {
            ...
            utfIRadio->setRadioPower_1_5(*static_cast<int32_t*>(t), on, emergency, preferredSub);
            return 0;
        } else {
            return 1;
        }
    ...
    case RIL_REQUEST_START_NETWORK_SCAN:
        ...
        if (utfIRadio != nullptr) {
            RIL_UTF_DEBUG("Calling startNetworkScan_1_5");
            V1_5::NetworkScanRequest nsRequest = {};
            RIL_NetworkScanRequest *rilReq = static_cast<RIL_NetworkScanRequest*>(data);
            convertNetworkScanRequestToHidl(*rilReq, nsRequest);
            utfIRadio->startNetworkScan_1_5(*static_cast<int32_t*>(t), nsRequest);
            return 0;
        }
    ...
    case RIL_REQUEST_SET_SYSTEM_SELECTION_CHANNELS:
        ...
        if (utfIRadio != nullptr) {
            RIL_UTF_DEBUG("Calling setSystemSelectionChannels_1_5");
            hidl_vec<V1_5::RadioAccessSpecifier> raspecifiers;
            ...
            raspecifiers = convertRadioAccessSpecifier(in.specifiers_length, in.specifiers);
            utfIRadio->setSystemSelectionChannels_1_5(*static_cast<int32_t*>(t),specifyChannels, raspecifiers);
            return 0;
        }
