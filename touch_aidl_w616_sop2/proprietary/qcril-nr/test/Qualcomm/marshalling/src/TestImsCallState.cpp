...
TEST(Marshalling, IMS_CallState) {
  ...
  RIL_IMS_AudioQuality imsAudioQuality = { .codec = RIL_IMS_CODEC_AMR_WB,
                                           .computedAudioQuality =
  ...
  RIL_IMS_CallInfo request{ .callState = RIL_IMS_CALLSTATE_ALERTING,
                    ...
                    .imsAudioQuality = &imsAudioQuality};
  ...
  std::string s =
      ...
      "ffffffff"    // Msim additional call info
      "00000001"    // IMS audio quality
      "00000007"    // imsAudioQuality.codec, RIL_IMS_CODEC_AMR_WB
      "00000003"    // imsAudioQuality.computedAudioQuality, RIL_IMS_COMPUTED_AUDIO_QUALITY_HD_PLUS
      ;
  ...
  ASSERT_NE(request_r.imsAudioQuality, nullptr);
  RIL_IMS_AudioQuality r_imsAudioQuality = *request_r.imsAudioQuality;
  ASSERT_EQ(imsAudioQuality.codec, r_imsAudioQuality.codec);
  ASSERT_EQ(imsAudioQuality.computedAudioQuality, r_imsAudioQuality.computedAudioQuality);
}
