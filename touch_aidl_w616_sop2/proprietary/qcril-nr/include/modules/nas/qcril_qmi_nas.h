/******************************************************************************
#  Copyright (c) 2010-2013, 2015, 2017-2021 Qualcomm Technologies, Inc.
#  All Rights Reserved.
...
#define QMI_RIL_NAS_RSSI_DELTA                               (65535)
...
typedef enum
{
    ...
    QMI_RIL_DMS_RADIO_PWR_STATE_WAITING_FOR_CARD_PROV_STATUS,
...
typedef struct
{
  ...
  nas_rat_plmn_info_type_v01* primary_plmn_info;
...
#include "modules/nas/NasSetVonrCapRequest.h"
...
===========================================================================*/
void qcril_qmi_nas_request_get_system_selection_channels
(
...
/*=========================================================================
  FUNCTION:  qcril_qmi_nas_get_barring_info

===========================================================================*/
void qcril_qmi_nas_get_barring_info
(
  std::shared_ptr<RilRequestGetBarringInfoMessage> msg
);
...
===========================================================================*/
RIL_Errno qcril_qmi_nas_get_device_capability(int need_feature_mode, int need_sub_capability);
...
/*=========================================================================
  FUNCTION:  qcril_qmi_nas_request_set_unsol_barring_filter

===========================================================================*/
void qcril_qmi_nas_request_set_unsol_barring_filter
(
  std::shared_ptr<RilRequestSetUnsolBarringFilterMessage> msg
);
...
void qcril_qmi_nas_dms_get_device_ims_capability
(
...
/*=========================================================================
  FUNCTION:  qcril_qmi_nas_get_imei

===========================================================================*/
void qcril_qmi_nas_get_imei
(
  std::shared_ptr<RilRequestGetImeiMessage> msg
);
...
===========================================================================*/
void qcril_qmi_nas_set_registered_on_ims(bool registered);
...
/*=========================================================================
  FUNCTION: qcril_qmi_util_retrieve_radio_power_telephony_request_name

===========================================================================*/
const char* qcril_qmi_util_retrieve_radio_power_telephony_request_name(int request);

const char* qcril_qmi_util_retrieve_radio_power_state_name(qmi_ril_dms_radio_pwr_state_e_type state);
const char* qcril_qmi_util_retrieve_card_status_name(qcril_uim_card_status_e_type card_status);
//===========================================================================
// qcril_qmi_util_retrieve_dms_op_mode_name
//===========================================================================
const char* qcril_qmi_util_retrieve_dms_op_mode_name(dms_operating_mode_enum_v01 mode);
...
===========================================================================*/
int qmi_ril_nwreg_is_designated_number_enforcable_ncl(const char * emergency_number);

/*=========================================================================
  FUNCTION:  qmi_ril_nwreg_convert_emergency_number_to_ims_address

===========================================================================*/
int qmi_ril_nwreg_convert_emergency_number_to_ims_address(char* emergency_number, size_t emergency_number_sz);

/*=========================================================================
  FUNCTION:  qmi_ril_nwreg_is_designated_number_emergency_for_display_purposes_only

===========================================================================*/
int qmi_ril_nwreg_is_designated_number_emergency_for_display_purposes_only(const char * emergency_number);

/*=========================================================================
  FUNCTION:  qmi_ril_is_designated_number_nw_mcc_roaming_emergency

===========================================================================*/
int qmi_ril_is_designated_number_nw_mcc_roaming_emergency(const char * emergency_number);
...
void qcril_qmi_nas_enable_engineer_mode(std::shared_ptr<RilRequestEnableEngineerModeMessage> msg);
...
===========================================================================*/
RIL_Errno qcril_qmi_nas_mode_pref_request_response_helper(std::shared_ptr<RilRequestSetPrefNetworkTypeMessage> msg, uint8_t *is_change);
...
(
    qcril::interfaces::RilRatBandType band_type,
    qcril::interfaces::RilBandPrefType *band_pref_map
);
...
/*=========================================================================
  FUNCTION:  qcril_qmi_nas_get_max_active_data_subs

===========================================================================*/
RIL_Errno qcril_qmi_nas_get_max_active_data_subs(uint8_t &max_active_data_subs);
...
/*=========================================================================
  FUNCTION:  qcril_qmi_dms_get_max_modem_subscritions

===========================================================================*/
int qcril_qmi_dms_get_max_modem_subscritions(void);
...
===========================================================================*/
bool qcril_qmi_nas_is_voice_over_lte_registered(void);
...
===========================================================================*/
bool qcril_qmi_nas_is_lte_only_registered(void);
...
void qcril_qmi_nas_oem_hook_set_atel_ui_status_to_modem
(
    std::shared_ptr<RilRequestSetUiStatusMessage> msg
);
...
===========================================================================*/
bool qcril_qmi_nas_is_feature_power_opt_enable();
...
===========================================================================*/
uint8_t qcril_qmi_nas_query_network_time(char *ril_nitz_time_msg);

/*=========================================================================
  FUNCTION:  qcril_qmi_nas_query_nr_sib9_network_time
===========================================================================*/
uint8_t qcril_qmi_nas_query_nr_sib9_network_time(char *ril_nitz_time_msg);

/*=========================================================================
  FUNCTION:  qcril_qmi_nas_query_sib16_network_time
===========================================================================*/
uint8_t qcril_qmi_nas_query_sib16_network_time(char *ril_nitz_time_msg);
...
RIL_Errno qcril_qmi_nas_set_vonr_cap_request
(
  std::shared_ptr<NasSetVonrCapRequest> msg
);
...
===========================================================================*/
bool qcril_qmi_nas_is_1x_sms_blocked(void);
...
/*=====================================================================================
  FUNCTION:  qcril_qmi_nas_get_l_plus_l_feature_support_status
======================================================================================*/
RIL_Errno qcril_qmi_nas_get_l_plus_l_feature_support_status(bool &status);

/*=====================================================================================
  FUNCTION:  qcril_qmi_nas_is_device_registered_for_cs_domain
======================================================================================*/
bool qcril_qmi_nas_is_device_registered_for_cs_domain(void);
...
void qcril_qmi_nas_set_msim_preference
(
...
/*=========================================================
  FUNCTION:  qcril_qmi_nas_fill_3gpp_cell_identity
===========================================================*/
...
/*=========================================================
  FUNCTION:  qcril_qmi_nas_fill_3gpp2_cell_identity
===========================================================*/
...
===========================================================*/
bool qcril_qmi_nas_fetch_mcc_mnc_of_current_system
(
...
uint8_t qcril_qmi_nas_fetch_nr_disable_mode(RIL_NR_DISABLE_MODE *disable_mode);
...
void qcril_qmi_nas_get_enhanced_radio_capability
(
    std::shared_ptr<RilRequestGetEnhancedRadioCapabilityMessage> msg
);

uint8_t qcril_qmi_nas_is_non_modem_build_id();
...
bool qcril_qmi_nas_is_prov_in_progress(void);
void qcril_qmi_dms_cancel_radio_power_wait_for_dial_request_timer(void);
void qcril_qmi_dms_send_radio_power_online_no_dial_request(void);
void qcril_qmi_dms_send_radio_power_online(void);
uint8_t qcril_qmi_nas_acb_info_ind_handler(nas_acb_info_ind_msg_v01 *qmi_msg);
uint8_t qcril_qmi_nas_cell_barring_info_ind_handler(nas_cell_barring_info_ind_msg_v01 *qmi_msg);
uint8_t qcril_qmi_nas_access_barring_status_ind_handler(nas_access_barring_status_ind_msg_v01 *qmi_msg);
qmi_ril_nw_reg_rte_type qcril_qmi_nas_decide_rat_for_barring_info(void);
void qcril_qmi_nas_broadcast_cell_barring_info();

void qcril_qmi_nas_handle_multiple_rild_radio_power_state_propagation(int is_genuine_signal);
void qcril_qmi_acquire_nas_cache_lock(void);
void qcril_qmi_release_nas_cache_lock(void);
uint8_t is_emergency_voice_service_possible_on_nr5g(nas_nr5g_emerg_srv_ind_type_v01 *nr5g_emerg_srv_ind);
uint8_t is_emergency_voice_service_possible_on_lte_nr5g(uint32_t nas_sys_info_flag, nas_tri_state_boolean_type_v01 *lte_is_eb_supported,
            nas_tri_state_boolean_type_v01 *emergency_access_barred, nas_nr5g_emerg_srv_ind_type_v01 *nr5g_emerg_srv_ind);
uint8_t qcril_qmi_nas_is_nr_supported(uint8_t *is_sa_enable);
