...
typedef struct
{
    ...
    FLOAT                       compenADRCGain;             ///< Compensation ADRC gain
    BOOL                        isInsensorHDRSnapshot;      ///< Decide the sensor mode for CFA sensor
    IHDRTriggerInfo             IHDRTriggerOutputInfo;      ///< IHDR trigger output information
...
/// @brief Identifies the type of configuration to AEC algorithm
    ...
    AECAlgoSetParamStartUpExpSensitivity,               ///< The Sensitivity info for start up exposure override
                                                        ///  Payload Type : AECAlgoStartupSensitivity
    ...
    AECAlgoSetParamUnstabilizedFaceROI,                 ///< The unstabilized face ROI from face detect module
                                                        ///  Payload type: UnstabilizedFaceROIInformation
...
typedef enum
{
    ...
    AECAlgoCreateParamTypeCameraInfo,                           ///< Set camera information regarding algo role(master/slave)
                                                                ...
                                                                ///  Payload type: StatsCameraInfo
    AECCreateParamsTypeTuningData,                              ///< Tuning data manager.
