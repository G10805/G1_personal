...
/// @brief: Structure representing the IHDR trigger final result
struct IHDRTriggerSet
{
...
/// @brief: Structure representing the calculated CFD for the IHDR trigger final result
struct CDFSet
{
...
/// @brief: Structure representing IHDR trigger information
struct IHDRTriggerInfo
{
    BOOL            isSeamlessIHDRSupported;    ///< Flag to indicate whether the informatino is valid or not
    IHDRTriggerSet  finalTriggerResult;         ///< The IHDR trigger final result
    CDFSet          calculatedCDF;              ///< The calculated CDF for the IHDR trigger result
    FLOAT           realDRCGain;                ///< The reak drc gain for the IHDR trigger result
    FLOAT           ambientRaw;                 ///< The ambient raw for the IHDR trigger result
    FLOAT           faceLuma;                   ///< The face luma CDF for the IHDR trigger result
};
...
typedef struct
{
    UINT64              requestID;                              ///< Sequence of the frame were the faces were detected
    UINT32              roiCount;                               ///< Number of faces detected
...
typedef struct
{
    ...
    StatsHDR3ExposureHistStats      averageBayerHist;                           ///< RDI average histogram stats
    UINT32                          averageHistchannelCount;                    ///< Indicate the number of channels in the
...
typedef enum
{
    ...
    StatsCameraTypeUltraWide,       ///< Ultrawide camera type
