...
static const UINT32 ChiNodeCapsSHDR              = 1 << 11;     ///< Support SHDR mode
...
typedef enum ChiFormat
{
    ...
    P010,            ///< P010 format
    RawPlain64,      ///< Raw Plain 64
    UBWCP010,        ///< UBWC P010 format (as per UBWC2.0 design specification)
    RawDepth,        ///< 16 bit depth
    ARGB,            ///< ARGB format, each pixel occupies 4 or 8 bytes.
                     ///< ARGB8888 and ARGB2101010 are 4 bytes, ARGB16161616 are 8 bytes
    YUV422YUYV       ///< YUV422YUYV format
} ChiFormat;
...
typedef enum ChiTitanChipVersion
{
    TitanNone = 0,                     ///< Invalid Titan HW version
    Titan150V100 = 0x150100,           ///< Titan HW version for SDM640 (SM6150)
    Titan150V110 = 0x150110,           ///< Titan HW version for SM6250 V110
    Titan170V100 = 0x170100,           ///< Titan HW version for SDM845/SDM710/SDM670 V100
    Titan170V110 = 0x170110,           ///< Titan HW version for SDM845/SDM710/SDM670 V110
    Titan170V120 = 0x170120,           ///< Titan HW version for SDM845/SDM710/SDM670 V110
    Titan175V100 = 0x175100,           ///< Titan HW version for SDM855 (SM8150) V100
    Titan175V101 = 0x175101,           ///< Titan HW version for SDM855 (SM8150) V101
    Titan175V120 = 0x175120,           ///< Titan HW version for SM7150/SM7150P V100
    TitanMax                           ///< Titan MAX
}ChiTitanChipVersion;
...
typedef struct ChiNodeCreateInfo
{
    ...
    ChiTitanChipVersion   chiTitanVersion;   ///< Titan version
