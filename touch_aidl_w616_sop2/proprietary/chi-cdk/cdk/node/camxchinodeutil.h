...
#define CHICDK_LOG_ERROR(fmt, ...)   printf(fmt, __VA_ARGS__)
#define CHICDK_LOG_WARN(fmt, ...)    printf(fmt, __VA_ARGS__)
#define CHICDK_LOG_VERBOSE(fmt, ...) printf(fmt, __VA_ARGS__)
#define CHICDK_LOG_INFO(fmt, ...)    printf(fmt, __VA_ARGS__)
...
#elif defined (_LINUX) || defined(__QNXNTO__)
...
#if defined(__AGL__)
//#define CHI_DEBUG_ENABLED
#define CHICDK_LOG_ERROR(fmt, args...)   fprintf(stderr, "%s():%d " fmt "\n", __func__, __LINE__, ##args)
#define CHICDK_LOG_WARN(fmt, args...)    fprintf(stderr, "%s():%d " fmt "\n", __func__, __LINE__, ##args)
#ifdef CHI_DEBUG_ENABLED
#define CHICDK_LOG_VERBOSE(fmt, args...) fprintf(stderr, "%s():%d " fmt "\n", __func__, __LINE__, ##args)
#else
#define CHICDK_LOG_VERBOSE(fmt, args...) NULL
#endif
#define CHICDK_LOG_INFO(fmt, args...)    fprintf(stderr, "%s():%d " fmt "\n", __func__, __LINE__, ##args)
#elif defined(ANDROID)
#include <log/log.h>
#define CHICDK_LOG_ERROR(fmt, args...)   ALOGE("%s():%d " fmt "\n", __func__, __LINE__, ##args)
#define CHICDK_LOG_WARN(fmt, args...)    ALOGW("%s():%d " fmt "\n", __func__, __LINE__, ##args)
#define CHICDK_LOG_VERBOSE(fmt, args...) ALOGV("%s():%d " fmt "\n", __func__, __LINE__, ##args)
#define CHICDK_LOG_INFO(fmt, args...)    ALOGI("%s():%d " fmt "\n", __func__, __LINE__, ##args)
#elif defined(__QNXNTO__)
#include <sys/time.h>
#include <sys/slog2.h>
#define CAMX_LOG_OS_ID 415
#define CHICDK_LOG_ERROR(fmt, args...)   slog2f(NULL, CAMX_LOG_OS_ID, SLOG2_ERROR, "%s():%d " fmt "\n", __func__, __LINE__, ##args);
#define CHICDK_LOG_WARN(fmt, args...)    slog2f(NULL, CAMX_LOG_OS_ID, SLOG2_WARNING, "%s():%d " fmt "\n", __func__, __LINE__, ##args);
#define CHICDK_LOG_VERBOSE(fmt, args...) slog2f(NULL, CAMX_LOG_OS_ID, SLOG2_DEBUG1, "%s():%d " fmt "\n", __func__, __LINE__, ##args);
#define CHICDK_LOG_INFO(fmt, args...)    slog2f(NULL, CAMX_LOG_OS_ID, SLOG2_INFO, "%s():%d " fmt "\n", __func__, __LINE__, ##args);
#else
#define CHICDK_LOG_ERROR(fmt, args...)   fprintf(stderr, "%s():%d " fmt "\n", __func__, __LINE__, ##args)
#define CHICDK_LOG_WARN(fmt, args...)    fprintf(stderr, "%s():%d " fmt "\n", __func__, __LINE__, ##args)
#define CHICDK_LOG_VERBOSE(fmt, args...) fprintf(stderr, "%s():%d " fmt "\n", __func__, __LINE__, ##args)
...
#if defined(__AGL__)
#if defined(USELIB64)
static const CHAR VendorLibPath[]           = "/usr/lib64";
static const CHAR CameraComponentLibPath[]  = "/usr/lib64/camera/components";
#else //USELIB64
static const CHAR VendorLibPath[]           = "/usr/lib";
static const CHAR CameraComponentLibPath[]  = "/usr/lib/camera/components";
#endif
#elif defined(__QNXNTO__)
static const CHAR VendorLibPath[]           = "/lib64/camera";
static const CHAR CameraComponentLibPath[]  = "/lib64/camera/components";
#else
#if defined(_LP64)
...
static const CHAR ConfigFileDirectory[] = "/var/camera";
static const CHAR FileDumpPath[]        = "/var/camera";
#else
...
public:
    ...
    {
        return (requestId > lastFlushedRequestId) ? (requestId) : (requestId - lastFlushedRequestId);
    }
