    ...
    UINT32  cameraId)
{
    if (pMetaData != NULL)
    {
        ...
        ChxUtils::AndroidMetadata::GetVendorTagValue(pMetaData, MultiCamera, (VOID**)&pData);
        if (NULL != pData)
        {
            inputMetadata = *pData;
        }
        ...
        ChxUtils::AndroidMetadata::SetVendorTagValue(pMetaData, MultiCamera, sizeof(inputMetadata), &inputMetadata);
    }
}
    ...
    UINT32*                    pFeature2Value)
{
    if (pMetaData != NULL)
    {
        ...
        ChxUtils::AndroidMetadata::SetVendorTagValue(pMetaData, TuningMode, sizeof(ChiTuningModeParameter), &chiTuningModeParameter);
   ...
   UINT32       frameNum)
{
    if (NULL != pChiMetadata)
    {
        ...
        if (shutterTimestamp != sensorTimeStamp)
        {
            ...
            CHX_LOG_INFO("Chi Timestamp sensor %" PRIu64 " shutter %" PRIu64 " metadata %p frameNum %d",
                         sensorTimeStamp,
                         shutterTimestamp,
