    ...
    VOID** ppOEMData)
{
    ...
    {
          /* log error */
        CHICDK_LOG_ERROR("failed: data %p\n", pData);
    ...
    HVXResolutionInfo** ppResInfo)
{
    ...
    {
        CHICDK_LOG_ERROR("failed: pOEMData %p pHVXInfo %p\n", pOEMData, ppResInfo);
        result = CDKResultEFailed;
    }
    ...
    INT*                 phDSPHandle)
{
        ...
        (NULL != pAdspConfig->pDSPStaticConfig))
    {
        ...
        {
            /* log error */
            CHICDK_LOG_ERROR("failed: adspConfig_call ret %d\n", result);
        }
        ...
        *pData = 5;
        ...
        {
            /* log error */
            CHICDK_LOG_ERROR("failed: pDSPDynamicConfig ret %d\n", result);
        }

    }
    else
    {
        CHICDK_LOG_ERROR("failed: %p %p %p\n", pOEMData, pStaticConfig, pAdspConfig);
        result =  CDKResultEFailed;
    }
    ...
    VOID* pOEMData)
{
    ...
    {            /* log error */
        CHICDK_LOG_ERROR("failed: hvx_lib_close pOEMData %p\n", pOEMData);
