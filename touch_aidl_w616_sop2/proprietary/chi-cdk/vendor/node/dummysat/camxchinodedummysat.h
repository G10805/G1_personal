...
static const UINT DUAL_TRANSITION_LOW      = 400;        ///<.Threshold for switching to DUAL ZONE
static const UINT DUAL_TRANSITION_HIGH     = 1500;       ///<.Threshold for switching to TELE ZONE
static const UINT DUAL_MASTER_SWITCH       = 1000;       ///< Threshold for switching master
static const UINT TRIPLE_TRANSITION_LOW    = 1000;       ///<.Threshold for switching to DUAL ZONE
static const UINT TRIPLE_TRANSITION_HIGH   = 1700;       ///<.Threshold for switching to TELE ZONE
static const UINT TRIPLE_MASTER_SWITCH     = 1550;       ///< Threshold for switching master
...
private:
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// GetCameraIndexFromRole
    ///
    /// @brief  Get Index from camera_info structure based on Role
    ///
    /// @param  camRole   Camera Role
    ///
    /// @return camera index  if successful
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    UINT32 GetCameraIndexFromRole(
