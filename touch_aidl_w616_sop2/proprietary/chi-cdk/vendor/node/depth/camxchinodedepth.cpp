    ...
    CHINODECAPSINFO* pCapsInfo)
{
    ...
    if (CDKResultSuccess == result)
    {
        ...
        {
            CHICDK_LOG_ERROR("CHINODECAPSINFO is smaller than expected, %u < %zu",
    ...
    CHINODECREATEINFO* pCreateInfo)
{
    ...
    if (CDKResultSuccess == result)
    {
        ...
        {
            CHICDK_LOG_ERROR("CHINODECREATEINFO is smaller than expected, %u < %zu",
    ...
    if (CDKResultSuccess != result)
    {
        delete pNode;
        pNode = NULL;
        CHICDK_LOG_ERROR("DepthNodeCreate failed, %d", result);
    }
    ...
    CHINODEDESTROYINFO* pDestroyInfo)
{
    ...
    {
        result = CDKResultEInvalidPointer;
        CHICDK_LOG_ERROR("Invalid argument: pDestroyInfo %p", pDestroyInfo);
    }
    ...
    if (CDKResultSuccess == result)
    {
        ...
        {
            CHICDK_LOG_ERROR("CHINODEDESTROYINFO is smaller than expected, %u < %zu",
    ...
    CHINODEQUERYBUFFERINFO* pQueryBufferInfo)
{
    ...
    {
        result = CDKResultEInvalidPointer;
        CHICDK_LOG_ERROR("Invalid argument: pQueryBufferInfo %p", pQueryBufferInfo);
    }
    ...
    if (CDKResultSuccess == result)
    {
        ...
        {
            CHICDK_LOG_ERROR("CHINODEQUERYBUFFERINFO is smaller than expected, %u < %zu",
    ...
    CHINODESETBUFFERPROPERTIESINFO* pSetBufferInfo)
{
    ...
    if (CDKResultSuccess == result)
    {
        ...
        {
            CHICDK_LOG_ERROR("CHINODESETBUFFERPROPERTIESINFO is smaller than expected, %u < %zu",
    ...
    CHINODEPROCESSREQUESTINFO* pProcessRequestInfo)
{
    ...
    CHICDK_LOG_VERBOSE("DepthNodeProcRequest");
    ...
    if (CDKResultSuccess == result)
    {
        ...
        {
            CHICDK_LOG_ERROR("CHINODEPROCESSREQUESTINFO is smaller than expected, %u < %zu",
     ...
     CHIHANDLE hChiHandle)
{
    ...
    {
        CHICDK_LOG_ERROR("Invalid Chi Handle");
        result = CDKResultEInvalidPointer;
    }
    return result;
}
    ...
    CHINODECREATEINFO* pCreateInfo)
{
    ...
    CHICDK_LOG_VERBOSE("Initialize CHI depth node");
...
CDKResult ChiDepthNode::SetBufferInfo(
    CHINODESETBUFFERPROPERTIESINFO* pSetBufferInfo)
{
    CHICDK_LOG_VERBOSE("%s: wxh = %ux%u", __func__, pSetBufferInfo->pFormat->width, pSetBufferInfo->pFormat->height);
    ...
    CHINODEPROCESSREQUESTINFO* pProcessRequestInfo)
{
    ...
    CHICDK_LOG_VERBOSE("Input: inputNum=%d, imageCount=%d, numPlanes=%d, wxh=%dx%d, format=%d,"
    ...
    {
        CHICDK_LOG_WARN("Received too many output formats!");
        numOutputs = MAX_DEPTH_OUTPUT_FORMATS;
    }

    for (UINT i = 0; i < numOutputs; ++i)
    {
        CHICDK_LOG_VERBOSE("Output: outputNum=%u, imageCount=%u, numPlanes=%u, wxh=%ux%u, format=%d, pAddr=%p,"
                    " fd=%d, size=%zu",
                    i,
...
ChiDepthNode::~ChiDepthNode()
{
    ...
    if (NULL != m_hDepthLib)
    {
        ...
        if (CDKResultSuccess != result)
        {
            CHICDK_LOG_ERROR("Uninitialize Failed to unmap lib %s: %d",
...
CDKResult ChiDepthNode::GetVendorTagBases()
{
    ...
    {
        CHICDK_LOG_ERROR("Unable to get sensor meta data vendor tag base");
    }
    ...
    if (CDKResultSuccess == result)
    {
        ...
        {
            CHICDK_LOG_ERROR("Unable to get stream dimension vendor tag base");
        }
    }
    ...
    if (CDKResultSuccess == result)
    {
        ...
        {
            CHICDK_LOG_ERROR("Unable to get AEC data publisher present vendor tag base");
        }
    }
    ...
    if (CDKResultSuccess == result)
    {
        ...
        {
            CHICDK_LOG_ERROR("Unable to get AEC data vendor tag base");
        }
    }
    ...
    if (CDKResultSuccess == result)
    {
        ...
        {
            CHICDK_LOG_ERROR("Unable to get frame count vendor tag base");
        }
    }
...
CDKResult ChiDepthNode::InitConversionLib()
{
    ...
    if (NULL != pMetaData)
    {
        ...
        CHICDK_LOG_VERBOSE("Sensor Output Dimensions %ux%u", pSensorModeInfo->frameDimension.width,
    ...
    {
        CHICDK_LOG_ERROR("Error getting depth input dimension");
        result = CDKResultEFailed;
    }
    ...
    if (CDKResultSuccess == result)
    {
        ...
        if (NULL != pMetaData)
        {
            ...
            CHICDK_LOG_VERBOSE("Depth Output Dimensions %ux%u", pdepthStreamDimension->width,
        ...
        {
            CHICDK_LOG_ERROR("Error getting depth output dimension");
            result = CDKResultEFailed;
        }
    }
    ...
    if (CDKResultSuccess == result)
    {
        ...
        if (NULL == m_hDepthLib)
        {
            CHICDK_LOG_ERROR("Error loading lib %s", libFullName);
            result = CDKResultEFailed;
        }
        else
        {
            ...
            {
                CHICDK_LOG_ERROR("Error getting function address(es) from library: %s", libFullName);
                result = CDKResultEFailed;
            }
            else
            {
                ...
                if (NULL == m_DepthMapWrapper)
                {
                    CHICDK_LOG_ERROR("Error creating depth map wrapper");
                    result = CDKResultEFailed;
                }
                else
                {
    ...
    UINT64 exposureTime)
{
    ...
    if (CDKResultSuccess != result)
    {
        CHICDK_LOG_ERROR("Error publishing AEC data");
    }
    return result;
}
