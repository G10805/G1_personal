...
using namespace vendor::qti::hardware::automotive::audiocontrol::V1_0;
...
int main() {
    ...
    android::sp<IAudioControl> service = new QtiAudioControl();
    configureRpcThreadpool(1, true /*callerWillJoin*/);

    ALOGI("Registering as QtiAudioControl Service...");
    if (service->registerAsService() != OK) {
        ALOGE("registerAsService failed");
        return 1;
    }
    ALOGI("QtiAudioControlService is Ready");
