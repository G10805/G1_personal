#ifndef AMS_OSAL_MUTEX_H
#define AMS_OSAL_MUTEX_H

/**
*
* \file ams_osal_mutex.h
*
* \brief
...
/** @weakgroup weakf_ams_osal_mutex_intro
...
Recursive mutex are always used for thread-safe programming.
 - ams_osal_mutex_init()
 - ams_osal_mutex_deinit()
 - ams_osal_mutex_get_size()
 - ams_osal_mutex_create()
 - ams_osal_mutex_destroy()
 - ams_osal_mutex_lock()
 - ams_osal_mutex_try_lock()
 - ams_osal_mutex_unlock()
*/
...
/**
  ...
  None. @newpage
*/
int32_t ams_osal_mutex_init(ams_osal_mutex_t mutex);
...
/**
  ...
  None. @newpage
*/
int32_t ams_osal_mutex_deinit(ams_osal_mutex_t mutex);
...
/**
  ...
  None. @newpage
*/
int32_t ams_osal_mutex_create(ams_osal_mutex_t *mutex);
...
/**
  ...
  @newpage
*/
int32_t ams_osal_mutex_destroy(ams_osal_mutex_t mutex);
...
*/
int32_t ams_osal_mutex_lock(ams_osal_mutex_t mutex);
...
/**
  ...
  @newpage
*/
int32_t ams_osal_mutex_try_lock(ams_osal_mutex_t mutex);
...
/**
  ...
  @newpage
 */
int32_t ams_osal_mutex_unlock(ams_osal_mutex_t mutex);
