...
TARGET_LIST := msm8998 sdm845 sdm710 msmnile gen4 $(MSMSTEPPE) $(TRINKET) kona lito atoll bengal lahaina holi taro kalama monaco
...
ifneq ($(TARGET_BOARD_SUFFIX),_gvm)
ifneq ($(TARGET_BOARD_DERIVATIVE_SUFFIX),_tb)
$(info IPA_FWS creation for msmnile/gen4)
...
# lahaina family (Lahaina/Cedros/Molokini) IPA FWs configs (IPAv4.9)
