...
/*===========================================================================
  Copyright (c) 2011-2019, 2021-2022 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
static int pb_resolve_target(struct pb_targetinfo *targetinfo)
{
  ...
  switch (target)
  {
    ...
    case DS_TARGET_FUSION_WAIPIO_SDXLEMUR:
      do
      {
        FILE *fp = NULL;
    ...
    case DS_TARGET_LAHAINA:
    case DS_TARGET_WAIPIO:
    case DS_TARGET_WAIPIO_VT:
    case DS_TARGET_KAILUA:
    case DS_TARGET_MONACO:
