...
/*===========================================================================
  ...
  Copyright (c) 2010-2015, 2020-2022 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
)
{
  ...
  DSI_LOG_VERBOSE(">>>dsi_netmgr_cb ENTRY");
  ...
  if (ret == DSI_ERROR)
  {
    DSI_LOG_VERBOSE(">>>dsi_netmgr_cb EXIT with err");
  }
  else
  {
    DSI_LOG_VERBOSE(">>>dsi_netmgr_cb EXIT with suc");
  }
