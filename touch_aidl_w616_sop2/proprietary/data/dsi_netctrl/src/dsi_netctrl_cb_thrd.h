...
typedef enum dsi_netctrl_cb_cmd_type_e
{
  ...
  DSI_NETCTRL_CB_CMD_QMI_WDS_EXT_IND,
...
typedef struct dsi_netctrl_cb_cmd_data_s
{
  ...
  union
  {
    ...
    dsi_netctrl_cb_wds_extended_ind_data_t wds_ext_ind;
...
/*===========================================================================
                  QMI WDS Extended Service Event Callback
===========================================================================*/
void dsi_process_qmi_wds_extended_ind
(
  dsi_netctrl_cb_wds_extended_ind_data_t *ext_ind_data
);
