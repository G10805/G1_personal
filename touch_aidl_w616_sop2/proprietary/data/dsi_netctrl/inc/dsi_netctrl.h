...
typedef enum dsi_ce_reason_type_e
{
  ...
  DSI_CE_TYPE_DSI_INTERNAL = 0x0d,
  DSI_CE_TYPE_CALL_ALREADY_EXISTS = 0x0e
} dsi_ce_reason_type_t;

typedef enum dsi_ce_reason_code_e
{
  DSI_CE_REASON_CODE_MIN = 0,
  DSI_CE_REASON_CODE_NETMGR_RESTART_ONGOING,
  DSI_CE_REASON_CODE_NETMGR_ERROR,
  DSI_CE_REASON_CODE_MAX
} dsi_ce_reason_code_t;
...
typedef enum dsi_ext_ip_chng_e
{
  DSI_EXT_IP_INVALID = 0,
  DSI_EXT_IP_MTU = 0x00002000,
  DSI_EXT_IP_PCSF_ADDR_PC = 0x00000400,
  DSI_EXT_IP_PCSF_SERVER_ADDR_LIST = 0x00000800,
  DSI_EXT_IP_PCSF_DOMAIN_NAME_LIST = 0x00001000
  /*
...
typedef enum dsi_ssc_mode_e
{
  DSI_SSC_MODE_INVALID = 0,
  DSI_SSC_MODE_DEFAULT,
  DSI_SSC_MODE_SSC_ONLY,
  DSI_SSC_MODE_MAX
} dsi_ssc_mode_t;
...
#define PRIMARY_PDU 0
#define SECONDARY_PDU 1
#define DSI_NUM_PDUS 2
...
typedef enum
{
  ...
  DSI_EVT_PDU_AVAILABLE,              /**< PDU update. */
  DSI_EVT_PDU_PROMOTION,              /**< PDU update. */
  DSI_EVT_PDU_RELEASE,                /**< PDU update. */
  DSI_EVT_PDU_RECONFIGED,
  DSI_EXTENDED_IP_CHANGE_EV,          /* Change in EXTEND_IP_IND */

  DSI_NET_TUNEAWAY_INFO,

  DSI_EVT_WDS_EXT_IS_CONN,
  DSI_EVT_WDS_EXT_NO_NET,
  DSI_EVT_OEMPRXY_IS_CONN,
  DSI_EVT_OEMPRXY_NO_NET,
...
typedef struct evt_info_s
{
  ...
  dsi_ip_family_t ip_type;      /* This member is used only while generating
                                 ...
                                 */
  unsigned int               pdu_id;
  dsi_ext_ip_chng_t          ext_ip_changes; /* Used for DSI_EXTENDED_IP_CHANGE_EV*/
} dsi_evt_payload_t;
...
typedef enum dsi_addr_type_e
{
  DSI_ADDR_TYPE_INVALID = -1,
  DSI_ADDR_TYPE_DEFAULT = 0,
  DSI_ADDR_TYPE_CANDIDATE,
  DSI_ADDR_TYPE_MULTIHOME,
  DSI_NUM_ADDR_TYPES,
} dsi_addr_type;
...
/** IP address information structure. */
typedef struct dsi_addr_info_ex_s
{
  /* Network interface address */
  dsi_addr_t iface_addr_s; /**< Interface IP address. */
  unsigned int iface_mask; /**< Subnet mask.       */
  ...
  /* Secondary DNS server  address */
  dsi_addr_t dnss_addr_s;  /**< Secondary DNS address. */
  unsigned int deprecateTime; /* Remaing Lifetime of Primary PDU address */
  unsigned int expiryTime; /* Lifetime before expire for Secondary PDU address */
  unsigned int pdu_id; /* P*/
  unsigned int primary;
  dsi_addr_type address_type; /**< IPv6 address classification */
} dsi_addr_info_ex_t;
...
typedef enum
{
  DSI_IFACE_IOCTL_EX_MIN = 0,
  DSI_IFACE_IOCTL_EX_GET_PCSCF_SERV_ADDRESS = DSI_IFACE_IOCTL_MIN,
  DSI_IFACE_IOCTL_EX_GET_PCSCF_DOMAIN_NAME_LIST,
  DSI_IFACE_IOCTL_EX_REMOVE_DELEGATED_IPV6_PREFIX,
  DSI_IFACE_IOCTL_EX_MAX,
  _DSI_IFACE_IOCTL_EX_FORCE_32_BIT = 0x7FFFFFFF // Force 32 bits to be used for enum
}dsi_iface_ioctl_ex_enum_t;
...
typedef enum
{
  ...
  DSI_DATA_BEARER_TECH_3GPP_CIWLAN,   /**< CIWLAN */
...
#define DSI_APN_TYPE_MASK_UT          (WDS_APN_TYPE_MASK_UT_V01)
#define DSI_APN_TYPE_MASK_MCX         (WDS_APN_TYPE_MASK_MCX_V01)

#define IFACE_NAME_LEN  16
#define APN_NAME_LEN    150

typedef enum
{
  DSI_OEMPRXY_IP_TYPE_INVALID = -1,
  DSI_OEMPRXY_IP_TYPE_V4,
  DSI_OEMPRXY_IP_TYPE_V6,
  DSI_OEMPRXY_IP_TYPE_MAX
} dsi_oemprxy_req_ip_type_t;

typedef struct
{
  dsi_oemprxy_req_ip_type_t  req_ip_type;
  char                       pdn_ip_address[IPV6_ADDR_LEN];
  unsigned int               netmask_prefix;    /* IPv4 mask or IPv6 prefix */
  char                       dns_addr_primary[IPV6_ADDR_LEN];
  char                       dns_addr_secondary[IPV6_ADDR_LEN];
  int                        subscription_id;
  char                       wlan_iface_name[IFACE_NAME_LEN];
  char                       apn_name[APN_NAME_LEN + 1];
} dsi_oemprxy_params_t;

/** @} */ /* end_addtogroup datatypes */

#define DSI_MATCHING_CALL_PARAMS_APN_NAME        0x0001
#define DSI_MATCHING_CALL_PARAMS_PROFILE_ID      0x0002
#define DSI_MATCHING_CALL_PARAMS_APN_TYPE_MASK   0x0004
#define DSI_MATCHING_CALL_PARAMS_IP_TYPE         0x0008
...
typedef struct
{
  ...
  int                      ip_type;  /* DSI_IP_VERSION_4,
                                        DSI_IP_VERSION_6,
                                        or DSI_IP_VERSION_4_6 */
} dsi_matching_call_check_t;
...
*/
/*=========================================================================*/
extern unsigned int dsi_get_ip_addr_count_ex
(
  dsi_hndl_t hndl
);
...
/** @ingroup dsi_get_ip_addr_count
    ...
    Gets the number of IP addresses (IPv4 and global IPv6) associated with
    the DSI interface. This count does NOT include secondary PDUs.
...
/*===========================================================================
  FUNCTION:  dsi_get_current_data_bearer_tech_string	1387
===========================================================================*/
/** @ingroup dsi_get_current_data_bearer_tech_string	1389

    Returns the current data bearer technology string on which a 
    call was brought up
...
*/
/*=========================================================================*/
extern int dsi_get_link_mtu_by_family_ex
(
   dsi_hndl_t                             dsi_hndl,
...
*/
/*=========================================================================*/
extern int dsi_start_extended_data_call(dsi_hndl_t hndl, void *opts);
...
*/
/*=========================================================================*/
extern int dsi_stop_extended_data_call(dsi_hndl_t hndl, void *opts);
