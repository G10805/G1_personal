...
/*===========================================================================
  ...
  Copyright (c) 2010-2013,2015,2017,2020-2022 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
typedef struct netmgr_exec_cmd_data_s {
  ...
  netmgr_op_status_info_t       op_status;       /* Every netmgr executor command will have this
                                                    field that can tell whether the op succeeded
                                                    or failed so that we can do some kind of
                                                    recovery */
  union {
    ...
    struct connect_msg_s {
      ...
      int                       non_primary;
      wds_secondary_pdu_status_enum_v01     pdu_status;
