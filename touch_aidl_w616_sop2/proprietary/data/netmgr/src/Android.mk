...
LOCAL_SHARED_LIBRARIES += libnetmgrxfrmutils
endif
...
LOCAL_HEADER_LIBRARIES += libnetmgrxfrmutils_headers
LOCAL_HEADER_LIBRARIES += libcndinc_headers
LOCAL_HEADER_LIBRARIES += cne_common_inc
LOCAL_HEADER_LIBRARIES += librmnetctl_headers
LOCAL_HEADER_LIBRARIES += libnlnetmgr_headers
LOCAL_HEADER_LIBRARIES += libnetmgrmodemproxy_headers
LOCAL_HEADER_LIBRARIES += libnetmgr_sscm3_headers
...
LOCAL_SHARED_LIBRARIES += libnetmgr_utils
...
ifneq ($(TARGET_BOARD_AUTO),true)
LOCAL_SHARED_LIBRARIES += libnetmgrxfrmutils
LOCAL_SHARED_LIBRARIES += libnetmgrmodemproxy
LOCAL_SHARED_LIBRARIES += libnetmgr_sscm3
endif
