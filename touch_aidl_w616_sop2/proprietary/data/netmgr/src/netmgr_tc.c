...
)
{
  ...
  *list_index = 0;
  ...
  while ( iter )
  {
    ...
    /* Sec PDU flow filters are put in front of primariy */
    if (NETMGR_IS_SEC_PDU_FLOW(flow_id) && !NETMGR_IS_SEC_PDU_FLOW(filter_data->flow_id))
      break;
    if ((NETMGR_IS_SEC_PDU_FLOW(flow_id) == NETMGR_IS_SEC_PDU_FLOW(filter_data->flow_id)) &&
        (filter_data->ip_version == ip_version) && (filter_data->precedence > precedence))
      break;
    iter = iter->next;
...
)
{
  ...
  netmgr_tc_filter_data *filter_data = NULL, *filter_data_bundle = NULL;
  NETMGR_LOG_FUNC_ENTRY;
...
/*===========================================================================
  FUNCTION  netmgr_tc_flow_control_hdlr_dummy
===========================================================================*/
/*!
@brief
  Dummy handler.
...
/*=========================================================================*/
LOCAL int
netmgr_tc_flow_control_hdlr_dummy
(
  __attribute__((unused)) int link,
  __attribute__((unused)) const netmgr_qmi_qos_flow_info_t  *qos_flow,
  __attribute__((unused)) netmgr_tc_flow_state_t state
)
{
  return NETMGR_SUCCESS;
}
...
/*===========================================================================
  FUNCTION  	netmgr_tc_flow_modify_hdlr_dummy
===========================================================================*/
/*!
@brief
 Dummy handler
...
/*=========================================================================*/
LOCAL int
netmgr_tc_flow_modify_hdlr_dummy
(
  __attribute__((unused)) int       link,
  __attribute__((unused)) const netmgr_qmi_qos_flow_info_t  *qos_flow
)
...
/*===========================================================================
  FUNCTION  	netmgr_tc_flow_activate_hdlr_dummy
===========================================================================*/
/*!
@brief
  Dummy handler
...
/*=========================================================================*/
LOCAL int
	netmgr_tc_flow_activate_hdlr_dummy
(
  __attribute__((unused))  int                                link,
  __attribute__((unused))  const netmgr_qmi_qos_flow_info_t  *qos_flow
)
...
/*===========================================================================
  FUNCTION  netmgr_tc_flow_delete_hdlr_dummy
===========================================================================*/
/*!
@brief
 Dummy handler
...
/*=========================================================================*/
LOCAL int
netmgr_tc_flow_delete_hdlr_dummy
(
  __attribute__((unused))  int       link,
  __attribute__((unused))  const netmgr_qmi_qos_flow_info_t  *qos_flow
)
...
/*=========================================================================*/
LOCAL void
netmgr_tc_filter_list_cleanup( int link )
{
  ds_dll_el_t *iter = NULL;
  void *data = NULL;
  netmgr_tc_flow_info_t* flow_info;
  ...
  while (NULL != (iter = ds_dll_deq(netmgr_tc_cfg.links[link].flow_list,
                                    NULL, &data)))
  {
    ...
    if (flow_info)
    {
      ...
      {
        netmgr_tc_filter_delete_hdlr(flow_info, link,
                                     flow_info->qos_flow.flow_id);
      }
...
netmgr_tc_reset_link( int link )
{
  ...
  if (link < 0 || link >= netmgr_tc_cfg.nlink)
  {
    return NETMGR_FAILURE;
  }
  ...
  NETMGR_LOCK_MUTEX(tc_lock);
  if (netmgr_tc_cfg.is_initialized && netmgr_tc_cfg.links[link].flow_list)
  {
...
int netmgr_tc_flow_rebind_hdlr_dummy
(
  int link,
  const netmgr_qmi_qos_flow_info_t  *qos_flow
)
...
netmgr_tc_init( int nlink, netmgr_ctl_port_config_type links[], int netmgr_restart )
{
  ...
  NETMGR_ASSERT(nlink > 0 && nlink <= NETMGR_MAX_LINK);
  memset(&netmgr_tc_cfg, 0, sizeof(netmgr_tc_cfg));
  ...
  {
    vtable.reset             = netmgr_tc_reset_link;
    vtable.flow_activate     = netmgr_tc_flow_activate_hdlr_dummy;
    vtable.flow_modify       = netmgr_tc_flow_modify_hdlr_dummy;
    vtable.flow_delete       = netmgr_tc_flow_delete_hdlr_dummy;
    vtable.flow_control      = netmgr_tc_flow_control_hdlr_dummy;
    vtable.flow_suspend      = netmgr_tc_flow_activate_hdlr_dummy;
    vtable.flow_rebind       = netmgr_tc_flow_rebind_hdlr_dummy;
  }
  ...
  netmgr_cb_insert_cb(NETMGR_NETD_CB_TABLE,
                      ...
                      NETMGR_TC_CB_MODNAME,
                      &netmgr_tc_reorder_qos_post_routing_chain_ref);
...
/*=========================================================================*/
void*
netmgr_tc_reorder_qos_post_routing_chain_ref(__attribute__((unused)) void *arg)
{
  int result = 0;
