...
/*===========================================================================
  ...
  Copyright (c) 2010-2015, 2017-2018, 2020-2022 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
int netmgr_tc_flow_rebind (int link,
                           const netmgr_qmi_qos_flow_info_t  *qos_flow)
{
  VERIFY_VTABLE_FUNC( tc, flow_rebind );
...
*/
/*=========================================================================*/
int netmgr_kif_wlan_open ( uint8 link, char* wlan_ifname )
{
  VERIFY_VTABLE_FUNC( kif, wlan_open );
  return netmgr_platform_vtable.kif.wlan_open( link, wlan_ifname );
}
...
*/
/*=========================================================================*/
int netmgr_kif_wlan_close ( uint8 link, char* wlan_ifname )
{
  VERIFY_VTABLE_FUNC( kif, wlan_close );
  return netmgr_platform_vtable.kif.wlan_close( link, wlan_ifname);
}
