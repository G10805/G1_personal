...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/6.2/uim/api/user_identity_module_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define UIM_V01_IDL_MINOR_VERS 0x64
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define UIM_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define UIM_V01_MAX_MESSAGE_ID 0x0079
/**
    @}
  */
...
#define QMI_UIM_EUICC_INFO2_MAX_V01 1024
...
#define QMI_UIM_EVENT_COMMAND_ERROR_BIT_V01 12
#define QMI_UIM_EVENT_MAP_PROVISIONING_SESSION_TO_SLOT_V01 13
...
typedef struct {
  ...
  */
  ...
  /**<   Indicates the slot used for primary sessions. Valid values:\n
      ...
      - UIM_SLOT_5 (0x05) --  Slot 5
 */
}uim_primary_slot_status_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Indicates the slot used for secondory sessions. Valid values:\n
      - UIM_SLOT_1 (0x01) --  Slot 1 \n
      - UIM_SLOT_2 (0x02) --  Slot 2 \n
      - UIM_SLOT_3 (0x03) --  Slot 3 \n
      - UIM_SLOT_4 (0x04) --  Slot 4 \n
      - UIM_SLOT_5 (0x05) --  Slot 5
 */
}uim_secondary_slot_status_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint16_t index_gw_ter;
  /**<   Index of the tertiary GW provisioning application. The most significant
       byte indicates the slot (starting from 0), while the least significant
       byte indicates the application for that slot (starting from 0). The
       value 0xFFFF identifies that the session does not exist.
  */

  uint16_t index_1x_ter;
  /**<   Index of the tertiary 1X provisioning application. The most significant
       byte indicates the slot (starting from 0), while the least significant
       byte indicates the application for that slot (starting from 0). The
       value 0xFFFF identifies that the session does not exist.
    */
  ...
  /**<   Indicates the slot used for tertiary sessions. Valid values:\n
      ...
      - UIM_SLOT_5 (0x05) --  Slot 5
 */
}uim_tertiary_slot_status_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Bitmask of the events to be received by the client. Additional
       bits are reserved for future use and must be set to zero by the caller.\n
        ...
        - Bit 12 -- Command error indication
        - Bit 13 -- Map provisioning session to slot indication
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Indication Message; Indicates the status of current slot mapping */
typedef struct {

  /* Mandatory */
  /*  Primary Slot Status */
  uim_primary_slot_status_v01 primary_slot_status;

  /* Optional */
  /*  Secondary Slot Status */
  uint8_t secondary_slot_status_valid;  /**< Must be set to true if secondary_slot_status is being passed */
  uim_secondary_slot_status_v01 secondary_slot_status;

  /* Optional */
  /*  Tertiary Slot Status */
  uint8_t tertiary_slot_status_valid;  /**< Must be set to true if tertiary_slot_status is being passed */
  uim_tertiary_slot_status_v01 tertiary_slot_status;
}uim_map_provisioning_session_to_slot_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Sends the provisioning type to modem */
typedef struct {

  /* Mandatory */
  /*  Provisioning Type */
  uint8_t provisioning_type;
  /**<   Indicates whether session provisioning Manual or Auto. Valid values:\n
         - 0 -- Manual session Provisioning\n
         - 1 -- Auto session provisioning
  */
}qmi_uim_provisioning_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Sends the provisioning type to modem */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:\n
       ...
       qmi_error_type  -- Error code. Possible error code values are described
                          ...
                          definition.
  */
}qmi_uim_provisioning_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Retrieves the EUICC info2 information from EUICC */
typedef struct {

  /* Mandatory */
  /*  Slot */
  uim_slot_enum_v01 slot;
  /**<   Indicates the slot from which EUICC_info2 will be retrieved.Valid values:\n
      - UIM_SLOT_1 (0x01) --  Slot 1 \n
      - UIM_SLOT_2 (0x02) --  Slot 2 \n
      - UIM_SLOT_3 (0x03) --  Slot 3 \n
      - UIM_SLOT_4 (0x04) --  Slot 4 \n
      - UIM_SLOT_5 (0x05) --  Slot 5
 */
}uim_get_euicc_info2_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Retrieves the EUICC info2 information from EUICC */
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  EUICC_INFO2 */
  uint8_t euicc_info2_val_valid;  /**< Must be set to true if euicc_info2_val is being passed */
  uint32_t euicc_info2_val_len;  /**< Must be set to # of elements in euicc_info2_val */
  uint8_t euicc_info2_val[QMI_UIM_EUICC_INFO2_MAX_V01];
  /**<   eUICC Info2 value */
}uim_get_euicc_info2_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup uim_qmi_enums
  ...
  */
typedef enum {
  UIM_COMMAND_NAME_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  UIM_TERMINAL_PROFILE_CMD_V01 = 0x00, /**<  Command is Terminal Profile \n  */
  UIM_SELECT_CMD_V01 = 0x01, /**<  Command is select \n  */
  UIM_READ_CMD_V01 = 0x02, /**<  Command is read_transparent or read_record \n  */
  UIM_AUTHENTICATE_CMD_V01 = 0x03, /**<  Command is USIM authentication or ISIM authentication  */
  UIM_COMMAND_NAME_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}uim_command_name_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t error_sw1;
  /**<   Error SW1 status code received from the card.*/

  uint8_t error_sw2;
  /**<   Error SW2 status code received from the card.*/
}uim_error_sw_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Indication Message; Indicates the error response of specified commands. */
typedef struct {

  /* Mandatory */
  /*  Slot */
  uim_slot_enum_v01 slot;
  /**<   Indicates the slot where specified
 command is failed.
 Valid values: \n
      - UIM_SLOT_1 (0x01) --  Slot 1 \n
      - UIM_SLOT_2 (0x02) --  Slot 2 \n
 ...
 */
  ...
  /* Mandatory */
  /*  Command Name Type */
  uim_command_name_enum_v01 cmd_name;
  /**<   Indicates command name for which command
 error indication is sent.
 Valid values:\n
      - UIM_TERMINAL_PROFILE_CMD (0x00) --  Command is Terminal Profile \n
      - UIM_SELECT_CMD (0x01) --  Command is select \n
      - UIM_READ_CMD (0x02) --  Command is read_transparent or read_record \n
      - UIM_AUTHENTICATE_CMD (0x03) --  Command is USIM authentication or ISIM authentication
 */

  /* Mandatory */
  /*  Error Status Words Type */
  uim_error_sw_type_v01 error_status_words;
  /**<   Indicates error status words. */

  /* Optional */
  /*  File ID Type */
  uint8_t file_id_valid;  /**< Must be set to true if file_id is being passed */
  uint16_t file_id;
  /**<   Indicates file ID on which select or read
       command is sent.
  */
  ...
  uint32_t aid_len;  /**< Must be set to # of elements in aid */
  uint8_t aid[QMI_UIM_AID_MAX_V01];
  /**<   Indicates app AID on which failed authentication
       command is sent.
  */
}uim_command_error_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_UIM_COMMAND_ERROR_IND_V01
...
//#define REMOVE_QMI_UIM_GET_EUICC_INFO2_V01
...
//#define REMOVE_QMI_UIM_MAP_PROVISIONING_SESSIONS_TO_SLOTS_IND_V01
...
//#define REMOVE_QMI_UIM_PROVISIONING_V01
...
#define QMI_UIM_PROVISIONING_REQ_V01 0x0076
#define QMI_UIM_PROVISIONING_RESP_V01 0x0076
#define QMI_UIM_GET_EUICC_INFO2_REQ_V01 0x0077
#define QMI_UIM_GET_EUICC_INFO2_RESP_V01 0x0077
#define QMI_UIM_COMMAND_ERROR_IND_V01 0x0078
#define QMI_UIM_MAP_PROVISIONING_SESSIONS_TO_SLOTS_IND_V01 0x0079
/**
    @}
  */
