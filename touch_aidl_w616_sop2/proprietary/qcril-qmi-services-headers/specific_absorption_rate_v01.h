...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/6.2/sar/api/specific_absorption_rate_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9
   It was generated on: Mon Nov 15 2021 (Spin 0)
...
#define SAR_V01_IDL_MINOR_VERS 0x0E
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define SAR_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define SAR_V01_MAX_MESSAGE_ID 0x0029
/**
    @}
  */
...
typedef enum {
  ...
  QMI_SAR_RF_STATE_21_V01 = 21, /**<  RF state 21. \n  */
  QMI_SAR_RF_STATE_22_V01 = 22, /**<  RF state 22. \n  */
  QMI_SAR_RF_STATE_23_V01 = 23, /**<  RF state 23. \n  */
  QMI_SAR_RF_STATE_24_V01 = 24, /**<  RF state 24. \n  */
  QMI_SAR_RF_STATE_25_V01 = 25, /**<  RF state 25. \n  */
  QMI_SAR_RF_STATE_26_V01 = 26, /**<  RF state 26. \n  */
  QMI_SAR_RF_STATE_27_V01 = 27, /**<  RF state 27. \n  */
  QMI_SAR_RF_STATE_28_V01 = 28, /**<  RF state 28. \n  */
  QMI_SAR_RF_STATE_29_V01 = 29, /**<  RF state 29. \n  */
  QMI_SAR_RF_STATE_30_V01 = 30, /**<  RF state 30. \n  */
  QMI_SAR_RF_STATE_31_V01 = 31, /**<  RF state 31. \n  */
  QMI_SAR_RF_STATE_32_V01 = 32, /**<  RF state 32. \n  */
  QMI_SAR_RF_STATE_33_V01 = 33, /**<  RF state 33. \n  */
  QMI_SAR_RF_STATE_34_V01 = 34, /**<  RF state 34. \n  */
  QMI_SAR_RF_STATE_35_V01 = 35, /**<  RF state 35. \n  */
  QMI_SAR_RF_STATE_36_V01 = 36, /**<  RF state 36. \n  */
  QMI_SAR_RF_STATE_37_V01 = 37, /**<  RF state 37. \n  */
  QMI_SAR_RF_STATE_38_V01 = 38, /**<  RF state 38. \n  */
  QMI_SAR_RF_STATE_39_V01 = 39, /**<  RF state 39. \n  */
  QMI_SAR_RF_STATE_40_V01 = 40, /**<  RF state 40.     */
...
/** @addtogroup sar_qmi_enums
  ...
  */
typedef enum {
  QMI_SAR_CONCURRENT_RADIO_STATE_ENUM_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  QMI_SAR_CONCURRENT_RADIO_OFF_V01 = 0, /**<  Concurrent radio is not transmitting  */
  QMI_SAR_CONCURRENT_RADIO_ON_V01 = 1, /**<  Concurrent radio is transmitting  */
  QMI_SAR_CONCURRENT_RADIO_STATE_ENUM_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}qmi_sar_concurrent_radio_state_enum_type_v01;
/**
    @}
  */
...
typedef struct {
 ...
 SAR RF state must be specified: \n
      ...
      - QMI_SAR_RF_STATE_21 (21) --  RF state 21. \n
      - QMI_SAR_RF_STATE_22 (22) --  RF state 22. \n
      - QMI_SAR_RF_STATE_23 (23) --  RF state 23. \n
      - QMI_SAR_RF_STATE_24 (24) --  RF state 24. \n
      - QMI_SAR_RF_STATE_25 (25) --  RF state 25. \n
      - QMI_SAR_RF_STATE_26 (26) --  RF state 26. \n
      - QMI_SAR_RF_STATE_27 (27) --  RF state 27. \n
      - QMI_SAR_RF_STATE_28 (28) --  RF state 28. \n
      - QMI_SAR_RF_STATE_29 (29) --  RF state 29. \n
      - QMI_SAR_RF_STATE_30 (30) --  RF state 30. \n
      - QMI_SAR_RF_STATE_31 (31) --  RF state 31. \n
      - QMI_SAR_RF_STATE_32 (32) --  RF state 32. \n
      - QMI_SAR_RF_STATE_33 (33) --  RF state 33. \n
      - QMI_SAR_RF_STATE_34 (34) --  RF state 34. \n
      - QMI_SAR_RF_STATE_35 (35) --  RF state 35. \n
      - QMI_SAR_RF_STATE_36 (36) --  RF state 36. \n
      - QMI_SAR_RF_STATE_37 (37) --  RF state 37. \n
      - QMI_SAR_RF_STATE_38 (38) --  RF state 38. \n
      - QMI_SAR_RF_STATE_39 (39) --  RF state 39. \n
      - QMI_SAR_RF_STATE_40 (40) --  RF state 40.
 */
  ...
  */
  ...
  /* Optional */
  /*  Sensor info */
  uint8_t oem_data_valid;  /**< Must be set to true if oem_data is being passed */
  uint64_t oem_data;
  /**<
     OEM discretionary data to be passed in tandem with SAR RF state\n
     update information to modem. This field is ignored by Qualcomm modem code\n
     and any handling must be implemented by the OEM.
  */

  /* Optional */
  /*  Concurrent radio transmit status */
  uint8_t concurrent_radio_state_valid;  /**< Must be set to true if concurrent_radio_state is being passed */
  qmi_sar_concurrent_radio_state_enum_type_v01 concurrent_radio_state;
  /**<
     The transmit status of any concurrent radios signaled as an ON/OFF flag to be \n
     used by QUALCOMM Smart Transmit for RF exposure compliance.
  */
 ...
 */
  ...
  */
  ...
  qmi_sar_concurrent_radio_state_enum_type_v01 concurrent_radio_state;
  /**<
     If Smart Transmit is configured and enabled, the transmit status of any concurrent radios is reported back to the caller.
     Absence of this field in the response message should be considered equivalent to QMI_SAR_CONCURRENT_RADIO_OFF
  */
...
/** @addtogroup sar_qmi_messages
    @{
  */
/** Request Message; Updates USB State changes to Modem */
typedef struct {

  /* Optional */
  /*  SAR USB CONN STATE */
  uint8_t usb_is_connected_valid;  /**< Must be set to true if usb_is_connected is being passed */
  uint8_t usb_is_connected;
  /**<
     State variable to determine USB Conn.

      usb_is_connected = FALSE will mean USB is not connected.
      usb_is_connected = TRUE will mean USB is connected.
  */
}sar_set_usb_conn_state_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup sar_qmi_messages
    @{
  */
/** Response Message; Updates USB State changes to Modem */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are
                          ...
                          message definition.
  */
}sar_set_usb_conn_state_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup sar_qmi_messages
    @{
  */
/** Request Message; Syncs MODEM USB State to AP */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}sar_get_usb_conn_state_req_msg_v01;
...
/** @addtogroup sar_qmi_messages
    @{
  */
/** Response Message; Syncs MODEM USB State to AP */
typedef struct {
  ...
  */
  ...
  /**<
     State variable to determine USB Conn.
      ...
      usb_is_connected = TRUE will mean USB is connected.
  */
}sar_get_usb_conn_state_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup sar_qmi_messages
    @{
  */
/** Request Message; Sets the beam pairs to those within given subarray pair */
typedef struct {

  /* Mandatory */
  /*  SAR BEAM SUB ARRAY */
  uint16_t subarray_id_1;
  /**<
     Index 1 for the subarray of restricted beam pairs.
  */

  /* Mandatory */
  uint16_t subarray_id_2;
  /**<
     Index 2 for the subarray of restricted beam pairs.
  */
}sar_set_beam_sub_array_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup sar_qmi_messages
    @{
  */
/** Response Message; Sets the beam pairs to those within given subarray pair */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are
                          ...
                          message definition.
  */
}sar_set_beam_sub_array_resp_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_SAR_GET_USB_CONN_STATE_V01
...
//#define REMOVE_QMI_SAR_SET_BEAM_SUB_ARRAY_V01
//#define REMOVE_QMI_SAR_SET_USB_CONN_STATE_V01
...
#define QMI_SAR_SET_USB_CONN_STATE_REQ_V01 0x0027
#define QMI_SAR_SET_USB_CONN_STATE_RESP_V01 0x0027
#define QMI_SAR_GET_USB_CONN_STATE_REQ_V01 0x0028
#define QMI_SAR_GET_USB_CONN_STATE_RESP_V01 0x0028
#define QMI_SAR_SET_BEAM_SUB_ARRAY_REQ_V01 0x0029
#define QMI_SAR_SET_BEAM_SUB_ARRAY_RESP_V01 0x0029
/**
    @}
  */
