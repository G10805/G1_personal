...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/6.4/voice/api/voice_service_v02.h#3 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9
   It was generated on: Mon Jan 16 2023 (Spin 0)
...
#define VOICE_V02_IDL_MINOR_VERS 0x95
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define VOICE_V02_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define VOICE_V02_MAX_MESSAGE_ID 0x0087
/**
    @}
  */
...
#define QMI_VOICE_EMERG_SERVICE_URN_MAX_LEN_V02 128
#define QMI_VOICE_PROG_INFO_NOTIF_TEXT_MAX_LEN_V02 128
#define QMI_VOICE_IP_DIVERSION_INFO_MAX_LEN_V02 512
...
#define QMI_VOICE_IP_CALLER_INFO_CONTENT_EXT_TYPE_LENGTH_V02 128
#define QMI_VOICE_IP_CALLER_INFO_EXT_LENGTH_V02 255
#define QMI_VOICE_IP_ACCEPT_INFO_LENGTH_V02 128
#define QMI_VOICE_CALL_COMP_SUBJECT_MAX_LEN_V02 64
#define QMI_VOICE_CALL_COMP_PIC_URL_MAX_LEN_V02 256
#define QMI_VOICE_IUT_STN_MAX_LEN_V02 128
#define QMI_VOICE_CALL_COMP_ORG_HDR_MAX_LEN_V02 256
#define QMI_VOICE_VEHICLE_XML_PAYLOAD_IDS_MAX_LEN_V02 386
#define QMI_VOICE_SIP_DTMF_STRING_MAX_LEN_V02 128
#define QMI_VOICE_ECALL_EFS_CONFIG_DIGITS_MAX_LEN_V02 18
#define QMI_VOICE_CALL_ECNAM_ICON_URL_MAX_LEN_V02 256
#define QMI_VOICE_CALL_ECNAM_INFO_URL_MAX_LEN_V02 256
#define QMI_VOICE_CALL_ECNAM_CARD_URL_MAX_LEN_V02 256
...
#define QMI_VOICE_IP_DIVERSION_INFO_ARRAY_MAX_V02 7
#define QMI_VOICE_CALL_ECNAM_ARRAY_MAX_V02 7
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Network Detected ECC Number Event  */
  uint8_t network_detected_ecc_number_event_valid;  /**< Must be set to true if network_detected_ecc_number_event is being passed */
  uint8_t network_detected_ecc_number_event;
  /**<   Values: \n
      - 0x00 -- Disable (default) \n
      - 0x01 -- Enable
  */
  ...
  /* Optional */
  /*  IUT Call Push Delay Events */
  uint8_t iut_call_push_delay_events_valid;  /**< Must be set to true if iut_call_push_delay_events is being passed */
  uint8_t iut_call_push_delay_events;
  /**<   Values: \n
       - 0x00 -- Disable (default) \n
       - 0x01 -- Enable
  */
  ...
  /* Optional */
  /*  SIP DTMF Indication */
  uint8_t sip_dtmf_event_valid;  /**< Must be set to true if sip_dtmf_event is being passed */
  uint8_t sip_dtmf_event;
  /**<   Values: \n
       - 0x00 -- Disable (default) \n
       - 0x01 -- Enable
  */
  ...
  /* Optional */
  /*  Notify CLIR Mode Events */
  uint8_t notify_clir_mode_events_valid;  /**< Must be set to true if notify_clir_mode_events is being passed */
  uint8_t notify_clir_mode_events;
  /**<   Values: \n
           - 0x00 -- Disable (default) \n
           - 0x01 -- Enable
  */
...
typedef enum {
  ...
  IP_PRESENTATION_NUM_ALLOWED_V02 = 0x00, /**<  Allowed \n */
  IP_PRESENTATION_NUM_RESTRICTED_V02 = 0x01, /**<  Restricted  */
...
typedef enum {
  ...
  UUS_TYPE_DATA_V02 = 0x00, /**<  Data \n */
  UUS_TYPE1_IMPLICIT_V02 = 0x01, /**<  Type 1 implicit \n */
  UUS_TYPE1_REQUIRED_V02 = 0x02, /**<  Type 1 required \n */
  UUS_TYPE1_NOT_REQUIRED_V02 = 0x03, /**<  Type 1 not required \n */
  UUS_TYPE2_REQUIRED_V02 = 0x04, /**<  Type 2 required \n */
  UUS_TYPE2_NOT_REQUIRED_V02 = 0x05, /**<  Type 2 not required \n */
  UUS_TYPE3_REQUIRED_V02 = 0x06, /**<  Type 3 required \n */
  UUS_TYPE3_NOT_REQUIRED_V02 = 0x07, /**<  Type 3 not required  */
...
typedef enum {
  ...
  UUS_DCS_USP_V02 = 0x01, /**<  USP \n */
  UUS_DCS_OHLP_V02 = 0x02, /**<  OHLP \n */
  UUS_DCS_X244_V02 = 0x03, /**<  X244 \n */
  UUS_DCS_SMCF_V02 = 0x04, /**<  SMCF \n */
  UUS_DCS_IA5_V02 = 0x05, /**<  IA5 \n */
  UUS_DCS_RV12RD_V02 = 0x06, /**<  RV12RD \n */
  UUS_DCS_Q931UNCCM_V02 = 0x07, /**<  Q931UNCCM */
...
typedef struct {
  ...
  /**<   UUS type. Values: \n
      - UUS_TYPE_DATA (0x00) --  Data \n
      - UUS_TYPE1_IMPLICIT (0x01) --  Type 1 implicit \n
      - UUS_TYPE1_REQUIRED (0x02) --  Type 1 required \n
      - UUS_TYPE1_NOT_REQUIRED (0x03) --  Type 1 not required \n
      - UUS_TYPE2_REQUIRED (0x04) --  Type 2 required \n
      - UUS_TYPE2_NOT_REQUIRED (0x05) --  Type 2 not required \n
      - UUS_TYPE3_REQUIRED (0x06) --  Type 3 required \n
      - UUS_TYPE3_NOT_REQUIRED (0x07) --  Type 3 not required
 */

  uus_dcs_enum_v02 uus_dcs;
  /**<   UUS data coding scheme. Values: \n
      - UUS_DCS_USP (0x01) --  USP \n
      - UUS_DCS_OHLP (0x02) --  OHLP \n
      - UUS_DCS_X244 (0x03) --  X244 \n
      - UUS_DCS_SMCF (0x04) --  SMCF \n
      - UUS_DCS_IA5 (0x05) --  IA5 \n
      - UUS_DCS_RV12RD (0x06) --  RV12RD \n
      - UUS_DCS_Q931UNCCM (0x07) --  Q931UNCCM
 */
...
typedef enum {
  ...
  CLIR_SUPPRESSION_V02 = 0x01, /**<  Suppression \n */
  CLIR_INVOCATION_V02 = 0x02, /**<  Invocation  */
...
typedef enum {
  ...
  SUBADDRESS_TYPE_NSAP_V02 = 0x00, /**<  NSAP \n */
  SUBADDRESS_TYPE_USER_V02 = 0x01, /**<  User  */
...
typedef struct {
  ...
  */
  ...
  /**<   Subaddress type. Values: \n
      - SUBADDRESS_TYPE_NSAP (0x00) --  NSAP \n
      - SUBADDRESS_TYPE_USER (0x01) --  User
 */
...
typedef enum {
  ...
  VOICE_DIAL_CALL_SRV_TYPE_AUTOMATIC_V02 = 0x01, /**<  Automatic \n */
  VOICE_DIAL_CALL_SRV_TYPE_GSM_V02 = 0x02, /**<  GSM \n  */
  VOICE_DIAL_CALL_SRV_TYPE_WCDMA_V02 = 0x03, /**<  WCDMA \n */
  VOICE_DIAL_CALL_SRV_TYPE_CDMA_AUTOMATIC_V02 = 0x04, /**<  CDMA automatic \n */
  VOICE_DIAL_CALL_SRV_TYPE_GSM_WCDMA_V02 = 0x05, /**<  GSM or WCDMA \n */
  VOICE_DIAL_CALL_SRV_TYPE_LTE_V02 = 0x06, /**<  LTE \n */
  VOICE_DIAL_CALL_SRV_TYPE_TDSCDMA_V02 = 0x07, /**<  TD-SCDMA \n */
  VOICE_DIAL_CALL_SRV_TYPE_GSM_WCDMA_TDSCDMA_V02 = 0x08, /**<  GSM or WCDMA or TD-SCDMA \n */
  VOICE_DIAL_CALL_SRV_TYPE_CS_ONLY_V02 = 0x09, /**<  Circuit-switched domain \n */
  VOICE_DIAL_CALL_SRV_TYPE_PS_ONLY_V02 = 0x0A, /**<  Packet-switched domain \n */
  VOICE_DIAL_CALL_SRV_TYPE_NR5G_V02 = 0x0B, /**<  NR5G  */
...
typedef enum {
  ...
  SUPS_DOMAIN_AUTOMATIC_V02 = 0x01, /**<  SUPS_DOMAIN_AUTOMATIC \n */
  SUPS_DOMAIN_CS_V02 = 0x02, /**<  SUPS_DOMAIN_CS \n */
  SUPS_DOMAIN_PS_V02 = 0x03, /**<  SUPS_DOMAIN_PS  */
...
typedef enum {
  ...
  ECALL_RECONFIG_V02 = 0x03, /**<  Reconfigure eCall \n */
...
typedef enum {
  ...
  CALL_MODE_C_IWLAN_V02 = 0x09, /**<  C_IWLAN  */
...
typedef struct {
  ...
  /**<   Number to dial in ASCII string.
       Range: 1 to 81.
  */
  ...
  */
  ...
  /**<   CLIR type. Values: \n
      - CLIR_SUPPRESSION (0x01) --  Suppression \n
      - CLIR_INVOCATION (0x02) --  Invocation
 */
  ...
  */
  ...
  /**<   Service type. Values: \n
      - VOICE_DIAL_CALL_SRV_TYPE_AUTOMATIC (0x01) --  Automatic \n
      - VOICE_DIAL_CALL_SRV_TYPE_GSM (0x02) --  GSM \n
      - VOICE_DIAL_CALL_SRV_TYPE_WCDMA (0x03) --  WCDMA \n
      - VOICE_DIAL_CALL_SRV_TYPE_CDMA_AUTOMATIC (0x04) --  CDMA automatic \n
      - VOICE_DIAL_CALL_SRV_TYPE_GSM_WCDMA (0x05) --  GSM or WCDMA \n
      - VOICE_DIAL_CALL_SRV_TYPE_LTE (0x06) --  LTE \n
      - VOICE_DIAL_CALL_SRV_TYPE_TDSCDMA (0x07) --  TD-SCDMA \n
      - VOICE_DIAL_CALL_SRV_TYPE_GSM_WCDMA_TDSCDMA (0x08) --  GSM or WCDMA or TD-SCDMA \n
      - VOICE_DIAL_CALL_SRV_TYPE_CS_ONLY (0x09) --  Circuit-switched domain \n
      - VOICE_DIAL_CALL_SRV_TYPE_PS_ONLY (0x0A) --  Packet-switched domain \n
      - VOICE_DIAL_CALL_SRV_TYPE_NR5G (0x0B) --  NR5G
 */
 ...
 */
  ...
  /**<   Presentation indicator for a VT or VoIP call. Values: \n
      - IP_PRESENTATION_NUM_ALLOWED (0x00) --  Allowed \n
      - IP_PRESENTATION_NUM_RESTRICTED (0x01) --  Restricted
 */
  ...
  /**<   eCall variant. Values: \n
      ...
      - ECALL_RECONFIG (0x03) --  Reconfigure eCall \n
 ...
 */
  ...
  */
  ...
  /**<   Display text; can contain up to 98 UTF-16 characters
       and is not guaranteed to be NULL-terminated.
       Range: 0 to 98.
  */
 ...
 */
  ...
  */
  ...
  /**<   Indicates the mode on which previous call failed.
       ...
       This TLV is not applicable to C_IWLAN and should not be set to C_IWLAN. \n
       This TLV must be configured along with call_failure_reason to capture complete
  ...
  */
  ...
  /**<   Indicates the reason with which previous call failed.
       ...
       This TLV must be configured along with call_failure_mode to capture complete
       call failure information. If this TLV is not configured, this message is treated as a
       Legacy Dial Call command.
  */
 ...
 */
  ...
  /**<   Subject of the call; can contain up to 64 UTF-16 characters
       and is not guaranteed to be NULL-terminated. If this TLV is not configured,
  ...
  */
  ...
  /* Optional */
  /*  Call Composer Point Geolocation */
  ...
  /**<   \n User-provided point geolocation. If this TLV is not configured, it indicates
       that there is no point geolocation.
  */

  /* Optional */
  /*  Call Composer Circle Geolocation */
  ...
  /**<   User-provided circle geolocation. If this TLV is not configured, it indicates
       that there is no circle geolocation.
  */
  ...
  */
  ...
  /* Optional */
  /*  Number of Vehicle XML Payloads IDs Added in SIP INVITE */
  uint8_t num_vehicle_xml_payloads_valid;  /**< Must be set to true if num_vehicle_xml_payloads is being passed */
  uint16_t num_vehicle_xml_payloads;
  /**<   Indicates the number of XML payload IDs populated in the
       Array/List of Vehicle XML Payload IDs Added in SIP INVITE TLV
  */

  /* Optional */
  /*  Array/List of Vehicle XML Payload IDs Added in SIP INVITE */
  uint8_t vehicle_xml_payload_ids_valid;  /**< Must be set to true if vehicle_xml_payload_ids is being passed */
  uint8_t vehicle_xml_payload_ids[QMI_VOICE_VEHICLE_XML_PAYLOAD_IDS_MAX_LEN_V02];
  /**<   Indicates the IDs of the vehicle XML payloads.
       IDs are comma seperated.
  */

  /* Optional */
  /*  IUT Call Pulled from User Phone to Car Modem */
  uint8_t iut_call_pull_valid;  /**< Must be set to true if iut_call_pull is being passed */
  uint8_t iut_call_pull;
  /**<   Indicates whether the call is an Inter-UE transfer (IUT) call pull.
       If this TLV is set as TRUE, the Calling Number or SIP URI TLV is
       session transfer number in ASCII format.
  */

  /* Optional */
  /*  Session Transfer Number for IUT Call Pull Request (Deprecated; use the Calling Number or SIP URI TLV for IUT call pull STN) */
  uint8_t iut_stn_valid;  /**< Must be set to true if iut_stn is being passed */
  uint32_t iut_stn_len;  /**< Must be set to # of elements in iut_stn */
  uint8_t iut_stn[QMI_VOICE_IUT_STN_MAX_LEN_V02];
  /**<   Session transfer number for an IUT call pull.
  */

  /* Optional */
  /*  Emergency URN Info */
  uint8_t emerg_service_urn_valid;  /**< Must be set to true if emerg_service_urn is being passed */
  uint32_t emerg_service_urn_len;  /**< Must be set to # of elements in emerg_service_urn */
  uint8_t emerg_service_urn[QMI_VOICE_EMERG_SERVICE_URN_MAX_LEN_V02];

  /* Optional */
  /*  IP Caller Info Content Type Extended */
  uint8_t ip_caller_info_content_ext_type_valid;  /**< Must be set to true if ip_caller_info_content_ext_type is being passed */
  uint32_t ip_caller_info_content_ext_type_len;  /**< Must be set to # of elements in ip_caller_info_content_ext_type */
  uint8_t ip_caller_info_content_ext_type[QMI_VOICE_IP_CALLER_INFO_CONTENT_EXT_TYPE_LENGTH_V02];
  /**<   Content type of the IP caller information. \n
       Range: 1 to 128
  */

  /* Optional */
  /*  IP Caller Info Extended */
  uint8_t ip_caller_info_ext_valid;  /**< Must be set to true if ip_caller_info_ext is being passed */
  uint32_t ip_caller_info_ext_len;  /**< Must be set to # of elements in ip_caller_info_ext */
  uint8_t ip_caller_info_ext[QMI_VOICE_IP_CALLER_INFO_EXT_LENGTH_V02];
  /**<   IP caller information sent over the SIP header. \n
       It is ASN.1 PER encoded data. \n
       Range: 1 to 255
  */

  /* Optional */
  /*  IP Accept Info */
  uint8_t ip_accept_info_valid;  /**< Must be set to true if ip_accept_info is being passed */
  uint32_t ip_accept_info_len;  /**< Must be set to # of elements in ip_accept_info */
  uint8_t ip_accept_info[QMI_VOICE_IP_ACCEPT_INFO_LENGTH_V02];
  /**<   IP Accept information sent over the SIP header. \n
       It is ASN.1 PER encoded data. \n
       Range: 1 to 128
  */
...
typedef enum {
  ...
  ALPHA_DCS_GSM_V02 = 0x01, /**<  SMS default 7-bit coded alphabet as defined
                 in \hyperref[STD-23038]{3GPP TS 23.038} with bit 8 is set to 0 \n */
  ALPHA_DCS_UCS2_V02 = 0x02, /**<  UCS2  */
...
typedef struct {
  ...
  /**<   Alpha coding scheme. Values: \n
      - ALPHA_DCS_GSM (0x01) --  SMS default 7-bit coded alphabet as defined
                 in \hyperref[STD-23038]{3GPP TS 23.038} with bit 8 is set to 0 \n
      - ALPHA_DCS_UCS2 (0x02) --  UCS2
 */
...
typedef enum {
  ...
  VOICE_CC_SUPS_RESULT_SERVICE_TYPE_ACTIVATE_V02 = 0x01, /**<  Activate \n  */
  VOICE_CC_SUPS_RESULT_SERVICE_TYPE_DEACTIVATE_V02 = 0x02, /**<  Deactivate \n  */
  VOICE_CC_SUPS_RESULT_SERVICE_TYPE_REGISTER_V02 = 0x03, /**<  Register \n  */
  VOICE_CC_SUPS_RESULT_SERVICE_TYPE_ERASE_V02 = 0x04, /**<  Erase \n  */
  VOICE_CC_SUPS_RESULT_SERVICE_TYPE_INTERROGATE_V02 = 0x05, /**<  Interrogate \n  */
  VOICE_CC_SUPS_RESULT_SERVICE_TYPE_REGISTER_PASSWORD_V02 = 0x06, /**<  Register password \n  */
  VOICE_CC_SUPS_RESULT_SERVICE_TYPE_USSD_V02 = 0x07, /**<  USSD  */
...
typedef struct {
  ...
  /**<   Service type. Values: \n
      - VOICE_CC_SUPS_RESULT_SERVICE_TYPE_ACTIVATE (0x01) --  Activate \n
      - VOICE_CC_SUPS_RESULT_SERVICE_TYPE_DEACTIVATE (0x02) --  Deactivate \n
      - VOICE_CC_SUPS_RESULT_SERVICE_TYPE_REGISTER (0x03) --  Register \n
      - VOICE_CC_SUPS_RESULT_SERVICE_TYPE_ERASE (0x04) --  Erase \n
      - VOICE_CC_SUPS_RESULT_SERVICE_TYPE_INTERROGATE (0x05) --  Interrogate \n
      - VOICE_CC_SUPS_RESULT_SERVICE_TYPE_REGISTER_PASSWORD (0x06) --  Register password \n
      - VOICE_CC_SUPS_RESULT_SERVICE_TYPE_USSD (0x07) --  USSD
 */
...
typedef struct {
  ...
  /*  Call ID */
  uint8_t call_id;
  /**<   Call identifier of the call to query for information.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Call state. Values: \n
      ...
      - CALL_STATE_PRE_ALERTING (0x0B) --  MT call is in Pre alerting state (applicable to IMS Call Composer) \n
 */
  ...
  */
  ...
  /**<   Direction. Values: \n
      - CALL_DIRECTION_MO (0x01) --  MO call \n
      - CALL_DIRECTION_MT (0x02) --  MT call \n
 */
  ...
  /**<   Mode. Values: \n
      ...
      - CALL_MODE_C_IWLAN (0x09) --  C_IWLAN
 */
...
typedef enum {
  ...
  VOICE_PRIVACY_STANDARD_V02 = 0x00, /**<  Standard privacy \n */
  VOICE_PRIVACY_ENHANCED_V02 = 0x01, /**<  Enhanced privacy  */
...
typedef enum {
  ...
  QMI_VOICE_ALERTING_PATTERN_1_V02 = 0x00, /**<  Pattern 0 \n */
  QMI_VOICE_ALERTING_PATTERN_2_V02 = 0x01, /**<  Pattern 1 \n */
  QMI_VOICE_ALERTING_PATTERN_3_V02 = 0x02, /**<  Pattern 2 \n */
  QMI_VOICE_ALERTING_PATTERN_5_V02 = 0x04, /**<  Pattern 4 \n */
  QMI_VOICE_ALERTING_PATTERN_6_V02 = 0x05, /**<  Pattern 5 \n */
  QMI_VOICE_ALERTING_PATTERN_7_V02 = 0x06, /**<  Pattern 6 \n */
  QMI_VOICE_ALERTING_PATTERN_8_V02 = 0x07, /**<  Pattern 7 \n */
  QMI_VOICE_ALERTING_PATTERN_9_V02 = 0x08, /**<  Pattern 8  */
...
typedef struct {
  ...
  */
  ...
  /**<   Caller name; can contain up to 128 UTF-16 characters
       and is not guaranteed to be NULL-terminated.
       Range: 0 to 128.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   End reason text; can contain up to 128 UTF-16
       characters and is not guaranteed to be NULL-terminated.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Values: \n
      - VOICE_PRIVACY_STANDARD (0x00) --  Standard privacy \n
      - VOICE_PRIVACY_ENHANCED (0x01) --  Enhanced privacy
 */
  ...
  */
  ...
  /**<   Alerting pattern. Values: \n
      - QMI_VOICE_ALERTING_PATTERN_1 (0x00) --  Pattern 0 \n
      - QMI_VOICE_ALERTING_PATTERN_2 (0x01) --  Pattern 1 \n
      - QMI_VOICE_ALERTING_PATTERN_3 (0x02) --  Pattern 2 \n
      - QMI_VOICE_ALERTING_PATTERN_5 (0x04) --  Pattern 4 \n
      - QMI_VOICE_ALERTING_PATTERN_6 (0x05) --  Pattern 5 \n
      - QMI_VOICE_ALERTING_PATTERN_7 (0x06) --  Pattern 6 \n
      - QMI_VOICE_ALERTING_PATTERN_8 (0x07) --  Pattern 7 \n
      - QMI_VOICE_ALERTING_PATTERN_9 (0x08) --  Pattern 8
 */
 ...
 */
  ...
  */
  ...
  /**<   History information fields from
 ...
 */
  ...
  */
  ...
  uint8_t is_dc_call_valid;  /**< Must be set to true if is_dc_call is being passed */
  uint8_t is_dc_call;
  /**<   Flag that indicates if the current call is a data channel call. \n
       This flag is set to TRUE only for a pre-alerting MT call
       which is a DC call. \n
       TLV is absent by default.
  */

  /* Optional */
  /*  Video Online Service Support */
  uint8_t vos_support_valid;  /**< Must be set to true if vos_support is being passed */
  uint8_t vos_support;
  /**<   Indicates if the call supports video online service (VOS). \n
       This TLV is populated only if network can support VOS capability for the call. \n
       TLV is absent by default.
  */
...
typedef enum {
  ...
  QMI_VOICE_FLASH_TYPE_SIMPLE_FLASH_V02 = 0, /**<  Simple flash \n  */
  QMI_VOICE_FLASH_TYPE_ACT_ANSWER_HOLD_V02 = 1, /**<  Activate answer hold \n */
  QMI_VOICE_FLASH_TYPE_DEACT_ANSWER_HOLD_V02 = 2, /**<  Deactivate answer hold */
...
typedef struct {
  ...
  */
  ...
  /**<   Payload in ASCII to send in the flash.
  */
  ...
  /**<   Flash type. Values: \n
      - QMI_VOICE_FLASH_TYPE_SIMPLE_FLASH (0) --  Simple flash \n
      - QMI_VOICE_FLASH_TYPE_ACT_ANSWER_HOLD (1) --  Activate answer hold \n
      - QMI_VOICE_FLASH_TYPE_DEACT_ANSWER_HOLD (2) --  Deactivate answer hold
 */
...
typedef enum {
  ...
  ALS_LINE1_V02 = 0x00, /**<  Line 1 (default) \n */
  ALS_LINE2_V02 = 0x01, /**<  Line 2  */
...
typedef struct {
  ...
  */
  ...
  voice_call_attribute_type_mask_v02 audio_attrib;
  /**<   Audio capabilities of the call;
 bitmask of call attributes. Values: \n
      - VOICE_CALL_ATTRIB_TX (0x01) --  Transmission \n
      - VOICE_CALL_ATTRIB_RX (0x02) --  Receiving \n
 */
 ...
 */
  ...
  voice_call_attribute_type_mask_v02 video_attrib;
  /**<   Video capabilities of the call;
 bitmask of call attributes. Values: \n
      - VOICE_CALL_ATTRIB_TX (0x01) --  Transmission \n
      - VOICE_CALL_ATTRIB_RX (0x02) --  Receiving \n
 */
 ...
 */
  ...
  */
  ...
  /**<   ALS line indicator. Values: \n
      - ALS_LINE1 (0x00) --  Line 1 (default) \n
      - ALS_LINE2 (0x01) --  Line 2
 */
...
typedef enum {
  ...
  VOICE_CALL_MODIFIED_CAUSE_UPGRADE_DUE_TO_VIDEO_CRBT_V02 = 0x0C, /**<  Upgrade due to video CRBT on \n  */
  VOICE_CALL_MODIFIED_CAUSE_DOWNGRADE_DUE_TO_VIDEO_CRBT_V02 = 0x0D, /**<  Downgrade due to video CRBT off  */
...
/** @addtogroup voice_qmi_enums
  ...
  */
typedef enum {
  VOICE_CALL_CRS_TYPE_ENUM_MIN_ENUM_VAL_V02 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  VOICE_CALL_CRS_TYPE_NONE_V02 = 0, /**<  No customized ringing signal (CRS) \n  */
  VOICE_CALL_CRS_TYPE_AUDIO_V02 = 1, /**<  Music \n  */
  VOICE_CALL_CRS_TYPE_VOICE_V02 = 2, /**<  Voice \n  */
  VOICE_CALL_CRS_TYPE_TEXT_V02 = 3, /**<  Text \n  */
  VOICE_CALL_CRS_TYPE_VIDEO_V02 = 4, /**<  Video; includes both video and audio \n  */
  VOICE_CALL_CRS_TYPE_OTHER_V02 = 5, /**<  Other \n  */
  VOICE_CALL_CRS_TYPE_VIDEO_ONLY_V02 = 6, /**<  Video only  */
  VOICE_CALL_CRS_TYPE_ENUM_MAX_ENUM_VAL_V02 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}voice_call_crs_type_enum_v02;
/**
    @}
  */
...
/** @addtogroup voice_qmi_enums
  ...
  */
typedef enum {
  VOICE_CALL_PROG_INFO_NOTIF_TYPE_ENUM_MIN_ENUM_VAL_V02 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  VOICE_CALL_PROG_INFO_NOTIF_TYPE_CALL_REJ_Q850_V02 = 1, /**<  Call rejected with Q850 failure cause \n  */
  VOICE_CALL_PROG_INFO_NOTIF_TYPE_CALL_WAITING_V02 = 2, /**<  Call waiting \n  */
  VOICE_CALL_PROG_INFO_NOTIF_TYPE_CALL_FORWARDING_V02 = 3, /**<  Call forwarding \n  */
  VOICE_CALL_PROG_INFO_NOTIF_TYPE_REMOTE_AVAILABLE_V02 = 4, /**<  Remote available for call  */
  VOICE_CALL_PROG_INFO_NOTIF_TYPE_ENUM_MAX_ENUM_VAL_V02 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}voice_call_prog_info_notif_type_enum_v02;
/**
    @}
  */
...
/** @addtogroup voice_qmi_enums
  ...
  */
typedef enum {
  VOICE_MSIM_ADDITIONAL_CALL_INFO_ENUM_MIN_ENUM_VAL_V02 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  VOICE_MSIM_ADDL_INFO_NONE_V02 = 0, /**<  No additional information. \n
   */
  VOICE_MSIM_ADDL_INFO_CONCURRENT_CALL_NOT_POSSIBLE_V02 = 1, /**<  Call failed, but may succeed if reattempted after concurrent calls
       on the other subscription end.
   */
  VOICE_MSIM_ADDITIONAL_CALL_INFO_ENUM_MAX_ENUM_VAL_V02 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}voice_msim_additional_call_info_enum_v02;
/**
    @}
  */
...
/** @addtogroup voice_qmi_aggregates
    @{
  */
/**  Enumeration for type of Customized Ringing Signal of the call.

 Enumeration for the Call Progress Info Notification Type

 Enumeration of additional call information.
...
typedef struct {
  ...
  */
  ...
  uint32_t ip_diversion_info_len;  /**< Must be set to # of elements in ip_diversion_info */
  uint16_t ip_diversion_info[QMI_VOICE_IP_DIVERSION_INFO_MAX_LEN_V02];
  /**<   Diversion information fields from the SIP header in the order in
       which they occur in the header. Successive fields are separated by
       @latexonly\textbackslash r\textbackslash n.@endlatexonly. If a field
       does not fit into the remaining space in a buffer, neither it nor any
       subsequent field is added.
  */
}voice_ip_diversion_info_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Indicates whether the network supports the unwanted call feature. This value is obtained from the
       network. When this value is enabled, the user gets the option on the UI to reject or end the received
...
typedef struct {
  ...
  */
  ...
  /**<   Verstat information for the received call.
   */
...
typedef struct {
  ...
  */
  ...
  /**<   Subject of the call; can contain up to 64 UTF-16
       characters and is not guaranteed to be NULL-terminated.
  */
...
typedef struct {
  ...
  */
  ...
  uint32_t org_header_len;  /**< Must be set to # of elements in org_header */
  uint16_t org_header[QMI_VOICE_CALL_COMP_ORG_HDR_MAX_LEN_V02];
  /**<   Organization header of the call; can contain up to 256 UTF-16
       characters and is not guaranteed to be NULL-terminated.
  */
}voice_call_composer_org_hdr_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  uint8_t silent_ui;
  /**<   Display incoming call. Values: \n
       TRUE -- Do not display incoming call \n
       FALSE -- Display incoming call
   */
}voice_silent_ui_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  call_type_enum_v02 original_call_type;
  /**<   Type of call when dialed or received by the modem
   */
}voice_original_call_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  voice_call_crs_type_enum_v02 crs_type;
  /**<   Type of Customized Ringing Signal. Values: \n
      - VOICE_CALL_CRS_TYPE_NONE (0) --  No customized ringing signal (CRS) \n
      - VOICE_CALL_CRS_TYPE_AUDIO (1) --  Music \n
      - VOICE_CALL_CRS_TYPE_VOICE (2) --  Voice \n
      - VOICE_CALL_CRS_TYPE_TEXT (3) --  Text \n
      - VOICE_CALL_CRS_TYPE_VIDEO (4) --  Video; includes both video and audio \n
      - VOICE_CALL_CRS_TYPE_OTHER (5) --  Other \n
      - VOICE_CALL_CRS_TYPE_VIDEO_ONLY (6) --  Video only
 */
}voice_crs_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  voice_call_prog_info_notif_type_enum_v02 notif_type;
  /**<   Call progress information notification type.
   */

  uint16_t notif_reason;
  /**<   Reason for progress information notification.
  */

  char notif_text[QMI_VOICE_PROG_INFO_NOTIF_TEXT_MAX_LEN_V02];
  /**<   Detailed progress information to display to the user.\n
       The notification text is in ASCII format.
  */
}voice_prog_info_notif_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  voice_msim_additional_call_info_enum_v02 call_info;
  /**<   Additional call information.
   */
}voice_msim_additional_call_info_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  char ecnam_icon_url[QMI_VOICE_CALL_ECNAM_ICON_URL_MAX_LEN_V02 + 1];
  /**<   URL for the caller's name icon.
  */
}voice_call_ecnam_icon_url_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  char ecnam_info_url[QMI_VOICE_CALL_ECNAM_INFO_URL_MAX_LEN_V02 + 1];
  /**<   URL for the caller's name information.
  */
}voice_call_ecnam_info_url_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  char ecnam_card_url[QMI_VOICE_CALL_ECNAM_CARD_URL_MAX_LEN_V02 + 1];
  /**<   URL for the caller's name card.
  */
}voice_call_ecnam_card_url_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  uint8_t is_dc_call;
  /**<   Flag that indicates if the current pre-alerting MT call is a data channel call. \n
  */
}voice_dc_call_info_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  uint8_t vos_support;
  /**<   Flag that indicates if the current call supports video online service.
  */
}voice_vos_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<   \n Verstat information of the MT call receiving number. Based on the value of the
  ...
  */
  ...
  /**<   \n An emergency service category received from IMS when a call ends with cause code 380;
        see \hyperref[STD-24008]{3GPP TS 24.008} Table 10.5.135 for valid data. */
  ...
  /**<   \n When the network ends the MT call with SIP 607, the value of the
  ...
  /**<   \n Value of TIR mode of the MT call; can be Temporary or Permanent mode.
  */
  ...
  /* Optional */
  /*  Silent UI */
  uint8_t silent_ui_valid;  /**< Must be set to true if silent_ui is being passed */
  uint32_t silent_ui_len;  /**< Must be set to # of elements in silent_ui */
  voice_silent_ui_type_v02 silent_ui[QMI_VOICE_CALL_INFO_MAX_V02];
  /**<   \n Notifies the UI whether to display the incoming call.
        The UI should display the incoming call in the absence of this TLV.
  */

  /* Optional */
  /*  Original Call Type */
  uint8_t original_call_type_valid;  /**< Must be set to true if original_call_type is being passed */
  uint32_t original_call_type_len;  /**< Must be set to # of elements in original_call_type */
  voice_original_call_type_v02 original_call_type[QMI_VOICE_CALL_INFO_MAX_V02];
  /**<   \n Type of call when dialed or received by the modem.
        In the absence of this TLV, the AP must refer to the call_type field of the call_info TLV.
  */

  /* Optional */
  /*  Customized Ringing Signal Type */
  uint8_t crs_type_valid;  /**< Must be set to true if crs_type is being passed */
  uint32_t crs_type_len;  /**< Must be set to # of elements in crs_type */
  voice_crs_type_v02 crs_type[QMI_VOICE_CALL_INFO_MAX_V02];
  /**<   \n Absence of this TLV signifies: \n
         - No CRS information received from the network \n
         - CRS information could not be retrieved due to network failure
           (bearer activation failure, bearer activation time out, and so on.)
  */

  /* Optional */
  /*  Progress Info Notification */
  uint8_t prog_info_notif_valid;  /**< Must be set to true if prog_info_notif is being passed */
  uint32_t prog_info_notif_len;  /**< Must be set to # of elements in prog_info_notif */
  voice_prog_info_notif_type_v02 prog_info_notif[QMI_VOICE_CALL_INFO_MAX_V02];
  /**<   \n Call progress information notification. \n
           Absence of this TLV means there is no progress information for the call.
  */

  /* Optional */
  /*  IP Diversion Information */
  uint8_t ip_diversion_info_valid;  /**< Must be set to true if ip_diversion_info is being passed */
  uint32_t ip_diversion_info_len;  /**< Must be set to # of elements in ip_diversion_info */
  voice_ip_diversion_info_type_v02 ip_diversion_info[QMI_VOICE_IP_DIVERSION_INFO_ARRAY_MAX_V02];

  /* Optional */
  /*  MSIM Additional Call Information */
  uint8_t msim_additional_call_info_valid;  /**< Must be set to true if msim_additional_call_info is being passed */
  uint32_t msim_additional_call_info_len;  /**< Must be set to # of elements in msim_additional_call_info */
  voice_msim_additional_call_info_type_v02 msim_additional_call_info[QMI_VOICE_CALL_INFO_MAX_V02];

  /* Optional */
  /*  Enhanced Calling Name Icon URL  */
  uint8_t call_ecnam_icon_url_valid;  /**< Must be set to true if call_ecnam_icon_url is being passed */
  uint32_t call_ecnam_icon_url_len;  /**< Must be set to # of elements in call_ecnam_icon_url */
  voice_call_ecnam_icon_url_type_v02 call_ecnam_icon_url[QMI_VOICE_CALL_ECNAM_ARRAY_MAX_V02];

  /* Optional */
  /*  Enhanced Calling Name Info URL  */
  uint8_t call_ecnam_info_url_valid;  /**< Must be set to true if call_ecnam_info_url is being passed */
  uint32_t call_ecnam_info_url_len;  /**< Must be set to # of elements in call_ecnam_info_url */
  voice_call_ecnam_info_url_type_v02 call_ecnam_info_url[QMI_VOICE_CALL_ECNAM_ARRAY_MAX_V02];

  /* Optional */
  /*  Enhanced Calling Name Card URL  */
  uint8_t call_ecnam_card_url_valid;  /**< Must be set to true if call_ecnam_card_url is being passed */
  uint32_t call_ecnam_card_url_len;  /**< Must be set to # of elements in call_ecnam_card_url */
  voice_call_ecnam_card_url_type_v02 call_ecnam_card_url[QMI_VOICE_CALL_ECNAM_ARRAY_MAX_V02];

  /* Optional */
  /*  Call Composer Organization Header  */
  uint8_t call_composer_organization_header_valid;  /**< Must be set to true if call_composer_organization_header is being passed */
  uint32_t call_composer_organization_header_len;  /**< Must be set to # of elements in call_composer_organization_header */
  voice_call_composer_org_hdr_type_v02 call_composer_organization_header[QMI_VOICE_CALL_COMPOSER_ARRAY_MAX_V02];

  /* Optional */
  /*  Data Channel Call Info */
  uint8_t dc_call_info_valid;  /**< Must be set to true if dc_call_info is being passed */
  uint32_t dc_call_info_len;  /**< Must be set to # of elements in dc_call_info */
  voice_dc_call_info_type_v02 dc_call_info[QMI_VOICE_CALL_INFO_MAX_V02];
  /**<   Indicates if the call is a data channel call; associated with a call ID.
       This TLV is only populated only if a pre-alerting MT call is a DC call. \n
       TLV is absent by default.
  */
  ...
  /*  Video Online Service Support */
  uint8_t vos_support_valid;  /**< Must be set to true if vos_support is being passed */
  uint32_t vos_support_len;  /**< Must be set to # of elements in vos_support */
  voice_vos_type_v02 vos_support[QMI_VOICE_CALL_INFO_MAX_V02];
  /**<   Indicates if the call supports VOS; associated with a call ID.
       This TLV is populated only if network can support VOS capability for the call. \n
       TLV is absent by default.
  */
...
typedef enum {
  ...
  QMI_FAILURE_CAUSE_SERVICE_NOT_REGISTERED_V02 = 0x190,
...
typedef enum {
  ...
  ECT_CALL_STATE_NONE_V02 = 0x00, /**<  None. \n */
  ECT_CALL_STATE_ALERTING_V02 = 0x01, /**<  Altering \n */
  ECT_CALL_STATE_ACTIVE_V02 = 0x02, /**<  Active  */
...
typedef struct {
  ...
  /**<   ECT call state. Values: \n
      - ECT_CALL_STATE_NONE (0x00) --  None. \n
      - ECT_CALL_STATE_ALERTING (0x01) --  Altering \n
      - ECT_CALL_STATE_ACTIVE (0x02) --  Active
 */
 ...
 */
  ...
  /**<   IP forward history information; can contain up to 512 UTF-16
       characters and is not guaranteed to be NULL-terminated.
  */
...
typedef enum {
  ...
  VOICE_REASON_FWD_NOT_LOGGED_IN_V02 = 0x17, /**<  Incoming call forwarded when the subscriber is not registered  */
 ...
 */
  ...
  /**<   Reason. Values: \n
      ...
      - VOICE_REASON_FWD_NOT_LOGGED_IN (0x17) --  Incoming call forwarded when the subscriber is not registered
 */
...
typedef enum {
  ...
  PROVISION_STATUS_NOT_PROVISIONED_V02 = 0x00, /**<  Not provisioned \n */
  PROVISION_STATUS_PROVISIONED_PERMANENT_V02 = 0x01, /**<  Provisioned \n  */
  PROVISION_STATUS_PRESENTATION_RESTRICTED_V02 = 0x02, /**<  Presentation restricted \n */
  PROVISION_STATUS_PRESENTATION_ALLOWED_V02 = 0x03, /**<  Presentation allowed  */
 ...
 */
  ...
  /**<   Provisioned status. Values: \n
      - PROVISION_STATUS_NOT_PROVISIONED (0x00) --  Not provisioned \n
      - PROVISION_STATUS_PROVISIONED_PERMANENT (0x01) --  Provisioned \n
...
typedef struct {
  ...
  */
  ...
  /**<   Call forwarding number to register with the network; ASII string.*/
  ...
  */
  ...
  /**<   \n
       List of call barring numbers to activate/deactivate
       or register with/erase from the network.
  */
 ...
 */
  ...
  */
  ...
  /**<   Failure cause description received from the network; can contain
       up to 256 UTF-16 characters and is not guaranteed to be NULL-terminated.
       Range: 0 to 256.
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Additional Supplementary Service Request Expected */
  uint8_t additional_ss_expected_valid;  /**< Must be set to true if additional_ss_expected is being passed */
  uint8_t additional_ss_expected;
  /**<   Indicates whether more back-to-back supplementary service requests are expected or not.
  */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  Call Barring Password Required */
  uint8_t is_cb_password_required_valid;  /**< Must be set to true if is_cb_password_required is being passed */
  uint8_t is_cb_password_required;
  /**<   Flag that indicates that a password is required for call barring.
  */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  CLIP Domain Route */
  uint8_t clip_domain_route_valid;  /**< Must be set to true if clip_domain_route is being passed */
  sups_domain_enum_v02 clip_domain_route;
  /**<   Domain route from which the CLIP Response is received. Values: \n
      - SUPS_DOMAIN_CS (0x02) --  SUPS_DOMAIN_CS \n
      - SUPS_DOMAIN_PS (0x03) --  SUPS_DOMAIN_PS
 */
 ...
 */
  ...
  /**<   Provisioned status. Values: \n
      - PROVISION_STATUS_NOT_PROVISIONED (0x00) --  Not provisioned \n
      - PROVISION_STATUS_PROVISIONED_PERMANENT (0x01) --  Provisioned \n
      - PROVISION_STATUS_PRESENTATION_RESTRICTED (0x02) --  Presentation restricted \n
      - PROVISION_STATUS_PRESENTATION_ALLOWED (0x03) --  Presentation allowed
 */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Gets the current supplementary service operation mode. */
typedef struct {
  ...
  /**<   Reason. Values: \n
      ...
      - VOICE_REASON_FWD_NOT_LOGGED_IN (0x17) --  Incoming call forwarded when the subscriber is not registered
 */
}voice_get_sups_operation_mode_req_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_enums
  ...
  */
typedef enum {
  SUPS_OPERATION_MODE_ENUM_MIN_ENUM_VAL_V02 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  UE_BASED_SUPS_V02 = 0x01, /**<  UE-based supplementary service \n  */
  NETWORK_BASED_SUPS_V02 = 0x02, /**<  Network-based supplementary service  */
  SUPS_OPERATION_MODE_ENUM_MAX_ENUM_VAL_V02 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}sups_operation_mode_enum_v02;
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Gets the current supplementary service operation mode. */
typedef struct {
  ...
  /* Optional */
  /*  Supplementary Service Operation Mode */
  uint8_t sups_operation_mode_valid;  /**< Must be set to true if sups_operation_mode is being passed */
  sups_operation_mode_enum_v02 sups_operation_mode;
  /**<   Current operation mode of supplementary service. Values: \n
      - UE_BASED_SUPS (0x01) --  UE-based supplementary service \n
      - NETWORK_BASED_SUPS (0x02) --  Network-based supplementary service  */
}voice_get_sups_operation_mode_resp_msg_v02;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Reason. Values: \n
       ...
       - 0x17 -- QMI_VOICE_REASON_FWD_NOT_LOGGED_IN --
	             Forward when the subscriber is not registered
  */
...
typedef enum {
  ...
  SERVICE_STATUS_INACTIVE_V02 = 0x00, /**<  Inactive \n  */
  SERVICE_STATUS_ACTIVE_V02 = 0x01, /**<  Active  */
...
typedef struct {
  ...
  /**<   Service status. Values: \n
      - SERVICE_STATUS_INACTIVE (0x00) --  Inactive \n
      - SERVICE_STATUS_ACTIVE (0x01) --  Active
 */
...
typedef struct {
  ...
  */
  ...
  uint8_t is_secondary_valid;  /**< Must be set to true if is_secondary is being passed */
  uint8_t is_secondary;
  /**<   Indicates whether the USSD originates on a secondary line. \n
       Set to FALSE by default.
  */

  /* Optional */
  /*  USSD Domain Preference */
  ...
  /**<   Domain preference over which the USSD is to originate. Values: \n
      - SUPS_DOMAIN_AUTOMATIC (0x01) --  SUPS_DOMAIN_AUTOMATIC \n
      - SUPS_DOMAIN_CS (0x02) --  SUPS_DOMAIN_CS \n
 */
 ...
 */
  ...
  */
  ...
  /**<   USSD error cause description received from the network;
       contains up to 256 UTF-16 characters and is not guaranteed to be
  ...
  */
  ...
  /**<   Domain route to which the USSD is sent. Values: \n
      - SUPS_DOMAIN_CS (0x02) --  SUPS_DOMAIN_CS \n
      - SUPS_DOMAIN_PS (0x03) --  SUPS_DOMAIN_PS
 */
...
typedef enum {
  ...
  FURTHER_USER_ACTION_NOT_REQUIRED_V02 = 0x01, /**<  No further action is required \n  */
  FURTHER_USER_ACTION_REQUIRED_V02 = 0x02, /**<  Further action is required  */
...
typedef struct {
  ...
  /**<   Notification type. Values: \n
      - FURTHER_USER_ACTION_NOT_REQUIRED (0x01) --  No further action is required \n
      - FURTHER_USER_ACTION_REQUIRED (0x02) --  Further action is required
 */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Indication Message; Notifies clients about the current CLIR mode. */
typedef struct {

  /* Optional */
  /*  CLIR Mode */
  uint8_t is_ue_based_clir_valid;  /**< Must be set to true if is_ue_based_clir is being passed */
  uint8_t is_ue_based_clir;
  /**<   Values: \n
       - 0x00 -- Network-based CLIR \n
       - 0x01 -- UE-based CLIR*/
}voice_notify_clir_mode_ind_msg_v02;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t nam_id;
  /**<   Index of the NAM (CDMA subscription) to configure.
       Range: 0 to 3. Some modems support only 1 or 2 NAMs.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Home page voice SO; most preferred CDMA SO to request from the
 ...
 */
  ...
  /**<   Home origination voice SO; most preferred CDMA SO to request
 ...
 */
  ...
  /**<   Roaming origination voice SO; most preferred CDMA SO to request
...
typedef enum {
  ...
  VOICE_DOMAIN_PREF_CS_ONLY_V02 = 0x00, /**<  Circuit-switched (CS) only \n  */
  VOICE_DOMAIN_PREF_PS_ONLY_V02 = 0x01, /**<  Packet-switched (PS) only \n  */
  VOICE_DOMAIN_PREF_CS_PREF_V02 = 0x02, /**<  CS is preferred; PS is secondary \n */
  VOICE_DOMAIN_PREF_PS_PREF_V02 = 0x03, /**<  PS is preferred; CS is secondary  */
 ...
 */
  ...
  /**<   Values: \n
      - VOICE_DOMAIN_PREF_CS_ONLY (0x00) --  Circuit-switched (CS) only \n
      - VOICE_DOMAIN_PREF_PS_ONLY (0x01) --  Packet-switched (PS) only \n
      - VOICE_DOMAIN_PREF_CS_PREF (0x02) --  CS is preferred; PS is secondary \n
      - VOICE_DOMAIN_PREF_PS_PREF (0x03) --  PS is preferred; CS is secondary
 */
...
typedef struct {
  ...
  */
  ...
  uint8_t nam_id;
  /**<   Index of the NAM (CDMA subscription) to configur.
       Range: 0 to 3. Some modems support only 1 or 2 NAMs.
   */
...
typedef struct {
  ...
  /**<   Value returned is read from NV_AUTO_ANSWER_I. Values: \n
       - 0x00 -- Disabled \n
       - 0x01 -- Enabled
  */
  ...
  /**<   Value returned is read from NV_TTY_I. Values: \n
      - TTY_MODE_FULL (0x00) --  Full \n
      - TTY_MODE_VCO (0x01) --  Voice carry over \n
      - TTY_MODE_HCO (0x02) --  Hearing carry over \n
      - TTY_MODE_OFF (0x03) --  Off
 */
  ...
  /**<   \n EVRC capability and preferred service options; value returned is read from NV_PREF_VOICE_SO_I. */

  /* Optional */
  /*  Current AMR Configuration  */
  ...
  /**<   \n Values returned are read from NV_GSM_ARM_CALL_CONFIG_I and NV_UMTS_AMR_CODEC_ PREFERENCE_CONFIG_I. */
  ...
  /**<   Value returned is read from NV_VOICE_PRIV_I. Values: \n
      - VOICE_PRIVACY_STANDARD (0x00) --  Standard privacy \n
      - VOICE_PRIVACY_ENHANCED (0x01) --  Enhanced privacy
 */
...
typedef enum {
  ...
  SERVICE_TYPE_ACTIVATE_V02 = 0x01, /**<  Activate \n  */
  SERVICE_TYPE_DEACTIVATE_V02 = 0x02, /**<  Deactivate \n  */
  SERVICE_TYPE_REGISTER_V02 = 0x03, /**<  Register \n  */
  SERVICE_TYPE_ERASE_V02 = 0x04, /**<  Erase \n  */
  SERVICE_TYPE_INTERROGATE_V02 = 0x05, /**<  Interrogate \n  */
  SERVICE_TYPE_REGISTER_PASSWORD_V02 = 0x06, /**<  Register password \n  */
  SERVICE_TYPE_USSD_V02 = 0x07, /**<  USSD  */
...
typedef struct {
  ...
  /**<   Service type. Values: \n
      - SERVICE_TYPE_ACTIVATE (0x01) --  Activate \n
      - SERVICE_TYPE_DEACTIVATE (0x02) --  Deactivate \n
      - SERVICE_TYPE_REGISTER (0x03) --  Register \n
      - SERVICE_TYPE_ERASE (0x04) --  Erase \n
      - SERVICE_TYPE_INTERROGATE (0x05) --  Interrogate \n
      - SERVICE_TYPE_REGISTER_PASSWORD (0x06) --  Register password \n
      - SERVICE_TYPE_USSD (0x07) --  USSD
 */
 ...
 */
  ...
  uint8_t number_valid;  /**< Must be set to true if number is being passed */
  char number[QMI_VOICE_NUMBER_MAX_V02 + 1];
  /**<   Call forwarding number to register with the network; ASCII string.*/
  ...
  */
  ...
  uint8_t call_id_valid;  /**< Must be set to true if call_id is being passed */
  uint8_t call_id;
  /**<   Call identifier of the voice call that is modified to a
  ...
  */
  ...
  char password[4];
  /**<   Password is required if call barring is provisioned using a password.
       Password consists of four ASCII digits. Range: 0000 to 9999. This also
  ...
  */
  ...
  /**<   Distinguishes between the supplementary service data sent to the
       ...
       this TLV, assume that the supplementary service data in this indication
       is a request sent to the network.
  */
...
typedef struct {
  ...
  uint8_t ussd_domain_pref_valid;  /**< Must be set to true if ussd_domain_pref is being passed */
  sups_domain_enum_v02 ussd_domain_pref;
  /**<   Domain preference over which the USSD originates. Values: \n
      - SUPS_DOMAIN_AUTOMATIC (0x01) --  SUPS_DOMAIN_AUTOMATIC \n
      - SUPS_DOMAIN_CS (0x02) --  SUPS_DOMAIN_CS \n
 */
...
typedef struct {
  ...
  */
  ...
  uint8_t ussd_domain_route_valid;  /**< Must be set to true if ussd_domain_route is being passed */
  sups_domain_enum_v02 ussd_domain_route;
  /**<   Domain to route which the USSD is sent. Values: \n
      - SUPS_DOMAIN_CS (0x02) --  SUPS_DOMAIN_CS \n
      - SUPS_DOMAIN_PS (0x03) --  SUPS_DOMAIN_PS
 */
...
typedef enum {
  ...
  VOICE_SUBS_TYPE_PRIMARY_V02 = 0x00, /**<  Primary \n  */
  VOICE_SUBS_TYPE_SECONDARY_V02 = 0x01, /**<  Secondary \n  */
  VOICE_SUBS_TYPE_TERTIARY_V02 = 0x02, /**<  Tertiary  */
...
typedef struct {
  ...
  /**<   Values: \n
      - VOICE_SUBS_TYPE_PRIMARY (0x00) --  Primary \n
      - VOICE_SUBS_TYPE_SECONDARY (0x01) --  Secondary \n
      - VOICE_SUBS_TYPE_TERTIARY (0x02) --  Tertiary
 */
...
typedef enum {
  ...
  VOICE_LINE_SWITCHING_NOT_ALLOWED_V02 = 0x00, /**<  Line switching is not allowed \n */
  VOICE_LINE_SWITCHING_ALLOWED_V02 = 0x01, /**<  Line switching is allowed  */
...
typedef struct {
  ...
  /**<   Values: \n
      - VOICE_LINE_SWITCHING_NOT_ALLOWED (0x00) --  Line switching is not allowed \n
      - VOICE_LINE_SWITCHING_ALLOWED (0x01) --  Line switching is allowed
 */
...
typedef struct {
  ...
  uint16_t info_mask;
  /**<   Bitmask of the following items to fetch. Values: \n
...
typedef enum {
  ...
  VOIP_SUPS_TYPE_EXPLICIT_CALL_TRANSFER_IUT_V02 = 0x10, /**<  Transfer the call to a new UE for IUT  */
...
typedef struct {
  ...
  /**<   URI name consisting of up to 128 UTF-16 characters;
...
typedef struct {
  ...
  /**<   Supplementary service type during the call. Values: \n
      ...
      - VOIP_SUPS_TYPE_EXPLICIT_CALL_TRANSFER_IUT (0x10) --  Transfer the call to a new UE for IUT
 */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  Speech Codec Type (Deprecated: Use the Speech Codec Mask Type TLV instead) */
 ...
 */
  ...
  /**<   ECT consultative call ID; used only for a consultative transfer.
  */
 ...
 */
  ...
  /* Optional */
  /*  Session Transfer Number for IUT Call Push Request (Deprecated; use the IUT Call Push Session Transfer Number TLV for IUT call push STN) */
  uint8_t iut_stn_valid;  /**< Must be set to true if iut_stn is being passed */
  uint32_t iut_stn_len;  /**< Must be set to # of elements in iut_stn */
  uint8_t iut_stn[QMI_VOICE_IUT_STN_MAX_LEN_V02];
  /**<   Session transfer number for IUT call push.
  */

  /* Optional */
  /*  IUT Call Push Session Transfer Number */
  uint8_t iut_stn_number_valid;  /**< Must be set to true if iut_stn_number is being passed */
  char iut_stn_number[QMI_VOICE_IUT_STN_MAX_LEN_V02 + 1];
  /**<   Session transfer number in ASCII format for and IUT call push.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Call modified cause. Values: \n
      ...
      - VOICE_CALL_MODIFIED_CAUSE_UPGRADE_DUE_TO_VIDEO_CRBT (0x0C) --  Upgrade due to video CRBT on \n
      - VOICE_CALL_MODIFIED_CAUSE_DOWNGRADE_DUE_TO_VIDEO_CRBT (0x0D) --  Downgrade due to video CRBT off
 */
...
typedef enum {
  ...
  VOICE_NETWORK_MODE_C_IWLAN_V02 = 0x08, /**<  C_IWLAN   */
...
/** @addtogroup voice_qmi_enums
  ...
  */
typedef enum {
  VOICE_AUDIO_QUALITY_ENUM_MIN_ENUM_VAL_V02 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  VOICE_AUDIO_QUALITY_NO_HD_V02 = 0x01, /**<  No HD \n  */
  VOICE_AUDIO_QUALITY_HD_V02 = 0x02, /**<  HD \n  */
  VOICE_AUDIO_QUALITY_HD_PLUS_V02 = 0x03, /**<  HD+  */
  VOICE_AUDIO_QUALITY_ENUM_MAX_ENUM_VAL_V02 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}voice_audio_quality_enum_v02;
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Network mode. Values: \n
      ...
      - VOICE_NETWORK_MODE_C_IWLAN (0x08) --  C_IWLAN
 */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  Audio Quality  */
  uint8_t audio_quality_valid;  /**< Must be set to true if audio_quality is being passed */
  voice_audio_quality_enum_v02 audio_quality;
  /**<   Audio quality of VOLTE/VONR/VOWIFI call. Values: \n
      - VOICE_AUDIO_QUALITY_NO_HD (0x01) --  No HD \n
      - VOICE_AUDIO_QUALITY_HD (0x02) --  HD \n
      - VOICE_AUDIO_QUALITY_HD_PLUS (0x03) --  HD+
 */
...
typedef struct {
  ...
  */
  ...
  uint32_t total_size;
  /**<   Total size of the document being passed; included in the
       first indication of an update, for example, the indication with sequence
...
typedef struct {
  ...
  /**<   URI of the participant. The URI is unique to each user
 ...
 */
  ...
  /**<   Disconnection information; an ASCII string that is not guaranteed
 ...
 */
  ...
  /**<   Array of call information of conference participants.
    */
...
typedef struct {
  ...
  /*  Call ID */
  uint8_t call_id;
  /**<   Unique call identifier of the call for which videosharing is
       answered (accepted).
  */
...
typedef struct {
  ...
  */
  ...
  uint32_t total_size;
  /**<   Total size of the update to pass. The client has received the
...
typedef enum {
  ...
  VOICE_ECALL_MSD_TX_USER_DEFINED_3_V02 = 0x09, /**<  Customer defined MSD Tx status \n  */
...
typedef struct {
  ...
  */
  ...
  /**<   Minimum set of data transmission status. Values: \n
      ...
      - VOICE_ECALL_MSD_TX_USER_DEFINED_3 (0x09) --  Customer defined MSD Tx status \n
...
typedef enum {
  ...
  VOICE_ECALL_TIMER_STATUS_INACTIVE_V02 = 0x00, /**<  Inactive \n  */
  VOICE_ECALL_TIMER_STATUS_ACTIVE_V02 = 0x01, /**<  Active \n  */
  VOICE_ECALL_TIMER_STATUS_STARTED_V02 = 0x02, /**<  Started \n  */
  VOICE_ECALL_TIMER_STATUS_STOPPED_V02 = 0x03, /**<  Stopped \n  */
  VOICE_ECALL_TIMER_STATUS_EXPIRED_V02 = 0x04, /**<  Expired \n */
  VOICE_ECALL_TIMER_STATUS_RESUMED_V02 = 0x05, /**<  Resumed  */
...
typedef struct {
  ...
  /**<   eCall HLAP t2 timer status. Values: \n
      - VOICE_ECALL_TIMER_STATUS_INACTIVE (0x00) --  Inactive \n
      - VOICE_ECALL_TIMER_STATUS_ACTIVE (0x01) --  Active \n
      - VOICE_ECALL_TIMER_STATUS_STARTED (0x02) --  Started \n
      - VOICE_ECALL_TIMER_STATUS_STOPPED (0x03) --  Stopped \n
      - VOICE_ECALL_TIMER_STATUS_EXPIRED (0x04) --  Expired \n
      - VOICE_ECALL_TIMER_STATUS_RESUMED (0x05) --  Resumed
 */
 ...
 */
  ...
  /* Optional */
  /*  eCall t10 Timer Status */
  uint8_t t10_timer_status_valid;  /**< Must be set to true if t10_timer_status is being passed */
  ecall_hlap_timer_status_enum_v02 t10_timer_status;
  /**<   eCall HLAP t10 timer status. Values: \n
      - VOICE_ECALL_TIMER_STATUS_INACTIVE (0x00) --  Inactive \n
      - VOICE_ECALL_TIMER_STATUS_ACTIVE (0x01) --  Active \n
      - VOICE_ECALL_TIMER_STATUS_STARTED (0x02) --  Started \n
      - VOICE_ECALL_TIMER_STATUS_STOPPED (0x03) --  Stopped \n
...
typedef struct {
  ...
  uint8_t is_era_glonass_enabled;
  /**<   Check whether eCall ERA-GLONASS is enabled. Values: \n
        - 0x00 -- FALSE \n
        - 0x01 -- TRUE
  */
...
typedef struct {
  ...
  /**<   Status of the call reestablishment. Values: \n
 ...
 */
  ...
  uint32_t call_composer_subject_len;  /**< Must be set to # of elements in call_composer_subject */
  uint16_t call_composer_subject[QMI_VOICE_CALL_COMP_SUBJECT_MAX_LEN_V02];
  /**<   Subject of the call; can contain up to 64 UTF-16 characters and is not guaranteed
  ...
  */
  ...
  /*  Enhanced Calling Name Icon URL  */
  uint8_t call_ecnam_icon_url_valid;  /**< Must be set to true if call_ecnam_icon_url is being passed */
  char call_ecnam_icon_url[QMI_VOICE_CALL_ECNAM_ICON_URL_MAX_LEN_V02 + 1];
  /**<   URL for the enhanced calling name icon.
  */

  /* Optional */
  /*  Enhanced Calling Name Info URL  */
  uint8_t call_ecnam_info_url_valid;  /**< Must be set to true if call_ecnam_info_url is being passed */
  char call_ecnam_info_url[QMI_VOICE_CALL_ECNAM_INFO_URL_MAX_LEN_V02 + 1];
  /**<   URL for the enhanced calling name information.
  */

  /* Optional */
  /*  Enhanced Calling Name Card URL  */
  uint8_t call_ecnam_card_url_valid;  /**< Must be set to true if call_ecnam_card_url is being passed */
  char call_ecnam_card_url[QMI_VOICE_CALL_ECNAM_CARD_URL_MAX_LEN_V02 + 1];
  /**<   URL for the enhanced calling name card.
  */
  ...
  */
  ...
  uint8_t call_composer_organization_header_valid;  /**< Must be set to true if call_composer_organization_header is being passed */
  uint32_t call_composer_organization_header_len;  /**< Must be set to # of elements in call_composer_organization_header */
  uint16_t call_composer_organization_header[QMI_VOICE_CALL_COMP_ORG_HDR_MAX_LEN_V02];
  /**<   Organization Header of the call; can contain up to 256 UTF-16 characters and is not guaranteed
       to be NULL-terminated.
  */
 ...
 */
  ...
  /**<   Service class; see Table
       ...
       information. If this TLV is not present, voice service is one
       of the following: \n
       - ACTIVATE -- Activation request applies to all subscribed
          basic service groups against which all call forward operation is
          registered. \n
        ...
        - DEACTIVATE -- Deactivation request applies to all basic
           services for which all call forward operations are active. */

  /* Optional */
  /*  Call Forwarding No Reply Timer */
  uint8_t timer_value_valid;  /**< Must be set to true if timer_value is being passed */
  uint32_t timer_value;
  /**<   Timer value in seconds. If this TLV is not present, the previous
  ...
  /**<   \n If this TLV is not present, the modem derives the number type
        and plan from the Call Forwarding Number TLV.
   */
  ...
  uint8_t call_fwd_start_time_valid;  /**< Must be set to true if call_fwd_start_time is being passed */
  voice_time_type_v02 call_fwd_start_time;
  /**<   \n If this TLV is not present, the UE uses the fwd_start and fwd_end
       timers received from the NW during bootup.
   */
  ...
  uint8_t reason_valid;  /**< Must be set to true if reason is being passed */
  voice_reason_enum_v02 reason;
  /**<   If this TLV is not present, the SUPS operation is executed for the
 voice reason. Value: \n
      - VOICE_REASON_FWD_UNCONDITIONAL (0x01) --  Unconditional call forwarding \n
      - VOICE_REASON_FWD_MOBILEBUSY (0x02) --  Forward when the mobile is busy \n
      - VOICE_REASON_FWD_NOREPLY (0x03) --  Forward when there is no reply \n
...
typedef struct {
  ...
  */
  ...
  /**<   Failure cause description received from the network; contains
  ...
  */
  ...
  /**<   Indicates success or failure of the call forward unconditional operation.
       If all sub operations (CFB, CFU, CFNRY, CFNRC) of all call forwards
       are success, this TLV is not present and only the Response TLV is
       present. \n
       - qmi_result_type -- QMI_RESULT_SUCCESS or QMI_RESULT_FAILURE  */
  ...
  */
  ...
  /**<   Indicates succes or failure of the call forward busy operation. If all
       sub operations (CFB, CFU, CFNRY, CFNRC) of all call forwards
       are success, this TLV is not present and only the Response TLV
       is present. \n
       - qmi_result_type -- QMI_RESULT_SUCCESS or QMI_RESULT_FAILURE
    */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Indication Message; Indicates that the Inter-UE transfer call push is delayed. */
typedef struct {

  /* Mandatory */
  /*  Call ID */
  uint8_t call_id;
  /**<   Unique call identifier for which the IUT call push is delayed.
  */
}voice_iut_call_push_delay_ind_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Indication Message; Informs clients about the emergency URN information. */
typedef struct {

  /* Optional */
  /*  Calling Number or SIP URI */
  uint8_t num_valid;  /**< Must be set to true if num is being passed */
  voice_num_with_id_type_v02 num;
  /**<   \n (Call ID and number information.)
  */
  ...
  /**<   SIP URN number.
  */
}voice_network_detected_ecc_number_ind_msg_v02;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  char dtmf_string[QMI_VOICE_SIP_DTMF_STRING_MAX_LEN_V02 + 1];
  /**<   DTMF string
  */
}voice_sip_dtmf_info_type_v02;  /* Type */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Sends a SIP DTMF string from the user. */
typedef struct {

  /* Mandatory */
  /*  DTMF Information */
  voice_sip_dtmf_info_type_v02 dtmf_info;
  /**<   \n SIP DTMF information.
  */
}voice_sip_dtmf_req_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Sends a SIP DTMF string from the user. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}voice_sip_dtmf_resp_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Indication Message; Informs the control point about the SIP DTMF information from the
             network. */
typedef struct {

  /* Optional */
  /*  DTMF Information */
  uint8_t dtmf_info_valid;  /**< Must be set to true if dtmf_info is being passed */
  voice_sip_dtmf_info_type_v02 dtmf_info;
  /**<   \n SIP DTMF information.
  */
}voice_sip_dtmf_ind_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Requests that the modem release the audio codec. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}voice_release_audio_req_msg_v02;
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Requests that the modem release the audio codec. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}voice_release_audio_resp_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_enums
  ...
  */
typedef enum {
  ECALL_DIAL_NUM_ENUM_MIN_ENUM_VAL_V02 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  VOICE_ECALL_DIAL_NUM_ECALL_NORMAL_V02 = 0x00, /**<  eCall dial number normal  \n  */
  VOICE_ECALL_DIAL_NUM_ECALL_OVERRIDE_V02 = 0x01, /**<  eCall dial number override  */
  ECALL_DIAL_NUM_ENUM_MAX_ENUM_VAL_V02 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}ecall_dial_num_enum_v02;
/**
    @}
  */
...
/** @addtogroup voice_qmi_enums
  ...
  */
typedef enum {
  MMGSDI_SLOT_ID_ENUM_MIN_ENUM_VAL_V02 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  VOICE_MMGSDI_SLOT_ID_1_V02 = 0x00000001, /**<   MMGSDI slot ID 1 \n  */
  VOICE_MMGSDI_SLOT_ID_2_V02 = 0x00000002, /**<   MMGSDI slot ID 2 \n */
  VOICE_MMGSDI_SLOT_ID_3_V02 = 0x00000003, /**<   MMGSDI slot ID 3   */
  MMGSDI_SLOT_ID_ENUM_MAX_ENUM_VAL_V02 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}mmgsdi_slot_id_enum_v02;
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Sets the eCall configuration. */
typedef struct {

  /* Optional */
  /*  New eCall EFS Vocoder Configuration */
  uint8_t voc_config_valid;  /**< Must be set to true if voc_config is being passed */
  uint8_t voc_config;
  /**<   Indicates whether vocoder Rx muting is required. Values: \n
 - 0 -- Vocoder Rx muting not required \n
 - 1 -- Vocoder Rx muting required
  */

  /* Optional */
  /*  New eCall Dial Number */
  uint8_t ecall_dial_num_valid;  /**< Must be set to true if ecall_dial_num is being passed */
  ecall_dial_num_enum_v02 ecall_dial_num;
  /**<   Indicates whether to update the dial number as normal or override.
 Values: \n
      - VOICE_ECALL_DIAL_NUM_ECALL_NORMAL (0x00) --  eCall dial number normal  \n
      - VOICE_ECALL_DIAL_NUM_ECALL_OVERRIDE (0x01) --  eCall dial number override
 */

  /* Optional */
  /*  Canned MSD */
  uint8_t canned_msd_valid;  /**< Must be set to true if canned_msd is being passed */
  uint8_t canned_msd;
  /**<   Indicates whether MSD is canned or real.
       Values: \n
       - 0 -- Real MSD \n
       - 1 -- Canned MSD
  */
  ...
  /* Optional */
  /*  New eCall EFS Digits */
  uint8_t digits_valid;  /**< Must be set to true if digits is being passed */
  uint32_t digits_len;  /**< Must be set to # of elements in digits */
  char digits[QMI_VOICE_ECALL_EFS_CONFIG_DIGITS_MAX_LEN_V02];
  /**<   Indicates an update to the dial number when ecall_dial_num type is override.
  */

  /* Optional */
  /*  New eCall EFS GNSS Update Time */
  uint8_t gnss_update_time_ms_valid;  /**< Must be set to true if gnss_update_time_ms is being passed */
  uint32_t gnss_update_time_ms;
  /**<   Update the timer to get GPS after a definite time interval.
  */

  /* Optional */
  /*  Callback Timer */
  uint8_t test_only_callback_timer_ms_valid;  /**< Must be set to true if test_only_callback_timer_ms is being passed */
  uint32_t test_only_callback_timer_ms;
  /**<   Update the callback timer (T9 timer).
  */

  /* Optional */
  /*  Call Cleardown Timer */
  uint8_t test_only_call_cleardown_timer_ms_valid;  /**< Must be set to true if test_only_call_cleardown_timer_ms is being passed */
  uint32_t test_only_call_cleardown_timer_ms;
  /**<   Update the call cleardown timer (T2 timer).
  */

  /* Optional */
  /*  Session Timer */
  uint8_t test_only_session_timer_ms_valid;  /**< Must be set to true if test_only_session_timer_ms is being passed */
  uint32_t test_only_session_timer_ms;
  /**<   Update the session timer (T7 timer).
  */

  /* Optional */
  /*  USIM Slot ID */
  uint8_t ecall_usim_slot_id_valid;  /**< Must be set to true if ecall_usim_slot_id is being passed */
  mmgsdi_slot_id_enum_v02 ecall_usim_slot_id;
  /**<   Update slot ID. Values: \n
      - VOICE_MMGSDI_SLOT_ID_1 (0x00000001) --   MMGSDI slot ID 1 \n
      - VOICE_MMGSDI_SLOT_ID_2 (0x00000002) --   MMGSDI slot ID 2 \n
      - VOICE_MMGSDI_SLOT_ID_3 (0x00000003) --   MMGSDI slot ID 3
 */

  /* Optional */
  /*  Update MSD Version ID */
  uint8_t ecall_msdversion_valid;  /**< Must be set to true if ecall_msdversion is being passed */
  uint8_t ecall_msdversion;
  /**<   Update MSD version identifier.
  */
}voice_set_ecall_efs_config_req_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Sets the eCall configuration. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}voice_set_ecall_efs_config_resp_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Queries the eCall configuration. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}voice_get_ecall_efs_config_req_msg_v02;
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Queries the eCall configuration. */
typedef struct {
  ...
  uint8_t voc_config_valid;  /**< Must be set to true if voc_config is being passed */
  uint8_t voc_config;
  /**<   New eCall EFS value to get the vocoder configuration. Values: \n
       - 0 -- Vocoder Rx muting not required \n
       - 1 -- Vocoder Rx muting required
  */

  /* Optional */
  /*  New eCall EFS Dial Number */
  uint8_t ecall_dial_num_valid;  /**< Must be set to true if ecall_dial_num is being passed */
  ecall_dial_num_enum_v02 ecall_dial_num;
  /**<   New eCall EFS to get the dial number. Values: \n
      - VOICE_ECALL_DIAL_NUM_ECALL_NORMAL (0x00) --  eCall dial number normal  \n
      - VOICE_ECALL_DIAL_NUM_ECALL_OVERRIDE (0x01) --  eCall dial number override
 */

  /* Optional */
  /*  New eCall EFS Canned MSD */
  uint8_t canned_msd_valid;  /**< Must be set to true if canned_msd is being passed */
  uint8_t canned_msd;
  /**<   Indicates whether MSD is canned or real. Values: \n
       - 0 -- Real MSD \n
       - 1 -- Canned MSD
  */
  ...
  uint32_t digits_len;  /**< Must be set to # of elements in digits */
  char digits[QMI_VOICE_ECALL_EFS_CONFIG_DIGITS_MAX_LEN_V02];
  /**<   New eCall EFS contains the dial number when ecall_dial_num type is OVERRIDE.
  */
  ...
  uint8_t gnss_update_time_ms_valid;  /**< Must be set to true if gnss_update_time_ms is being passed */
  uint32_t gnss_update_time_ms;
  /**<   New eCall EFS timer value to get GPS after a definite time interval.
  */

  /* Optional */
  /*  New eCall EFS Callback Timer */
  uint8_t test_only_callback_timer_ms_valid;  /**< Must be set to true if test_only_callback_timer_ms is being passed */
  uint32_t test_only_callback_timer_ms;
  /**<   New eCall EFS is callback timer (T9 timer).
  */

  /* Optional */
  /*  New eCall EFS Cleardown Timer */
  uint8_t test_only_call_cleardown_timer_ms_valid;  /**< Must be set to true if test_only_call_cleardown_timer_ms is being passed */
  uint32_t test_only_call_cleardown_timer_ms;
  /**<   New eCall EFS is call cleardown timer (T2 timer).
  */

  /* Optional */
  /*  New eCall EFS Session Timer */
  uint8_t test_only_session_timer_ms_valid;  /**< Must be set to true if test_only_session_timer_ms is being passed */
  uint32_t test_only_session_timer_ms;
  /**<   New eCall EFS is session timer (T7 timer).
  */

  /* Optional */
  /*  New eCall EFS USIM Slot ID */
  uint8_t ecall_usim_slot_id_valid;  /**< Must be set to true if ecall_usim_slot_id is being passed */
  mmgsdi_slot_id_enum_v02 ecall_usim_slot_id;
  /**<   New eCall is slot ID at eCall. Values: \n
      - VOICE_MMGSDI_SLOT_ID_1 (0x00000001) --   MMGSDI slot ID 1 \n
      - VOICE_MMGSDI_SLOT_ID_2 (0x00000002) --   MMGSDI slot ID 2 \n
      - VOICE_MMGSDI_SLOT_ID_3 (0x00000003) --   MMGSDI slot ID 3
 */
  ...
  /* Optional */
  /*  New eCall EFS MSD Version */
  uint8_t ecall_msdversion_valid;  /**< Must be set to true if ecall_msdversion is being passed */
  uint8_t ecall_msdversion;
  /**<   New eCall EFS is the current MSD version identifier.
  */
}voice_get_ecall_efs_config_resp_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Sets the eCall T10 timer value. */
typedef struct {

  /* Mandatory */
  /*  New eCall T10 Timer Value */
  uint32_t t10_timer;
  /**<   New eCall T10 Timer Value. Values: \n
       @UINT32()
  */
}voice_set_ecall_t10_timer_req_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Sets the eCall T10 timer value. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}voice_set_ecall_t10_timer_resp_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Queries the eCall t10 timer value. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}voice_get_ecall_t10_timer_req_msg_v02;
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Queries the eCall t10 timer value. */
typedef struct {
  ...
  /* Optional */
  /*  eCall T10 Timer */
  uint8_t t10_timer_valid;  /**< Must be set to true if t10_timer is being passed */
  uint32_t t10_timer;
  /**<   eCall T10 timer. Values: \n
       @UINT32()
  */
}voice_get_ecall_t10_timer_resp_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Sends the SIP VOS capability of AP. */
typedef struct {
  ...
  */
  ...
  /*  VOS Support */
  uint8_t vos_support;
  /**<   Indicates whether the AP supports VOS feature or not.
  */
}voice_sip_vos_capability_ack_req_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Sends the SIP VOS capability of AP. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}voice_sip_vos_capability_ack_resp_msg_v02;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  */
}sip_vos_coordinate_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  sip_vos_coordinate_type_v02 start_coordinates;
  /**<   Start video coordinates for SIP VOS move event.
  */

  sip_vos_coordinate_type_v02 end_coordinates;
  /**<   End video coordinates for SIP VOS move event.
  */
}sip_vos_move_info_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  sip_vos_coordinate_type_v02 touch_coordinates;
  /**<   Touch video coordinates for SIP VOS touch event.
  */

  uint32_t touch_duration;
}sip_vos_touch_info_type_v02;  /* Type */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Sends a SIP VOS message from the user. */
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  SIP VOS Move Info */
  uint8_t sip_vos_move_info_valid;  /**< Must be set to true if sip_vos_move_info is being passed */
  sip_vos_move_info_type_v02 sip_vos_move_info;
  /**<   Information for SIP VOS move event.
  */

  /* Optional */
  /*  SIP VOS Touch Info */
  uint8_t sip_vos_touch_info_valid;  /**< Must be set to true if sip_vos_touch_info is being passed */
  sip_vos_touch_info_type_v02 sip_vos_touch_info;
  /**<   Information for SIP VOS touch event.
  */
}voice_sip_vos_action_req_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Sends a SIP VOS message from the user. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}voice_sip_vos_action_resp_msg_v02;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_VOICE_GET_ECALL_T10_TIMER_V02
...
//#define REMOVE_QMI_VOICE_GET_SUPS_OPERATION_MODE_V02
...
//#define REMOVE_QMI_VOICE_IUT_CALL_PUSH_DELAY_IND_V02
...
//#define REMOVE_QMI_VOICE_NETWORK_DETECTED_ECC_NUM_IND_V02
//#define REMOVE_QMI_VOICE_NOTIFY_CLIR_MODE_IND_V02
...
//#define REMOVE_QMI_VOICE_RELEASE_AUDIO_V02
...
//#define REMOVE_QMI_VOICE_SET_ECALL_T10_TIMER_V02
...
//#define REMOVE_QMI_VOICE_SIP_DTMF_V02
//#define REMOVE_QMI_VOICE_SIP_DTMF_IND_V02
//#define REMOVE_QMI_VOICE_SIP_VOS_ACTION_V02
//#define REMOVE_QMI_VOICE_SIP_VOS_CAPABILITY_ACK_V02
...
#define QMI_VOICE_IUT_CALL_PUSH_DELAY_IND_V02 0x007B
#define QMI_VOICE_NETWORK_DETECTED_ECC_NUM_IND_V02 0x007C
#define QMI_VOICE_SIP_DTMF_REQ_V02 0x007D
#define QMI_VOICE_SIP_DTMF_RESP_V02 0x007D
#define QMI_VOICE_SIP_DTMF_IND_V02 0x007E
#define QMI_VOICE_NOTIFY_CLIR_MODE_IND_V02 0x007F
#define QMI_VOICE_GET_SUPS_OPERATION_MODE_REQ_V02 0x0080
#define QMI_VOICE_GET_SUPS_OPERATION_MODE_RESP_V02 0x0080
#define QMI_VOICE_RELEASE_AUDIO_REQ_V02 0x0081
#define QMI_VOICE_RELEASE_AUDIO_RESP_V02 0x0081
#define QMI_VOICE_SET_ECALL_CONFIG_REQ_V02 0x0082
#define QMI_VOICE_SET_ECALL_CONFIG_RESP_V02 0x0082
#define QMI_VOICE_GET_ECALL_CONFIG_REQ_V02 0x0083
#define QMI_VOICE_GET_ECALL_CONFIG_RESP_V02 0x0083
#define QMI_VOICE_SET_ECALL_T10_TIMER_REQ_V02 0x0084
#define QMI_VOICE_SET_ECALL_T10_TIMER_RESP_V02 0x0084
#define QMI_VOICE_GET_ECALL_T10_TIMER_REQ_V02 0x0085
#define QMI_VOICE_GET_ECALL_T10_TIMER_RESP_V02 0x0085
#define QMI_VOICE_SIP_VOS_CAPABILITY_ACK_REQ_V02 0x0086
#define QMI_VOICE_SIP_VOS_CAPABILITY_ACK_RESP_V02 0x0086
#define QMI_VOICE_SIP_VOS_ACTION_REQ_V02 0x0087
#define QMI_VOICE_SIP_VOS_ACTION_RESP_V02 0x0087
/**
    @}
  */
