...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/6.0/coex/api/coexistence_service_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9
   It was generated on: Thu Aug  5 2021 (Spin 0)
...
#define COEX_V01_IDL_MINOR_VERS 0x2A
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define COEX_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define COEX_V01_MAX_MESSAGE_ID 0x0059
/**
    @}
  */
...
#define COEX_ANT_BLOCKING_MAX_CLIENTS_V01 4
#define COEX_ANT_MAP_MAX_ANTS_V01 16
#define COEX_UWB_MAX_IF_ENTRIES_V01 4
#define COEX_TRANSPARENT_MSG_MAX_BYTES_V01 32
#define COEX_TRANSPARENT_MSG_MAX_ENTRIES_V01 8
#define COEX_SPMI_CONFIG_MAX_ENTRIES_V01 8
#define COEX_GPR0_CONFIG_MAX_ENTRIES_V01 8
/**
    @}
  */
...
typedef enum {
  ...
  COEX_CARRIER_SECONDARY_11_V01 = 12, /**<  Component carrier ID for twelfth secondary carrier  */
  COEX_CARRIER_SECONDARY_12_V01 = 13, /**<  Component carrier ID for thirteenth secondary carrier  */
  COEX_CARRIER_SECONDARY_13_V01 = 14, /**<  Component carrier ID for fourteenth secondary carrier  */
  COEX_CARRIER_SECONDARY_14_V01 = 15, /**<  Component carrier ID for fifteenth secondary carrier  */
  COEX_CARRIER_SECONDARY_15_V01 = 16, /**<  Component carrier ID for sixteenth secondary carrier  */
...
#define COEX_PCM_RESERVED_FOR_ENABLE_UART_V01 ((coex_policy_config_mask_v01)0x0000000000020000ull) /**<  Policy bitmask reserved for use to enable UART  */
#define COEX_PCM_GPIO_ENABLE_LAA_COEX_V01 ((coex_policy_config_mask_v01)0x0000000000040000ull) /**<  Policy bitmask to enable GPIOs for LAA coexistence  */
...
#define COEX_PCM_ENFORCE_STATIC_WLAN_POWER_BACKOFF_V01 ((coex_wcn_policy_config_mask_v01)0x0000000000000080ull) /**<  Update WLAN Static Power backoff  */
#define COEX_PCM_ENFORCE_WLAN_CGIM_V01 ((coex_wcn_policy_config_mask_v01)0x0000000000000100ull) /**<  Enable WLAN CGIM procedure  */
...
typedef struct {
  ...
  uint32_t num_max_allowed_slot_denials;
  /**<   Number of maximum allowed slot denials over the window. */

  uint32_t num_slots_in_denial_window;
  /**<   Number of slots in window over which the slot denial applies. */
}coex_slot_denial_duty_cycle_params_type_v01;  /* Type */
/**
    @}
  */
...
typedef enum {
  ...
  COEX_NR5G2_TECH_V01 = 11, /**<  NR5G (Instance 2)  */
 ...
 */
  ...
  /**<   Specifies the technology to which this range refers. Values:\n
      ...
      - COEX_NR5G2_TECH (11) --  NR5G (Instance 2)
 */
...
typedef struct {
  ...
  coex_slot_denial_duty_cycle_params_type_v01 duty_cycle_params;
  /**<   Maximum duty cycle. */

  uint32_t max_continuous_denials;
  /**<   Maximum continuous slot denials. */
}coex_wwan_tx_slot_denials_params_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  coex_wwan_tx_slot_denials_params_type_v01 slot_denials;
  /**<   Tx slot denial parameters when reacting to WCN priority. */
...
typedef struct {
  ...
  uint8_t valid;
  /**<   Flag indicating whether this is a valid power limit. */

  int16_t power_dbm10;
  /**<   Tx power limit for WLAN in dBm10 unit. */
}coex_wlan_tx_pwr_limit_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  coex_wlan_tx_pwr_limit_type_v01 wlan_tx_pwr_limit;
  /**<   Tx power limits for WLAN. */
...
typedef struct {
  ...
  coex_carrier_v01 id;
  /**<   Identifies which carrier ID the information refers to. Values:\n
      ...
      - COEX_CARRIER_SECONDARY_11 (12) --  Component carrier ID for twelfth secondary carrier
      - COEX_CARRIER_SECONDARY_12 (13) --  Component carrier ID for thirteenth secondary carrier
      - COEX_CARRIER_SECONDARY_13 (14) --  Component carrier ID for fourteenth secondary carrier
      - COEX_CARRIER_SECONDARY_14 (15) --  Component carrier ID for fifteenth secondary carrier
      - COEX_CARRIER_SECONDARY_15 (16) --  Component carrier ID for sixteenth secondary carrier
 */
...
/** @addtogroup coex_qmi_enums
  ...
  */
typedef enum {
  COEX_NR5G_DUPLEX_MODE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  COEX_NR5G_DUPLEX_MODE_INVALID_V01 = 0, /**<  Invalid duplex mode  */
  COEX_NR5G_DUPLEX_MODE_FDD_V01 = 1, /**<  Frequency division duplex  */
  COEX_NR5G_DUPLEX_MODE_TDD_V01 = 2, /**<  Time division duplex  */
  COEX_NR5G_DUPLEX_MODE_SDL_V01 = 3, /**<  Supplemental donwlink  */
  COEX_NR5G_DUPLEX_MODE_SUL_V01 = 4, /**<  Supplemental uplink  */
  COEX_NR5G_DUPLEX_MODE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}coex_nr5g_duplex_mode_v01;
/**
    @}
  */
...
/** @addtogroup coex_qmi_enums
  ...
  */
typedef enum {
  COEX_NR5G_FREQ_RANGE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  COEX_NR5G_FREQ_RANGE_FR1_V01 = 0, /**<  Frequency range for Sub-6  */
  COEX_NR5G_FREQ_RANGE_FR2_V01 = 1, /**<  Frequency range for mmW  */
  COEX_NR5G_FREQ_RANGE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}coex_nr5g_freq_range_v01;
/**
    @}
  */
...
/** @addtogroup coex_qmi_enums
  ...
  */
typedef enum {
  COEX_NR5G_SUBCARRIER_SPACING_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  COEX_NR5G_SCS_INVALID_V01 = -1, /**<  Default/invalid subcarrier spacing  */
  COEX_NR5G_SCS_15KHZ_V01 = 0, /**<  15 kHz subcarrier spacing  */
  COEX_NR5G_SCS_30KHZ_V01 = 1, /**<  30 kHz subcarrier spacing  */
  COEX_NR5G_SCS_60KHZ_V01 = 2, /**<  60 kHz subcarrier spacing  */
  COEX_NR5G_SCS_120KHZ_V01 = 3, /**<  120 kHz subcarrier spacing  */
  COEX_NR5G_SCS_240KHZ_V01 = 4, /**<  240 kHz subcarrier spacing  */
  COEX_NR5G_SCS_480KHZ_V01 = 5, /**<  480 kHz subcarrier spacing  */
  COEX_NR5G_SUBCARRIER_SPACING_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}coex_nr5g_subcarrier_spacing_v01;
/**
    @}
  */
...
/** @addtogroup coex_qmi_enums
  ...
  */
typedef enum {
  COEX_NR5G_DL_UL_TRANS_PERIODICITY_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  COEX_NR5G_TRANS_PERIOD_0P5_MS_V01 = 0, /**<  Periodicity of 0.5 ms  */
  COEX_NR5G_TRANS_PERIOD_0P625_MS_V01 = 1, /**<  Periodicity of 0.625 ms  */
  COEX_NR5G_TRANS_PERIOD_1_MS_V01 = 2, /**<  Periodicity of 1 ms  */
  COEX_NR5G_TRANS_PERIOD_1P25_MS_V01 = 3, /**<  Periodicity of 1.25 ms  */
  COEX_NR5G_TRANS_PERIOD_2_MS_V01 = 4, /**<  Periodicity of 2 ms  */
  COEX_NR5G_TRANS_PERIOD_2P5_MS_V01 = 5, /**<  Periodicity of 2.5 ms  */
  COEX_NR5G_TRANS_PERIOD_3_MS_V01 = 6, /**<  Periodicity of 3 ms  */
  COEX_NR5G_TRANS_PERIOD_4_MS_V01 = 7, /**<  Periodicity of 4 ms  */
  COEX_NR5G_TRANS_PERIOD_5_MS_V01 = 8, /**<  Periodicity of 5 ms  */
  COEX_NR5G_TRANS_PERIOD_10_MS_V01 = 9, /**<  Periodicity of 10 ms  */
  COEX_NR5G_DL_UL_TRANS_PERIODICITY_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}coex_nr5g_dl_ul_trans_periodicity_v01;
/**
    @}
  */
...
typedef struct {
  ...
  coex_nr5g_dl_ul_trans_periodicity_v01 trans_periodicity;
  /**<   Periodicity of the NR5G DL-UL pattern. Values: \n
      - COEX_NR5G_TRANS_PERIOD_0P5_MS (0) --  Periodicity of 0.5 ms
      - COEX_NR5G_TRANS_PERIOD_0P625_MS (1) --  Periodicity of 0.625 ms
      - COEX_NR5G_TRANS_PERIOD_1_MS (2) --  Periodicity of 1 ms
      - COEX_NR5G_TRANS_PERIOD_1P25_MS (3) --  Periodicity of 1.25 ms
      - COEX_NR5G_TRANS_PERIOD_2_MS (4) --  Periodicity of 2 ms
      - COEX_NR5G_TRANS_PERIOD_2P5_MS (5) --  Periodicity of 2.5 ms
      - COEX_NR5G_TRANS_PERIOD_3_MS (6) --  Periodicity of 3 ms
      - COEX_NR5G_TRANS_PERIOD_4_MS (7) --  Periodicity of 4 ms
      - COEX_NR5G_TRANS_PERIOD_5_MS (8) --  Periodicity of 5 ms
      - COEX_NR5G_TRANS_PERIOD_10_MS (9) --  Periodicity of 10 ms
 */

  uint16_t num_dl_slots;
  /**<    Number of consecutive full downlink slots at the beginning of
        each DL-UL pattern.
  */

  uint16_t num_special_slots;
  /**<    Number of consecutive special slots between full DL and full UL
        slots in each pattern.
  */

  uint16_t num_ul_slots;
  /**<    Number of consecutive full uplink slots at the beginning of
        each DL-UL pattern.
  */
}coex_nr5g_tdd_pattern_type_v01;  /* Type */
/**
    @}
  */
 ...
 */
  ...
  coex_nr5g_duplex_mode_v01 duplex_mode;
  /**<   NR5G supported band duplex mode. Values:\n
      - COEX_NR5G_DUPLEX_MODE_INVALID (0) --  Invalid duplex mode
      - COEX_NR5G_DUPLEX_MODE_FDD (1) --  Frequency division duplex
      - COEX_NR5G_DUPLEX_MODE_TDD (2) --  Time division duplex
      - COEX_NR5G_DUPLEX_MODE_SDL (3) --  Supplemental donwlink
      - COEX_NR5G_DUPLEX_MODE_SUL (4) --  Supplemental uplink
 */

  coex_nr5g_freq_range_v01 freq_range;
  /**<   NR5G frequency range. Values:\n
      - COEX_NR5G_FREQ_RANGE_FR1 (0) --  Frequency range for Sub-6
      - COEX_NR5G_FREQ_RANGE_FR2 (1) --  Frequency range for mmW
 */

  coex_nr5g_subcarrier_spacing_v01 subcarrier_spacing;
  /**<   NR5G subcarrier spacing type. Values:\n
      - COEX_NR5G_SCS_INVALID (-1) --  Default/invalid subcarrier spacing
      - COEX_NR5G_SCS_15KHZ (0) --  15 kHz subcarrier spacing
      - COEX_NR5G_SCS_30KHZ (1) --  30 kHz subcarrier spacing
      - COEX_NR5G_SCS_60KHZ (2) --  60 kHz subcarrier spacing
      - COEX_NR5G_SCS_120KHZ (3) --  120 kHz subcarrier spacing
      - COEX_NR5G_SCS_240KHZ (4) --  240 kHz subcarrier spacing
      - COEX_NR5G_SCS_480KHZ (5) --  480 kHz subcarrier spacing
 */

  coex_nr5g_tdd_pattern_type_v01 tdd_pattern;
  /**<   NR5G time division duplex pattern.
  */
}coex_nr5g_carrier_info_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup coex_qmi_enums
  ...
  */
typedef enum {
  COEX_FR2_STATE_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  COEX_FR2_STATE_INACTIVE_V01 = 0, /**<  FR2 is inactive \n  */
  COEX_FR2_STATE_CONFIGURED_V01 = 1, /**<  FR2 is configured but not activated \n  */
  COEX_FR2_STATE_ACTIVATED_V01 = 2, /**<  FR2 is configured and activated  */
  COEX_FR2_STATE_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}coex_fr2_state_type_v01;
/**
    @}
  */
...
/** @addtogroup coex_qmi_enums
  ...
  */
typedef enum {
  COEX_UWB_MODE_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  COEX_UWB_MODE_P0_V01 = 0, /**<  UWB Priority 0 Mode \n  */
  COEX_UWB_MODE_P1_V01 = 1, /**<  UWB Priority 1 Mode \n  */
  COEX_UWB_MODE_P2_V01 = 2, /**<  UWB Priority 2 Mode \n  */
  COEX_UWB_MODE_P3_V01 = 3, /**<  UWB Priority 3 Mode \n  */
  COEX_UWB_MODE_P4_V01 = 4, /**<  UWB Priority 4 Mode \n  */
  COEX_UWB_MODE_P5_V01 = 5, /**<  UWB Priority 5 Mode  */
  COEX_UWB_MODE_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}coex_uwb_mode_type_v01;
/**
    @}
  */

typedef uint64_t coex_uwb_mode_mask_v01;
#define COEX_UWB_MASK_P0_V01 ((coex_uwb_mode_mask_v01)0x0000000000000001ull) /**<   UWB Priority 0 Mask \n  */
#define COEX_UWB_MASK_P1_V01 ((coex_uwb_mode_mask_v01)0x0000000000000002ull) /**<   UWB Priority 1 Mask \n  */
#define COEX_UWB_MASK_P2_V01 ((coex_uwb_mode_mask_v01)0x0000000000000004ull) /**<   UWB Priority 2 Mask \n  */
#define COEX_UWB_MASK_P3_V01 ((coex_uwb_mode_mask_v01)0x0000000000000008ull) /**<   UWB Priority 3 Mask \n  */
#define COEX_UWB_MASK_P4_V01 ((coex_uwb_mode_mask_v01)0x0000000000000010ull) /**<   UWB Priority 4 Mask \n  */
#define COEX_UWB_MASK_P5_V01 ((coex_uwb_mode_mask_v01)0x0000000000000020ull) /**<   UWB Priority 5 Mask  */
/** @addtogroup coex_qmi_aggregates
    @{
  */
typedef struct {
  ...
  uint32_t module_id;
  /**<   FR2 Module ID that is under mitigation.
       Note that this field is used for mitigation only if
       mitigation is enabled and UWB P0 mode bitmask is set.
  */

  uint32_t freq_start;
  /**<   FR2 starting intermediate frequency that interferes with UWB.
       Units is in kHz. */

  uint32_t freq_end;
  /**<   FR2 ending intermediate frequency that interferes with UWB.
       Units is in kHz. */
}coex_uwb_if_freq_range_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  coex_fr2_state_type_v01 state;
  /**<   Provides the current state of FR2. Values: \n
      - COEX_FR2_STATE_INACTIVE (0) --  FR2 is inactive \n
      - COEX_FR2_STATE_CONFIGURED (1) --  FR2 is configured but not activated \n
      - COEX_FR2_STATE_ACTIVATED (2) --  FR2 is configured and activated
 */

  uint32_t if_freq;
  /**<   Provides the IF frequency of FR2 in kHz.
       This field is valid only if FR2 is configured or activated.
       In other cases this field is reset to zero. */
}coex_fr2_state_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t cdrx_start;
  /**<   Indicates if CDRX started for FR2.
       This field is set to TRUE to indicate a CDRX start.
       This CDRX status could be sent independently of the 1.28sec timer and
       for the CDRX status indication the usage field will be reset to zero. */

  uint32_t usage;
  /**<   Provides the FR2 usage in msec over a 1.28sec window.
       Modem sleep could affect the 1.28sec reporting periodicity.
  */
}coex_fr2_usage_info_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup coex_qmi_enums
  ...
  */
typedef enum {
  COEX_GNSS_BAND_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  COEX_GNSS_BAND_L1_V01 = 1, /**<  GNSS band L1  */
  COEX_GNSS_BAND_L5_V01 = 5, /**<  GNSS band L5  */
  COEX_GNSS_BAND_L1_L5_V01 = 6, /**<  GNSS bands L1 and L5  */
  COEX_GNSS_BAND_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}coex_gnss_band_enum_v01;
/**
    @}
  */
...
/** @addtogroup coex_qmi_enums
  ...
  */
typedef enum {
  COEX_GNSS_L5_LEVEL_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  COEX_GNSS_L5_LEVEL1_V01 = 1, /**<  Level 1 for GNSS band L5  */
  COEX_GNSS_L5_LEVEL2_V01 = 2, /**<  Level 2 for GNSS band L5  */
  COEX_GNSS_L5_LEVEL3_V01 = 3, /**<  Level 3 for GNSS band L5  */
  COEX_GNSS_L5_DEFAULT_V01 = 4, /**<  Default level for GNSS band L5  */
  COEX_GNSS_L5_LEVEL_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}coex_gnss_l5_level_enum_v01;
/**
    @}
  */
...
/** @addtogroup coex_qmi_enums
  ...
  */
typedef enum {
  COEX_ANT_BLOCKING_CLIENT_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  COEX_ANT_BLOCKING_CLIENT_CNV_V01 = 0, /**<  Client CNV(WIFI/BT) for Antenna blocking  */
  COEX_ANT_BLOCKING_CLIENT_RC1_V01 = 1, /**<  Client RC1 for Antenna blocking  */
  COEX_ANT_BLOCKING_CLIENT_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}coex_ant_blocking_client_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t ant_num;
  /**<   Identifies the antenna ID to which the information refers. The bands
...
typedef struct {
  ...
  coex_ant_blocking_client_enum_v01 client_id;
  /**<   Identifies the client to which the antenna blocking information
       refers.
  */

  uint32_t time_multiplier_usec;
  /**<   Multiplier (in usec) by which the received data should be
       multiplied with in order to get the antenna blocking duration.
  */

  uint8_t block_voice;
  /**<   Flag indicating whether antenna blocking should be supported in
       VOLTE and VONR scenarios.
  */

  uint32_t ant_blocking_info_len;  /**< Must be set to # of elements in ant_blocking_info */
  coex_ant_blocking_info_type_v01 ant_blocking_info[COEX_MAX_TX_ANTENNA_V01];
  /**<   Antenna to band number maps for the antennae on which antenna
       blocking should be supported.
  */
}coex_client_ant_blocking_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  uint32_t msg_byte_len;  /**< Must be set to # of elements in msg_byte */
  uint8_t msg_byte[COEX_TRANSPARENT_MSG_MAX_BYTES_V01];
  /**<   Transparent message bytes.
  */
}coex_transparent_msg_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t message_id;
  /**<   ID of the SPMI message which should be rerouted.
  */

  uint8_t type;
  /**<   Arbitration type of the SPMI message.
       Allowed values: \n
       - 0 - A \n
       - 1 - SR
  */
  ...
  uint8_t sid_gid;
  /**<   USID or GID of the device to which the SPMI message should be
       rerouted.
  */

  uint8_t target_subsystem;
  /**<   Target subsystem to which the SPMI message should be sent.
  */

  uint8_t priority;
  /**<   Priority of the SPMI message.
       Allowed values: \n
       - 0 - NONE \n
       - 1 - LOW \n
       - 2 - MEDIUM \n
       - 3 - HIGH
  */
}coex_spmi_msg_config_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t event;
  /**<   Event ID that should be used for writing the GPR0 message.
  */

  uint8_t type;
  /**<   Arbitration type of the GPR0 message.
       Allowed values: \n
       - 0 - A \n
       - 1 - SR
  */
  ...
  uint8_t sid_gid;
  /**<   USID or GID of the device to which the GPR0 message should be
       written.
  */
}coex_spmi_gpr0_config_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Action to be taken by MDM when this conflict is found. Values:\n
      ...
      - COEX_PCM_RESERVED_FOR_ENABLE_UART (0x0000000000020000) --  Policy bitmask reserved for use to enable UART
      - COEX_PCM_GPIO_ENABLE_LAA_COEX (0x0000000000040000) --  Policy bitmask to enable GPIOs for LAA coexistence
 */
  ...
  /**<   Action to be taken by WCN when this conflict is found. Values:\n
      ...
      - COEX_PCM_ENFORCE_TDM_STICKY (0x0000000000000040) --  Run sticky TDM, which is similar to COEX_PCM_ENFORCE_TDM except after TDM
       is triggered, it stays triggered when the WLAN RX rate is recovered to high.
      - COEX_PCM_ENFORCE_STATIC_WLAN_POWER_BACKOFF (0x0000000000000080) --  Update WLAN Static Power backoff
      - COEX_PCM_ENFORCE_WLAN_CGIM (0x0000000000000100) --  Enable WLAN CGIM procedure
 */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  NR5G Component Carrier Information */
  uint8_t nr5g_carrier_info_set_valid;  /**< Must be set to true if nr5g_carrier_info_set is being passed */
  uint32_t nr5g_carrier_info_set_len;  /**< Must be set to # of elements in nr5g_carrier_info_set */
  coex_nr5g_carrier_info_type_v01 nr5g_carrier_info_set[COEX_WWAN_MAX_BANDS_PER_TECH_V01];
  /**<   \n Contains information specific to each active NR5G component carrier.
     To match this TLV to the NR5G Band Information Set TLV, use the same
     index for both arrays.\n
     Note: A carrier must contain one downlink band and can contain up to one uplink
           band. In other words, a carrier ID can be shared by one uplink and one
           downlink. In this case, the carrier information is the same for both.
  */
  ...
  /* Optional */
  /*  NR5G TDD Information */
  uint8_t nr5g_tdd_pattern_valid;  /**< Must be set to true if nr5g_tdd_pattern is being passed */
  coex_nr5g_tdd_pattern_type_v01 nr5g_tdd_pattern;
  /**<   \n  If NR5G is operating with carrier aggregation, this TLV
           reflects the configuration of the primary carrier.
  */

  /* Optional */
  /*  NR5G2 Band Information Set */
  uint8_t nr5g2_band_info_set_valid;  /**< Must be set to true if nr5g2_band_info_set is being passed */
  uint32_t nr5g2_band_info_set_len;  /**< Must be set to # of elements in nr5g2_band_info_set */
  coex_band_type_and_direction_v01 nr5g2_band_info_set[COEX_WWAN_MAX_BANDS_PER_TECH_V01];
  /**<   \n Contains all NR5G2 center frequencies and bandwidths
     for uplink and downlink. A band is specified as both uplink
     and downlink by combining the mask values of uplink and downlink.
  */

  /* Optional */
  /*  NR5G2 Component Carrier Information */
  uint8_t nr5g2_carrier_info_set_valid;  /**< Must be set to true if nr5g2_carrier_info_set is being passed */
  uint32_t nr5g2_carrier_info_set_len;  /**< Must be set to # of elements in nr5g2_carrier_info_set */
  coex_nr5g_carrier_info_type_v01 nr5g2_carrier_info_set[COEX_WWAN_MAX_BANDS_PER_TECH_V01];
  /**<   \n Contains information specific to each active NR5G2 component carrier.
     To match this TLV to the NR5G Band Information Set TLV, use the same
     index for both arrays.\n
     Note: A carrier must contain one downlink band and can contain up to one uplink
           band. In other words, a carrier ID can be shared by one uplink and one
  ...
  */
  ...
  /* Optional */
  /*  NR5G2 TDD Information */
  uint8_t nr5g2_tdd_pattern_valid;  /**< Must be set to true if nr5g2_tdd_pattern is being passed */
  coex_nr5g_tdd_pattern_type_v01 nr5g2_tdd_pattern;
  /**<   \n  If NR5G2 is operating with carrier aggregation, this TLV
           reflects the configuration of the primary carrier.
  */
 ...
 */
  ...
  /* Optional */
  /*  NR5G Tx Continuous Slot Denials Threshold */
  uint8_t nr5g_tx_continuous_slot_denials_threshold_valid;  /**< Must be set to true if nr5g_tx_continuous_slot_denials_threshold is being passed */
  uint32_t nr5g_tx_continuous_slot_denials_threshold;
  /**<   Maximum number of continuous NR5G Tx slot denials
       allowed in the system while reacting to WCI-2's WCN priority.\n
       Note: The default startup value is dynamic based upon current
             implementation. Therefore, the client can use the GET_POLICY
             message to query the current system value.
  */
  ...
  /* Optional */
  /*  NR5G Tx Slot Denials Parameters */
  uint8_t nr5g_tx_slot_denial_params_valid;  /**< Must be set to true if nr5g_tx_slot_denial_params is being passed */
  coex_slot_denial_duty_cycle_params_type_v01 nr5g_tx_slot_denial_params;
  /**<   The parameters for NR5G Tx slot denials allowed
       in the system while reacting to WCI-2's WCN priority (if available).\n
       Note: The default startup value is dynamic, based on current
             implementation. Therefore, the client can use the GET_POLICY
             message to query the current system value.
  */
  ...
  /* Optional */
  /*  WWAN Technology */
  uint8_t secondary_tech_valid;  /**< Must be set to true if secondary_tech is being passed */
  coex_wwan_tech_v01 secondary_tech;
  /**<   WWAN technology the secondary policies are set for. Values: \n
      - COEX_LTE_TECH (0) --  LTE \n
      - COEX_TDSCDMA_TECH (1) --  TD-SCDMA \n
      - COEX_GSM_TECH (2) --  GSM (Instance 1)\n
      - COEX_ONEX_TECH (3) --  CDMA2000\textsuperscript{\textregistered} 1X \n
      ...
      - COEX_NR5G2_TECH (11) --  NR5G (Instance 2)
 \n
 Note: If secondary technology information is not passed, secondary
 policies will be applied to the primary technology.
 */

  /* Optional */
  /*  Technology Instance */
  uint8_t secondary_tech_instance_valid;  /**< Must be set to true if secondary_tech_instance is being passed */
  coex_tech_instance_enum_v01 secondary_tech_instance;
  /**<   WWAN technology instance secondary policies are set for. Values: \n
      - COEX_TECH_INSTANCE1 (0) --  Technology instance 1
      - COEX_TECH_INSTANCE2 (1) --  Technology instance 2
 \n
 Note: At startup, the default value for the technology instance is zero,
 ...
 */
  ...
  /* Optional */
  /*  Carrier ID */
  uint8_t secondary_carrier_valid;  /**< Must be set to true if secondary_carrier is being passed */
  coex_carrier_v01 secondary_carrier;
  /**<   Specifies the component carrier of the technology for which to set the
 secondary policies, if technology is doing carrier aggregation. If this
 field is not present, COEX_CARRIER_PRIMARY is assumed. Values:\n
      - COEX_CARRIER_PRIMARY (0) --  Primary component carrier ID
      - COEX_CARRIER_SECONDARY_0 (1) --  Component carrier ID for first secondary carrier
      - COEX_CARRIER_SECONDARY_1 (2) --  Component carrier ID for second secondary carrier
      - COEX_CARRIER_SECONDARY_2 (3) --  Component carrier ID for third secondary carrier
 ...
 */
  ...
  uint8_t secondary_tech_valid;  /**< Must be set to true if secondary_tech is being passed */
  coex_wwan_tech_v01 secondary_tech;
  /**<   WWAN technology the secondary policies have been set for. Values: \n
      - COEX_LTE_TECH (0) --  LTE \n
      - COEX_TDSCDMA_TECH (1) --  TD-SCDMA \n
      - COEX_GSM_TECH (2) --  GSM (Instance 1)\n
      - COEX_ONEX_TECH (3) --  CDMA2000\textsuperscript{\textregistered} 1X \n
      ...
      - COEX_NR5G2_TECH (11) --  NR5G (Instance 2)
 \n
 Note: If secondary technology information is not passed, it means
 secondary policies have been applied to the primary technology.
 */
  ...
  uint8_t secondary_tech_instance_valid;  /**< Must be set to true if secondary_tech_instance is being passed */
  coex_tech_instance_enum_v01 secondary_tech_instance;
  /**<   WWAN technology instance secondary policies have been set for. Values: \n
      - COEX_TECH_INSTANCE1 (0) --  Technology instance 1
      - COEX_TECH_INSTANCE2 (1) --  Technology instance 2
 \n
 Note: At startup, the default value for the technology instance is zero,
 ...
 */
  ...
  uint8_t secondary_carrier_valid;  /**< Must be set to true if secondary_carrier is being passed */
  coex_carrier_v01 secondary_carrier;
  /**<   Specifies the component carrier of the technology for which secondary
 policies have been set, if technology is doing carrier aggregation.
 Values:\n
      - COEX_CARRIER_PRIMARY (0) --  Primary component carrier ID
      - COEX_CARRIER_SECONDARY_0 (1) --  Component carrier ID for first secondary carrier
      - COEX_CARRIER_SECONDARY_1 (2) --  Component carrier ID for second secondary carrier
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Antenna to WCI-2 Index Map Information */
  uint8_t ant_to_wci2_idx_map_valid;  /**< Must be set to true if ant_to_wci2_idx_map is being passed */
  uint32_t ant_to_wci2_idx_map_len;  /**< Must be set to # of elements in ant_to_wci2_idx_map */
  uint8_t ant_to_wci2_idx_map[COEX_ANT_MAP_MAX_ANTS_V01];
  /**<   Map indicating indices of WCI-2 Type-7 message for different
          antenna numbers. \n
       Note: The indices in the Type-7 message can be 0 to 7 and the
             antenna numbers can be 0 to 15. This array maps to the
             WCI-2 indices for different antenna ID.
  */

  /* Optional */
  /*  Configuration for mmW Tx information */
  uint8_t mmw_tx_info_enabled_valid;  /**< Must be set to true if mmw_tx_info_enabled is being passed */
  uint8_t mmw_tx_info_enabled;
  /**<   Flag indicating whether the mmW Tx information are conveyed in
       WCI-2 Type-7 messages. If set to TRUE, the most significant
       bit in a WCI-2 Type-7 message denotes the Tx state of mmW.
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Enables or disables antenna blocking on a particular antennae. */
typedef struct {
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Enables or disables antenna blocking on a particular antennae. */
typedef struct {
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Request to set the Tx antennae to WCI-2 Type-7 message indices
              mapping. */
typedef struct {
  ...
  /*  Tx Antenna Configuration */
  uint8_t enable;
  /**<   Flag indicating whether host is enabling Tx antenna to index map for
       WCI-2 Type-7 message. If set to FALSE, Tx antenna configuration map
       is disabled and the service sends default index for any Type-7 message.
  */
  ...
  */
  ...
  /**<   Contains the index that will be used for a default Type-7 message. \n
       Note: This is the default index passed as a part of Type-7 message
             if there is no Tx active or Tx is active on an antenna which
             is not present in the map.
  */

  /* Optional */
  /*  Configuration for mmW Tx information */
  uint8_t enable_mmw_tx_info_valid;  /**< Must be set to true if enable_mmw_tx_info is being passed */
  uint8_t enable_mmw_tx_info;
  /**<   Flag indicating whether host is requesting to convey mmW Tx
       information in WCI-2 Type-7 messages. If set to TRUE, the most
       significant bit in a WCI-2 Type-7 message will denote the
       Tx state of mmW.
  */
}coex_set_wci2_tx_ant_map_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Request to set the Tx antennae to WCI-2 Type-7 message indices
              mapping. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_set_wci2_tx_ant_map_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Enables or disables secondary critical carrier for a WWAN
              technology. */
typedef struct {
 ...
 */
  ...
  uint8_t carrier_valid;  /**< Must be set to true if carrier is being passed */
  coex_carrier_v01 carrier;
  /**<   Specifies the critical component carrier for this particular WWAN
 technology. Values:\n
      - COEX_CARRIER_PRIMARY (0) --  Primary component carrier ID
      - COEX_CARRIER_SECONDARY_0 (1) --  Component carrier ID for first secondary carrier
      - COEX_CARRIER_SECONDARY_1 (2) --  Component carrier ID for second secondary carrier
 ...
 */
  ...
  /**<   \n WWAN band on which critical carrier needs to be set. \n
       Notes: \begin{itemize1}
        ...
        \end{itemize1}
  */
}coex_set_secondary_crit_carrier_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Enables or disables secondary critical carrier for a WWAN
              technology. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_set_secondary_crit_carrier_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Sets the thresholds of WLAN Tx activity for deactivating or
              reactivating LAA secondary cell. */
typedef struct {

  /* Mandatory */
  /*  Threshold In Percentage */
  uint8_t threshold_in_percentage;
  /**<   Threshold for 5 GHz Wi-Fi Tx activity in percentage above which to
       deactivate LAA secondary cell.
  */

  /* Mandatory */
  /*  Threshold Out Percentage */
  uint8_t threshold_out_percentage;
  /**<   Threshold for 5 GHz Wi-Fi Tx activity in percentage below which to
       reactivate LAA secondary cell. This must be less than
       Threshold In Percentage TLV.
  */

  /* Mandatory */
  /*  Deactivation Timer Duration */
  uint32_t deactivation_timer_ms;
  /**<   Timer duration (in ms) for which deactivation of LAA secondary
       cell should be delayed after 5 GHz Wi-Fi Tx activity crosses
       Threshold In Percentage TLV.
  */

  /* Mandatory */
  /*  Reactivation Timer Duration */
  uint32_t stop_deactivation_timer_ms;
  /**<   Timer duration (in ms) for which reactivation of LAA secondary
       cell should be delayed after 5 GHz Wi-Fi Tx activity falls below
       Threshold Out Percentage TLV.
  */
}coex_set_laa_thresholds_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Sets the thresholds of WLAN Tx activity for deactivating or
              reactivating LAA secondary cell. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_set_laa_thresholds_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Enables or disables throttling of outgoing GPIO for LAA
              coexistence. */
typedef struct {
  ...
  /*  Enable Throttling */
  uint8_t enable;
  /**<   Set to TRUE to enable throttling of the outgoing GPIO. Otherwise,
       throttling will be cancelled.
  */

  /* Optional */
  /*  Periodicty of Throttling */
  uint8_t periodicity_ms_valid;  /**< Must be set to true if periodicity_ms is being passed */
  uint32_t periodicity_ms;
  /**<   Periodicity of throttling (in ms) for the outgoing GPIO. If this
       field is not present, the GPIO will be set when needed without any
       throttling.
  */

  /* Optional */
  /*  Duration */
  uint8_t duration_ms_valid;  /**< Must be set to true if duration_ms is being passed */
  uint32_t duration_ms;
  /**<   Duration (in ms) -- reserved for future use.
  */
}coex_set_laa_gpio_throttle_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Enables or disables throttling of outgoing GPIO for LAA
              coexistence. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_set_laa_gpio_throttle_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Enables or disables GNSS bands for GNSS L1/L5 coexistence. */
typedef struct {

  /* Mandatory */
  /*  Enable GNSS */
  uint8_t enable;
  /**<   Set to TRUE to enable GNSS for GNSS L1/L5 coexistence.
  */

  /* Optional */
  /*  GNSS Band */
  uint8_t gnss_band_valid;  /**< Must be set to true if gnss_band is being passed */
  coex_gnss_band_enum_v01 gnss_band;
  /**<   GNSS band for GNSS L1/L5 coexistence.Values: \n
      - COEX_GNSS_BAND_L1 (1) --  GNSS band L1
      - COEX_GNSS_BAND_L5 (5) --  GNSS band L5
      - COEX_GNSS_BAND_L1_L5 (6) --  GNSS bands L1 and L5
 */

  /* Optional */
  /*  GNSS L5 Level */
  uint8_t gnss_l5_level_valid;  /**< Must be set to true if gnss_l5_level is being passed */
  coex_gnss_l5_level_enum_v01 gnss_l5_level;
  /**<   Level for GNSS band L5.Values: \n
      - COEX_GNSS_L5_LEVEL1 (1) --  Level 1 for GNSS band L5
      - COEX_GNSS_L5_LEVEL2 (2) --  Level 2 for GNSS band L5
      - COEX_GNSS_L5_LEVEL3 (3) --  Level 3 for GNSS band L5
      - COEX_GNSS_L5_DEFAULT (4) --  Default level for GNSS band L5
 */
}coex_set_gnss_band_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Enables or disables GNSS bands for GNSS L1/L5 coexistence. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_set_gnss_band_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Sets the mitigation configuration for UWB. */
typedef struct {

  /* Mandatory */
  /*  Mitigation Enable */
  uint8_t enable;
  /**<   Set to TRUE to enable FR2 mitigation for UWB.
       Set to FALSE to disable FR2 mitigation for UWB.
       By default this mitigation is disabled.
  */

  /* Optional */
  /*  Mitigation Mode */
  uint8_t uwb_mode_valid;  /**< Must be set to true if uwb_mode is being passed */
  coex_uwb_mode_mask_v01 uwb_mode;
  /**<   This field indicates the UWB active modes. Multiple modes could
 be active at the same time as indicated by the mask. Values: \n
      - COEX_UWB_MASK_P0 (0x0000000000000001) --   UWB Priority 0 Mask \n
      - COEX_UWB_MASK_P1 (0x0000000000000002) --   UWB Priority 1 Mask \n
      - COEX_UWB_MASK_P2 (0x0000000000000004) --   UWB Priority 2 Mask \n
      - COEX_UWB_MASK_P3 (0x0000000000000008) --   UWB Priority 3 Mask \n
      - COEX_UWB_MASK_P4 (0x0000000000000010) --   UWB Priority 4 Mask \n
      - COEX_UWB_MASK_P5 (0x0000000000000020) --   UWB Priority 5 Mask
 */

  /* Optional */
  /*  Mitigation Module and Frequencies */
  uint8_t uwb_victim_info_valid;  /**< Must be set to true if uwb_victim_info is being passed */
  uint32_t uwb_victim_info_len;  /**< Must be set to # of elements in uwb_victim_info */
  coex_uwb_if_freq_range_type_v01 uwb_victim_info[COEX_UWB_MAX_IF_ENTRIES_V01];
  /**<   Module ID and IF frequencies of FR2 agressor.
  */
}coex_configure_uwb_mitigation_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Sets the mitigation configuration for UWB. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_configure_uwb_mitigation_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Indication Message; Indicates the state of FR2 including IF frequency. */
typedef struct {

  /* Optional */
  /*  FR2 State Information */
  uint8_t fr2_state_valid;  /**< Must be set to true if fr2_state is being passed */
  coex_fr2_state_info_type_v01 fr2_state;
  /**<   \n
       Indicates the state of FR2 and whether it is configured.
       If configured this also indicates the IF frequency.
  */
}coex_fr2_state_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Indication Message; Indicates the usage of FR2 over a 1.28second window. */
typedef struct {

  /* Optional */
  /*  FR2 Usage Information */
  uint8_t fr2_usage_valid;  /**< Must be set to true if fr2_usage is being passed */
  coex_fr2_usage_info_type_v01 fr2_usage;
  /**<   \n
       Indicates the usage of FR2 and whether CDRX is configured.
  */
}coex_fr2_usage_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Transfers transparent messages between the host and baseband
              for COEX purposes. */
typedef struct {

  /* Optional */
  /*  Transparent Message Information */
  uint8_t transparent_msg_valid;  /**< Must be set to true if transparent_msg is being passed */
  uint32_t transparent_msg_len;  /**< Must be set to # of elements in transparent_msg */
  coex_transparent_msg_type_v01 transparent_msg[COEX_TRANSPARENT_MSG_MAX_ENTRIES_V01];
  /**<   \n Transparent message entries.
  */
}coex_pass_transparent_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Transfers transparent messages between the host and baseband
              for COEX purposes. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_pass_transparent_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Enables the host to overwrite configurations for outgoing SPMI
              messages from baseband. */
typedef struct {

  /* Mandatory */
  /*  SPMI Configurations */
  uint32_t spmi_config_len;  /**< Must be set to # of elements in spmi_config */
  coex_spmi_msg_config_type_v01 spmi_config[COEX_SPMI_CONFIG_MAX_ENTRIES_V01];
  /**<   \n SPMI configurations that should be applied by baseband during an
          outgoing SPMI message.
  */
}coex_configure_spmi_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Enables the host to overwrite configurations for outgoing SPMI
              messages from baseband. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_configure_spmi_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Enables the host to overwrite default configurations of the GPR0
              writes by baseband. */
typedef struct {

  /* Mandatory */
  /*  GPR0 Configurations */
  uint32_t gpr0_config_len;  /**< Must be set to # of elements in gpr0_config */
  coex_spmi_gpr0_config_type_v01 gpr0_config[COEX_GPR0_CONFIG_MAX_ENTRIES_V01];
  /**<   \n GPR0 configurations that should be applied by baseband during a
          GPR0 write.
  */
}coex_configure_gpr0_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Enables the host to overwrite default configurations of the GPR0
              writes by baseband. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_configure_gpr0_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Sets antenna blocking on a particular antenna for any specific
              client. */
typedef struct {

  /* Optional */
  /*  Client Antenna Blocking Information */
  uint8_t client_info_valid;  /**< Must be set to true if client_info is being passed */
  uint32_t client_info_len;  /**< Must be set to # of elements in client_info */
  coex_client_ant_blocking_info_type_v01 client_info[COEX_ANT_BLOCKING_MAX_CLIENTS_V01];
  /**<   \n Antenna blocking information for the specific clients.
  */
}coex_set_client_ant_blocking_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Sets antenna blocking on a particular antenna for any specific
              client. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_set_client_ant_blocking_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Enables or disables antenna blocking on a specific client. */
typedef struct {

  /* Mandatory */
  /*  Client ID */
  coex_ant_blocking_client_enum_v01 client_id;
  /**<   Client ID for which to enable or disable antenna blocking.
  */

  /* Mandatory */
  /*  Enable or Disable Antenna Blocking */
  uint8_t enable;
  /**<   Flag indicating whether to enable or disable antenna blocking
       for this client.
  */

  /* Optional */
  /*  Duration of Antenna Blocking */
  uint8_t duration_ms_valid;  /**< Must be set to true if duration_ms is being passed */
  uint32_t duration_ms;
  /**<   Duration of antenna blocking in msec.
  */
}coex_trig_client_ant_blocking_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Enables or disables antenna blocking on a specific client. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_trig_client_ant_blocking_resp_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_COEX_CONFIGURE_GPR0_V01
//#define REMOVE_QMI_COEX_CONFIGURE_LTE_5GHZ_V01
//#define REMOVE_QMI_COEX_CONFIGURE_NR_V01
//#define REMOVE_QMI_COEX_CONFIGURE_SPMI_V01
//#define REMOVE_QMI_COEX_CONFIG_TIME_SHARE_V01
//#define REMOVE_QMI_COEX_CONFIG_UWB_MITIGATION_V01
//#define REMOVE_QMI_COEX_FR2_STATE_INFO_IND_V01
//#define REMOVE_QMI_COEX_FR2_USAGE_INFO_IND_V01
...
//#define REMOVE_QMI_COEX_PASS_TRANSPARENT_V01
...
//#define REMOVE_QMI_COEX_SET_CLIENT_ANT_BLOCKING_V01
//#define REMOVE_QMI_COEX_SET_CRIT_CARRIER_V01
//#define REMOVE_QMI_COEX_SET_GNSS_BAND_V01
//#define REMOVE_QMI_COEX_SET_LAA_GPIO_THROTTLE_V01
//#define REMOVE_QMI_COEX_SET_LAA_THRESHOLDS_V01
//#define REMOVE_QMI_COEX_SET_POLICY_V01
//#define REMOVE_QMI_COEX_SET_SCAN_FREQ_BAND_FILTER_V01
//#define REMOVE_QMI_COEX_SET_SECONDARY_CRIT_CARRIER_V01
//#define REMOVE_QMI_COEX_SET_SLEEP_NOTIFICATION_V01
//#define REMOVE_QMI_COEX_SET_WCI2_TX_ANT_MAP_V01
...
//#define REMOVE_QMI_COEX_TRIG_CLIENT_ANT_BLOCKING_V01
...
#define QMI_COEX_SET_WCI2_TX_ANT_MAP_REQ_V01 0x004D
#define QMI_COEX_SET_WCI2_TX_ANT_MAP_RESP_V01 0x004D
#define QMI_COEX_SET_SECONDARY_CRIT_CARRIER_REQ_V01 0x004E
#define QMI_COEX_SET_SECONDARY_CRIT_CARRIER_RESP_V01 0x004E
#define QMI_COEX_SET_LAA_THRESHOLDS_REQ_V01 0x004F
#define QMI_COEX_SET_LAA_THRESHOLDS_RESP_V01 0x004F
#define QMI_COEX_SET_LAA_GPIO_THROTTLE_REQ_V01 0x0050
#define QMI_COEX_SET_LAA_GPIO_THROTTLE_RESP_V01 0x0050
#define QMI_COEX_SET_GNSS_BAND_REQ_V01 0x0051
#define QMI_COEX_SET_GNSS_BAND_RESP_V01 0x0051
#define QMI_COEX_CONFIG_UWB_MITIGATION_REQ_V01 0x0052
#define QMI_COEX_CONFIG_UWB_MITIGATION_RESP_V01 0x0052
#define QMI_COEX_FR2_STATE_INFO_IND_V01 0x0053
#define QMI_COEX_FR2_USAGE_INFO_IND_V01 0x0054
#define QMI_COEX_PASS_TRANSPARENT_REQ_V01 0x0055
#define QMI_COEX_PASS_TRANSPARENT_RESP_V01 0x0055
#define QMI_COEX_CONFIGURE_SPMI_REQ_V01 0x0056
#define QMI_COEX_CONFIGURE_SPMI_RESP_V01 0x0056
#define QMI_COEX_CONFIGURE_GPR0_REQ_V01 0x0057
#define QMI_COEX_CONFIGURE_GPR0_RESP_V01 0x0057
#define QMI_COEX_SET_CLIENT_ANT_BLOCKING_REQ_V01 0x0058
#define QMI_COEX_SET_CLIENT_ANT_BLOCKING_RESP_V01 0x0058
#define QMI_COEX_TRIG_CLIENT_ANT_BLOCKING_REQ_V01 0x0059
#define QMI_COEX_TRIG_CLIENT_ANT_BLOCKING_RESP_V01 0x0059
/**
    @}
  */
