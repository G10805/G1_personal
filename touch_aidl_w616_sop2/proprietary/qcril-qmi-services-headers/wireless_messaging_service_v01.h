...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/6.2/wms/api/wireless_messaging_service_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define WMS_V01_IDL_MINOR_VERS 0x27
...
/** @addtogroup wms_qmi_enums
  ...
  */
typedef enum {
  WMS_IMS_RAT_INFO_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  WMS_IMS_RAT_NONE_V01 = 0x00, /**<  MO SMS triggered over NAS \n  */
  WMS_IMS_RAT_WCDMA_V01 = 0x01, /**<  MO SMS is sent over IMS transport type on WCDMA RAT \n  */
  WMS_IMS_RAT_LTE_V01 = 0x02, /**<  MO SMS is sent over IMS transport type on LTE RAT \n  */
  WMS_IMS_RAT_NR_V01 = 0x03, /**<  MO SMS is sent over IMS transport type on NR RAT \n  */
  WMS_IMS_RAT_WLAN_V01 = 0x04, /**<  MO SMS is sent over IMS transport type on WLAN \n  */
  WMS_IMS_RAT_CIWLAN_V01 = 0x05, /**<  MO SMS is sent over IMS transport type on CIWLAN  */
  WMS_IMS_RAT_INFO_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wms_ims_rat_info_enum_v01;
/**
    @}
  */
...
typedef enum {
  ...
  WMS_MESSAGE_BLOCKED_DUE_TO_ACCESS_BARRING_V01 = 0x02,
 ...
 */
  ...
  uint8_t barring_timer_valid;  /**< Must be set to true if barring_timer is being passed */
  ...
  /* Optional */
  /*  IMS SMS Mode */
  uint8_t ims_rat_info_valid;  /**< Must be set to true if ims_rat_info is being passed */
  wms_ims_rat_info_enum_v01 ims_rat_info;
  /**<   \n
          (Indicates on which RAT IMS the MO SMS is sent)
    */
...
typedef struct {
  ...
  /* Optional */
  /*  NV GW Del Per Sub** */
  uint8_t nv_gw_del_per_sub_valid;  /**< Must be set to true if nv_gw_del_per_sub is being passed */
  uint8_t nv_gw_del_per_sub;
  /**<   NV GW Del Per Sub. Values: \n
         - 0x00 -- Delete complete NV GW SMS (default) \n
         - 0x01 -- Delete NV GW SMS related to particular sub
    */
...
typedef struct {
  ...
  */
  ...
  uint8_t reg_bc_cfg_chng_events_valid;  /**< Must be set to true if reg_bc_cfg_chng_events is being passed */
  uint8_t reg_bc_cfg_chng_events;
  /**<   Values: \n
       - 0x00 -- Disable (default)\n
       - 0x01 -- Enable
  */
