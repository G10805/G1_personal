...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/6.2/dms/api/device_management_service_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define DMS_V01_IDL_MINOR_VERS 0x58
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define DMS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define DMS_V01_MAX_MESSAGE_ID 0x007E
/**
    @}
  */
...
#define QMI_DMS_MASK_BAND_PREF_TDS_BANDA_V01 ((dms_tds_band_capability_mask_v01)0x0000000000000001ull) /**<  TDS Band A 1900-1920 MHz, 2010-2020 MHz \n  */
#define QMI_DMS_MASK_BAND_PREF_TDS_BANDB_V01 ((dms_tds_band_capability_mask_v01)0x0000000000000002ull) /**<  TDS Band B 1850-1910 MHz, 1930-1990 MHz \n  */
#define QMI_DMS_MASK_BAND_PREF_TDS_BANDC_V01 ((dms_tds_band_capability_mask_v01)0x0000000000000004ull) /**<  TDS Band C 1910-1930 MHz \n  */
#define QMI_DMS_MASK_BAND_PREF_TDS_BANDD_V01 ((dms_tds_band_capability_mask_v01)0x0000000000000008ull) /**<  TDS Band D 2570-2620 MHz \n  */
#define QMI_DMS_MASK_BAND_PREF_TDS_BANDE_V01 ((dms_tds_band_capability_mask_v01)0x0000000000000010ull) /**<  TDS Band E 2300-2400 MHz \n  */
#define QMI_DMS_MASK_BAND_PREF_TDS_BANDF_V01 ((dms_tds_band_capability_mask_v01)0x0000000000000020ull) /**<  TDS Band F 1880-1920 MHz   */
/** @addtogroup dms_qmi_enums
    @{
  */
typedef enum {
...
/** @addtogroup dms_qmi_enums
  ...
  */
typedef enum {
  DMS_DEVICE_STATE_FAIL_REASON_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DMS_DEVICE_STATE_FAIL_RF_SW_V01 = 1, /**<  RF software failure. \n  */
  DMS_DEVICE_STATE_FAIL_RF_HW_V01 = 2, /**<  RF hardware failure. \n  */
  DMS_DEVICE_STATE_FAIL_GPS_V01 = 3, /**<  GPS failure. \n  */
  DMS_DEVICE_STATE_FAIL_REASON_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}dms_device_state_fail_reason_enum_v01;
/**
    @}
  */
...
/** @addtogroup dms_qmi_enums
  ...
  */
typedef enum {
  DMS_DEVICE_INIT_STATE_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DMS_INIT_STATE_UNSPECIFIED_V01 = 0, /**<  Device initialization state unspecified. \n   */
  DMS_INIT_STATE_IN_PROGRESS_V01 = 1, /**<  Device initialization in progress. \n   */
  DMS_INIT_STATE_READY_V01 = 2, /**<  Device initialized. \n  */
  DMS_INIT_STATE_FAILED_V01 = 3, /**<  Device initialization failed.   */
  DMS_DEVICE_INIT_STATE_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}dms_device_init_state_enum_v01;
/**
    @}
  */
...
typedef enum {
  ...
  DMS_OP_MODE_LOW_POWER_2_V01 = 0x0A, /**<  Low Power mode 2 - use for OEM customization,
                                       do not use for regular LPM operations.
									   Deprecated in favor of DMS_OP_MODE_SDRM from version 1.82 onwards  */
  DMS_OP_MODE_SDRM_V01 = 0x0B, /**<  Software defined radio mode - use for OEM customization   */
...
typedef enum {
  ...
  DMS_UIM_INITIALIZATION_COMPLETED_V01 = 0x00, /**<  UIM initialization is complete \n  */
...
#define DMS_SUBS_CAPABILITY_NR5G_V01 ((dms_subs_capability_mask_type_v01)0x00000080ull) /**<  NR5G can be used as NSA \n  */
#define DMS_SUBS_CAPABILITY_NR5G_SA_V01 ((dms_subs_capability_mask_type_v01)0x00000100ull) /**<  NR5G SA  */
/** @addtogroup dms_qmi_enums
    @{
  */
typedef enum {
...
typedef struct {
  ...
  float delta_value;
  /**<   Minimum change in sensor values, which must be treated as policy
...
typedef struct {
 ...
 The client ignores any bits in the mask that it does not recognize. Values:
      ...
      - DMS_SUBS_CAPABILITY_NR5G (0x00000080) --  NR5G can be used as NSA \n
      - DMS_SUBS_CAPABILITY_NR5G_SA (0x00000100) --  NR5G SA  */
 ...
 */
  ...
  /**<   Current operating mode. Values: \n
      ...
      - DMS_OP_MODE_LOW_POWER_2 (0x0A) --  Low Power mode 2 - use for OEM customization,
                                       do not use for regular LPM operations.
									   Deprecated in favor of DMS_OP_MODE_SDRM from version 1.82 onwards
      - DMS_OP_MODE_SDRM (0x0B) --  Software defined radio mode - use for OEM customization
 */
  ...
  /**<   UIM state. Values: \n
      - DMS_UIM_INITIALIZATION_COMPLETED (0x00) --  UIM initialization is complete \n
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Report Device Activity State Requests */
  uint8_t report_device_activity_state_reqs_valid;  /**< Must be set to true if report_device_activity_state_reqs is being passed */
  uint8_t report_device_activity_state_reqs;
  /**<   Values: \n
    - 0 -- Do not report \n
    - 1 -- Report device activity state requests from the modem
  */

  /* Optional */
  /*  Report Device State */
  uint8_t report_device_state_valid;  /**< Must be set to true if report_device_state is being passed */
  uint8_t report_device_state;
  /**<   Values: \n
    - 0 -- Do not report \n
    - 1 -- Report device state
  */

  /* Optional */
  /*  Report IMEI type change */
  uint8_t report_imei_type_change_valid;  /**< Must be set to true if report_imei_type_change is being passed */
  uint8_t report_imei_type_change;
  /**<   Values: \n
    - 0 -- Do not report \n
    - 1 -- Report IMEI type change
  */

  /* Optional */
  /*  Report Non-Encrypt IMEI */
  uint8_t report_nonencrypt_imei_valid;  /**< Must be set to true if report_nonencrypt_imei is being passed */
  uint8_t report_nonencrypt_imei;
  /**<   Values: \n
    - 0 -- FALSE \n
    - 1 -- TRUE
  */
...
/** @addtogroup dms_qmi_enums
  ...
  */
typedef enum {
  DMS_HYBRID_DSDA_CAPABILITY_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DMS_HYBRID_DSDA_UNSUPPORTED_V01 = 1, /**<  Hybrid DSDA is not supported   */
  DMS_HYBRID_DSDA_SUPPORTED_V01 = 2, /**<  Hybrid DSDA is supported   */
  DMS_HYBRID_DSDA_CAPABILITY_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}dms_hybrid_dsda_capability_v01;
/**
    @}
  */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  Hybrid DSDA Capability */
  uint8_t hybrid_dsda_capability_valid;  /**< Must be set to true if hybrid_dsda_capability is being passed */
  dms_hybrid_dsda_capability_v01 hybrid_dsda_capability;
  /**<   \n Indicates hybrid DSDA capability (static capability). Hybrid DSDA is the
 capability of UE to operate in dual subscription with dual active based
 on RAT combination and UE location. Only applicable when
 TLV Device Multisim Voice Data Capability is
 max_subscriptions >= 2 and max_active >= 2. Values:\n
      - DMS_HYBRID_DSDA_UNSUPPORTED (1) --  Hybrid DSDA is not supported
      - DMS_HYBRID_DSDA_SUPPORTED (2) --  Hybrid DSDA is supported
 */
...
typedef struct {
  ...
  /**<   Specifies the ID of the PIN to enable or disable. Values: \n
 ...
 */
  ...
  */
  ...
  /**<   Specifies the PIN value of the PIN to enable/disable. The
...
typedef struct {
  ...
  dms_pin_id_enum_v01 pin_id;
  /**<   Specifies the ID of the PIN to change. Values: \n
      - DMS_QMI_PIN_ID_PIN_1 (0x01) --  PIN1 (also called PIN) \n
      - DMS_QMI_PIN_ID_PIN_2 (0x02) --  PIN2
 */
...
typedef struct {
  ...
  uint8_t is_pending;
  /**<   Specifies whether E911 is pending. */

  dms_bind_subscription_enum_v01 subscription_id;
  /**<   Specifies the subscription on which the E911 call is pending. \n
 This field is only applicable/processed when the is_pending field is sent as TRUE. \n
 Values: \n
      - DMS_PRIMARY_SUBS (0x0001) --  Primary \n
      - DMS_SECONDARY_SUBS (0x0002) --  Secondary \n
      - DMS_TERTIARY_SUBS (0x0003) --  Tertiary
 */
}dms_e911_pending_type_v01;  /* Type */
/**
    @}
  */
 ...
 */
  ...
  /* Optional */
  /*  E911 Pending Information */
  uint8_t e911_pending_info_valid;  /**< Must be set to true if e911_pending_info is being passed */
  dms_e911_pending_type_v01 e911_pending_info;
  /**<     */
...
typedef struct {
  ...
  dms_device_state_fail_reason_enum_v01 fail_reason;
  /**<   Failure reason with setting the operation mode. Values:\n
      - DMS_DEVICE_STATE_FAIL_RF_SW (1) --  RF software failure. \n
      - DMS_DEVICE_STATE_FAIL_RF_HW (2) --  RF hardware failure. \n
      - DMS_DEVICE_STATE_FAIL_GPS (3) --  GPS failure. \n
 */
...
typedef struct {
  ...
  /**<   Activation code to use by the default activation type
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Queries the band capability of the device. (Deprecated) */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Queries the band capability of the device. (Deprecated) */
typedef struct {
  ...
  */
  ...
  /**<   Array of supported NR5G bands where each entry is a
       ...
       The bands are comprised of both SA and NSA bands.
  */
...
typedef struct {
  ...
  /**<   Configuration parameters to use for TDS CDMA. Values: \n
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  Modem Only Timer */
  uint8_t modem_only_timer_valid;  /**< Must be set to true if modem_only_timer is being passed */
  uint32_t modem_only_timer;
  /**<   PSM periodic modem only timer value (in seconds).
  */
 ...
 */
  ...
  /* Optional */
  /*  ENDC Mute Feature */
  uint8_t endc_mute_feature_valid;  /**< Must be set to true if endc_mute_feature is being passed */
  uint8_t endc_mute_feature;
  /**<   Extra Network Dual Connectivity (ENDC) mute feature. Values:\n
       - 0 : Do not retrieve (default) \n
       - 1 : Retrieve ENDC mute feature status
   */

  /* Optional */
  /*  ENDC Interactive Configuration */
  uint8_t endc_interactive_config_valid;  /**< Must be set to true if endc_interactive_config is being passed */
  uint8_t endc_interactive_config;
  /**<   ENDC user interactive configuration. Values:\n
       - 0 : Do not retrieve (default) \n
       - 1 : Retrieve ENDC interactive configuration
  */

  /* Optional */
  /*  ENDC Throughput Threshold */
  uint8_t endc_throughput_threshold_valid;  /**< Must be set to true if endc_throughput_threshold is being passed */
  uint8_t endc_throughput_threshold;
  /**<   To retrieve ENDC throughput threshold. Values:\n
       - 0 : Do not retrieve (default) \n
       - 1 : Retrieve ENDC throughput threshold values
   */
 ...
 */
  ...
  /* Optional */
  /*  ENDC Mute Feature */
  uint8_t endc_mute_feature_enable_valid;  /**< Must be set to true if endc_mute_feature_enable is being passed */
  uint8_t endc_mute_feature_enable;
  /**<   ENDC mute feature. Values:\n
  ...
  uint8_t endc_interactive_config_valid;  /**< Must be set to true if endc_interactive_config is being passed */
  uint8_t endc_interactive_config;
  /**<   ENDC user interactive configuration. Only applicable when
       ENDC Mute Feature TLV is enabled in the response.  Values:\n
       - 0 : Modem does not consider interactive state
             in ENDC feature \n
       - 1 : Modem considers interactive state in ENDC mute feature
  */

  /* Optional */
  /*  ENDC Throughput Threshold 1 */
  uint8_t throughput_threshold_1_valid;  /**< Must be set to true if throughput_threshold_1 is being passed */
  uint32_t throughput_threshold_1;
  /**<   ENDC throughput threshold in kbps. Only applicable when
       ENDC Mute Feature TLV is enabled in the response.
   */

  /* Optional */
  /*  ENDC Throughput Threshold 2 */
  uint8_t throughput_threshold_2_valid;  /**< Must be set to true if throughput_threshold_2 is being passed */
  uint32_t throughput_threshold_2;
  /**<   ENDC throughput threshold in kbps. Only applicable when
       ENDC Mute Feature TLV is enabled in the response.
   */
...
typedef enum {
  ...
  DMS_DEVICE_IMAGE_NON_PERF_V01 = 2, /**<  Nonperformance image    */
...
typedef struct {
  ...
  */
  ...
  /**<   Software image type. Values:\n
      ...
      - DMS_DEVICE_IMAGE_NON_PERF (2) --  Nonperformance image
 */
...
typedef enum {
  ...
  DMS_MARB_CLI_GROUP_GNSS_V01 = 0, /**<  For all GNSS clients to use. \n   */
  DMS_MARB_CLI_GROUP_WWAN_V01 = 1, /**<  For all WWAN clients to use.   */
...
typedef struct {
  ...
  /**<   Application that must be prioritized on the modem.
      - DMS_MARB_CLI_GROUP_GNSS (0) --  For all GNSS clients to use. \n
      - DMS_MARB_CLI_GROUP_WWAN (1) --  For all WWAN clients to use.
 */
 ...
 */
  ...
  uint32_t sensor_policy_len;  /**< Must be set to # of elements in sensor_policy */
  dms_sensor_policy_cond_v01 sensor_policy[QMI_DMS_SENSOR_CONFIG_MAX_V01];
  /**<   \n Sensor policy data to configure.
        */
...
/** @addtogroup dms_qmi_enums
  ...
  */
typedef enum {
  DMS_LOADED_TECH_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DMS_LOADED_TECH_NONE_V01 = 0, /**<  No technology loaded. \n  */
  DMS_LOADED_TECH_WWAN_PENDING_V01 = 1, /**<  WWAN pending to load. \n  */
  DMS_LOADED_TECH_GPS_PENDING_V01 = 2, /**<  GPS pending to load. \n  */
  DMS_LOADED_TECH_WWAN_LOADED_V01 = 3, /**<  WWAN loaded. \n */
  DMS_LOADED_TECH_GPS_LOADED_V01 = 4, /**<  GPS loaded.  */
  DMS_LOADED_TECH_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}dms_loaded_tech_type_v01;
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Queries the application priority and loaded technology information from the modem.  */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}dms_get_app_priority_info_req_msg_v01;
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Queries the application priority and loaded technology information from the modem.  */
typedef struct {
  ...
  /* Optional */
  /*  Prioritized Application  */
  uint8_t prioritized_app_valid;  /**< Must be set to true if prioritized_app is being passed */
  dms_marb_client_group_type_v01 prioritized_app;
  /**<   Application that is prioritized on the modem.
      - DMS_MARB_CLI_GROUP_GNSS (0) --  For all GNSS clients to use. \n
      - DMS_MARB_CLI_GROUP_WWAN (1) --  For all WWAN clients to use.
 */
  ...
  /* Optional */
  /*  Loaded Technology  */
  uint8_t loaded_tech_valid;  /**< Must be set to true if loaded_tech is being passed */
  dms_loaded_tech_type_v01 loaded_tech;
  /**<   Technology that is currently loaded on the modem. Values:\n
      - DMS_LOADED_TECH_NONE (0) --  No technology loaded. \n
      - DMS_LOADED_TECH_WWAN_PENDING (1) --  WWAN pending to load. \n
      - DMS_LOADED_TECH_GPS_PENDING (2) --  GPS pending to load. \n
      - DMS_LOADED_TECH_WWAN_LOADED (3) --  WWAN loaded. \n
      - DMS_LOADED_TECH_GPS_LOADED (4) --  GPS loaded.
 */
}dms_get_app_priority_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Sends TE user input to the modem. */
typedef struct {

  /* Optional */
  /*  Auto Registration Consent */
  uint8_t auto_reg_consent_valid;  /**< Must be set to true if auto_reg_consent is being passed */
  uint8_t auto_reg_consent;
  /**<   Consent of the user for PS auto registration.
   */
}dms_send_user_input_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Sends TE user input to the modem. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}dms_send_user_input_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Sets the modem DMS capability.  */
typedef struct {
  ...
  uint8_t endc_interactive_config;
  /**<   ENDC user interactive configuration. Only applicable when
       ENDC Mute Feature TLV is enabled. If TLV not present,
       modem uses modem default configuration. Values:\n
       - 0 : Modem does not consider interactive state
             in ENDC feature \n
       - 1 : Modem considers interactive state in ENDC mute feature
  */
  ...
  /**<   ENDC throughput threshold in kbps. Only applicable when
       ENDC Mute Feature TLV is enabled. If TLV not present,
       modem uses modem default configuration.
   */
  ...
  /**<   ENDC throughput threshold in kbps. Only applicable when
       ...
       modem uses modem default configuration.
   */
}dms_set_capability_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Sets the modem DMS capability.  */
typedef struct {
  ...
  uint8_t endc_interactive_config;
  /**<   ENDC user interactive configuration. Only applicable when
       ENDC Mute Feature TLV is enabled.  Values:\n
       - 0 : Modem does not consider interactive state
             in ENDC feature \n
       - 1 : Modem considers interactive state in ENDC mute feature
  */
  ...
  uint32_t throughput_threshold_1;
  /**<   ENDC throughput threshold in kbps. Only applicable when
       ENDC Mute Feature TLV is enabled.
   */
  ...
  /**<   ENDC throughput threshold in kbps. Only applicable when
       ENDC Mute Feature TLV is enabled.
   */
}dms_set_capability_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}dms_get_band_capability_ex_req_msg_v01;
...
typedef struct {
  ...
  /*  Result Code */
  qmi_response_type_v01 resp;
}dms_get_band_capability_ex_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Indication Message; Indicates band capability of the device
           requested using the QMI_DMS_GET_BAND_CAPABILITY_EX command. */
typedef struct {

  /* Optional */
  /*  Band Capability */
  uint8_t band_capability_valid;  /**< Must be set to true if band_capability is being passed */
  dms_band_capability_mask_v01 band_capability;
  /**<   Bitmask of bands supported by the device; see Appendix
       \ref{app:BandCapability} for the definition of these
       values.
  ...
  */
  ...
  /* Optional */
  /*  Band Capability Low */
  uint8_t band_capability_low_valid;  /**< Must be set to true if band_capability_low is being passed */
  dms_band_capability_mask_v01 band_capability_low;
  /**<   Bitmask of low capabilty bands supported by the device; see Appendix
       \ref{app:BandCapability} for the definition of these
       values.
  */

  /* Optional */
  /*  TDS Band Capability Low */
  uint8_t tds_band_capability_low_valid;  /**< Must be set to true if tds_band_capability_low is being passed */
  dms_tds_band_capability_mask_v01 tds_band_capability_low;
  /**<   This TLV is present on devices that support assymetric TDS bands.
       Bitmask of low cabality TDS bands supported by the device.
       Values: \n
       - Bit 0 -- TDS Band A 1900 to 1920 MHz, 2010 to 2020 MHz \n
       - Bit 1 -- TDS Band B 1850 to 1910 MHz, 1930 to 1990 MHz \n
       - Bit 2 -- TDS Band C 1910 to 1930 MHz \n
  ...
  */
  ...
  /* Optional */
  /*  Supported LTE Bands Low */
  uint8_t supported_lte_bands_low_valid;  /**< Must be set to true if supported_lte_bands_low is being passed */
  uint32_t supported_lte_bands_low_len;  /**< Must be set to # of elements in supported_lte_bands_low */
  uint16_t supported_lte_bands_low[QMI_DMS_MAX_SUPPORTED_LTE_BANDS_V01];
  /**<   Array of supported low capability LTE bands where each entry is a
       decimal representation of the LTE band number supported.
  */

  /* Optional */
  /*  Supported NR5G Bands Low */
  uint8_t supported_nr5g_bands_low_valid;  /**< Must be set to true if supported_nr5g_bands_low is being passed */
  uint32_t supported_nr5g_bands_low_len;  /**< Must be set to # of elements in supported_nr5g_bands_low */
  uint16_t supported_nr5g_bands_low[QMI_DMS_MAX_SUPPORTED_NR5G_BANDS_V01];
  /**<   Array of supported low capability NR5G bands where each entry is a
       decimal representation of the NR5G band number supported.
       The bands are comprised of both SA and NSA bands.
  */
}dms_band_capability_ex_ind_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Optional */
  /*  Report Device Activity State */
  uint8_t report_device_activity_state_valid;  /**< Must be set to true if report_device_activity_state is being passed */
  uint8_t report_device_activity_state;
  /**<   Report device activity state. Values:\n
       -0 -- Do not report\n
       -1 -- Report device activity state
  */
}dms_device_activity_state_request_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_enums
  ...
  */
typedef enum {
  DMS_ACTIVITY_STATE_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DMS_ACTIVITY_STATE_INVALID_V01 = 0, /**<  Activity state invalid. \n   */
  DMS_ACTIVITY_STATE_IDLE_V01 = 1, /**<  Idle state. \n   */
  DMS_ACTIVITY_STATE_ACTIVE_V01 = 2, /**<  Active state.     */
  DMS_ACTIVITY_STATE_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}dms_activity_state_type_v01;
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Notifies the modem about the device activity state.  */
typedef struct {

  /* Mandatory */
  /*  Device Activity State  */
  dms_activity_state_type_v01 activity_state;
  /**<   Device activity state. Values:\n
      - DMS_ACTIVITY_STATE_INVALID (0) --  Activity state invalid. \n
      - DMS_ACTIVITY_STATE_IDLE (1) --  Idle state. \n
      - DMS_ACTIVITY_STATE_ACTIVE (2) --  Active state.
 */
}dms_device_activity_state_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Notifies the modem about the device activity state.  */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}dms_device_activity_state_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Indication Message; Indicates the device state information. */
typedef struct {

  /* Mandatory */
  /*  Device Initialization State */
  dms_device_init_state_enum_v01 init_state;
  /**<   Device initialization state. Values:\n
       @ENUM
  */

  /* Optional */
  /*  Device Initialization Failure Reason */
  uint8_t failure_reason_valid;  /**< Must be set to true if failure_reason is being passed */
  dms_device_state_fail_reason_enum_v01 failure_reason;
  /**<   Device initialization failure reason, applicable when init_state
       is DMS_INIT_STATE_FAILED value. Values:\n
       @ENUM
  */
}dms_device_state_info_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Query device state information. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}dms_get_device_state_info_req_msg_v01;
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Query device state information. */
typedef struct {
  ...
  /* Optional */
  /*  Device Initialization State */
  uint8_t init_state_valid;  /**< Must be set to true if init_state is being passed */
  dms_device_init_state_enum_v01 init_state;
  /**<   Device initialization state. Values:\n
       @ENUM
  */
  ...
  /**<   Device initialization failure reason, applicable when init_state
       ...
       @ENUM
  */
}dms_get_device_state_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Query IMEI information. */
typedef struct {

  /* Optional */
  /*  Exempt Encrypt */
  uint8_t exempt_encrypt_valid;  /**< Must be set to true if exempt_encrypt is being passed */
  uint8_t exempt_encrypt;
  /**<   Exempt_encrypt . Values:\n
       -0 -- FALSE\n
       -1 -- TRUE
  */
}dms_get_imei_info_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Query IMEI information. */
typedef struct {
...
}dms_get_imei_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_enums
  ...
  */
typedef enum {
  DMS_IMEI_TYPE_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DMS_PRIMARY_IMEI_V01 = 0,
  DMS_SECONDARY_IMEI_V01 = 1,
  DMS_IMEI_TYPE_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}dms_imei_type_enum_v01;
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Indication Message; Notifies the IMEI information to control points. */
typedef struct {
  ...
  */
  ...
  /* Mandatory */
  /*  IMEI Type */
  dms_imei_type_enum_v01 imei_type;
  /**<   Type of IMEI. Values:\n
       @ENUM
  */
  ...
  /* Optional */
  /*  Non Encrypted IMEI */
  uint8_t imei_nonencrypted_valid;  /**< Must be set to true if imei_nonencrypted is being passed */
  char imei_nonencrypted[QMI_DMS_IMEI_MAX_V01 + 1];
  /**<   Non Encrypted IMEI of the device.
  */
}dms_imei_info_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_DMS_BAND_CAPABILITY_EX_IND_V01
//#define REMOVE_QMI_DMS_BIND_SUBSCRIPTION_V01
//#define REMOVE_QMI_DMS_CLEAR_TEST_CONFIG_V01
//#define REMOVE_QMI_DMS_DEVICE_ACTIVITY_STATE_V01
//#define REMOVE_QMI_DMS_DEVICE_ACTIVITY_STATE_REQUEST_IND_V01
...
//#define REMOVE_QMI_DMS_DEVICE_STATE_INFO_IND_V01
//#define REMOVE_QMI_DMS_GET_ACTIVATION_STATE_V01
//#define REMOVE_QMI_DMS_GET_ALT_NET_CONFIG_V01
//#define REMOVE_QMI_DMS_GET_APP_PRIORITY_INFO_V01
//#define REMOVE_QMI_DMS_GET_BAND_CAPABILITY_V01
//#define REMOVE_QMI_DMS_GET_BAND_CAPABILITY_EX_V01
...
//#define REMOVE_QMI_DMS_IMEI_INFO_IND_V01
...
//#define REMOVE_QMI_DMS_SEND_USER_INPUT_V01
...
//#define REMOVE_QMI_DMS_SET_CAPABILITY_V01
...
#define QMI_DMS_GET_APP_PRIORITY_INFO_REQ_V01 0x0075
#define QMI_DMS_GET_APP_PRIORITY_INFO_RESP_V01 0x0075
#define QMI_DMS_SEND_USER_INPUT_REQ_V01 0x0076
#define QMI_DMS_SEND_USER_INPUT_RESP_V01 0x0076
#define QMI_DMS_SET_CAPABILITY_REQ_V01 0x0077
#define QMI_DMS_SET_CAPABILITY_RESP_V01 0x0077
#define QMI_DMS_GET_BAND_CAPABILITY_EX_REQ_V01 0x0078
#define QMI_DMS_GET_BAND_CAPABILITY_EX_RESP_V01 0x0078
#define QMI_DMS_BAND_CAPABILITY_EX_IND_V01 0x0078
#define QMI_DMS_DEVICE_ACTIVITY_STATE_REQUEST_IND_V01 0x0079
#define QMI_DMS_DEVICE_ACTIVITY_STATE_REQ_V01 0x007A
#define QMI_DMS_DEVICE_ACTIVITY_STATE_RESP_V01 0x007A
#define QMI_DMS_DEVICE_STATE_INFO_IND_V01 0x007B
#define QMI_DMS_GET_DEVICE_STATE_INFO_REQ_V01 0x007C
#define QMI_DMS_GET_DEVICE_STATE_INFO_RESP_V01 0x007C
#define QMI_DMS_GET_IMEI_INFO_REQ_V01 0x007D
#define QMI_DMS_GET_IMEI_INFO_RESP_V01 0x007D
#define QMI_DMS_IMEI_INFO_IND_V01 0x007E
/**
    @}
  */
