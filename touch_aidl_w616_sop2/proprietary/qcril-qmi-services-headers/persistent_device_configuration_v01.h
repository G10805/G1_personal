...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/6.0/pdc/api/persistent_device_configuration_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define PDC_V01_IDL_MINOR_VERS 0x10
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define PDC_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define PDC_V01_MAX_MESSAGE_ID 0x0033
/**
    @}
  */
...
/** @addtogroup pdc_qmi_enums
  ...
  */
typedef enum {
  PDC_REMOTE_DISCOVERY_EVENT_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  PDC_EVENT_REMOTE_DISCOVERY_START_V01 = 0x00, /**<  Remote discovery start event \n   */
  PDC_EVENT_REMOTE_DISCOVERY_COMPLETE_V01 = 0x01, /**<  Remote discovery complete event  */
  PDC_REMOTE_DISCOVERY_EVENT_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}pdc_remote_discovery_event_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t hw_mbn_discovery_info;
  /**<   Hardware MBN remote discovery information.	 	 */

  uint32_t sw_mbn_discovery_info;
  /**<   Software MBN remote discovery information.*/
}pdc_remote_discover_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Component Configuration */
  uint8_t reg_remote_discovery_event_valid;  /**< Must be set to true if reg_remote_discovery_event is being passed */
  uint8_t reg_remote_discovery_event;
  /**<   Controls the reporting of QMI_PDC_REMOTE_DISCOVERY_EVENT_IND for remote discovery. Values: \n
       - 0x00 -- Disable (default)  \n
       - 0x01 -- Enable
   */
...
/** @addtogroup pdc_qmi_messages
    @{
  */
/** Request Message; Performs the remote discovery procedure. */
typedef struct {
  ...
  /**<   Token used to identify the indication sent when the request is complete.
  */
}pdc_remote_discover_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup pdc_qmi_messages
    @{
  */
/** Response Message; Performs the remote discovery procedure. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:\n
       ...
       qmi_error_type  -- Error code. Possible error code values are described
                          ...
                          definition.
  */
}pdc_remote_discover_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup pdc_qmi_messages
    @{
  */
/** Indication Message; Indication with the Remote discovery result.  */
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Remote Discovery Information */
  uint8_t remote_discovery_info_valid;  /**< Must be set to true if remote_discovery_info is being passed */
  pdc_remote_discover_info_type_v01 remote_discovery_info;
  /**<   Additional information about the remote discovery
        process, which is used for internal debugging.
  */
  ...
  /**<   Token passed in the request that generated.
  */
}pdc_remote_discover_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup pdc_qmi_messages
    @{
  */
/** Indication Message; Indication for remote discovery events. */
typedef struct {

  /* Mandatory */
  /*  Remote discovery event */
  pdc_remote_discovery_event_enum_v01 remote_discovery_event;
  /**<   Remote discovery events. Values: \n
      - PDC_EVENT_REMOTE_DISCOVERY_START (0x00) --  Remote discovery start event \n
      - PDC_EVENT_REMOTE_DISCOVERY_COMPLETE (0x01) --  Remote discovery complete event
 */
}pdc_remote_discovery_event_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_PDC_REMOTE_DISCOVER_V01
//#define REMOVE_QMI_PDC_REMOTE_DISCOVERY_EVENT_IND_V01
//#define REMOVE_QMI_PDC_REMOTE_DISCOVER_IND_V01
...
#define QMI_PDC_REMOTE_DISCOVER_REQ_V01 0x0032
#define QMI_PDC_REMOTE_DISCOVER_RESP_V01 0x0032
#define QMI_PDC_REMOTE_DISCOVER_IND_V01 0x0032
#define QMI_PDC_REMOTE_DISCOVERY_EVENT_IND_V01 0x0033
/**
    @}
  */
