...
{
    fprintf(stderr, "Usage: adrd [OPTIONS]\n\n"
        "  -d\tset all modules log level (QUIET:6, ASSERT:5, ERROR:4, WARNING:3,"
            " INFO:2, DEBUG:1, LOGALL:0) \n"
        "  -da\tset algo log level (QUIET:6, ASSERT:5, ERROR:4, WARNING:3,"
            " INFO:2, DEBUG:1, LOGALL:0) \n"
        "  -dv\tset vehicle log level (QUIET:6, ASSERT:5, ERROR:4, WARNING:3,"
            " INFO:2, DEBUG:1, LOGALL:0) \n"
        "  -h\thelp text\n\n");
    exit(error_code);
}
