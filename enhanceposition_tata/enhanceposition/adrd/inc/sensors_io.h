...
struct ACC_GYRO_DATA {
    struct hwm_sensor_data acc;
    struct hwm_sensor_data gyro;
};

#define FIFO_DATA_CHUNK_NUM 20
#define ACC_GYRO_DEV_DEFAULT "/dev/acc_gyro"
#define BARO_TEMP_DEV_DEFAULT "/dev/baro_temp"
...
#define ACC_GYRO                            0x8A
#define ACC_GYRO_IOCTL_SET_ENABLE           _IOW(ACC_GYRO, 0x01, int)
#define ACC_GYRO_IOCTL_SET_POLLING_RATE     _IOW(ACC_GYRO, 0x02, int)
#define ACC_GYRO_IOCTL_GET_SENSORDATA       _IOR(ACC_GYRO, 0x03, struct ACC_GYRO_DATA*)

#ifdef CONFIG_COMPAT
#define COMPAT_ACC_GYRO_IOCTL_SET_ENABLE       _IOW(ACC_GYRO, 0x01, compat_int_t)
#define COMPAT_ACC_GYRO_IOCTL_SET_POLLING_RATE _IOW(ACC_GYRO, 0x02, compat_int_t)
#define COMPAT_ACC_GYRO_IOCTL_GET_SENSORDATA   _IOR(ACC_GYRO, 0x03, struct ACC_GYRO_DATA*)
#endif

#define BARO_TEMP                            0x8B
#define BARO_TEMP_IOCTL_SET_ENABLE           _IOW(BARO_TEMP, 0x01, int)
#define BARO_TEMP_IOCTL_SET_POLLING_RATE     _IOW(BARO_TEMP, 0x02, int)
#define BARO_TEMP_IOCTL_GET_SENSORDATA       _IOR(BARO_TEMP, 0x03, struct hwm_sensor_data*)

#ifdef CONFIG_COMPAT
#define COMPAT_BARO_TEMP_IOCTL_SET_ENABLE       _IOW(BARO_TEMP, 0x01, compat_int_t)
#define COMPAT_BARO_TEMP_IOCTL_SET_POLLING_RATE _IOW(BARO_TEMP, 0x02, compat_int_t)
#define COMPAT_BARO_TEMP_IOCTL_GET_SENSORDATA   _IOR(BARO_TEMP, 0x03, struct hwm_sensor_data*)
#endif
