...
LOCAL_CFLAGS += -DMTK_GPS_MNL_PROP_PATH="\"/vendor/etc/gnss/\""
...
LOCAL_SHARED_LIBRARIES +=  libmnl libcurl libcutils libc libm libcrypto libssl libz liblog libhardware libutils libhardware
LOCAL_HEADER_LIBRARIES +=  libcutils_headers
LOCAL_EXPORT_HEADER_LIBRARY_HEADERS += libhardware_headers
# MPE HIDL #
LOCAL_SHARED_LIBRARIES += libutils android.frameworks.sensorservice@1.0 android.hardware.sensors@1.0 libhidlbase libhidltransport libsensorndkbridge
LOCAL_MODULE_TAGS := optional
#LOCAL_REQUIRED_MODULES := libmnl.so

include $(BUILD_EXECUTABLE)
include $(MY_LOCAL_PATH)/mnl/MNL/Android.mk
