...
class Gnss : public IGnss {
 ...
 private:
    ...
    static bool isADRActive ;
    static std::string old_angle;
...
//Vehicle_Property *mVehProperty = nullptr;

    static std::vector<std::string> split(std::string str, char delimiter);
    static void nmeaCheckSum(std::string& nmeaString);
    static void updateRMC(char *nmea);
    static void updateGGA(char *nmea);
    static float mCoG;
