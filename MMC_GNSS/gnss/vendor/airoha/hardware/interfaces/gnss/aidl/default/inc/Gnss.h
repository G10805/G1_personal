...
class Gnss : public BnGnss {
  public:
    ...
    std::shared_ptr<GnssNavigationMessageInterface>
        mGnssNavigationMessageInterface;
    std::shared_ptr<GnssPsds> mGnssPsds;
    static void initCb();
    static void reportYearCapName();
    static void reportYear();
    static void reportCap();
    static void reportName(const char* name = nullptr);
    // Location Report
    static void reportLocation(const PreGnssLocation* location);
    static void reportSvStatus(const PreGnssSvStatus* svStatusBlock);
    static void reportNMEA(const NavNmea* nmeaBlock);
    static void reportStatus(
        ::aidl::android::hardware::gnss::IGnssCallback::GnssStatusValue value);
    static void requestTime();
    static void requestLocation();
    static void requestConfigurationSync();

 private:
    static std::shared_ptr<IGnssCallback> sGnssCallback;
    static bool sEnableNmea;
    static bool sEnableSvStatus;
};
