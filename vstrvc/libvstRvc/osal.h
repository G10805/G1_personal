...
//#define LOG_LEVEL_CRITICAL  ANDROID_LOG_FATAL
...
#define LOG_PRINT ALOG
#define LOG_CRIT ALOGE
#define LOG_ERR  ALOGE
#define LOG_WARN ALOGW
...
#define LOG_ONCE(fmt, args...) \
	do {\
		...
		if (LOG_VAR(log_count_, __LINE__) == 0) {\
			...
			LOG_PRINT(LOG_INFO, "[ONCE]", fmt, ##args);\
		}\
	} while(0)
